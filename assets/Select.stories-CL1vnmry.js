import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{g as n,j as r}from"./iframe-ZXKnLi48.js";import{Ar as i,En as a,Tn as o,qn as s,t as c,vt as l}from"./src-4oLAFcVt.js";import{n as u,t as d}from"./onCardStoryShell-Cr8LbQed.js";var f,p,m,h,g,_,v,y,b;e((()=>{f=t(r(),1),s(),c(),u(),p=n(),m=[{value:`apple`,label:`Apple`},{value:`banana`,label:`Banana`},{value:`orange`,label:`Orange`}],h={title:`Components/Dropdown/Select`,component:l,tags:[`autodocs`],args:{options:m,placeholder:`Choose an option`,size:`medium`,state:`default`,disabled:!1,inline:!1,fullWidth:!1},argTypes:{size:{control:`inline-radio`,options:o},inline:{control:`boolean`},fullWidth:{control:`boolean`},disabled:{control:`boolean`},placeholder:{control:`text`},label:{control:`text`},helperText:{control:`text`},errorMessage:{control:`text`},warningMessage:{control:`text`},successMessage:{control:`text`},hideLabel:{control:`boolean`},state:{control:`inline-radio`,options:a}},render:e=>{let[t,n]=(0,f.useState)(e.value);return(0,p.jsx)(l,{...e,value:t,onChange:e=>{n(e)}})},parameters:{docs:{description:{component:`Native select field styled to match the design system. Use when the browser's built-in picker is acceptable and you don't need a rich Dropdown menu.`}}}},g={args:{id:`playground-select`,label:`Label`,helperText:`Helper text below the field.`,errorMessage:`Error message`,warningMessage:`Warning message`,successMessage:`Erledigt`}},_={args:{id:`slot-select`,label:`Label`,helperText:`Helper text below the field.`,successMessage:`Saved`,state:`success`},render:e=>{let[t,n]=(0,f.useState)(e.value);return(0,p.jsx)(l,{...e,value:t,onChange:e=>{n(e)},leadingSlot:(0,p.jsx)(i,{size:12,className:`stroke-icon-info`}),trailingSlot:(0,p.jsx)(`span`,{className:`typography-label-small text-text-accent`,children:`Slot`})})}},v={args:{id:`on-card-select`,label:`Label`,helperText:`Helper text below the field.`,errorMessage:`Error message`,warningMessage:`Warning message`,successMessage:`Erledigt`,surface:`onCard`},render:e=>{let[t,n]=(0,f.useState)(e.value);return(0,p.jsx)(d,{children:(0,p.jsx)(l,{...e,value:t,onChange:e=>{n(e)}})})}},y={parameters:{controls:{disable:!0}},render:()=>(0,p.jsxs)(`div`,{className:`gap-xlg grid max-w-[720px] grid-cols-1 md:grid-cols-2`,children:[(0,p.jsx)(l,{id:`overview-default`,label:`Default + helper`,placeholder:`Select an option`,helperText:`Optional helper text.`,options:m}),(0,p.jsx)(l,{id:`overview-error`,label:`Error + notification`,placeholder:`Select an option`,state:`error`,errorMessage:`This field has an error.`,helperText:`Hidden while error is shown.`,options:m}),(0,p.jsx)(l,{id:`overview-warning`,label:`Warning + notification`,placeholder:`Select an option`,state:`warning`,warningMessage:`Please review your choice.`,options:m}),(0,p.jsx)(l,{id:`overview-success`,label:`Success`,placeholder:`Select an option`,state:`success`,successMessage:`Saved`,helperText:`Success still shows helper when no error/warning.`,options:m,value:`apple`})]})},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  args: {
