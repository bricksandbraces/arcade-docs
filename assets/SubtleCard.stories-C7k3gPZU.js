import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ei as n,Es as r,Na as i,Ta as a,Vo as o,Vs as s,Xt as c,ha as l,i as u}from"./iframe-BNwjH-n2.js";import{n as d,t as f}from"./figmaDesign-CO6i5n9C.js";var p,m,h,g,_,v,y,b,x,S,C,w;e((()=>{u(),l(),p=t(s(),1),d(),m=r(),{action:h}=__STORYBOOK_MODULE_ACTIONS__,g={title:`Display & Data/Cards/SubtleCard`,component:n,tags:[`autodocs`],parameters:{design:f(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=5802-42871`),layout:`padded`,docs:{description:{component:`A quiet container for one setting: title and description on a subtle background, an optional switch at the trailing edge, and content that unfolds beneath the header.`}}},argTypes:{title:{control:`text`},description:{control:`text`},toggleLabel:{control:`text`},selected:{control:`boolean`},disabled:{control:`boolean`}}},_={args:{title:`Title`,description:`Description`,toggleLabel:`Enable`,selected:!1,disabled:!1},render:e=>(0,m.jsx)(n,{...e,className:`max-w-[448px]`,onSelectedChange:e=>h(`onSelectedChange`)(e)})},v={render:()=>(0,m.jsx)(n,{title:`Title`,description:`Description`,className:`max-w-[448px]`})},y={render:()=>(0,m.jsx)(n,{title:`Title`,toggleLabel:`Enable`,defaultSelected:!0,className:`max-w-[448px]`})},b={render:()=>(0,m.jsx)(n,{title:`Title`,description:`Description`,toggleLabel:`Enable`,defaultSelected:!0,disabled:!0,className:`max-w-[448px]`})},x=3,S=()=>{let[e,t]=p.useState(!1),[r,s]=p.useState([``]);return(0,m.jsx)(n,{title:`Add URL alias`,description:`Add up to 3 aliases pointing to storm.orapulse.app. Contact support to change your main URL.`,toggleLabel:`Add URL alias`,selected:e,onSelectedChange:t,className:`max-w-[448px]`,children:e&&(0,m.jsxs)(`div`,{className:`gap-lg flex flex-col`,children:[r.map((e,t)=>(0,m.jsxs)(`div`,{className:`gap-sm flex items-center`,children:[(0,m.jsx)(c,{id:`alias-${t}`,label:`URL alias`,hideLabel:!0,hideNotificationContainer:!0,size:`large`,placeholder:`studio-fit-alias`,suffix:`orapulse.app`,value:e,onChange:e=>s(n=>n.map((n,r)=>r===t?e.target.value:n)),className:`flex-1`}),(0,m.jsx)(o,{kind:`ghost-danger`,size:`small`,IconLeft:a,"aria-label":`Remove alias`,onClick:()=>s(e=>e.filter((e,n)=>n!==t))})]},t)),r.length<x&&(0,m.jsx)(o,{kind:`tertiary`,size:`small`,label:`Add URL alias`,IconLeft:i,className:`self-start`,onClick:()=>s(e=>[...e,``])})]})})},C={parameters:{controls:{disable:!0}},render:()=>(0,m.jsx)(S,{})},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  args: {
    title: "Title",
