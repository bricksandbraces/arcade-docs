import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ya as n,st as r,t as i,uo as a}from"./iframe-B5zdIyFp.js";var o,s,c,l,u,d,f,p;e((()=>{i(),o=t(n(),1),s=a(),c={title:`Layout & Structure/Header/HeaderLogo`,component:r,tags:[`autodocs`],parameters:{layout:`centered`,docs:{description:{component:"Optional logo slot for the app header (20px wordmark height per Figma). Use standalone or pass children into `Header` via the optional `logo` prop."}}}},l=e=>`/arcade-docs/assets/${e}`,u=()=>(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(`img`,{src:l(`logo_default-dark.svg`),alt:``,className:(0,o.default)(`h-[20px] w-auto max-w-full`,`dark:hidden`)}),(0,s.jsx)(`img`,{src:l(`logo_default-light.svg`),alt:``,className:(0,o.default)(`hidden h-[20px] w-auto max-w-full`,`dark:block`)})]}),d={render:()=>(0,s.jsx)(r,{children:(0,s.jsx)(u,{})})},f={render:()=>(0,s.jsx)(r,{href:`#`,linkLabel:`Home`,children:(0,s.jsx)(u,{})})},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  render: () => <HeaderLogo>
      <Wordmark />
    </HeaderLogo>
