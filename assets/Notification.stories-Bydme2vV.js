import{n as e}from"./chunk-jRWAZmH_.js";import{Ai as t,No as n,Ns as r,fi as i,i as a,ji as o,ki as s,vs as c}from"./iframe-vatATh5Q.js";import{n as l,t as u}from"./figmaDesign-CO6i5n9C.js";var d,f,p,m,h,g,_,v;e((()=>{a(),r(),l(),d=c(),{action:f}=__STORYBOOK_MODULE_ACTIONS__,p={title:`Feedback & Status/Notification/Notification`,component:s,tags:[`autodocs`],argTypes:{kind:{control:{type:`select`},options:[...t]},state:{control:{type:`select`},options:[...o]}},parameters:{design:u(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2149-2526`),docs:{description:{component:`Inline banner communicating status or feedback within a page. Use for persistent messages tied to a view (unlike Toast, which is transient).`}}}},m={render:e=>(0,d.jsx)(s,{...e}),args:{title:`Title`,subtitle:`Subtitle`,timestamp:new Date().toISOString(),kind:`banner`,state:`info`,onClose:f(`onClose`)}},h={parameters:{controls:{disable:!0}},render:()=>(0,d.jsx)(s,{title:`Jonas Bergmann's qualification expired.`,subtitle:`Jonas's First Aid Course ran out on October 10. Renew it to keep them cleared for sessions.`,kind:`banner`,state:`error`,onClose:f(`onClose`),action:(0,d.jsx)(n,{kind:`ghost`,size:`small`,variant:`rounded`,label:`Check Qualifications`,onClick:f(`onAction`)}),className:`w-[720px]`})},g={parameters:{controls:{disable:!0}},render:()=>(0,d.jsx)(s,{title:`Looking to change main URL?`,kind:`banner`,state:`info`,titleAction:(0,d.jsx)(i,{inline:!0,size:`md`,label:`Contact support`,href:`#`,onClick:f(`onTitleAction`)}),className:`w-[720px]`})},_={parameters:{controls:{disable:!0}},render:()=>(0,d.jsxs)(`div`,{className:`gap-lg flex flex-row`,children:[(0,d.jsx)(`div`,{className:`gap-lg flex flex-col`,children:[`banner`].map(e=>o.map(t=>(0,d.jsx)(s,{title:`Title`,subtitle:`Subtitle`,kind:e,state:t,onClose:f(`onClose`),className:`w-[460px]`},`${e}-${t}`)))}),(0,d.jsx)(`div`,{className:`gap-lg flex flex-col`,children:[`inline`].map(e=>o.map(t=>(0,d.jsx)(s,{title:`Title`,kind:e,state:t},`${e}-${t}`)))})]})},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
