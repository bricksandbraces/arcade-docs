import{n as e}from"./chunk-jRWAZmH_.js";import{Mn as t,ea as n,ha as r,jn as i,t as a}from"./iframe-Ds1wyhK1.js";var o,s,c,l,u,d;e((()=>{a(),r(),o=n(),{action:s}=__STORYBOOK_MODULE_ACTIONS__,c={title:`Components/Badge/Badge`,component:i,tags:[`autodocs`],parameters:{docs:{description:{component:`Small colored label for status, counts, or metadata. Use inline next to text to flag state or categorize items.`}}}},l=({text:e,showCloseButton:t,...n})=>(0,o.jsx)(`div`,{children:(0,o.jsx)(i,{...n,type:t?`filter`:void 0,onDelete:t?s(`onDelete`):void 0,children:e})}),l.args={color:`red`,text:`Badge`,showCloseButton:!1},l.argTypes={color:{description:`The color of the badge`,control:{type:`select`},options:t},showCloseButton:{name:`Close button`,description:`Renders the filter badge with a dismiss control`,control:{type:`boolean`},table:{category:`Playground`}},text:{description:`Label text`,control:{type:`text`},table:{category:`Playground`}}},u={render:e=>{let{text:n,showCloseButton:r,...a}=e;return(0,o.jsx)(`div`,{className:`gap-x-md flex`,children:t.map(e=>(0,o.jsx)(i,{color:e,...a,type:r?`filter`:void 0,onDelete:r?s(`onDelete`):void 0,children:n},e))})},args:{text:`Badge`,showCloseButton:!1},argTypes:{color:{control:!1,table:{disable:!0}},type:{control:!1,table:{disable:!0}},id:{control:!1,table:{disable:!0}},className:{control:!1,table:{disable:!0}},onDelete:{control:!1,table:{disable:!0}},buttonProps:{control:!1,table:{disable:!0}},showCloseButton:{name:`Close button`,description:`Renders each badge as a filter badge with a dismiss control`,control:{type:`boolean`},table:{category:`Overview`}},text:{description:`Label text`,control:{type:`text`},table:{category:`Overview`}}}},l.__docgenInfo={description:``,methods:[],displayName:`Playground`,props:{text:{required:!1,tsType:{name:`string`},description:``},showCloseButton:{required:!1,tsType:{name:`boolean`},description:``}}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`({
  text,
  showCloseButton,
  ...args
