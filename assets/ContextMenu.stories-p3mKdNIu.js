import{n as e}from"./chunk-jRWAZmH_.js";import{$i as t,Aa as n,Ba as r,Gi as i,Io as a,Oa as o,Ra as s,Ta as c,Vi as l,_a as u,ba as d,d as f,ga as p,ha as m,ia as h,ji as g,l as _,na as v,t as y,u as b,wi as x,ya as S,za as C}from"./iframe-D6-Ak9zf.js";import{n as w,t as T}from"./figmaDesign-CO6i5n9C.js";var E,D,O,k,A;e((()=>{y(),g(),w(),E=a(),D={title:`Overlays & Menus/ContextMenu/ContextMenu`,component:_,tags:[`autodocs`],argTypes:{size:{control:`inline-radio`,options:b}},args:{size:`medium`},parameters:{design:T(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=3861-205`),layout:`centered`,docs:{description:{component:["Right-click menu attached to a trigger surface. Compose entries with `ContextMenuListItem` (optionally nested via `submenu`) and `Divider` for grouping.",``,"Breaking change from earlier versions: `ContextMenuList` was removed - compose items directly as `ContextMenu` children."].join(`
`)}}}},O=`select-none rounded-md border border-dashed border-border p-xlg text-center text-text typography-body-small`,k={render:e=>(0,E.jsxs)(_,{size:e.size,ariaLabel:`File actions`,trigger:(0,E.jsx)(`div`,{className:O,children:`Right-click anywhere in this area`}),children:[(0,E.jsx)(f,{label:`Cut`,shortcut:`⌘X`,IconLeft:c,onClick:()=>console.log(`Cut`)}),(0,E.jsx)(f,{label:`Copy`,shortcut:`⌘C`,IconLeft:o,onClick:()=>console.log(`Copy`)}),(0,E.jsx)(f,{label:`Paste`,shortcut:`⌘V`,IconLeft:n,onClick:()=>console.log(`Paste`)}),(0,E.jsx)(x,{}),(0,E.jsx)(f,{label:`Edit`,shortcut:`⌘E`,IconLeft:S,onClick:()=>console.log(`Edit`)}),(0,E.jsx)(f,{label:`Share`,IconLeft:i,submenu:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(f,{label:`Email`,IconLeft:v,submenu:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(f,{label:`New message`,IconLeft:v}),(0,E.jsx)(f,{label:`Reply to thread`,IconLeft:t})]})}),(0,E.jsx)(f,{label:`Copy link`,IconLeft:h,submenu:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(f,{label:`Full URL`,IconLeft:h}),(0,E.jsx)(f,{label:`Short URL`,IconLeft:h})]})}),(0,E.jsx)(f,{label:`Social`,IconLeft:i,submenu:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(f,{label:`Post to X`,IconLeft:s}),(0,E.jsx)(f,{label:`Share on LinkedIn`,IconLeft:C}),(0,E.jsx)(f,{label:`Share on Facebook`,IconLeft:r})]})})]})}),(0,E.jsx)(f,{label:`Download`,IconLeft:d,submenu:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(f,{label:`As PDF`,IconLeft:p}),(0,E.jsx)(f,{label:`As PNG`,IconLeft:m}),(0,E.jsx)(f,{label:`As CSV`,IconLeft:u})]})}),(0,E.jsx)(x,{}),(0,E.jsx)(f,{label:`Delete`,kind:`danger`,shortcut:`⌫`,IconLeft:l,onClick:()=>console.log(`Delete`)})]})},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
