import{j as d}from"./jsx-runtime-D_zvdyIk.js";import{r as o}from"./index-CY-HDqYb.js";import{C,i as c}from"./ContextMenuList-C0nT4XLm.js";import"./index-DWvd7WUe.js";import"./index-BDYMFBcC.js";import"./index-ZRCHFLd-.js";import"./borders-N_bRvfGw.js";import"./colors-mvAPBTAn.js";const T={title:"F/DatePicker/Calendar",component:c,argTypes:{variant:{control:"inline-radio",options:C}}},n={args:{variant:"single"},render:e=>{const[t,a]=o.useState(),[x,k]=o.useState(),f=l=>{a(l)},v=l=>{k(l)};return d.jsx(c,{...e,selectedDate:t,selectedRange:x,onDateSelect:f,onRangeSelect:v})}},s={args:{variant:"single"},render:e=>{const[t,a]=o.useState();return d.jsx(c,{...e,selectedDate:t,onDateSelect:a})}},r={args:{variant:"range"},render:e=>{const[t,a]=o.useState();return d.jsx(c,{...e,selectedRange:t,onRangeSelect:a})}};var g,i,S;n.parameters={...n.parameters,docs:{...(g=n.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    variant: "single"
  },
  render: args => {
