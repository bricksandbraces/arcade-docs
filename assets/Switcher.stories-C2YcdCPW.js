import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{B as n,H as r,Pi as i,Qn as a,U as o,V as s,Yi as c,_r as l,t as u,vr as d,yr as f}from"./iframe-CppZwykT.js";var p,m,h,g,_,v;e((()=>{a(),u(),p=t(c(),1),m=i(),h={title:`Components/Switcher/Switcher`,component:n,tags:[`autodocs`],argTypes:{kind:{control:`inline-radio`,options:s},size:{control:`inline-radio`,options:o},children:{control:{disable:!0},table:{disable:!0}}},parameters:{layout:`padded`,docs:{description:{component:`Segmented control for switching between a small number of related views or modes. Use instead of Tabs for compact toggles.`}}}},g={render:function(e){let[t,i]=p.useState(`day`);return p.useEffect(()=>{i(e.kind===`icon`?`grid`:`day`)},[e.kind]),e.kind===`icon`?(0,m.jsxs)(n,{...e,value:t,onValueChange:i,children:[(0,m.jsx)(r,{value:`list`,"aria-label":`List view`,children:(0,m.jsx)(l,{className:`stroke-icon size-4`})}),(0,m.jsx)(r,{value:`grid`,"aria-label":`Grid view`,children:(0,m.jsx)(f,{className:`stroke-icon size-4`})}),(0,m.jsx)(r,{value:`board`,"aria-label":`Board view`,children:(0,m.jsx)(d,{className:`stroke-icon size-4`})})]}):(0,m.jsxs)(n,{...e,value:t,onValueChange:i,children:[(0,m.jsx)(r,{value:`day`,children:`Day`}),(0,m.jsx)(r,{value:`week`,children:`Week`}),(0,m.jsx)(r,{value:`month`,children:`Month`})]})},args:{kind:`text`,size:`small`}},_={parameters:{controls:{disable:!0}},render:function(){let[e,t]=p.useState(`day`),[i,a]=p.useState(`grid`);return(0,m.jsxs)(`div`,{className:`gap-xlg flex flex-col items-start`,children:[(0,m.jsxs)(`div`,{className:`gap-sm flex flex-col items-start`,children:[(0,m.jsx)(`p`,{className:`typography-body-small text-text-accent`,children:`Text`}),(0,m.jsxs)(n,{value:e,onValueChange:t,children:[(0,m.jsx)(r,{value:`day`,children:`Day`}),(0,m.jsx)(r,{value:`week`,children:`Week`}),(0,m.jsx)(r,{value:`month`,children:`Month`})]})]}),(0,m.jsxs)(`div`,{className:`gap-sm flex flex-col items-start`,children:[(0,m.jsx)(`p`,{className:`typography-body-small text-text-accent`,children:`Icon`}),(0,m.jsxs)(n,{kind:`icon`,value:i,onValueChange:a,children:[(0,m.jsx)(r,{value:`list`,"aria-label":`List view`,children:(0,m.jsx)(l,{className:`stroke-icon size-4`})}),(0,m.jsx)(r,{value:`grid`,"aria-label":`Grid view`,children:(0,m.jsx)(f,{className:`stroke-icon size-4`})}),(0,m.jsx)(r,{value:`board`,"aria-label":`Board view`,children:(0,m.jsx)(d,{className:`stroke-icon size-4`})})]})]})]})}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
