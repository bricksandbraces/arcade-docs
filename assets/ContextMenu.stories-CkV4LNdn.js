import{n as e}from"./chunk-jRWAZmH_.js";import{Aa as t,Bi as n,Ca as r,Di as i,Li as a,Ma as o,Oo as s,Qi as c,Sa as l,Xi as u,bi as d,d as f,da as p,ja as m,l as h,la as g,ma as _,pa as v,qi as y,t as b,u as x,ua as S,ya as C}from"./iframe-CbONSzYF.js";import{n as w,t as T}from"./figmaDesign-CO6i5n9C.js";var E,D,O,k,A;e((()=>{b(),i(),w(),E=s(),D={title:`Overlays & Menus/ContextMenu/ContextMenu`,component:h,tags:[`autodocs`],argTypes:{size:{control:`inline-radio`,options:x}},args:{size:`medium`},parameters:{design:T(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=3861-205`),layout:`centered`,docs:{description:{component:["Right-click menu attached to a trigger surface. Compose entries with `ContextMenuListItem` (optionally nested via `submenu`) and `Divider` for grouping.",``,"Breaking change from earlier versions: `ContextMenuList` was removed - compose items directly as `ContextMenu` children."].join(`
`)}}}},O=`select-none rounded-md border border-dashed border-border p-xlg text-center text-text typography-body-small`,k={render:e=>(0,E.jsxs)(h,{size:e.size,ariaLabel:`File actions`,trigger:(0,E.jsx)(`div`,{className:O,children:`Right-click anywhere in this area`}),children:[(0,E.jsx)(f,{label:`Cut`,shortcut:`⌘X`,IconLeft:C,onClick:()=>console.log(`Cut`)}),(0,E.jsx)(f,{label:`Copy`,shortcut:`⌘C`,IconLeft:l,onClick:()=>console.log(`Copy`)}),(0,E.jsx)(f,{label:`Paste`,shortcut:`⌘V`,IconLeft:r,onClick:()=>console.log(`Paste`)}),(0,E.jsx)(d,{}),(0,E.jsx)(f,{label:`Edit`,shortcut:`⌘E`,IconLeft:v,onClick:()=>console.log(`Edit`)}),(0,E.jsx)(f,{label:`Share`,IconLeft:n,submenu:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(f,{label:`Email`,IconLeft:u,submenu:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(f,{label:`New message`,IconLeft:u}),(0,E.jsx)(f,{label:`Reply to thread`,IconLeft:y})]})}),(0,E.jsx)(f,{label:`Copy link`,IconLeft:c,submenu:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(f,{label:`Full URL`,IconLeft:c}),(0,E.jsx)(f,{label:`Short URL`,IconLeft:c})]})}),(0,E.jsx)(f,{label:`Social`,IconLeft:n,submenu:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(f,{label:`Post to X`,IconLeft:t}),(0,E.jsx)(f,{label:`Share on LinkedIn`,IconLeft:m}),(0,E.jsx)(f,{label:`Share on Facebook`,IconLeft:o})]})})]})}),(0,E.jsx)(f,{label:`Download`,IconLeft:_,submenu:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(f,{label:`As PDF`,IconLeft:S}),(0,E.jsx)(f,{label:`As PNG`,IconLeft:g}),(0,E.jsx)(f,{label:`As CSV`,IconLeft:p})]})}),(0,E.jsx)(d,{}),(0,E.jsx)(f,{label:`Delete`,kind:`danger`,shortcut:`⌫`,IconLeft:a,onClick:()=>console.log(`Delete`)})]})},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
