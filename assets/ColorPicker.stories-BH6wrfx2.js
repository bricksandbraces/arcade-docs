import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Do as n,Nt as r,fo as i,t as a}from"./iframe-CX2L4sc6.js";var o,s,c,l,u;e((()=>{o=t(n(),1),a(),s=i(),c={title:`Inputs & Controls/ColorPicker`,component:r,tags:[`autodocs`],argTypes:{value:{control:`text`},"aria-label":{control:`text`}},parameters:{docs:{description:{component:`Grid of color swatches for picking a single color. Use in customization panels where a curated palette is preferable to a full color wheel.`}}}},l={render:e=>{let[t,n]=(0,o.useState)(e.value||`#0291FF`);return(0,s.jsx)(r,{...e,value:t,onChange:n})},args:{value:`#0291FF`,"aria-label":`Color picker`}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  render: args => {
