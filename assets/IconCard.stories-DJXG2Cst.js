import{n as e}from"./chunk-jRWAZmH_.js";import{Di as t,Fo as n,Ni as r,Ri as i,Si as a,bo as o,ma as s,ni as c,pa as l,t as u,xa as d,ya as f}from"./iframe-Bb-sKdHW.js";var p,m,h,g,_,v,y,b,x,S,C,w,T;e((()=>{u(),a(),n(),p=o(),{action:m}=__STORYBOOK_MODULE_ACTIONS__,h={title:`Display & Data/Cards/IconCard`,component:c,tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:`Compact navigational card with a leading icon, title, optional subtitle, and trailing chevron. Hover / active scale matches ClickableCard.`}}},argTypes:{disabled:{control:`boolean`}}},g=(0,p.jsx)(r,{className:`stroke-icon`,"aria-hidden":!0}),_=`stroke-icon`,v=[{icon:(0,p.jsx)(t,{className:_,"aria-hidden":!0}),title:`Accounts`,subtitle:`Balances and transactions`},{icon:(0,p.jsx)(s,{className:_,"aria-hidden":!0}),title:`Cards`,subtitle:`Manage limits and freezes`},{icon:(0,p.jsx)(l,{className:_,"aria-hidden":!0}),title:`Transfers`,subtitle:`SEPA and instant payments`},{icon:(0,p.jsx)(f,{className:_,"aria-hidden":!0}),title:`Portfolio & markets`,subtitle:`Securities and quotes`},{icon:(0,p.jsx)(d,{className:_,"aria-hidden":!0}),title:`Financing`,subtitle:`Loans and conditions`},{icon:(0,p.jsx)(i,{className:_,"aria-hidden":!0}),title:`Statements`,subtitle:`Taxes and receipts`}],y={args:{title:`Title`,subtitle:`Subtitle`,disabled:!1},render:e=>(0,p.jsx)(c,{...e,icon:g,className:`max-w-[346px]`,onClick:e=>m(`onClick`)(e)})},b={args:{title:`Settings`,disabled:!1},render:e=>(0,p.jsx)(c,{...e,icon:g,className:`max-w-[346px]`,onClick:e=>m(`onClick`)(e)})},x={render:()=>(0,p.jsx)(c,{href:`https://example.com`,icon:g,title:`External link`,subtitle:`Opens example.com`,className:`max-w-[346px]`,onClick:e=>m(`onClick`)(e)})},S={args:{title:`Unavailable`,subtitle:`Try again later`,disabled:!0},render:e=>(0,p.jsx)(c,{...e,icon:g,className:`max-w-[346px]`})},C={parameters:{controls:{disable:!0}},render:()=>(0,p.jsx)(`div`,{className:`flex w-full flex-wrap gap-md`,children:v.map((e,t)=>(0,p.jsx)(c,{icon:e.icon,title:e.title,subtitle:e.subtitle,className:`max-w-[346px] flex-[1_1_220px]`,onClick:e=>m(`card-${t+1}`)(e)},e.title))})},w={parameters:{controls:{disable:!0}},render:()=>(0,p.jsxs)(`div`,{className:`gap-md flex max-w-[360px] flex-col`,children:[(0,p.jsx)(c,{icon:g,title:`Title`,subtitle:`Subtitle`,onClick:e=>m(`default`)(e)}),(0,p.jsx)(c,{icon:(0,p.jsx)(r,{className:`stroke-icon`}),title:`No subtitle`,onClick:e=>m(`no subtitle`)(e)}),(0,p.jsx)(c,{icon:g,title:`Disabled`,subtitle:`Subtitle`,disabled:!0})]})},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    title: "Title",
    subtitle: "Subtitle",
    disabled: false
