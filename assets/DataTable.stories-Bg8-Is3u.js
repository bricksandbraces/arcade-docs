import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{$n as n,$r as r,Ei as i,Kn as a,Li as o,O as s,P as c,Zn as l,an as u,ca as d,co as f,er as p,ji as m,nr as h,pi as g,qa as _,qn as v,qr as y,rr as b,t as x}from"./iframe-1mzDmMUm.js";function S(){let[e,t]=(0,w.useState)(`all`);return(0,T.jsx)(c,{leftSlot:(0,T.jsx)(u,{id:`data-table-composition-view`,title:`View`,hideLabel:!0,inline:!0,size:`small`,reserveInlineFeedbackHeight:!1,value:e,onChange:t,items:A}),rightSlot:(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(d,{kind:`ghost`,size:`small`,variant:`rounded`,IconLeft:i,"aria-label":`Layout`}),(0,T.jsx)(d,{kind:`ghost`,size:`small`,variant:`rounded`,IconLeft:g,"aria-label":`Search`}),(0,T.jsx)(d,{kind:`ghost`,size:`small`,variant:`rounded`,IconLeft:m,"aria-label":`Filter`}),(0,T.jsx)(`div`,{className:`flex items-center self-stretch py-sm`,children:(0,T.jsx)(y,{orientation:`vertical`,width:`0.5`,className:`min-h-[24px]`})}),(0,T.jsx)(d,{kind:`ghost`,size:`small`,label:`Export`,IconRight:o})]})})}function C(){if(typeof window>`u`)return{};try{let e=window.localStorage.getItem(H);if(!e)return{};let t=JSON.parse(e);if(t&&typeof t==`object`)return t}catch{}return{}}var w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G;e((()=>{x(),r(),w=t(f(),1),T=_(),E=[{name:`Ada Lovelace`,email:`ada@example.com`,role:`Admin`,status:`active`},{name:`Grace Hopper`,email:`grace@example.com`,role:`Editor`,status:`active`},{name:`Alan Turing`,email:`alan@example.com`,role:`Viewer`,status:`pending`},{name:`Katherine Johnson`,email:`katherine@example.com`,role:`Editor`,status:`inactive`},{name:`Margaret Hamilton`,email:`margaret@example.com`,role:`Admin`,status:`active`}],D=Array.from({length:47},(e,t)=>{let n=E[t%E.length],r=t+1;return{...n,id:String(r),name:`${n.name} #${r}`}}),O={active:`lime`,inactive:`gray`,pending:`orange`},k=10,A=[{label:`All members`,value:`all`},{label:`Admins only`,value:`admins`},{label:`Pending invites`,value:`pending`}],j=[{key:`_index`,header:``,kind:`rowIndex`},{key:`name`,header:`Name`,sortable:!0},{key:`owner`,header:`Owner`,kind:`user`,render:e=>(0,T.jsx)(h,{name:e.name})},{key:`email`,header:`Email`,sortable:!0},{key:`role`,header:`Role`},{key:`status`,header:`Status`,kind:`badge`,render:e=>(0,T.jsx)(b,{color:O[e.status],children:e.status})}],M=[{key:`_index`,header:``,kind:`rowIndex`},{key:`name`,header:`Name`,sortable:!0,editable:!0},{key:`owner`,header:`Owner`,kind:`user`,render:e=>(0,T.jsx)(h,{name:e.name})},{key:`email`,header:`Email`,sortable:!0},{key:`role`,header:`Role`},{key:`status`,header:`Status`,kind:`badge`,render:e=>(0,T.jsx)(b,{color:O[e.status],children:e.status})}],N={title:`Display & Data/DataTable/DataTable`,component:a,tags:[`autodocs`],argTypes:{selectionMode:{control:`inline-radio`,options:[`none`,`single`,`multiple`]},selectionControl:{control:`inline-radio`,options:v,description:`Row-index column control. Defaults: single → radio, multiple → checkbox. "multiple" always uses checkboxes.`}},args:{selectionMode:`none`,title:`Data Table`,subtitle:`A compact overview of the team.`},parameters:{docs:{description:{component:`Data grid with sorting, selection, and pagination. Use for dense tabular data where rows represent records and columns are consistent fields.`}}}},P={render:e=>{let[t,n]=(0,w.useState)(1),r=Math.max(1,Math.ceil(D.length/k)),i=Math.min(t,r);return(0,T.jsx)(`div`,{style:{width:960},children:(0,T.jsx)(a,{...e,columns:j,data:D,currentPage:i,rowsPerPage:k,footer:(0,T.jsx)(s,{currentPage:i,totalPages:r,onPageChange:n})})})}},F={args:{selectionMode:`single`},render:P.render},I={args:{selectionMode:`multiple`},render:P.render},L={args:{selectionMode:`single`},render:P.render},R={args:{selectionMode:`single`,selectionControl:`checkbox`},render:P.render},z={args:{selectionMode:`multiple`},render:e=>{let[t,r]=(0,w.useState)(1),i=Math.max(1,Math.ceil(D.length/k)),o=Math.min(t,i);return(0,T.jsx)(`div`,{style:{width:960},children:(0,T.jsx)(a,{...e,className:`bg-transparent`,toolbar:(0,T.jsx)(S,{}),header:(0,T.jsx)(n,{title:`Team directory`,subtitle:`Search, filter, and manage workspace members.`}),columns:j,data:D,currentPage:o,rowsPerPage:k,footer:(0,T.jsx)(s,{currentPage:o,totalPages:i,onPageChange:r})})})}},B={render:e=>(0,T.jsx)(`div`,{style:{width:960},children:(0,T.jsx)(a,{...e,columns:j,data:D})})},V={name:`With inline editable cells`,parameters:{docs:{description:{story:"The **Name** column uses `editable: true`. Click a cell to edit (pointer cursor); blur or Enter commits (updates local story state). Escape restores the previous value."}}},args:{selectionMode:`none`,title:`Editable cells`,subtitle:`Click a name to edit inline.`},render:e=>{let[t,n]=(0,w.useState)(()=>D.slice(0,12).map(e=>({...e})));return(0,T.jsx)(`div`,{style:{width:960},children:(0,T.jsx)(a,{...e,columns:M,data:t,onCellTextCommit:({rowId:e,columnKey:t,value:r})=>{n(n=>n.map(n=>n.id===e&&t===`name`?{...n,name:r}:n))}})})}},H=`arcade-storybook:datatable:column-widths`,U={name:`With persisted column widths`,parameters:{docs:{description:{story:"Columns are resizable; the widths are saved to `localStorage` so they persist across reloads. The story wires up `columnWidths` (controlled) + `onColumnWidthsChange`. Use the **Reset widths** button to clear the stored widths and fall back to auto sizing."}}},args:{selectionMode:`none`,title:`Persisted column widths`,subtitle:`Drag a header divider to resize. Reload to verify persistence.`},render:e=>{let[t,n]=(0,w.useState)(()=>C()),r=e=>{n(e);try{window.localStorage.setItem(H,JSON.stringify(e))}catch{}};return(0,T.jsxs)(`div`,{style:{width:960},className:`flex flex-col gap-md`,children:[(0,T.jsx)(`div`,{children:(0,T.jsx)(d,{kind:`ghost`,size:`small`,label:`Reset widths`,onClick:()=>{try{window.localStorage.removeItem(H)}catch{}n({})}})}),(0,T.jsx)(a,{...e,columns:j,data:D.slice(0,10),columnWidths:t,onColumnWidthsChange:r})]})}},W={render:e=>(0,T.jsx)(`div`,{style:{width:720},children:(0,T.jsxs)(a,{...e,title:`Recent activity`,subtitle:`Manually composed rows`,children:[(0,T.jsxs)(l,{showBorderTop:!0,showBorderBottom:!0,children:[(0,T.jsx)(p,{columnBorderRight:!0,children:`Deployment succeeded`}),(0,T.jsx)(p,{children:`2 minutes ago`})]}),(0,T.jsxs)(l,{children:[(0,T.jsx)(p,{columnBorderRight:!0,children:`Build finished`}),(0,T.jsx)(p,{children:`11 minutes ago`})]})]})})},P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
  render: args => {
