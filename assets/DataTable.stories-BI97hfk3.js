import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{$o as n,Br as r,Fr as i,Gr as a,Hr as o,I as s,Ir as c,Ji as l,Kr as u,L as d,La as f,Mn as p,O as m,P as ee,R as h,Ur as g,Vi as _,mo as v,ms as y,t as b}from"./iframe-DAdTAyfZ.js";import{n as x,t as S}from"./figmaDesign-CO6i5n9C.js";function C({search:e,onSearchChange:t,filters:n,onFiltersChange:r}){let[i,a]=(0,T.useState)(`all`),[o,c]=(0,T.useState)(`list`);return(0,E.jsx)(h,{leftSlot:(0,E.jsx)(p,{id:`data-table-composition-view`,title:`View`,hideLabel:!0,inline:!0,size:`small`,reserveInlineNotificationHeight:!1,value:i,onChange:a,items:j}),rightSlot:(0,E.jsxs)(E.Fragment,{children:[(0,E.jsxs)(`div`,{className:`gap-2xs flex items-center`,children:[(0,E.jsx)(d,{value:o,onValueChange:c}),(0,E.jsx)(s,{value:e,onValueChange:t}),(0,E.jsx)(ee,{groups:M,value:n,onValueChange:r})]}),(0,E.jsx)(`div`,{className:`py-sm flex items-center self-stretch`,children:(0,E.jsx)(_,{orientation:`vertical`,width:`0.5`,className:`min-h-[24px]`})}),(0,E.jsx)(v,{kind:`ghost`,size:`small`,label:`Export`,IconRight:f})]})})}function w(){if(typeof window>`u`)return{};try{let e=window.localStorage.getItem(q);if(!e)return{};let t=JSON.parse(e);if(t&&typeof t==`object`)return t}catch{}return{}}var T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{b(),l(),T=t(y(),1),x(),E=n(),D=[{name:`Ada Lovelace`,email:`ada@example.com`,role:`Admin`,status:`active`},{name:`Grace Hopper`,email:`grace@example.com`,role:`Editor`,status:`active`},{name:`Alan Turing`,email:`alan@example.com`,role:`Viewer`,status:`pending`},{name:`Katherine Johnson`,email:`katherine@example.com`,role:`Editor`,status:`inactive`},{name:`Margaret Hamilton`,email:`margaret@example.com`,role:`Admin`,status:`active`}],O=Array.from({length:47},(e,t)=>{let n=D[t%D.length],r=t+1;return{...n,id:String(r),name:`${n.name} #${r}`}}),k={active:`lime`,inactive:`gray`,pending:`orange`},A=10,j=[{label:`All members`,value:`all`},{label:`Admins only`,value:`admins`},{label:`Pending invites`,value:`pending`}],M=[{id:`role`,label:`Role`,options:[{value:`Admin`,label:`Admin`},{value:`Editor`,label:`Editor`},{value:`Viewer`,label:`Viewer`}]},{id:`status`,label:`Status`,options:[{value:`active`,label:`Active`},{value:`inactive`,label:`Inactive`},{value:`pending`,label:`Pending`}]}],N={role:`role`,status:`status`},P=[{key:`_index`,header:``,kind:`rowIndex`},{key:`name`,header:`Name`,sortable:!0},{key:`owner`,header:`Owner`,kind:`user`,render:e=>(0,E.jsx)(a,{name:e.name})},{key:`email`,header:`Email`,sortable:!0},{key:`role`,header:`Role`},{key:`status`,header:`Status`,kind:`badge`,render:e=>(0,E.jsx)(u,{color:k[e.status],children:e.status})}],F=[{key:`_index`,header:``,kind:`rowIndex`},{key:`name`,header:`Name`,sortable:!0,editable:!0},{key:`owner`,header:`Owner`,kind:`user`,render:e=>(0,E.jsx)(a,{name:e.name})},{key:`email`,header:`Email`,sortable:!0},{key:`role`,header:`Role`},{key:`status`,header:`Status`,kind:`badge`,render:e=>(0,E.jsx)(u,{color:k[e.status],children:e.status})}],I=[{id:`1`,firstName:`-`,lastName:`-`,email:`e2e@test.com`,role:`Owner`},{id:`2`,firstName:`Katherine`,lastName:`Johnson`,email:`katherine.johnson@example.com`,role:`Editor`},{id:`3`,firstName:`Margaret`,lastName:`Hamilton`,email:`margaret.hamilton@longsubdomain.example.com`,role:`Admin`}],L=[{key:`firstName`,header:`First name`},{key:`lastName`,header:`Last name`},{key:`email`,header:`Email`},{key:`role`,header:`Role`}],R={title:`Display & Data/DataTable/DataTable`,component:i,tags:[`autodocs`],argTypes:{selectionMode:{control:`inline-radio`,options:[`none`,`single`,`multiple`]},selectionControl:{control:`inline-radio`,options:c,description:`Row-index column control. Defaults: single → radio, multiple → checkbox. "multiple" always uses checkboxes.`}},args:{selectionMode:`none`,title:`Data Table`,subtitle:`A compact overview of the team.`},parameters:{design:S(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2419-29864&m=dev`),docs:{description:{component:`Data grid with sorting, selection, and pagination. Use for dense tabular data where rows represent records and columns are consistent fields.`}}}},z={render:e=>{let[t,n]=(0,T.useState)(1),r=Math.max(1,Math.ceil(O.length/A)),a=Math.min(t,r);return(0,E.jsx)(`div`,{style:{width:960},children:(0,E.jsx)(i,{...e,columns:P,data:O,currentPage:a,rowsPerPage:A,footer:(0,E.jsx)(m,{currentPage:a,totalPages:r,onPageChange:n})})})}},B={args:{selectionMode:`single`},render:z.render},V={args:{selectionMode:`multiple`},render:z.render},H={args:{selectionMode:`single`},render:z.render},U={args:{selectionMode:`single`,selectionControl:`checkbox`},render:z.render},W={args:{selectionMode:`multiple`},render:e=>{let[t,n]=(0,T.useState)(1),[r,a]=(0,T.useState)(``),[s,c]=(0,T.useState)({}),[l,u]=(0,T.useState)(O.length),d=Math.max(1,Math.ceil(l/A)),f=Math.min(t,d);return(0,E.jsx)(`div`,{style:{width:960},children:(0,E.jsx)(i,{...e,className:`bg-transparent`,toolbar:(0,E.jsx)(C,{search:r,onSearchChange:e=>{a(e),n(1)},filters:s,onFiltersChange:e=>{c(e),n(1)}}),header:(0,E.jsx)(o,{title:`Team directory`,subtitle:`Search, filter, and manage workspace members.`}),columns:P,data:O,searchQuery:r,filters:s,filterKeys:N,onFilteredCountChange:u,currentPage:f,rowsPerPage:A,footer:(0,E.jsx)(m,{currentPage:f,totalPages:d,onPageChange:n})})})}},G={render:e=>(0,E.jsx)(`div`,{style:{width:960},children:(0,E.jsx)(i,{...e,columns:P,data:O})})},K={name:`With inline editable cells`,parameters:{docs:{description:{story:"The **Name** column uses `editable: true`. Click a cell to edit (pointer cursor); blur or Enter commits (updates local story state). Escape restores the previous value."}}},args:{selectionMode:`none`,title:`Editable cells`,subtitle:`Click a name to edit inline.`},render:e=>{let[t,n]=(0,T.useState)(()=>O.slice(0,12).map(e=>({...e})));return(0,E.jsx)(`div`,{style:{width:960},children:(0,E.jsx)(i,{...e,columns:F,data:t,onCellTextCommit:({rowId:e,columnKey:t,value:r})=>{n(n=>n.map(n=>n.id===e&&t===`name`?{...n,name:r}:n))}})})}},q=`arcade-storybook:datatable:column-widths`,J={name:`With persisted column widths`,parameters:{docs:{description:{story:"Columns are resizable; the widths are saved to `localStorage` so they persist across reloads. The story wires up `columnWidths` (controlled) + `onColumnWidthsChange`. Use the **Reset widths** button to clear the stored widths and fall back to auto sizing."}}},args:{selectionMode:`none`,title:`Persisted column widths`,subtitle:`Drag a header divider to resize. Reload to verify persistence.`},render:e=>{let[t,n]=(0,T.useState)(()=>w()),r=e=>{n(e);try{window.localStorage.setItem(q,JSON.stringify(e))}catch{}};return(0,E.jsxs)(`div`,{style:{width:960},className:`gap-md flex flex-col`,children:[(0,E.jsx)(`div`,{children:(0,E.jsx)(v,{kind:`ghost`,size:`small`,label:`Reset widths`,onClick:()=>{try{window.localStorage.removeItem(q)}catch{}n({})}})}),(0,E.jsx)(i,{...e,columns:P,data:O.slice(0,10),columnWidths:t,onColumnWidthsChange:r})]})}},Y={render:e=>(0,E.jsx)(`div`,{style:{width:720},children:(0,E.jsxs)(i,{...e,title:`Recent activity`,subtitle:`Manually composed rows`,children:[(0,E.jsxs)(r,{showBorderTop:!0,showBorderBottom:!0,children:[(0,E.jsx)(g,{columnBorderRight:!0,children:`Deployment succeeded`}),(0,E.jsx)(g,{children:`2 minutes ago`})]}),(0,E.jsxs)(r,{children:[(0,E.jsx)(g,{columnBorderRight:!0,children:`Build finished`}),(0,E.jsx)(g,{children:`11 minutes ago`})]})]})})},X={name:`Column alignment (auto-sized, narrow)`,parameters:{docs:{description:{story:"Short header labels with long body content in a deliberately narrow container, with no per-column `width` set. Header and body columns must stay aligned and overflow truncates with an ellipsis. Guards the `min-w-0` fix that keeps auto-sized flex columns from being widened by their content."}}},render:e=>(0,E.jsx)(`div`,{style:{width:460},children:(0,E.jsx)(i,{...e,title:`People`,subtitle:`Auto-sized columns must align header-to-body.`,columns:L,data:I})})},Z=P.map(e=>e.kind===`rowIndex`?e:{...e,width:220}),Q={name:`Horizontal scroll fade`,parameters:{docs:{description:{story:`When the columns are wider than the container, the grid fades out towards every edge that still hides content - right only at the start, both once scrolled, left only at the end. The fade is a mask, so it works on any surface the table is placed on.`}}},render:e=>(0,E.jsx)(`div`,{style:{width:520},children:(0,E.jsx)(i,{...e,title:`People`,subtitle:`Scroll sideways - the faded edge marks the columns still out of view.`,columns:Z,data:O.slice(0,6)})})},z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  render: args => {
