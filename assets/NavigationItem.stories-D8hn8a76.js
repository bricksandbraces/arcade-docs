import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{$t as n,Fs as r,Ja as i,Ta as a,as as o,bs as s,en as c,i as l,so as u,tn as d,ua as f}from"./iframe-DxZG8z-m.js";import{n as p,t as m}from"./figmaDesign-CO6i5n9C.js";var h,g,_,v,y,b,x,S,C;e((()=>{l(),f(),h=t(o(),1),g=t(r(),1),p(),_=s(),v={parameters:{design:m(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2438-38919`)},title:`Navigation/Navigation/NavigationItem`,component:n,tags:[`autodocs`],argTypes:{level:{control:`inline-radio`,options:c},size:{control:`inline-radio`,options:d},selected:{control:`boolean`},disabled:{control:`boolean`},expandable:{control:`boolean`},expanded:{control:`boolean`},title:{control:`text`},tooltip:{control:`text`}},args:{title:`Dashboard`,level:1,expandable:!1,selected:!1,disabled:!1,size:`default`},decorators:[e=>(0,_.jsx)(`div`,{className:(0,h.default)(`p-lg`,`w-72`,`bg-background`),children:(0,_.jsx)(e,{})})]},y={args:{icon:u}},b={parameters:{controls:{disable:!0}},render:()=>(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-xlg`,`flex`,`flex-col`),children:[(0,_.jsxs)(`section`,{className:(0,h.default)(`gap-md`,`flex`,`flex-col`),children:[(0,_.jsx)(`h3`,{className:(0,h.default)(`typography-headline-04`,`text-text`),children:`Level 1 - default size`}),(0,_.jsx)(n,{title:`Enabled`,icon:u}),(0,_.jsx)(n,{title:`Selected`,icon:u,selected:!0}),(0,_.jsx)(n,{title:`Disabled`,icon:u,disabled:!0}),(0,_.jsx)(n,{title:`Expandable (collapsed)`,icon:i,expandable:!0}),(0,_.jsxs)(n,{title:`Expandable (expanded)`,icon:i,expandable:!0,defaultExpanded:!0,children:[(0,_.jsx)(n,{title:`Nested item`,level:2}),(0,_.jsx)(n,{title:`Another nested`,level:2})]})]}),(0,_.jsxs)(`section`,{className:(0,h.default)(`gap-md`,`flex`,`flex-col`),children:[(0,_.jsx)(`h3`,{className:(0,h.default)(`typography-headline-04`,`text-text`),children:`Level 2`}),(0,_.jsx)(n,{title:`Nested enabled`,level:2}),(0,_.jsx)(n,{title:`Nested selected`,level:2,selected:!0}),(0,_.jsx)(n,{title:`Nested disabled`,level:2,disabled:!0})]}),(0,_.jsxs)(`section`,{className:(0,h.default)(`gap-md`,`flex`,`flex-col`),children:[(0,_.jsx)(`h3`,{className:(0,h.default)(`typography-headline-04`,`text-text`),children:`Small - icon only with tooltip`}),(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-sm`,`flex`,`flex-col`,`w-16`),children:[(0,_.jsx)(n,{size:`small`,icon:u,tooltip:`Dashboard`}),(0,_.jsx)(n,{size:`small`,icon:i,tooltip:`Projects`,selected:!0}),(0,_.jsx)(n,{size:`small`,icon:a,tooltip:`Settings`,disabled:!0})]})]})]})},x={parameters:{controls:{disable:!0}},render:function(){let[e,t]=g.useState(`projects`);return(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,_.jsx)(n,{title:`Dashboard`,icon:u,selected:e===null}),(0,_.jsxs)(n,{title:`Projects`,icon:i,expandable:!0,expanded:e===`projects`,onExpandedChange:e=>t(e?`projects`:null),children:[(0,_.jsx)(n,{title:`All projects`,level:2}),(0,_.jsx)(n,{title:`Archived`,level:2}),(0,_.jsx)(n,{title:`Templates`,level:2,disabled:!0})]}),(0,_.jsxs)(n,{title:`Settings`,icon:a,expandable:!0,expanded:e===`settings`,onExpandedChange:e=>t(e?`settings`:null),children:[(0,_.jsx)(n,{title:`Profile`,level:2}),(0,_.jsx)(n,{title:`Billing`,level:2})]})]})}},S={parameters:{controls:{disable:!0}},render:()=>(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,_.jsx)(n,{title:`Dashboard`,icon:u,href:`#dashboard`,selected:!0}),(0,_.jsx)(n,{title:`Projects`,icon:i,href:`#projects`}),(0,_.jsx)(n,{title:`Settings`,icon:a,href:`#settings`})]})},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    icon: IconDashboard
  }
