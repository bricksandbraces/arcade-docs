import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ii as n,Jr as r,Kr as i,Zi as a,Zr as o,dr as s,dt as c,er as l,ft as u,gr as d,lt as f,q as p,t as m,ut as h}from"./iframe-B1mIPWxP.js";var g,_,v,y,b,x,S,C,w;e((()=>{m(),l(),g=t(a(),1),_=n(),v={title:`Components/Header/Header`,component:f,tags:[`autodocs`],argTypes:{showBackButton:{control:`boolean`}},parameters:{layout:`fullscreen`,docs:{description:{component:`Top app bar with slots for logo, navigation links, and actions. Use as the primary header across app pages.`}}}},y=()=>(0,_.jsxs)(`div`,{className:`gap-xs flex items-center`,children:[(0,_.jsx)(o,{kind:`ghost`,IconLeft:s,size:`medium`,"aria-label":`Settings`,tooltipContent:`Settings`,tooltipOpenDelayMs:0}),(0,_.jsx)(o,{kind:`ghost`,IconLeft:i,size:`medium`,"aria-label":`Notifications`,tooltipContent:`Notifications`,tooltipOpenDelayMs:0}),(0,_.jsx)(o,{kind:`ghost`,IconLeft:d,size:`medium`,"aria-label":`Menu`,tooltipContent:`Menu`,tooltipOpenDelayMs:0})]}),b=e=>`/arcade-docs/assets/${e}`,x=()=>(0,_.jsx)(p,{compact:!0,children:(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(`img`,{src:b(`logo_small-dark.svg`),alt:``,className:`size-full object-contain dark:hidden`}),(0,_.jsx)(`img`,{src:b(`logo_small-light.svg`),alt:``,className:`hidden size-full object-contain dark:block`})]})}),S={render:({showBackButton:e=!0})=>{let[t,n]=(0,g.useState)(`g1-b`);return(0,_.jsx)(f,{title:`Dashboard`,showBackButton:e,companyLogo:(0,_.jsx)(x,{}),companyLogoHref:`#`,backButton:(0,_.jsx)(o,{kind:`ghost`,IconLeft:r,size:`medium`,"aria-label":`Go back`,tooltipContent:`Go back`,tooltipOpenDelayMs:0}),linkGroupOne:(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(u,{selected:t===`g1-a`,onClick:()=>n(`g1-a`),children:`Link`}),(0,_.jsx)(u,{selected:t===`g1-b`,onClick:()=>n(`g1-b`),children:`Link`}),(0,_.jsx)(u,{selected:t===`g1-c`,onClick:()=>n(`g1-c`),children:`Link`})]}),linkGroupTwo:(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(u,{selected:t===`g2-a`,onClick:()=>n(`g2-a`),children:`Link`}),(0,_.jsx)(h,{selected:t===`g2-dropdown`,items:[{label:`Link`,onClick:()=>n(`g2-dropdown`)},{label:`Link`,onClick:()=>n(`g2-dropdown`)},{label:`Link`,onClick:()=>n(`g2-dropdown`)}],children:(0,_.jsx)(c,{children:`Link`})}),(0,_.jsx)(u,{selected:t===`g2-c`,onClick:()=>n(`g2-c`),children:`Link`})]}),actions:(0,_.jsx)(y,{})})},args:{showBackButton:!0},parameters:{layout:`fullscreen`,controls:{include:[`showBackButton`]}}},C={args:{showBackButton:!0},parameters:{layout:`fullscreen`,controls:{include:[`showBackButton`]},docs:{description:{story:"Header with exactly two top-level navigation links rendered as `HeaderButton`s. Click a link to make it the active one. Use when the app has only a couple of primary sections."}}},render:function({showBackButton:e=!0}){let[t,n]=(0,g.useState)(`products`);return(0,_.jsx)(f,{title:`Dashboard`,showBackButton:e,companyLogo:(0,_.jsx)(x,{}),companyLogoHref:`#`,backButton:(0,_.jsx)(o,{kind:`ghost`,IconLeft:r,size:`medium`,"aria-label":`Go back`}),linkGroupOne:(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(u,{selected:t===`products`,onClick:()=>n(`products`),children:`Products`}),(0,_.jsx)(u,{selected:t===`resources`,onClick:()=>n(`resources`),children:`Resources`})]}),actions:(0,_.jsx)(y,{})})}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  render: ({
    showBackButton = true
  }) => {
