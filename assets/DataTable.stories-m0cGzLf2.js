import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{O as n,P as r,Sa as i,So as a,Ti as o,Wi as s,Xi as c,fr as l,hn as u,ii as d,lr as f,nr as p,pr as m,rr as h,so as g,sr as _,t as v,ui as y,ur as b,zi as x}from"./iframe-BZilxiKJ.js";function S(){let[e,t]=(0,w.useState)(`all`);return(0,T.jsx)(r,{leftSlot:(0,T.jsx)(u,{id:`data-table-composition-view`,title:`View`,hideLabel:!0,inline:!0,size:`small`,reserveInlineNotificationHeight:!1,value:e,onChange:t,items:A}),rightSlot:(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(i,{kind:`ghost`,size:`small`,variant:`rounded`,IconLeft:x,"aria-label":`Layout`}),(0,T.jsx)(i,{kind:`ghost`,size:`small`,variant:`rounded`,IconLeft:o,"aria-label":`Search`}),(0,T.jsx)(i,{kind:`ghost`,size:`small`,variant:`rounded`,IconLeft:s,"aria-label":`Filter`}),(0,T.jsx)(`div`,{className:`py-sm flex items-center self-stretch`,children:(0,T.jsx)(d,{orientation:`vertical`,width:`0.5`,className:`min-h-[24px]`})}),(0,T.jsx)(i,{kind:`ghost`,size:`small`,label:`Export`,IconRight:c})]})})}function C(){if(typeof window>`u`)return{};try{let e=window.localStorage.getItem(W);if(!e)return{};let t=JSON.parse(e);if(t&&typeof t==`object`)return t}catch{}return{}}var w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J;e((()=>{v(),y(),w=t(a(),1),T=g(),E=[{name:`Ada Lovelace`,email:`ada@example.com`,role:`Admin`,status:`active`},{name:`Grace Hopper`,email:`grace@example.com`,role:`Editor`,status:`active`},{name:`Alan Turing`,email:`alan@example.com`,role:`Viewer`,status:`pending`},{name:`Katherine Johnson`,email:`katherine@example.com`,role:`Editor`,status:`inactive`},{name:`Margaret Hamilton`,email:`margaret@example.com`,role:`Admin`,status:`active`}],D=Array.from({length:47},(e,t)=>{let n=E[t%E.length],r=t+1;return{...n,id:String(r),name:`${n.name} #${r}`}}),O={active:`lime`,inactive:`gray`,pending:`orange`},k=10,A=[{label:`All members`,value:`all`},{label:`Admins only`,value:`admins`},{label:`Pending invites`,value:`pending`}],j=[{key:`_index`,header:``,kind:`rowIndex`},{key:`name`,header:`Name`,sortable:!0},{key:`owner`,header:`Owner`,kind:`user`,render:e=>(0,T.jsx)(l,{name:e.name})},{key:`email`,header:`Email`,sortable:!0},{key:`role`,header:`Role`},{key:`status`,header:`Status`,kind:`badge`,render:e=>(0,T.jsx)(m,{color:O[e.status],children:e.status})}],M=[{key:`_index`,header:``,kind:`rowIndex`},{key:`name`,header:`Name`,sortable:!0,editable:!0},{key:`owner`,header:`Owner`,kind:`user`,render:e=>(0,T.jsx)(l,{name:e.name})},{key:`email`,header:`Email`,sortable:!0},{key:`role`,header:`Role`},{key:`status`,header:`Status`,kind:`badge`,render:e=>(0,T.jsx)(m,{color:O[e.status],children:e.status})}],N=[{id:`1`,firstName:`—`,lastName:`—`,email:`e2e@test.com`,role:`Owner`},{id:`2`,firstName:`Katherine`,lastName:`Johnson`,email:`katherine.johnson@example.com`,role:`Editor`},{id:`3`,firstName:`Margaret`,lastName:`Hamilton`,email:`margaret.hamilton@longsubdomain.example.com`,role:`Admin`}],P=[{key:`firstName`,header:`First name`},{key:`lastName`,header:`Last name`},{key:`email`,header:`Email`},{key:`role`,header:`Role`}],F={title:`Display & Data/DataTable/DataTable`,component:p,tags:[`autodocs`],argTypes:{selectionMode:{control:`inline-radio`,options:[`none`,`single`,`multiple`]},selectionControl:{control:`inline-radio`,options:h,description:`Row-index column control. Defaults: single → radio, multiple → checkbox. "multiple" always uses checkboxes.`}},args:{selectionMode:`none`,title:`Data Table`,subtitle:`A compact overview of the team.`},parameters:{docs:{description:{component:`Data grid with sorting, selection, and pagination. Use for dense tabular data where rows represent records and columns are consistent fields.`}}}},I={render:e=>{let[t,r]=(0,w.useState)(1),i=Math.max(1,Math.ceil(D.length/k)),a=Math.min(t,i);return(0,T.jsx)(`div`,{style:{width:960},children:(0,T.jsx)(p,{...e,columns:j,data:D,currentPage:a,rowsPerPage:k,footer:(0,T.jsx)(n,{currentPage:a,totalPages:i,onPageChange:r})})})}},L={args:{selectionMode:`single`},render:I.render},R={args:{selectionMode:`multiple`},render:I.render},z={args:{selectionMode:`single`},render:I.render},B={args:{selectionMode:`single`,selectionControl:`checkbox`},render:I.render},V={args:{selectionMode:`multiple`},render:e=>{let[t,r]=(0,w.useState)(1),i=Math.max(1,Math.ceil(D.length/k)),a=Math.min(t,i);return(0,T.jsx)(`div`,{style:{width:960},children:(0,T.jsx)(p,{...e,className:`bg-transparent`,toolbar:(0,T.jsx)(S,{}),header:(0,T.jsx)(f,{title:`Team directory`,subtitle:`Search, filter, and manage workspace members.`}),columns:j,data:D,currentPage:a,rowsPerPage:k,footer:(0,T.jsx)(n,{currentPage:a,totalPages:i,onPageChange:r})})})}},H={render:e=>(0,T.jsx)(`div`,{style:{width:960},children:(0,T.jsx)(p,{...e,columns:j,data:D})})},U={name:`With inline editable cells`,parameters:{docs:{description:{story:"The **Name** column uses `editable: true`. Click a cell to edit (pointer cursor); blur or Enter commits (updates local story state). Escape restores the previous value."}}},args:{selectionMode:`none`,title:`Editable cells`,subtitle:`Click a name to edit inline.`},render:e=>{let[t,n]=(0,w.useState)(()=>D.slice(0,12).map(e=>({...e})));return(0,T.jsx)(`div`,{style:{width:960},children:(0,T.jsx)(p,{...e,columns:M,data:t,onCellTextCommit:({rowId:e,columnKey:t,value:r})=>{n(n=>n.map(n=>n.id===e&&t===`name`?{...n,name:r}:n))}})})}},W=`arcade-storybook:datatable:column-widths`,G={name:`With persisted column widths`,parameters:{docs:{description:{story:"Columns are resizable; the widths are saved to `localStorage` so they persist across reloads. The story wires up `columnWidths` (controlled) + `onColumnWidthsChange`. Use the **Reset widths** button to clear the stored widths and fall back to auto sizing."}}},args:{selectionMode:`none`,title:`Persisted column widths`,subtitle:`Drag a header divider to resize. Reload to verify persistence.`},render:e=>{let[t,n]=(0,w.useState)(()=>C()),r=e=>{n(e);try{window.localStorage.setItem(W,JSON.stringify(e))}catch{}};return(0,T.jsxs)(`div`,{style:{width:960},className:`gap-md flex flex-col`,children:[(0,T.jsx)(`div`,{children:(0,T.jsx)(i,{kind:`ghost`,size:`small`,label:`Reset widths`,onClick:()=>{try{window.localStorage.removeItem(W)}catch{}n({})}})}),(0,T.jsx)(p,{...e,columns:j,data:D.slice(0,10),columnWidths:t,onColumnWidthsChange:r})]})}},K={render:e=>(0,T.jsx)(`div`,{style:{width:720},children:(0,T.jsxs)(p,{...e,title:`Recent activity`,subtitle:`Manually composed rows`,children:[(0,T.jsxs)(_,{showBorderTop:!0,showBorderBottom:!0,children:[(0,T.jsx)(b,{columnBorderRight:!0,children:`Deployment succeeded`}),(0,T.jsx)(b,{children:`2 minutes ago`})]}),(0,T.jsxs)(_,{children:[(0,T.jsx)(b,{columnBorderRight:!0,children:`Build finished`}),(0,T.jsx)(b,{children:`11 minutes ago`})]})]})})},q={name:`Column alignment (auto-sized, narrow)`,parameters:{docs:{description:{story:"Short header labels with long body content in a deliberately narrow container, with no per-column `width` set. Header and body columns must stay aligned and overflow truncates with an ellipsis. Guards the `min-w-0` fix that keeps auto-sized flex columns from being widened by their content."}}},render:e=>(0,T.jsx)(`div`,{style:{width:460},children:(0,T.jsx)(p,{...e,title:`People`,subtitle:`Auto-sized columns must align header-to-body.`,columns:P,data:N})})},I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  render: args => {
