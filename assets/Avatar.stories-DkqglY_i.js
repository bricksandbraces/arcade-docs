import{n as e}from"./chunk-jRWAZmH_.js";import{Ar as t,Fr as n,Mo as r,_o as i,t as a}from"./iframe-dCkyJnNO.js";var o,s,c,l,u,d,f,p,m,h,g,_,v,y,b;e((()=>{a(),r(),o=i(),{action:s}=__STORYBOOK_MODULE_ACTIONS__,c={title:`Display & Data/Avatar/Avatar`,component:n,tags:[`autodocs`],parameters:{docs:{description:{component:`Circular representation of a user, showing an image, memoji, initials or fallback icon. Use in headers, comment threads, and member lists.`}}}},l=e=>(0,o.jsx)(n,{...e,image:e.media===`image`?(0,o.jsx)(`img`,{src:`/arcade-docs/assets/image-sample.png`,alt:`Franklin Kudos Profile`,className:`size-full object-cover`}):void 0,memoji:e.media===`memoji`?(0,o.jsx)(`img`,{src:`/arcade-docs/assets/memoji-sample.png`,alt:`Franklin Kudos Memoji`,className:`scale-[1.4] object-cover`}):void 0}),l.args={state:`Online`,size:`medium`,name:`Franklin Kudos`,media:`none`},u={description:`The state of the indicator`,control:{type:`select`},options:[void 0,`Online`,`Offline`,`Busy`,`Pending`,`Notification`]},l.argTypes={state:u,size:{description:`The size of the avatar`,control:{type:`select`},options:[`small`,`medium`,`large`]},name:{description:`The name of the avatar`,control:{type:`text`}},media:{description:`Optional media source for the avatar`,control:{type:`select`},options:[`image`,`memoji`,`none`]}},d=s(`onClick`),f={parameters:{controls:{disable:!0}},render:e=>{let t=[`large`,`medium`,`small`],r=[{media:`image`,name:`Franklin Kudos`},{media:`memoji`,name:`Franklin Kudos`},{media:`none`,name:`Franklin Kudos`},{media:`none`,name:``}];return(0,o.jsx)(`div`,{className:`gap-x-lg gap-y-md grid grid-cols-4`,children:t.map(t=>r.map((r,i)=>(0,o.jsx)(n,{state:e.state,size:t,name:r.name,image:r.media===`image`?(0,o.jsx)(`img`,{src:`/arcade-docs/assets/image-sample.png`,alt:`Franklin Kudos Profile`,className:`size-full object-cover`}):void 0,memoji:r.media===`memoji`?(0,o.jsx)(`img`,{src:`/arcade-docs/assets/memoji-sample.png`,alt:`Franklin Kudos Memoji`,className:`scale-[1.4] object-cover`}):void 0},`${t}-${i}`)))})},argTypes:{state:u}},p={parameters:{controls:{disable:!0}},render:()=>{let e=[`large`,`medium`,`small`],t=[{media:`image`,name:`Franklin Kudos`},{media:`memoji`,name:`Franklin Kudos`},{media:`none`,name:`Franklin Kudos`},{media:`none`,name:``}];return(0,o.jsx)(`div`,{className:`gap-x-lg gap-y-md grid grid-cols-4`,children:e.map(e=>t.map((t,r)=>(0,o.jsx)(n,{state:`Online`,size:e,name:t.name,onClick:d,image:t.media===`image`?(0,o.jsx)(`img`,{src:`/arcade-docs/assets/image-sample.png`,alt:`Franklin Kudos Profile`,className:`size-full object-cover`}):void 0,memoji:t.media===`memoji`?(0,o.jsx)(`img`,{src:`/arcade-docs/assets/memoji-sample.png`,alt:`Franklin Kudos Memoji`,className:`scale-[1.4] object-cover`}):void 0},`${e}-${r}`)))})}},m={parameters:{controls:{disable:!0}},render:()=>{let e=[`large`,`medium`,`small`],t=[{media:`image`,name:`Franklin Kudos`},{media:`memoji`,name:`Franklin Kudos`},{media:`none`,name:`Franklin Kudos`},{media:`none`,name:``}];return(0,o.jsx)(`div`,{className:`gap-x-lg gap-y-md grid grid-cols-4`,children:e.map(e=>t.map((t,r)=>(0,o.jsx)(n,{state:`Online`,size:e,name:t.name,href:`#`,image:t.media===`image`?(0,o.jsx)(`img`,{src:`/arcade-docs/assets/image-sample.png`,alt:`Franklin Kudos Profile`,className:`size-full object-cover`}):void 0,memoji:t.media===`memoji`?(0,o.jsx)(`img`,{src:`/arcade-docs/assets/memoji-sample.png`,alt:`Franklin Kudos Memoji`,className:`scale-[1.4] object-cover`}):void 0},`${e}-${r}`)))})}},h={parameters:{controls:{disable:!0}},render:()=>{let e=[`large`,`medium`,`small`],t=[{media:`image`,name:`Franklin Kudos`},{media:`memoji`,name:`Franklin Kudos`},{media:`none`,name:`Franklin Kudos`},{media:`none`,name:``}];return(0,o.jsx)(`div`,{className:`gap-x-lg gap-y-md grid grid-cols-4`,children:e.map(e=>t.map((t,r)=>(0,o.jsx)(n,{state:`Online`,size:e,name:t.name,disabled:!0,onClick:d,image:t.media===`image`?(0,o.jsx)(`img`,{src:`/arcade-docs/assets/image-sample.png`,alt:`Franklin Kudos Profile`,className:`size-full object-cover`}):void 0,memoji:t.media===`memoji`?(0,o.jsx)(`img`,{src:`/arcade-docs/assets/memoji-sample.png`,alt:`Franklin Kudos Memoji`,className:`scale-[1.4] object-cover`}):void 0},`${e}-${r}`)))})}},g={render:()=>(0,o.jsx)(t,{})},_=({href:e,children:t,...n})=>(0,o.jsx)(`a`,{...n,href:e,"data-next-link":`true`,children:t}),v=({src:e,alt:t,className:n})=>(0,o.jsx)(`img`,{src:e,alt:t,className:n,"data-next-image":`true`}),y={parameters:{controls:{disable:!0},docs:{description:{story:"End-to-end Next.js integration: `linkComponent={NextLink}` for routing, `next/image` via the `image` slot. The rendered nodes below carry `data-next-link` / `data-next-image` so the substitution is visible."}}},render:()=>(0,o.jsx)(`div`,{className:`gap-lg flex items-center`,children:(0,o.jsx)(n,{size:`large`,name:`Franklin Kudos`,href:`/profile`,linkComponent:_,image:(0,o.jsx)(v,{src:`/arcade-docs/assets/image-sample.png`,alt:`Franklin Kudos Profile`,className:`size-full object-cover`})})})},l.__docgenInfo={description:``,methods:[],displayName:`Playground`},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:'(args: React.ComponentProps<typeof Avatar> & Record<string, any>) => {\n  return <Avatar {...args} image={args.media === "image" ? <img src={`${import.meta.env.BASE_URL}assets/image-sample.png`} alt="Franklin Kudos Profile" className="size-full object-cover" /> : undefined} memoji={args.media === "memoji" ? <img src={`${import.meta.env.BASE_URL}assets/memoji-sample.png`} alt="Franklin Kudos Memoji" className="scale-[1.4] object-cover" /> : undefined} />;\n}',...l.parameters?.docs?.source}}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
