import{n as e}from"./chunk-jRWAZmH_.js";import{Fo as t,No as n,Po as r,ai as i,i as a,vs as o}from"./iframe-vatATh5Q.js";import{n as s,t as c}from"./figmaDesign-CO6i5n9C.js";var l,u,d,f,p,m,h,g,_,v,y,b;e((()=>{a(),s(),l=o(),{action:u}=__STORYBOOK_MODULE_ACTIONS__,{expect:d,fn:f}=__STORYBOOK_MODULE_TEST__,p=e=>{u(`onClick`)(e)},m={title:`Buttons & Actions/Button`,component:n,tags:[`autodocs`],args:{label:`Button`,disabled:!1,loading:!1,kind:`primary`,size:`medium`,IconLeft:void 0,IconRight:void 0,onClick:p,tooltipContent:`Tooltip text`,tooltipPlacement:`bottom`},parameters:{design:c(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2104-2841`),docs:{description:{component:`Triggers an action when clicked. Use the primary kind for the main action on a page, secondary or ghost for supporting actions.`}}}},h={args:{kind:`primary`},argTypes:{kind:{description:`The kind of button`,control:{type:`select`},options:[`primary`,`primary-light`,`secondary`,`tertiary`,`ghost`,`primary-danger`,`tertiary-danger`,`ghost-danger`,`ghost-compact`,`ghost-danger-compact`],defaultValue:`primary`},size:{description:`The size of the button`,control:{type:`select`},options:[`small`,`medium`,`large`],defaultValue:`medium`},onClick:{control:{disable:!0}},IconLeft:{control:{disable:!0}},IconRight:{control:{disable:!0}}}},g=e=>(0,l.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,fill:`none`,viewBox:`0 0 24 24`,stroke:`currentColor`,className:e.className,children:(0,l.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:2,d:`M12 6v6m0 0v6m0-6h6m-6 0H6`})}),_={parameters:{controls:{disable:!0}},render:e=>{let i=t.toReversed().flatMap(e=>[{size:e,loading:!1,disabled:!1},{size:e,loading:!1,disabled:!0},{size:e,loading:!0,disabled:!1}]),a=r;return(0,l.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${a.length}, minmax(0, 1fr))`},children:i.map((t,r)=>a.map((i,a)=>{let o=`${i}-${t.size}-${t.loading?`loading`:`default`}-${t.disabled?`disabled`:`enabled`}`;return(0,l.jsxs)(`div`,{style:{gridColumn:`${a+1} / span 1`,gridRow:`${r+1} / span 1`},children:[e.showLabels&&(0,l.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,t.size,`, kind=`,i,t.loading?`, loading`:``,t.disabled?`, disabled`:``]}),(0,l.jsxs)(`div`,{className:`gap-sm flex flex-row`,children:[(0,l.jsx)(n,{label:`Button`,kind:i,size:t.size,loading:t.loading,disabled:t.disabled,onClick:p,tooltipContent:e.tooltipContent,tooltipPlacement:e.tooltipPlacement}),(0,l.jsx)(n,{"aria-label":`Icon button`,kind:i,size:t.size,loading:t.loading,disabled:t.disabled,IconLeft:g,onClick:p,tooltipContent:e.tooltipContent,tooltipPlacement:e.tooltipPlacement})]})]},o)}))})},args:{showLabels:!1}},v={args:{kind:`primary`,label:`Click me`,onClick:f()},play:async({args:e,canvas:t,userEvent:n})=>{let r=t.getByRole(`button`,{name:/click me/i});await d(r).toBeEnabled(),await n.click(r),await d(e.onClick).toHaveBeenCalledOnce()}},y={render:()=>(0,l.jsx)(i,{})},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    kind: "primary"
  },
  argTypes: {
    kind: {
      ...
      options: ["primary", "primary-light", "secondary", "tertiary", "ghost", "primary-danger", "tertiary-danger", "ghost-danger", "ghost-compact", "ghost-danger-compact"],
