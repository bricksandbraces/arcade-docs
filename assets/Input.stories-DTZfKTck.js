import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{Z as o,I as N,aI as i}from"./ContextMenuList-UUP63zD1.js";import"./index-CY-HDqYb.js";import{a as v}from"./index-B-lxVbXh.js";import{O as P}from"./onCardStoryShell-BJaWLAPz.js";import"./index-A6zbrgSY.js";import"./index-DWvd7WUe.js";import"./index-BDYMFBcC.js";import"./v4-CtRu48qb.js";const U={title:"Components/Inputs/Input",component:i,argTypes:{state:{control:{type:"select"},options:N},size:{control:{type:"select"},options:o}}},n={args:{id:"input","aria-label":"Label",disabled:!1,loading:!1,state:"default",trailingSlot:void 0,placeholder:"Placeholder",onChange:v("onChange")},argTypes:{}},s={args:{...n.args,id:"slot-input",defaultValue:"123.45",leadingSlot:a.jsx("span",{className:"typography-label text-text-accent inline-flex min-w-[3ch] justify-center",children:"EUR"}),trailingSlot:a.jsx("span",{className:"typography-label text-text-accent inline-flex min-w-[3ch] justify-center",children:"NET"}),trailingSlotPadding:"inset"}},t={args:{...n.args,surface:"onCard"},render:r=>a.jsx(P,{children:a.jsx(i,{...r})})},l={parameters:{controls:{disable:!0}},render:r=>{const $=[{loading:!1,disabled:!1,state:"default"},{loading:!1,disabled:!1,state:"error"},{loading:!1,disabled:!1,state:"warning"},{loading:!1,disabled:!1,state:"success"},{loading:!1,disabled:!1,state:"success",trailingSlot:"Done"},{loading:!0,disabled:!1,state:"default"},{loading:!0,disabled:!0,state:"default"},{loading:!1,disabled:!0,state:"default"}];return a.jsx("div",{className:"gap-xlg grid",style:{display:"grid",gridTemplateColumns:`repeat(${o.length}, minmax(0, 1fr))`},children:$.map((e,I)=>o.map((d,j)=>{const c=`${d}-${e.loading?"loading":"default"}-${e.disabled?"disabled":"enabled"}-${e.state==="error"?"error":"noerror"}-${e.state==="success"?"success":"nosuccess"}`;return a.jsxs("div",{style:{gridColumn:`${j+1} / span 1`,gridRow:`${I+1} / span 1`},children:[r.showLabels&&a.jsxs("p",{className:"typography-body-small text-text",children:["size=",d,e.loading?", loading":"",e.disabled?", disabled":"",e.state]}),a.jsx("div",{className:"gap-sm flex flex-row",children:a.jsx(i,{id:`${c}-input`,defaultValue:"Text",placeholder:"Placeholder",size:d,loading:e.loading,disabled:e.disabled,state:e.state,className:"w-[192px]"})})]},c)}))})},args:{showLabels:!1}};var g,p,u;n.parameters={...n.parameters,docs:{...(g=n.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    id: "input",
    "aria-label": "Label",
    disabled: false,
