import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Dt as n,Oo as r,Ot as i,Uo as a,t as o,wn as s}from"./iframe-CWtmor6b.js";var c,l,u,d,f,p,m,h,g;e((()=>{c=t(a(),1),o(),l=r(),u={title:`Inputs & Controls/Toggle`,component:n,tags:[`autodocs`],argTypes:{size:{control:`inline-radio`,options:i},selected:{control:`boolean`},disabled:{control:`boolean`},label:{control:`text`}},parameters:{docs:{description:{component:`Switch for binary on/off settings that apply immediately. Use in preference panels where changes take effect without a save step.`}}}},d=e=>{let[t,r]=c.useState(e.selected||!1);return(0,l.jsx)(n,{...e,selected:t,onClick:()=>!e.disabled&&r(!t)})},f={render:e=>(0,l.jsx)(d,{...e}),args:{size:`default`,selected:!1,disabled:!1,label:`Label`}},p=e=>{let[t,r]=c.useState(e.selected);return(0,l.jsx)(n,{size:e.size,disabled:e.disabled,selected:t,label:e.label,onClick:()=>!e.disabled&&r(!t)})},m={parameters:{controls:{disable:!0}},render:()=>(0,l.jsxs)(`div`,{className:`gap-xlg flex flex-col`,children:[(0,l.jsxs)(`div`,{className:`gap-xlg grid grid-cols-[minmax(8rem,auto)_1fr_1fr] items-center`,children:[(0,l.jsx)(`span`,{}),(0,l.jsx)(`span`,{className:`typography-body-small text-text-accent`,children:`Default`}),(0,l.jsx)(`span`,{className:`typography-body-small text-text-accent`,children:`Small`})]}),[{label:`Off`,selected:!1},{label:`On`,selected:!0},{label:`Disabled`,selected:!1,disabled:!0},{label:`Disabled · on`,selected:!0,disabled:!0}].map(e=>(0,l.jsxs)(`div`,{className:`gap-xlg grid grid-cols-[minmax(8rem,auto)_1fr_1fr] items-center`,children:[(0,l.jsx)(`span`,{className:`typography-body-small text-text`,children:e.label}),(0,l.jsx)(p,{size:`default`,selected:e.selected,disabled:e.disabled,label:`Toggle`}),(0,l.jsx)(p,{size:`small`,selected:e.selected,disabled:e.disabled,label:`Toggle`})]},e.label))]})},h={render:()=>(0,l.jsx)(s,{})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
