import{n as e}from"./chunk-jRWAZmH_.js";import{Nr as t,Oo as n,Qa as r,ca as i,fi as a,i as o,ka as s,ko as c,vs as l}from"./iframe-vatATh5Q.js";import{n as u,t as d}from"./figmaDesign-CO6i5n9C.js";var f,p,m,h,g,_,v,y,b,x,S,C;e((()=>{o(),i(),u(),f=l(),p={none:void 0,IconArrowRight:n,IconArrowLeft:c,IconExternalLink:r,Icon123:s},m=[`sm`,`md`,`lg`],h={title:`Navigation/Link`,component:a,tags:[`autodocs`],args:{href:`#`,label:`Link`,disabled:!1,inline:!1,size:`md`,leadingIcon:!1,icon:`IconArrowRight`},parameters:{design:d(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2130-35884`),docs:{description:{component:`Anchor styled as a text link, with optional leading or trailing icon. Use for in-page navigation and external references.`}}}},g={render:e=>{let{icon:t,...n}=e,r=p[t];return(0,f.jsx)(a,{...n,icon:r})},argTypes:{size:{description:`Typography scale`,control:{type:`inline-radio`},options:[...m]},inline:{description:`Inline (link style) vs accent (standalone)`,control:`boolean`},disabled:{control:`boolean`},leadingIcon:{control:`boolean`},label:{control:`text`},href:{control:`text`},icon:{control:{type:`select`},options:Object.keys(p)},component:{control:{disable:!0}},linkComponent:{control:{disable:!0}}}},_=[{inline:!1,disabled:!1,leadingIcon:!1},{inline:!1,disabled:!1,leadingIcon:!0},{inline:!1,disabled:!0,leadingIcon:!1},{inline:!0,disabled:!1,leadingIcon:!1},{inline:!0,disabled:!0,leadingIcon:!1}],v={sm:`typography-label`,md:`typography-body-small`,lg:`typography-body`},y={parameters:{controls:{disable:!0}},render:e=>{let t=[...m].toReversed();return(0,f.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${t.length}, minmax(0, 1fr))`},children:_.map((i,o)=>t.map((t,s)=>{let c=`${t}-${i.inline?`inline`:`accent`}-${i.disabled?`disabled`:`enabled`}-${i.leadingIcon?`leading`:`trailing`}`;return(0,f.jsxs)(`div`,{style:{gridColumn:`${s+1} / span 1`,gridRow:`${o+1} / span 1`},children:[e.showLabels&&(0,f.jsxs)(`p`,{className:`${v[t]} text-text`,children:[`size=`,t,`, `,i.inline?`inline`:`accent`,i.disabled?`, disabled`:`, enabled`,i.leadingIcon?`, leading icon`:`, trailing icon`]}),i.inline?(0,f.jsxs)(`p`,{className:`${v[t]} text-text`,children:[`Before`,` `,(0,f.jsx)(a,{href:`#`,label:`link`,size:t,inline:!0,disabled:i.disabled,icon:r,leadingIcon:i.leadingIcon}),` `,`after.`]}):(0,f.jsx)(a,{href:`#`,label:`Link`,size:t,inline:!1,disabled:i.disabled,icon:n,leadingIcon:i.leadingIcon})]},c)}))})},args:{showLabels:!1}},b={render:()=>(0,f.jsx)(t,{})},x=({href:e,children:t,...n})=>(0,f.jsx)(`a`,{...n,href:e,"data-next-link":`true`,children:t}),S={parameters:{controls:{disable:!0},docs:{description:{story:"Plug in `next/link`'s `Link` (or any equivalent) via `linkComponent` so consumers preserve SPA navigation. The rendered anchor below carries a `data-next-link` attribute set by the mock component to make the substitution visible."}}},render:()=>(0,f.jsx)(a,{href:`/dashboard`,label:`Open dashboard`,linkComponent:x})},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  render: args => {
    const {
      icon,
      ...rest
