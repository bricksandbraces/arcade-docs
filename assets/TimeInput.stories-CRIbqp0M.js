import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Dt as n,Fi as r,Fs as i,Ii as a,Kt as o,Ot as s,bs as c,i as l}from"./iframe-BhGXUsCS.js";import{n as u,t as d}from"./surfaceStoryShell-CZ-EyK8j.js";var f,p,m,h,g,_,v;e((()=>{u(),f=t(i(),1),l(),p=c(),m={title:`Inputs & Controls/TimeInput`,component:n,tags:[`autodocs`],argTypes:{surface:{control:`inline-radio`,options:a},size:{control:`inline-radio`,options:s},disabled:{control:`boolean`},hideLabel:{control:`boolean`},min:{control:`number`},max:{control:`number`},step:{control:`number`},label:{control:`text`},helperText:{control:`text`},state:{control:`inline-radio`,options:r}},args:{surface:`default`,id:`playground-time-input`,label:`Duration`,size:`medium`,step:30,helperText:`Format mm:ss`},parameters:{docs:{description:{component:"Time input built on the same primitives as `NumberInput`. The value is a number of **seconds**; the field displays and parses `mm:ss` (or `h:mm:ss`). The +/- buttons and arrow keys step by `step` seconds (default 30). Use `trailingSlot` to add controls before the steppers (e.g. a colour picker)."}}}},h={render:e=>{let[t,r]=(0,f.useState)(e.value??90);return(0,p.jsx)(n,{...e,value:t,onValueChange:r})}},g={parameters:{docs:{description:{story:`A message longer than the reserved line grows the message slot and pushes the next field down.`}}},args:{id:`long-error-time-input`,state:`error`,errorMessage:`Enter a duration between 0:30 and 59:30 in steps of 30 seconds.`},render:e=>{let[t,r]=(0,f.useState)(90);return(0,p.jsxs)(`div`,{className:`flex w-[240px] flex-col`,children:[(0,p.jsx)(n,{...e,value:t,onValueChange:r}),(0,p.jsx)(o,{id:`long-error-time-next`,label:`Next field`,placeholder:`Placeholder text...`})]})}},_={render:e=>(0,p.jsx)(d,{children:t=>(0,p.jsx)(n,{...e,surface:t})})},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  render: args => {
