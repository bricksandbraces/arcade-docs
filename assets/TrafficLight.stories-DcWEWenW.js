import{n as e}from"./chunk-jRWAZmH_.js";import{Ht as t,Ii as n,Vt as r,t as i}from"./iframe-B1mIPWxP.js";var a,o,s,c,l,u,d,f,p;e((()=>{i(),a=n(),o={title:`Fabian Supervision/TrafficLight`,component:r,tags:[`autodocs`],argTypes:{state:{control:`inline-radio`,options:t},message:{control:`text`}},args:{state:`error`,message:`Your password is too vague.
...
Add a special character and numbers to it.`}},u={args:{state:`warning`,message:`Almost there. Mix upper- and lowercase letters.`}},d={args:{state:`success`,message:`Strong password.`}},f={render:()=>(0,a.jsx)(`div`,{className:`flex w-[368px] flex-col gap-xlg`,children:t.map(e=>(0,a.jsx)(r,{state:e,message:`State: ${e}`},e))})},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {}
