import{n as e}from"./chunk-jRWAZmH_.js";import{Cr as t,En as n,Vr as r,ai as i,cr as a,ii as o,qi as s,t as c}from"./iframe-BmX5hFjR.js";var l,u,d,f,p,m,h,g,_;e((()=>{c(),a(),l=s(),u={none:void 0,IconArrowRight:o,IconArrowLeft:i,IconExternalLink:r,Icon123:t},d=[`sm`,`md`,`lg`],f={title:`Components/Link`,component:n,tags:[`autodocs`],args:{href:`#`,label:`Link`,disabled:!1,inline:!1,size:`md`,leadingIcon:!1,icon:`IconArrowRight`},parameters:{docs:{description:{component:`Anchor styled as a text link, with optional leading or trailing icon. Use for in-page navigation and external references.`}}}},p={render:e=>{let{icon:t,...r}=e,i=u[t];return(0,l.jsx)(n,{...r,icon:i})},argTypes:{size:{description:`Typography scale`,control:{type:`inline-radio`},options:[...d]},inline:{description:`Inline (link style) vs accent (standalone)`,control:`boolean`},disabled:{control:`boolean`},leadingIcon:{control:`boolean`},label:{control:`text`},href:{control:`text`},icon:{control:{type:`select`},options:Object.keys(u)},component:{control:{disable:!0}}}},m=[{inline:!1,disabled:!1,leadingIcon:!1},{inline:!1,disabled:!1,leadingIcon:!0},{inline:!1,disabled:!0,leadingIcon:!1},{inline:!0,disabled:!1,leadingIcon:!1},{inline:!0,disabled:!0,leadingIcon:!1}],h={sm:`typography-label`,md:`typography-body-small`,lg:`typography-body`},g={parameters:{controls:{disable:!0}},render:e=>{let t=[...d].toReversed();return(0,l.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${t.length}, minmax(0, 1fr))`},children:m.map((i,a)=>t.map((t,s)=>{let c=`${t}-${i.inline?`inline`:`accent`}-${i.disabled?`disabled`:`enabled`}-${i.leadingIcon?`leading`:`trailing`}`;return(0,l.jsxs)(`div`,{style:{gridColumn:`${s+1} / span 1`,gridRow:`${a+1} / span 1`},children:[e.showLabels&&(0,l.jsxs)(`p`,{className:`${h[t]} text-text`,children:[`size=`,t,`, `,i.inline?`inline`:`accent`,i.disabled?`, disabled`:`, enabled`,i.leadingIcon?`, leading icon`:`, trailing icon`]}),i.inline?(0,l.jsxs)(`p`,{className:`${h[t]} text-text`,children:[`Before`,` `,(0,l.jsx)(n,{href:`#`,label:`link`,size:t,inline:!0,disabled:i.disabled,icon:r,leadingIcon:i.leadingIcon}),` `,`after.`]}):(0,l.jsx)(n,{href:`#`,label:`Link`,size:t,inline:!1,disabled:i.disabled,icon:o,leadingIcon:i.leadingIcon})]},c)}))})},args:{showLabels:!1}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  render: args => {
    const {
      icon,
      ...rest
