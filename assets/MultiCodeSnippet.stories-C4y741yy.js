import{M as D}from"./ContextMenuList-C0nT4XLm.js";import"./index-CY-HDqYb.js";import"./jsx-runtime-D_zvdyIk.js";import"./index-DWvd7WUe.js";import"./index-BDYMFBcC.js";import"./index-ZRCHFLd-.js";import"./borders-N_bRvfGw.js";import"./colors-mvAPBTAn.js";const o=`import React, { useState, useEffect } from 'react';
...
console.log(greeting);`,M={title:"WIP Components/CodeSnippet/MultiCodeSnippet",component:D,argTypes:{code:{control:"text"},language:{control:"text"},defaultOpen:{control:"boolean"},onToggle:{action:"toggled"},onCopy:{action:"copied"}},args:{code:o,language:"typescript",defaultOpen:!1}},e={args:{code:o,language:"typescript",defaultOpen:!1}},n={args:{code:o,language:"typescript",defaultOpen:!1}},t={args:{code:o,language:"typescript",defaultOpen:!0}},a={args:{code:B,language:"javascript",defaultOpen:!1}},s={args:{code:`{
...
}`,...(j=(x=r.parameters)==null?void 0:x.docs)==null?void 0:j.source}}};const N=["Playground","Closed","Open","ShortCode","JSONExample","BashCommands"];export{r as BashCommands,n as Closed,s as JSONExample,t as Open,e as Playground,a as ShortCode,N as __namedExportsOrder,M as default};
