import{n as e}from"./chunk-jRWAZmH_.js";import{Ai as t,fs as n,ji as r,jr as i,ki as a,t as o}from"./iframe-Dq9HnTRB.js";import{n as s,t as c}from"./figmaDesign-CO6i5n9C.js";import{n as l,t as u}from"./onCardStoryShell-DbAeESrZ.js";var d,f,p,m,h,g,_,v,y;e((()=>{o(),l(),s(),d=n(),{action:f}=__STORYBOOK_MODULE_ACTIONS__,p={title:`Inputs & Controls/Input`,component:a,tags:[`autodocs`],argTypes:{state:{control:{type:`select`},options:r},size:{control:{type:`select`},options:t}},parameters:{design:c(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2345-1233`),docs:{description:{component:`Unlabelled text input primitive used to build TextInput and other form fields. Use directly only when a custom label layout is needed.`}}}},m={args:{id:`input`,"aria-label":`Label`,disabled:!1,loading:!1,state:`default`,trailingSlot:void 0,placeholder:`Placeholder`,onChange:f(`onChange`)},argTypes:{}},h={args:{...m.args,id:`slot-input`,defaultValue:`123.45`,leadingSlot:(0,d.jsx)(`span`,{className:`typography-label text-text-accent inline-flex min-w-[3ch] justify-center`,children:`EUR`}),trailingSlot:(0,d.jsx)(`span`,{className:`typography-label text-text-accent inline-flex min-w-[3ch] justify-center`,children:`NET`}),trailingSlotPadding:`inset`}},g={args:{...m.args,surface:`onCard`},render:e=>(0,d.jsx)(u,{children:(0,d.jsx)(a,{...e})})},_={parameters:{controls:{disable:!0}},render:e=>(0,d.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${t.length}, minmax(0, 1fr))`},children:[{loading:!1,disabled:!1,state:`default`},{loading:!1,disabled:!1,state:`error`},{loading:!1,disabled:!1,state:`warning`},{loading:!1,disabled:!1,state:`success`},{loading:!1,disabled:!1,state:`success`,trailingSlot:`Done`},{loading:!0,disabled:!1,state:`default`},{loading:!0,disabled:!0,state:`default`},{loading:!1,disabled:!0,state:`default`}].map((n,r)=>t.map((t,i)=>{let o=`${t}-${n.loading?`loading`:`default`}-${n.disabled?`disabled`:`enabled`}-${n.state===`error`?`error`:`noerror`}-${n.state===`success`?`success`:`nosuccess`}`;return(0,d.jsxs)(`div`,{style:{gridColumn:`${i+1} / span 1`,gridRow:`${r+1} / span 1`},children:[e.showLabels&&(0,d.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,t,n.loading?`, loading`:``,n.disabled?`, disabled`:``,n.state]}),(0,d.jsx)(`div`,{className:`gap-sm flex flex-row`,children:(0,d.jsx)(a,{id:`${o}-input`,"aria-label":`Input ${t} ${n.state}`,defaultValue:`Text`,placeholder:`Placeholder`,size:t,loading:n.loading,disabled:n.disabled,state:n.state,className:`w-[192px]`})})]},o)}))}),args:{showLabels:!1}},v={render:()=>(0,d.jsx)(i,{})},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    id: "input",
    "aria-label": "Label",
    disabled: false,
