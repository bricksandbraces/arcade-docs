import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Di as n,Dn as r,Hi as i,t as a,vn as o}from"./iframe-QfUBFbw6.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b;e((()=>{s=t(i(),1),a(),c=n(),l=e=>e??!1,u=e=>{let[t,n]=(0,s.useState)(()=>l(e.checked));return(0,s.useEffect)(()=>{n(l(e.checked))},[e.checked]),(0,c.jsx)(o,{...e,checked:t,onChange:r=>{!e.disabled&&!e.readonly&&n(t===`indeterminate`?!0:r.target.checked)}})},d={title:`Components/Checkbox`,component:o,tags:[`autodocs`],argTypes:{checked:{control:`inline-radio`,options:[!1,!0,`indeterminate`]},disabled:{control:`boolean`},readonly:{control:`boolean`},label:{control:`text`},description:{control:`text`},errorMessage:{control:`text`},warningMessage:{control:`text`},hideLabel:{control:`boolean`},state:{control:`inline-radio`,options:r}},render:u,parameters:{docs:{description:{component:`Checkbox with label, description, and validation states. Use for binary choices and multi-select lists in forms.`}}}},f={args:{checked:!1,disabled:!1,readonly:!1,label:`Label`,description:`Checkbox`,errorMessage:``,warningMessage:``}},p={args:{checked:!1,disabled:!0,label:`Label`,description:`Checkbox`}},m={args:{checked:!0,disabled:!1,readonly:!0,label:`Label`,description:`Checkbox`}},h={args:{checked:`indeterminate`,disabled:!1,readonly:!0,label:`Label`,description:`Checkbox`}},g={args:{checked:!1,disabled:!1,label:`Label`,description:`Checkbox`,state:`error`,errorMessage:`Error Message goes here`}},_={args:{checked:!1,disabled:!1,label:`Label`,description:`Checkbox`,state:`warning`,warningMessage:`Warning Message goes here`}},v={args:{checked:!1,disabled:!1,description:`Checkbox`}},y={parameters:{controls:{disable:!0}},render:()=>(0,c.jsxs)(`div`,{className:`gap-lg flex flex-col`,children:[(0,c.jsxs)(`div`,{className:`gap-md grid grid-cols-3`,children:[(0,c.jsx)(o,{checked:!1,label:`Enabled`,description:`Unchecked`}),(0,c.jsx)(o,{checked:!0,label:`Enabled`,description:`Checked`}),(0,c.jsx)(o,{checked:`indeterminate`,label:`Enabled`,description:`Indeterminate`})]}),(0,c.jsxs)(`div`,{className:`gap-md grid grid-cols-3`,children:[(0,c.jsx)(o,{checked:!1,disabled:!0,label:`Disabled`,description:`Unchecked`}),(0,c.jsx)(o,{checked:!0,disabled:!0,label:`Disabled`,description:`Checked`}),(0,c.jsx)(o,{checked:`indeterminate`,disabled:!0,label:`Disabled`,description:`Indeterminate`})]}),(0,c.jsxs)(`div`,{className:`gap-md grid grid-cols-3`,children:[(0,c.jsx)(o,{checked:!1,readonly:!0,label:`Readonly`,description:`Unchecked`}),(0,c.jsx)(o,{checked:!0,readonly:!0,label:`Readonly`,description:`Checked`}),(0,c.jsx)(o,{checked:`indeterminate`,readonly:!0,label:`Readonly`,description:`Indeterminate`})]}),(0,c.jsxs)(`div`,{className:`gap-md grid grid-cols-2`,children:[(0,c.jsx)(o,{checked:!1,label:`Error`,description:`Checkbox`,errorMessage:`Error Message goes here`}),(0,c.jsx)(o,{checked:!0,label:`Error`,description:`Checkbox`,errorMessage:`Error Message goes here`})]}),(0,c.jsxs)(`div`,{className:`gap-md grid grid-cols-2`,children:[(0,c.jsx)(o,{checked:!1,label:`Warning`,description:`Checkbox`,warningMessage:`Warning Message goes here`}),(0,c.jsx)(o,{checked:!0,label:`Warning`,description:`Checkbox`,warningMessage:`Warning Message goes here`})]})]})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
    checked: false,
    disabled: false,
    readonly: false,
