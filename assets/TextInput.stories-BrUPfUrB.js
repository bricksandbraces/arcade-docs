import{j as s}from"./jsx-runtime-D_zvdyIk.js";import{I as S,W as w,bI as t}from"./ContextMenuList-DeCYJw7n.js";import"./index-CY-HDqYb.js";import{O as L}from"./onCardStoryShell-BJaWLAPz.js";import"./index-A6zbrgSY.js";import"./index-DWvd7WUe.js";import"./index-BDYMFBcC.js";const j={title:"Components/Inputs/TextInput",component:t,argTypes:{size:{control:"inline-radio",options:w},disabled:{control:"boolean"},loading:{control:"boolean"},successMessage:{control:"text"},errorMessage:{control:"text"},hideLabel:{control:"boolean"},label:{control:"text"},placeholder:{control:"text"},state:{control:"inline-radio",options:S}},args:{errorMessage:"Error Message",warningMessage:"Warning Message",successMessage:"Success",loadingMessage:"Loading...",helperText:"Helper Text",id:"playground-text-input",label:"Label",placeholder:"Placeholder text...",size:"medium"}},l={args:{}},r={args:{...j.args,surface:"onCard"},render:a=>s.jsx(L,{children:s.jsx(t,{...a})})},o={args:{id:"slot-text-input",label:"Label",placeholder:"Placeholder text...",trailingSlot:s.jsx("span",{className:"typography-label text-text-accent",children:"ID"})},render:a=>s.jsx(t,{...a})},d={parameters:{controls:{disable:!0}},args:{showLabels:!1},render:a=>{const z=w.toReversed().flatMap(e=>[{size:e,loading:!1,disabled:!1,state:"default"},{size:e,loading:!1,disabled:!0,state:"default"},{size:e,loading:!0,disabled:!1,state:"default"},{size:e,loading:!1,disabled:!1,state:"error"},{size:e,loading:!1,disabled:!1,state:"success"}]),g=S;return s.jsx("div",{className:"gap-xlg grid pb-[128px]",style:{display:"grid",gridTemplateColumns:`repeat(${g.length}, minmax(0, 1fr))`},children:z.map((e,i)=>g.map((n,I)=>{const T=`${n}-${e.size}-${e.loading?"loading":"default"}-${e.disabled?"disabled":"enabled"}-${e.state}`;return s.jsxs("div",{style:{gridColumn:`${I+1} / span 1`,gridRow:`${i+1} / span 1`},children:[a.showLabels&&s.jsxs("p",{className:"typography-body-small text-text",children:["size=",e.size,", state=",n,e.loading?", loading":"",e.disabled?", disabled":"",e.state!=="default"?`, status=${e.state}`:""]}),s.jsxs("div",{className:"gap-sm flex flex-col",children:[s.jsx("div",{className:"pb-[32px]",children:s.jsx(t,{id:`${n}-${e.size}-${i}-empty`,label:"Label",placeholder:"Placeholder text...",helperText:"Helper Text",loadingMessage:"Loading...",errorMessage:"Error Message",successMessage:"Success",warningMessage:"Warning Message",size:e.size,state:e.state,loading:e.loading,disabled:e.disabled})}),s.jsx("div",{className:"pb-[32px]",children:s.jsx(t,{id:`${n}-${e.size}-${i}-filled`,label:"Label",placeholder:"Placeholder text...",helperText:"Helper Text",loadingMessage:"Loading...",errorMessage:"Error Message",successMessage:"Success",warningMessage:"Warning Message",size:e.size,state:e.state,loading:e.loading,disabled:e.disabled,value:"john.doe@example.com"})})]})]},T)}))})}};var c,p,u;l.parameters={...l.parameters,docs:{...(c=l.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {}
...
}`,...($=(y=d.parameters)==null?void 0:y.docs)==null?void 0:$.source}}};const R=["Playground","OnCard","Slot","Overview"];export{r as OnCard,d as Overview,l as Playground,o as Slot,R as __namedExportsOrder,j as default};
