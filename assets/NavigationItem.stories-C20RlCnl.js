import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ma as n,Os as r,Us as i,_a as a,an as o,in as s,mo as c,on as l,ps as u,t as d,to as f}from"./iframe-jImnWlHt.js";import{n as p,t as m}from"./figmaDesign-DDiUnvXT.js";var h,g,_,v,y,b,x,S,C;e((()=>{d(),a(),h=t(u(),1),g=t(i(),1),p(),_=r(),v={parameters:{design:m(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2438-38919`)},title:`Navigation/Navigation/NavigationItem`,component:s,tags:[`autodocs`],argTypes:{level:{control:`inline-radio`,options:o},size:{control:`inline-radio`,options:l},selected:{control:`boolean`},disabled:{control:`boolean`},expandable:{control:`boolean`},expanded:{control:`boolean`},title:{control:`text`},tooltip:{control:`text`}},args:{title:`Dashboard`,level:1,expandable:!1,selected:!1,disabled:!1,size:`default`},decorators:[e=>(0,_.jsx)(`div`,{className:(0,h.default)(`p-lg`,`w-72`,`bg-background`),children:(0,_.jsx)(e,{})})]},y={args:{icon:c}},b={parameters:{controls:{disable:!0}},render:()=>(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-xlg`,`flex`,`flex-col`),children:[(0,_.jsxs)(`section`,{className:(0,h.default)(`gap-md`,`flex`,`flex-col`),children:[(0,_.jsx)(`h3`,{className:(0,h.default)(`typography-headline-04`,`text-text`),children:`Level 1 - default size`}),(0,_.jsx)(s,{title:`Enabled`,icon:c}),(0,_.jsx)(s,{title:`Selected`,icon:c,selected:!0}),(0,_.jsx)(s,{title:`Disabled`,icon:c,disabled:!0}),(0,_.jsx)(s,{title:`Expandable (collapsed)`,icon:f,expandable:!0}),(0,_.jsxs)(s,{title:`Expandable (expanded)`,icon:f,expandable:!0,defaultExpanded:!0,children:[(0,_.jsx)(s,{title:`Nested item`,level:2}),(0,_.jsx)(s,{title:`Another nested`,level:2})]})]}),(0,_.jsxs)(`section`,{className:(0,h.default)(`gap-md`,`flex`,`flex-col`),children:[(0,_.jsx)(`h3`,{className:(0,h.default)(`typography-headline-04`,`text-text`),children:`Level 2`}),(0,_.jsx)(s,{title:`Nested enabled`,level:2}),(0,_.jsx)(s,{title:`Nested selected`,level:2,selected:!0}),(0,_.jsx)(s,{title:`Nested disabled`,level:2,disabled:!0})]}),(0,_.jsxs)(`section`,{className:(0,h.default)(`gap-md`,`flex`,`flex-col`),children:[(0,_.jsx)(`h3`,{className:(0,h.default)(`typography-headline-04`,`text-text`),children:`Small - icon only with tooltip`}),(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-sm`,`flex`,`flex-col`,`w-16`),children:[(0,_.jsx)(s,{size:`small`,icon:c,tooltip:`Dashboard`}),(0,_.jsx)(s,{size:`small`,icon:f,tooltip:`Projects`,selected:!0}),(0,_.jsx)(s,{size:`small`,icon:n,tooltip:`Settings`,disabled:!0})]})]})]})},x={parameters:{controls:{disable:!0}},render:function(){let[e,t]=g.useState(`projects`);return(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,_.jsx)(s,{title:`Dashboard`,icon:c,selected:e===null}),(0,_.jsxs)(s,{title:`Projects`,icon:f,expandable:!0,expanded:e===`projects`,onExpandedChange:e=>t(e?`projects`:null),children:[(0,_.jsx)(s,{title:`All projects`,level:2}),(0,_.jsx)(s,{title:`Archived`,level:2}),(0,_.jsx)(s,{title:`Templates`,level:2,disabled:!0})]}),(0,_.jsxs)(s,{title:`Settings`,icon:n,expandable:!0,expanded:e===`settings`,onExpandedChange:e=>t(e?`settings`:null),children:[(0,_.jsx)(s,{title:`Profile`,level:2}),(0,_.jsx)(s,{title:`Billing`,level:2})]})]})}},S={parameters:{controls:{disable:!0}},render:()=>(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,_.jsx)(s,{title:`Dashboard`,icon:c,href:`#dashboard`,selected:!0}),(0,_.jsx)(s,{title:`Projects`,icon:f,href:`#projects`}),(0,_.jsx)(s,{title:`Settings`,icon:n,href:`#settings`})]})},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    icon: IconDashboard
  }
