import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{an as b,aG as g,aH as h}from"./ContextMenuList-DeCYJw7n.js";import{r as l}from"./index-CY-HDqYb.js";import{a as S}from"./index-B-lxVbXh.js";import"./index-A6zbrgSY.js";import"./index-DWvd7WUe.js";import"./index-BDYMFBcC.js";import"./v4-CtRu48qb.js";const y=e=>{S("onChange")(e)},I={title:"Hendrik Supervision/Slider/SliderControl",component:b,args:{value:50,min:0,max:100,step:1,disabled:!1,showTooltip:!1,variant:"bar",size:"md",onChange:y}},x=e=>{const[o,n]=l.useState(e.value??50);return l.useEffect(()=>{n(e.value??50)},[e.value]),a.jsx(b,{...e,value:o,onChange:t=>{var r;n(t),(r=e.onChange)==null||r.call(e,t)}})},i={render:e=>a.jsx(x,{...e}),argTypes:{variant:{description:"Bar (vertical handle) or Dot (circular handle)",control:{type:"inline-radio"},options:h},size:{description:"Track and handle scale",control:{type:"inline-radio"},options:g},value:{control:{type:"range",min:0,max:100,step:1}},min:{control:{type:"number"}},max:{control:{type:"number"}},step:{control:{type:"number"}},disabled:{control:"boolean"},showTooltip:{description:"Value tooltip under the handle; visible while dragging (active) or when the range input matches :focus-visible",control:"boolean"},tooltipFormat:{control:{disable:!0}},onChange:{control:{disable:!0}}}},f=[...g].toReversed().flatMap(e=>[{size:e,disabled:!1},{size:e,disabled:!0}]),s={parameters:{controls:{disable:!0}},render:e=>{const o=h;return a.jsx("div",{className:"gap-xlg grid",style:{display:"grid",gridTemplateColumns:`repeat(${o.length}, minmax(0, 1fr))`},children:f.map((n,t)=>o.map((r,w)=>{const C=`${r}-${n.size}-${n.disabled?"disabled":"enabled"}`;return a.jsxs("div",{style:{gridColumn:`${w+1} / span 1`,gridRow:`${t+1} / span 1`},children:[e.showLabels&&a.jsxs("p",{className:"typography-body-small text-text",children:["variant=",r,", size=",n.size,n.disabled?", disabled":", enabled"]}),a.jsx(x,{value:50,min:0,max:100,step:1,variant:r,size:n.size,disabled:n.disabled,onChange:y})]},C)}))})},args:{showLabels:!1}};var d,p,c;i.parameters={...i.parameters,docs:{...(d=i.parameters)==null?void 0:d.docs,source:{originalSource:`{
...
}`,...(v=(u=s.parameters)==null?void 0:u.docs)==null?void 0:v.source}}};const L=["Playground","Overview"];export{s as Overview,i as Playground,L as __namedExportsOrder,I as default};
