import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Fn as n,Io as r,Zo as i,ci as a,t as o}from"./iframe-D6-Ak9zf.js";import{n as s,t as c}from"./figmaDesign-CO6i5n9C.js";var l,u,d,f,p,m,h,g,_,v;e((()=>{o(),l=t(i(),1),s(),u=r(),{action:d}=__STORYBOOK_MODULE_ACTIONS__,f={title:`Display & Data/Cards/RadioCard`,component:a,tags:[`autodocs`],parameters:{design:c(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2172-664`),docs:{description:{component:`Larger selectable card acting as a radio, with room for a title and description. Use for exclusive choices that need more context than a plain RadioButton.`}}}},p=`flex flex-wrap gap-md`,m=e=>{let[t,n]=l.useState(`a`);return(0,u.jsxs)(`div`,{className:p,children:[(0,u.jsx)(a,{...e,name:`radio-card`,value:`a`,checked:t===`a`,onChange:e=>{d(`onChange`)(e),e.target.checked&&n(`a`)},className:`h-[218px] w-[388px] shrink-0`,children:(0,u.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card A`})}),(0,u.jsx)(a,{...e,name:`radio-card`,value:`b`,checked:t===`b`,onChange:e=>{d(`onChange`)(e),e.target.checked&&n(`b`)},className:`h-[218px] w-[388px] shrink-0`,children:(0,u.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card B`})}),(0,u.jsx)(a,{...e,name:`radio-card`,value:`c`,checked:t===`c`,onChange:e=>{d(`onChange`)(e),e.target.checked&&n(`c`)},className:`h-[218px] w-[388px] shrink-0`,children:(0,u.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card C`})})]})},m.args={disabled:!1,name:`radio-card`},h=e=>(0,u.jsxs)(`div`,{className:p,children:[(0,u.jsx)(a,{...e,name:`radio-card-disabled`,value:`a`,checked:!0,disabled:!0,onChange:e=>d(`onChange`)(e),className:`h-[218px] w-[388px] shrink-0`,children:(0,u.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card A`})}),(0,u.jsx)(a,{...e,name:`radio-card-disabled`,value:`b`,checked:!1,disabled:!0,onChange:e=>d(`onChange`)(e),className:`h-[218px] w-[388px] shrink-0`,children:(0,u.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card B`})}),(0,u.jsx)(a,{...e,name:`radio-card-disabled`,value:`c`,checked:!1,disabled:!0,onChange:e=>d(`onChange`)(e),className:`h-[218px] w-[388px] shrink-0`,children:(0,u.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card C`})})]}),h.args={disabled:!0,name:`radio-card`},g={render:()=>(0,u.jsxs)(`div`,{className:`gap-md flex w-[388px] flex-col`,children:[(0,u.jsx)(n,{}),(0,u.jsx)(n,{})]})},_=()=>{let[e,t]=l.useState(`a`);return(0,u.jsx)(`div`,{className:`bg-background-elevation gap-md p-xlg flex w-[420px] flex-col rounded-lg`,children:[`a`,`b`].map(n=>(0,u.jsx)(a,{name:`radio-card-elevation`,value:n,surface:`onCard`,checked:e===n,onChange:e=>{d(`onChange`)(e),e.target.checked&&t(n)},children:(0,u.jsxs)(`span`,{className:`typography-body text-text p-md block`,children:[`I'm on an elevated surface (`,n.toUpperCase(),`)`]})},n))})},_.parameters={docs:{description:{story:'`surface="onElevation"` for cards placed on an already-elevated surface (e.g. inside a Modal). The mock elevation below uses `bg-background-elevation`; the default surface would collide with it in dark mode, `onElevation` stays a distinct layer.'}}},m.__docgenInfo={description:``,methods:[],displayName:`Playground`},h.__docgenInfo={description:``,methods:[],displayName:`Disabled`},_.__docgenInfo={description:``,methods:[],displayName:`OnElevation`},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`(args: React.ComponentProps<typeof RadioCard> & Record<string, unknown>) => {
