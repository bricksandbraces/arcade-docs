import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ha as n,Ji as r,it as i,nt as a,ro as o,rt as s,si as c,t as l,vo as u,xi as d,zi as f}from"./iframe-C1Q2u2SU.js";var p,m,h,g,_,v,y,b,x;e((()=>{l(),c(),p=t(n(),1),m=t(u(),1),h=o(),g={title:`Navigation/Navigation/NavigationItem`,component:a,tags:[`autodocs`],argTypes:{level:{control:`inline-radio`,options:s},size:{control:`inline-radio`,options:i},selected:{control:`boolean`},disabled:{control:`boolean`},expandable:{control:`boolean`},expanded:{control:`boolean`},title:{control:`text`},tooltip:{control:`text`}},args:{title:`Dashboard`,level:1,expandable:!1,selected:!1,disabled:!1,size:`default`},decorators:[e=>(0,h.jsx)(`div`,{className:(0,p.default)(`p-lg`,`w-72`,`bg-background`),children:(0,h.jsx)(e,{})})]},_={args:{icon:r}},v={parameters:{controls:{disable:!0}},render:()=>(0,h.jsxs)(`div`,{className:(0,p.default)(`gap-xlg`,`flex`,`flex-col`),children:[(0,h.jsxs)(`section`,{className:(0,p.default)(`gap-md`,`flex`,`flex-col`),children:[(0,h.jsx)(`h3`,{className:(0,p.default)(`typography-headline-04`,`text-text`),children:`Level 1 - default size`}),(0,h.jsx)(a,{title:`Enabled`,icon:r}),(0,h.jsx)(a,{title:`Selected`,icon:r,selected:!0}),(0,h.jsx)(a,{title:`Disabled`,icon:r,disabled:!0}),(0,h.jsx)(a,{title:`Expandable (collapsed)`,icon:f,expandable:!0}),(0,h.jsxs)(a,{title:`Expandable (expanded)`,icon:f,expandable:!0,defaultExpanded:!0,children:[(0,h.jsx)(a,{title:`Nested item`,level:2}),(0,h.jsx)(a,{title:`Another nested`,level:2})]})]}),(0,h.jsxs)(`section`,{className:(0,p.default)(`gap-md`,`flex`,`flex-col`),children:[(0,h.jsx)(`h3`,{className:(0,p.default)(`typography-headline-04`,`text-text`),children:`Level 2`}),(0,h.jsx)(a,{title:`Nested enabled`,level:2}),(0,h.jsx)(a,{title:`Nested selected`,level:2,selected:!0}),(0,h.jsx)(a,{title:`Nested disabled`,level:2,disabled:!0})]}),(0,h.jsxs)(`section`,{className:(0,p.default)(`gap-md`,`flex`,`flex-col`),children:[(0,h.jsx)(`h3`,{className:(0,p.default)(`typography-headline-04`,`text-text`),children:`Small - icon only with tooltip`}),(0,h.jsxs)(`div`,{className:(0,p.default)(`gap-sm`,`flex`,`flex-col`,`w-16`),children:[(0,h.jsx)(a,{size:`small`,icon:r,tooltip:`Dashboard`}),(0,h.jsx)(a,{size:`small`,icon:f,tooltip:`Projects`,selected:!0}),(0,h.jsx)(a,{size:`small`,icon:d,tooltip:`Settings`,disabled:!0})]})]})]})},y={parameters:{controls:{disable:!0}},render:function(){let[e,t]=m.useState(`projects`);return(0,h.jsxs)(`div`,{className:(0,p.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,h.jsx)(a,{title:`Dashboard`,icon:r,selected:e===null}),(0,h.jsxs)(a,{title:`Projects`,icon:f,expandable:!0,expanded:e===`projects`,onExpandedChange:e=>t(e?`projects`:null),children:[(0,h.jsx)(a,{title:`All projects`,level:2}),(0,h.jsx)(a,{title:`Archived`,level:2}),(0,h.jsx)(a,{title:`Templates`,level:2,disabled:!0})]}),(0,h.jsxs)(a,{title:`Settings`,icon:d,expandable:!0,expanded:e===`settings`,onExpandedChange:e=>t(e?`settings`:null),children:[(0,h.jsx)(a,{title:`Profile`,level:2}),(0,h.jsx)(a,{title:`Billing`,level:2})]})]})}},b={parameters:{controls:{disable:!0}},render:()=>(0,h.jsxs)(`div`,{className:(0,p.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,h.jsx)(a,{title:`Dashboard`,icon:r,href:`#dashboard`,selected:!0}),(0,h.jsx)(a,{title:`Projects`,icon:f,href:`#projects`}),(0,h.jsx)(a,{title:`Settings`,icon:d,href:`#settings`})]})},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  args: {
    icon: IconDashboard
  }
