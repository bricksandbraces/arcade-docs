import{n as e}from"./chunk-jRWAZmH_.js";import{Ds as t,Lt as n,Rt as r,t as i,zt as a}from"./iframe-_Ug8tvbS.js";import{n as o,t as s}from"./figmaDesign-DDiUnvXT.js";import{n as c,t as l}from"./figmaFrame-BrknLJum.js";var u,d,f,p,m,h,g;e((()=>{i(),o(),c(),u=t(),d={title:`Display & Data/PaymentMethod`,component:n,tags:[`autodocs`],argTypes:{brand:{control:`select`,options:a},size:{control:`inline-radio`,options:r},label:{control:`text`}},args:{brand:`mastercard`,size:`sm`,label:`Mastercard`},parameters:{design:s(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=5717-5596`),docs:{description:{component:"Badge of a card network, named like Stripe's card brand ids so a provider's `brand` can be passed straight in. `inline` is the 16px mark used inside fields such as CreditCardInput."}}}},f={},p={parameters:{controls:{disable:!0}},render:()=>(0,u.jsx)(`div`,{className:`gap-lg grid grid-cols-[auto_repeat(4,max-content)] items-center`,children:a.map(e=>(0,u.jsxs)(`div`,{className:`contents`,children:[(0,u.jsx)(`span`,{className:`typography-label text-text-label`,children:e}),r.map(t=>(0,u.jsx)(n,{brand:e,size:t},t))]},e))})},m={parameters:{controls:{disable:!0}},render:()=>(0,u.jsx)(l,{node:`5717:6482`,width:34,height:24,children:(0,u.jsx)(n,{brand:`mastercard`,size:`sm`})})},h={parameters:{controls:{disable:!0}},render:()=>(0,u.jsx)(l,{node:`5717:6619`,width:58,height:40,children:(0,u.jsx)(n,{brand:`visa`,size:`lg`})})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{}`,...f.parameters?.docs?.source}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
