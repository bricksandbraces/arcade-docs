import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Dn as n,En as r,Li as i,Ri as a,Ui as o,ia as s,t as c,ya as l}from"./iframe-D_WxSr3l.js";import{n as u}from"./storybook-CGSdyNwD.js";import{C as d,N as f,S as p,T as m,h,k as g,s as _,t as v,w as y}from"./docs-Dzq_QmUV.js";var b,x,S,C,w,T;e((()=>{c(),a(),b=t(o(),1),x=t(l(),1),v(),S=s(),C={title:`Arcade Foundation/Colors/Color Tokens`,parameters:{a11y:{test:`off`},chromatic:{disableSnapshot:!0}}},w=()=>{let[e,t]=(0,x.useState)(`light`),a=g(i.light),o=()=>(0,S.jsx)(`div`,{className:p,children:(0,S.jsx)(`div`,{className:d,children:a.map(({group:t,items:n})=>(0,S.jsxs)(`section`,{className:y,children:[(0,S.jsx)(`h2`,{className:`typography-headline-03 text-text font-light capitalize`,children:t}),(0,S.jsxs)(`div`,{role:`row`,className:(0,b.default)(m,f),children:[(0,S.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Name`}),(0,S.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Description`}),(0,S.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`HEX value`}),(0,S.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Preview`})]}),(0,S.jsx)(`div`,{className:`gap-sm flex flex-col`,role:`presentation`,children:n.map(({key:t})=>(0,S.jsx)(_,{tokenKey:t,previewTheme:e,description:h(t)},t))})]},t))})});return(0,S.jsx)(`div`,{className:`gap-xlg text-text typography-body flex w-full min-w-0 flex-col`,children:(0,S.jsxs)(`div`,{className:`gap-xlg flex min-w-0 flex-col`,children:[(0,S.jsx)(u,{title:`Color Tokens`,className:`px-[80px] pt-[80px] pb-[48px]`}),(0,S.jsx)(`div`,{className:`semantic-tokens-tabs`,children:(0,S.jsxs)(n,{selectedId:e,onChange:e=>{(e===`light`||e===`dark`)&&t(e)},size:`md`,radius:`sharp`,withSpacing:!1,tabListClassName:`ml-[calc(80px-2*var(--spacing-lg)+4px)] mr-[calc(80px-var(--spacing-lg))]`,children:[(0,S.jsx)(r,{id:`light`,label:`Light mode`,children:(0,S.jsx)(`div`,{className:`gap-lg -m-lg flex flex-col`,children:o()})}),(0,S.jsx)(r,{id:`dark`,label:`Dark mode`,children:(0,S.jsx)(`div`,{className:`gap-lg -m-lg flex flex-col`,children:o()})})]})})]})})},w.__docgenInfo={description:``,methods:[],displayName:`ColorTokens`},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`() => {
