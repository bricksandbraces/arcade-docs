import{n as e}from"./chunk-jRWAZmH_.js";import{Bi as t,Ei as n,Ii as r,Ji as i,Li as a,Ri as o,Vi as s,Wi as c,Za as l,Zr as u,d,ea as f,fi as p,hi as m,l as h,na as g,qi as _,ri as v,t as y,ta as b,u as x,wi as S,xi as C}from"./iframe-D1tTUzW4.js";var w,T,E,D,O;e((()=>{y(),v(),w=l(),T={title:`Overlays & Menus/ContextMenu/ContextMenu`,component:h,tags:[`autodocs`],argTypes:{size:{control:`inline-radio`,options:x}},args:{size:`medium`},parameters:{layout:`centered`,docs:{description:{component:["Right-click menu attached to a trigger surface. Compose entries with `ContextMenuListItem` (optionally nested via `submenu`) and `Divider` for grouping.",``,"Breaking change from earlier versions: `ContextMenuList` was removed — compose items directly as `ContextMenu` children."].join(`
`)}}}},E=`select-none rounded-md border border-dashed border-border p-xlg text-center text-text typography-body-small`,D={render:e=>(0,w.jsxs)(h,{size:e.size,ariaLabel:`File actions`,trigger:(0,w.jsx)(`div`,{className:E,children:`Right-click anywhere in this area`}),children:[(0,w.jsx)(d,{label:`Cut`,shortcut:`⌘X`,IconLeft:c,onClick:()=>console.log(`Cut`)}),(0,w.jsx)(d,{label:`Copy`,shortcut:`⌘C`,IconLeft:_,onClick:()=>console.log(`Copy`)}),(0,w.jsx)(d,{label:`Paste`,shortcut:`⌘V`,IconLeft:i,onClick:()=>console.log(`Paste`)}),(0,w.jsx)(u,{}),(0,w.jsx)(d,{label:`Edit`,shortcut:`⌘E`,IconLeft:t,onClick:()=>console.log(`Edit`)}),(0,w.jsx)(d,{label:`Share`,IconLeft:m,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(d,{label:`Email`,IconLeft:S,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(d,{label:`New message`,IconLeft:S}),(0,w.jsx)(d,{label:`Reply to thread`,IconLeft:C})]})}),(0,w.jsx)(d,{label:`Copy link`,IconLeft:n,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(d,{label:`Full URL`,IconLeft:n}),(0,w.jsx)(d,{label:`Short URL`,IconLeft:n})]})}),(0,w.jsx)(d,{label:`Social`,IconLeft:m,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(d,{label:`Post to X`,IconLeft:f}),(0,w.jsx)(d,{label:`Share on LinkedIn`,IconLeft:b}),(0,w.jsx)(d,{label:`Share on Facebook`,IconLeft:g})]})})]})}),(0,w.jsx)(d,{label:`Download`,IconLeft:s,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(d,{label:`As PDF`,IconLeft:a}),(0,w.jsx)(d,{label:`As PNG`,IconLeft:r}),(0,w.jsx)(d,{label:`As CSV`,IconLeft:o})]})}),(0,w.jsx)(u,{}),(0,w.jsx)(d,{label:`Delete`,kind:`danger`,shortcut:`⌫`,IconLeft:p,onClick:()=>console.log(`Delete`)})]})},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
