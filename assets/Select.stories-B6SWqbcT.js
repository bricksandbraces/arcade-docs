import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{$n as n,Co as r,Hr as i,Vr as a,aa as o,co as s,di as c,ht as l,t as u}from"./iframe-Bza0kqWC.js";import{n as d,t as f}from"./onCardStoryShell-BzzVSyyU.js";var p,m,h,g,_,v,y,b,x,S;e((()=>{p=t(r(),1),c(),u(),d(),m=s(),h=[{value:`apple`,label:`Apple`},{value:`banana`,label:`Banana`},{value:`orange`,label:`Orange`}],g={title:`Overlays & Menus/Dropdown/Select`,component:l,tags:[`autodocs`],args:{options:h,placeholder:`Choose an option`,size:`medium`,state:`default`,disabled:!1,inline:!1,fullWidth:!1},argTypes:{size:{control:`inline-radio`,options:a},inline:{control:`boolean`},fullWidth:{control:`boolean`},disabled:{control:`boolean`},placeholder:{control:`text`},label:{control:`text`},helperText:{control:`text`},errorMessage:{control:`text`},warningMessage:{control:`text`},successMessage:{control:`text`},hideLabel:{control:`boolean`},state:{control:`inline-radio`,options:i}},render:e=>{let[t,n]=(0,p.useState)(e.value);return(0,m.jsx)(l,{...e,value:t,onChange:e=>{n(e)}})},parameters:{docs:{description:{component:`Native select field styled to match the design system. Use when the browser's built-in picker is acceptable and you don't need a rich Dropdown menu.`}}}},_={args:{id:`playground-select`,label:`Label`,helperText:`Helper text below the field.`,errorMessage:`Error message`,warningMessage:`Warning message`,successMessage:`Erledigt`}},v={args:{id:`slot-select`,label:`Label`,helperText:`Helper text below the field.`,successMessage:`Saved`,state:`success`},render:e=>{let[t,n]=(0,p.useState)(e.value);return(0,m.jsx)(l,{...e,value:t,onChange:e=>{n(e)},leadingSlot:(0,m.jsx)(o,{size:12,className:`stroke-icon-info`}),trailingSlot:(0,m.jsx)(`span`,{className:`typography-label-small text-text-accent`,children:`Slot`})})}},y={args:{id:`on-card-select`,label:`Label`,helperText:`Helper text below the field.`,errorMessage:`Error message`,warningMessage:`Warning message`,successMessage:`Erledigt`,surface:`onCard`},render:e=>{let[t,n]=(0,p.useState)(e.value);return(0,m.jsx)(f,{children:(0,m.jsx)(l,{...e,value:t,onChange:e=>{n(e)}})})}},b={parameters:{controls:{disable:!0}},render:()=>(0,m.jsxs)(`div`,{className:`gap-xlg grid max-w-[720px] grid-cols-1 md:grid-cols-2`,children:[(0,m.jsx)(l,{id:`overview-default`,label:`Default + helper`,placeholder:`Select an option`,helperText:`Optional helper text.`,options:h}),(0,m.jsx)(l,{id:`overview-error`,label:`Error + notification`,placeholder:`Select an option`,state:`error`,errorMessage:`This field has an error.`,helperText:`Hidden while error is shown.`,options:h}),(0,m.jsx)(l,{id:`overview-warning`,label:`Warning + notification`,placeholder:`Select an option`,state:`warning`,warningMessage:`Please review your choice.`,options:h}),(0,m.jsx)(l,{id:`overview-success`,label:`Success`,placeholder:`Select an option`,state:`success`,successMessage:`Saved`,helperText:`Success still shows helper when no error/warning.`,options:h,value:`apple`})]})},x={args:{showLabel:!0},argTypes:{showLabel:{control:`boolean`}},render:({showLabel:e})=>(0,m.jsx)(n,{showLabel:e})},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  args: {
