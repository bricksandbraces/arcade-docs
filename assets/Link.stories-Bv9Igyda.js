import{n as e}from"./chunk-jRWAZmH_.js";import{Ba as t,Br as n,Di as r,Gi as i,Oo as a,fa as o,sr as s,t as c,za as l}from"./iframe-CbONSzYF.js";import{n as u,t as d}from"./figmaDesign-CO6i5n9C.js";var f,p,m,h,g,_,v,y,b,x,S,C;e((()=>{c(),r(),u(),f=a(),p={none:void 0,IconArrowRight:l,IconArrowLeft:t,IconExternalLink:o,Icon123:i},m=[`sm`,`md`,`lg`],h={title:`Navigation/Link`,component:n,tags:[`autodocs`],args:{href:`#`,label:`Link`,disabled:!1,inline:!1,size:`md`,leadingIcon:!1,icon:`IconArrowRight`},parameters:{design:d(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2130-35884`),docs:{description:{component:`Anchor styled as a text link, with optional leading or trailing icon. Use for in-page navigation and external references.`}}}},g={render:e=>{let{icon:t,...r}=e,i=p[t];return(0,f.jsx)(n,{...r,icon:i})},argTypes:{size:{description:`Typography scale`,control:{type:`inline-radio`},options:[...m]},inline:{description:`Inline (link style) vs accent (standalone)`,control:`boolean`},disabled:{control:`boolean`},leadingIcon:{control:`boolean`},label:{control:`text`},href:{control:`text`},icon:{control:{type:`select`},options:Object.keys(p)},component:{control:{disable:!0}},linkComponent:{control:{disable:!0}}}},_=[{inline:!1,disabled:!1,leadingIcon:!1},{inline:!1,disabled:!1,leadingIcon:!0},{inline:!1,disabled:!0,leadingIcon:!1},{inline:!0,disabled:!1,leadingIcon:!1},{inline:!0,disabled:!0,leadingIcon:!1}],v={sm:`typography-label`,md:`typography-body-small`,lg:`typography-body`},y={parameters:{controls:{disable:!0}},render:e=>{let t=[...m].toReversed();return(0,f.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${t.length}, minmax(0, 1fr))`},children:_.map((r,i)=>t.map((t,a)=>{let s=`${t}-${r.inline?`inline`:`accent`}-${r.disabled?`disabled`:`enabled`}-${r.leadingIcon?`leading`:`trailing`}`;return(0,f.jsxs)(`div`,{style:{gridColumn:`${a+1} / span 1`,gridRow:`${i+1} / span 1`},children:[e.showLabels&&(0,f.jsxs)(`p`,{className:`${v[t]} text-text`,children:[`size=`,t,`, `,r.inline?`inline`:`accent`,r.disabled?`, disabled`:`, enabled`,r.leadingIcon?`, leading icon`:`, trailing icon`]}),r.inline?(0,f.jsxs)(`p`,{className:`${v[t]} text-text`,children:[`Before`,` `,(0,f.jsx)(n,{href:`#`,label:`link`,size:t,inline:!0,disabled:r.disabled,icon:o,leadingIcon:r.leadingIcon}),` `,`after.`]}):(0,f.jsx)(n,{href:`#`,label:`Link`,size:t,inline:!1,disabled:r.disabled,icon:l,leadingIcon:r.leadingIcon})]},s)}))})},args:{showLabels:!1}},b={render:()=>(0,f.jsx)(s,{})},x=({href:e,children:t,...n})=>(0,f.jsx)(`a`,{...n,href:e,"data-next-link":`true`,children:t}),S={parameters:{controls:{disable:!0},docs:{description:{story:"Plug in `next/link`'s `Link` (or any equivalent) via `linkComponent` so consumers preserve SPA navigation. The rendered anchor below carries a `data-next-link` attribute set by the mock component to make the substitution visible."}}},render:()=>(0,f.jsx)(n,{href:`/dashboard`,label:`Open dashboard`,linkComponent:x})},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  render: args => {
    const {
      icon,
      ...rest
