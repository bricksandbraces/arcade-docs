import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{$r as n,Ei as r,Eo as i,Oi as a,Ui as o,Va as s,Vo as c,dr as l,ei as u,ma as d,mn as f,pn as p,rn as m,t as h,ti as g}from"./iframe-Cy6jdjZ5.js";import{n as _,t as v}from"./surfaceStoryShell-B6tZ_sQt.js";function y({id:e,rowConfig:t,filled:n}){let[r,i]=(0,x.useState)(n?`de`:null);return(0,S.jsx)(p,{id:e,label:`Label`,title:`Select`,size:t.size,disabled:t.disabled,inline:t.inline,state:t.state,value:r,onChange:i,items:C,helperText:`Helper Text`,errorMessage:`Error Message`,warningMessage:`Warning Message`,successMessage:`Erledigt`})}function b(){let[e,t]=(0,x.useState)([`item2`,`item4`]);return(0,S.jsx)(p,{id:`multiple-dropdown`,label:`Location`,title:`Select one or multiple locations`,size:`large`,fullWidth:!0,multiple:!0,value:e,onChange:t,items:[{label:`Berlin`,value:`item1`},{label:`Cologne`,value:`item2`},{label:`Hamburg`,value:`item3`},{label:`Munich`,value:`item4`},{label:`Stuttgart`,value:`item5`}],helperText:`Picking keeps the menu open. The chip clears the selection.`})}var x,S,C,w,T,E,D,O,k,A,j,M,N,P;e((()=>{_(),x=t(c(),1),h(),r(),S=i(),C=[{label:`Germany`,value:`de`},{label:`France`,value:`fr`},{label:`Spain`,value:`es`}],w={component:p,title:`Overlays & Menus/Dropdown`,tags:[`autodocs`],args:{surface:`default`,title:`Select an option`,size:`medium`,disabled:!1,inline:!1,fullWidth:!1,items:[{label:`Item 1`,value:`item1`},{label:`Item 2`,value:`item2`},{label:`Item 3`,value:`item3`,disabled:!0},{label:`Item 4`,value:`item4`},{label:`Item 5`,value:`item5`},{label:`Item 6`,value:`item6`},{label:`Item 7`,value:`item7`},{label:`Item 8`,value:`item8`},{label:`Item 9`,value:`item9`},{label:`Item 10`,value:`item10`}]},argTypes:{surface:{control:`inline-radio`,options:g},size:{control:`inline-radio`,options:n},disabled:{control:`boolean`},inline:{control:`boolean`},fullWidth:{control:`boolean`},label:{control:`text`},errorMessage:{control:`text`},warningMessage:{control:`text`},successMessage:{control:`text`},helperText:{control:`text`},hideLabel:{control:`boolean`},state:{control:`inline-radio`,options:u},selectionIndicator:{control:`inline-radio`,options:f}},render:e=>{let[t,n]=(0,x.useState)(null);return(0,S.jsx)(p,{...e,value:t,onChange:n})},parameters:{docs:{description:{component:`Form field for picking one value from a list. Use when choices are short labels; prefer Select for typeahead over many options.`}}}},T={args:{id:`playground-dropdown`,label:`Select Option`,helperText:`Choose one of the available options.`,errorMessage:`Error Message`,warningMessage:`Warning Message`}},E={args:{...T.args,id:`slot-dropdown`,label:`Label`,trailingSlot:(0,S.jsx)(a,{size:10,className:`fill-icon-accent`,"aria-hidden":!0})}},D={parameters:{controls:{disable:!0},docs:{description:{story:"With `multiple`, the trigger keeps its placeholder and shows how many options are picked. The chip's close button clears them all."}}},render:()=>(0,S.jsx)(b,{})},O={parameters:{controls:{disable:!0}},args:{showLabels:!1},render:e=>{let t=n.toReversed().flatMap(e=>[{size:e,disabled:!1,inline:!1,state:`default`},{size:e,disabled:!0,inline:!1,state:`default`},{size:e,disabled:!1,inline:!0,state:`default`},{size:e,disabled:!1,inline:!1,state:`error`},{size:e,disabled:!1,inline:!1,state:`success`}]),r=u;return(0,S.jsx)(`div`,{className:`gap-xlg grid pb-[128px]`,style:{display:`grid`,gridTemplateColumns:`repeat(${r.length}, minmax(0, 1fr))`},children:t.map((t,n)=>r.map((r,i)=>{let a=`${r}-${t.size}-${t.disabled?`disabled`:`enabled`}-${t.state}-${t.inline?`inline`:`block`}`;return(0,S.jsxs)(`div`,{style:{gridColumn:`${i+1} / span 1`,gridRow:`${n+1} / span 1`},children:[e.showLabels?(0,S.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,t.size,`, state=`,r,t.disabled?`, disabled`:``,t.inline?`, inline`:``,t.state===`default`?``:`, status=${t.state}`]}):null,(0,S.jsxs)(`div`,{className:`gap-sm flex flex-col`,children:[(0,S.jsx)(`div`,{className:`pb-[32px]`,children:(0,S.jsx)(y,{id:`${r}-${t.size}-${n}-empty`,rowConfig:t,filled:!1})}),(0,S.jsx)(`div`,{className:`pb-[32px]`,children:(0,S.jsx)(y,{id:`${r}-${t.size}-${n}-filled`,rowConfig:t,filled:!0})})]})]},a)}))})}},k={args:{showLabel:!0},argTypes:{showLabel:{control:`boolean`}},render:({showLabel:e})=>(0,S.jsx)(l,{showLabel:e})},A={parameters:{controls:{disable:!0},a11y:{test:`off`},chromatic:{disableSnapshot:!0}},render:()=>{let[e,t]=(0,x.useState)(!0),[n,r]=(0,x.useState)(null);return(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(s,{label:`Open modal`,onClick:()=>t(!0)}),(0,S.jsx)(m,{open:e,onClose:()=>t(!1),title:`Invite member`,subtitle:`Pick a role from the dropdown.`,layoutMode:`fixed`,children:(0,S.jsx)(p,{label:`Role`,title:`Select a role`,size:`large`,value:n,onChange:r,items:C,fullWidth:!0})})]})}},j={render:e=>(0,S.jsx)(v,{children:t=>(0,S.jsx)(p,{...e,id:`dropdown-${t}`,surface:t})})},M={args:{selectionIndicator:`leading`,title:`All Employees`,hideLabel:!0,inline:!0,items:[{label:`All Employees`,value:`all`},{label:`External employees`,value:`external`},{label:`New view`,value:`new`,IconLeft:o,separatorBefore:!0}]},render:e=>{let[t,n]=(0,x.useState)(`all`);return(0,S.jsx)(p,{...e,value:t,onChange:n})}},N={args:{selectionIndicator:`leading`,title:`All Employees`,hideLabel:!0,inline:!0,items:[{label:`All Employees`,value:`all`,actionSlot:(0,S.jsx)(s,{kind:`ghost`,size:`small`,variant:`rounded`,IconLeft:d,"aria-label":`Manage All Employees`})},{label:`External employees`,value:`external`,actionSlot:(0,S.jsx)(s,{kind:`ghost`,size:`small`,variant:`rounded`,IconLeft:d,"aria-label":`Manage External employees`})}]},render:e=>{let[t,n]=(0,x.useState)(`all`);return(0,S.jsx)(p,{...e,value:t,onChange:n})}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  args: {
