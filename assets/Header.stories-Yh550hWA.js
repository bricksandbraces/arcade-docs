import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Di as n,Hi as r,Hr as i,Lr as a,at as o,ir as s,it as c,lr as l,ot as u,qn as d,st as f,t as p,zr as m}from"./iframe-BK1IgQO6.js";var h,g,_,v,y,b,x,S,C,w;e((()=>{p(),d(),h=t(r(),1),g=n(),_={title:`Fabian Supervision/Header/Header`,component:c,tags:[`autodocs`],argTypes:{border:{control:`boolean`},showBackButton:{control:`boolean`}},parameters:{layout:`fullscreen`,docs:{description:{component:`Top app bar with slots for logo, navigation links, and actions. Use as the primary header across app pages.`}}}},v=()=>(0,g.jsxs)(`div`,{className:`gap-xs flex items-center`,children:[(0,g.jsx)(f,{children:`Link`}),(0,g.jsx)(f,{selected:!0,children:`Link`}),(0,g.jsx)(f,{children:`Link`})]}),y=()=>(0,g.jsxs)(`div`,{className:`gap-xs flex items-center`,children:[(0,g.jsx)(f,{children:`Link`}),(0,g.jsx)(o,{items:[{label:`Link`,onClick:()=>{}},{label:`Link`,onClick:()=>{}},{label:`Link`,onClick:()=>{}}],children:(0,g.jsx)(u,{children:`Link`})}),(0,g.jsx)(f,{children:`Link`})]}),b=()=>(0,g.jsxs)(`div`,{className:`gap-xs flex items-center`,children:[(0,g.jsx)(i,{kind:`ghost`,IconLeft:s,size:`medium`,"aria-label":`Settings`}),(0,g.jsx)(i,{kind:`ghost`,IconLeft:a,size:`medium`,"aria-label":`Notifications`}),(0,g.jsx)(i,{kind:`ghost`,IconLeft:l,size:`medium`,"aria-label":`Menu`})]}),x=()=>(0,g.jsx)(`div`,{className:`border-border-brand text-text-brand typography-body-small size-container-xs flex items-center justify-center rounded-md border border-dashed`,children:`L`}),S={render:({border:e=!1,showBackButton:t=!0})=>(0,g.jsx)(c,{title:`Dashboard`,border:e,showBackButton:t,companyLogo:(0,g.jsx)(x,{}),backButton:(0,g.jsx)(i,{kind:`ghost`,IconLeft:m,size:`medium`,"aria-label":`Go back`}),linkGroupOne:(0,g.jsx)(v,{}),linkGroupTwo:(0,g.jsx)(y,{}),actions:(0,g.jsx)(b,{})}),args:{border:!1,showBackButton:!0},parameters:{layout:`fullscreen`,controls:{include:[`border`,`showBackButton`]}}},C={args:{border:!0,showBackButton:!0},parameters:{layout:`fullscreen`,controls:{include:[`border`,`showBackButton`]},docs:{description:{story:"Header with exactly two top-level navigation links rendered as `HeaderButton`s. Click a link to make it the active one. Use when the app has only a couple of primary sections."}}},render:function({border:e=!0,showBackButton:t=!0}){let[n,r]=h.useState(`products`);return(0,g.jsx)(c,{title:`Dashboard`,border:e,showBackButton:t,companyLogo:(0,g.jsx)(x,{}),backButton:(0,g.jsx)(i,{kind:`ghost`,IconLeft:m,size:`medium`,"aria-label":`Go back`}),linkGroupOne:(0,g.jsxs)(`div`,{className:`gap-xs flex items-center`,children:[(0,g.jsx)(f,{selected:n===`products`,onClick:()=>r(`products`),children:`Products`}),(0,g.jsx)(f,{selected:n===`resources`,onClick:()=>r(`resources`),children:`Resources`})]}),actions:(0,g.jsx)(b,{})})}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  render: ({
    border = false,
    showBackButton = true
