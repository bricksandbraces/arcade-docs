import{n as e}from"./chunk-jRWAZmH_.js";import{Hn as t,Un as n,Wn as r,ea as i,t as a}from"./iframe-mOkBvvs0.js";import{n as o,t as s}from"./onCardStoryShell-Dj-7Luml.js";var c,l,u,d,f,p,m,h;e((()=>{a(),o(),c=i(),{action:l}=__STORYBOOK_MODULE_ACTIONS__,u={title:`Components/Inputs/Input`,component:t,tags:[`autodocs`],argTypes:{state:{control:{type:`select`},options:r},size:{control:{type:`select`},options:n}},parameters:{docs:{description:{component:`Unlabelled text input primitive used to build TextInput and other form fields. Use directly only when a custom label layout is needed.`}}}},d={args:{id:`input`,"aria-label":`Label`,disabled:!1,loading:!1,state:`default`,trailingSlot:void 0,placeholder:`Placeholder`,onChange:l(`onChange`)},argTypes:{}},f={args:{...d.args,id:`slot-input`,defaultValue:`123.45`,leadingSlot:(0,c.jsx)(`span`,{className:`typography-label text-text-accent inline-flex min-w-[3ch] justify-center`,children:`EUR`}),trailingSlot:(0,c.jsx)(`span`,{className:`typography-label text-text-accent inline-flex min-w-[3ch] justify-center`,children:`NET`}),trailingSlotPadding:`inset`}},p={args:{...d.args,surface:`onCard`},render:e=>(0,c.jsx)(s,{children:(0,c.jsx)(t,{...e})})},m={parameters:{controls:{disable:!0}},render:e=>(0,c.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${n.length}, minmax(0, 1fr))`},children:[{loading:!1,disabled:!1,state:`default`},{loading:!1,disabled:!1,state:`error`},{loading:!1,disabled:!1,state:`warning`},{loading:!1,disabled:!1,state:`success`},{loading:!1,disabled:!1,state:`success`,trailingSlot:`Done`},{loading:!0,disabled:!1,state:`default`},{loading:!0,disabled:!0,state:`default`},{loading:!1,disabled:!0,state:`default`}].map((r,i)=>n.map((n,a)=>{let o=`${n}-${r.loading?`loading`:`default`}-${r.disabled?`disabled`:`enabled`}-${r.state===`error`?`error`:`noerror`}-${r.state===`success`?`success`:`nosuccess`}`;return(0,c.jsxs)(`div`,{style:{gridColumn:`${a+1} / span 1`,gridRow:`${i+1} / span 1`},children:[e.showLabels&&(0,c.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,n,r.loading?`, loading`:``,r.disabled?`, disabled`:``,r.state]}),(0,c.jsx)(`div`,{className:`gap-sm flex flex-row`,children:(0,c.jsx)(t,{id:`${o}-input`,"aria-label":`Input ${n} ${r.state}`,defaultValue:`Text`,placeholder:`Placeholder`,size:n,loading:r.loading,disabled:r.disabled,state:r.state,className:`w-[192px]`})})]},o)}))}),args:{showLabels:!1}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    id: "input",
    "aria-label": "Label",
    disabled: false,
