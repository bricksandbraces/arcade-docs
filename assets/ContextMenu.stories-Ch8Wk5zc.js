import{n as e}from"./chunk-jRWAZmH_.js";import{$i as t,Ai as n,Di as r,Ii as i,Qi as a,Vi as o,Zi as s,_a as c,_i as l,aa as u,ca as d,d as f,di as p,ga as m,ha as h,l as g,la as _,na as v,po as y,t as b,ta as x,u as S,zi as C}from"./iframe-CanflEBn.js";var w,T,E,D,O;e((()=>{b(),l(),w=y(),T={title:`Overlays & Menus/ContextMenu/ContextMenu`,component:g,tags:[`autodocs`],argTypes:{size:{control:`inline-radio`,options:S}},args:{size:`medium`},parameters:{layout:`centered`,docs:{description:{component:["Right-click menu attached to a trigger surface. Compose entries with `ContextMenuListItem` (optionally nested via `submenu`) and `Divider` for grouping.",``,"Breaking change from earlier versions: `ContextMenuList` was removed — compose items directly as `ContextMenu` children."].join(`
`)}}}},E=`select-none rounded-md border border-dashed border-border p-xlg text-center text-text typography-body-small`,D={render:e=>(0,w.jsxs)(g,{size:e.size,ariaLabel:`File actions`,trigger:(0,w.jsx)(`div`,{className:E,children:`Right-click anywhere in this area`}),children:[(0,w.jsx)(f,{label:`Cut`,shortcut:`⌘X`,IconLeft:u,onClick:()=>console.log(`Cut`)}),(0,w.jsx)(f,{label:`Copy`,shortcut:`⌘C`,IconLeft:d,onClick:()=>console.log(`Copy`)}),(0,w.jsx)(f,{label:`Paste`,shortcut:`⌘V`,IconLeft:_,onClick:()=>console.log(`Paste`)}),(0,w.jsx)(p,{}),(0,w.jsx)(f,{label:`Edit`,shortcut:`⌘E`,IconLeft:x,onClick:()=>console.log(`Edit`)}),(0,w.jsx)(f,{label:`Share`,IconLeft:n,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(f,{label:`Email`,IconLeft:C,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(f,{label:`New message`,IconLeft:C}),(0,w.jsx)(f,{label:`Reply to thread`,IconLeft:i})]})}),(0,w.jsx)(f,{label:`Copy link`,IconLeft:o,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(f,{label:`Full URL`,IconLeft:o}),(0,w.jsx)(f,{label:`Short URL`,IconLeft:o})]})}),(0,w.jsx)(f,{label:`Social`,IconLeft:n,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(f,{label:`Post to X`,IconLeft:h}),(0,w.jsx)(f,{label:`Share on LinkedIn`,IconLeft:m}),(0,w.jsx)(f,{label:`Share on Facebook`,IconLeft:c})]})})]})}),(0,w.jsx)(f,{label:`Download`,IconLeft:v,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(f,{label:`As PDF`,IconLeft:a}),(0,w.jsx)(f,{label:`As PNG`,IconLeft:s}),(0,w.jsx)(f,{label:`As CSV`,IconLeft:t})]})}),(0,w.jsx)(p,{}),(0,w.jsx)(f,{label:`Delete`,kind:`danger`,shortcut:`⌫`,IconLeft:r,onClick:()=>console.log(`Delete`)})]})},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
