import{n as e}from"./chunk-jRWAZmH_.js";import{Ar as t,Rn as n,jr as r,kr as i,qa as a,t as o}from"./iframe-1mzDmMUm.js";import{n as s,t as c}from"./onCardStoryShell-YCI3-qF1.js";var l,u,d,f,p,m,h,g,_;e((()=>{o(),s(),l=a(),{action:u}=__STORYBOOK_MODULE_ACTIONS__,d={title:`Inputs & Controls/Input`,component:i,tags:[`autodocs`],argTypes:{state:{control:{type:`select`},options:r},size:{control:{type:`select`},options:t}},parameters:{docs:{description:{component:`Unlabelled text input primitive used to build TextInput and other form fields. Use directly only when a custom label layout is needed.`}}}},f={args:{id:`input`,"aria-label":`Label`,disabled:!1,loading:!1,state:`default`,trailingSlot:void 0,placeholder:`Placeholder`,onChange:u(`onChange`)},argTypes:{}},p={args:{...f.args,id:`slot-input`,defaultValue:`123.45`,leadingSlot:(0,l.jsx)(`span`,{className:`typography-label text-text-accent inline-flex min-w-[3ch] justify-center`,children:`EUR`}),trailingSlot:(0,l.jsx)(`span`,{className:`typography-label text-text-accent inline-flex min-w-[3ch] justify-center`,children:`NET`}),trailingSlotPadding:`inset`}},m={args:{...f.args,surface:`onCard`},render:e=>(0,l.jsx)(c,{children:(0,l.jsx)(i,{...e})})},h={parameters:{controls:{disable:!0}},render:e=>(0,l.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${t.length}, minmax(0, 1fr))`},children:[{loading:!1,disabled:!1,state:`default`},{loading:!1,disabled:!1,state:`error`},{loading:!1,disabled:!1,state:`warning`},{loading:!1,disabled:!1,state:`success`},{loading:!1,disabled:!1,state:`success`,trailingSlot:`Done`},{loading:!0,disabled:!1,state:`default`},{loading:!0,disabled:!0,state:`default`},{loading:!1,disabled:!0,state:`default`}].map((n,r)=>t.map((t,a)=>{let o=`${t}-${n.loading?`loading`:`default`}-${n.disabled?`disabled`:`enabled`}-${n.state===`error`?`error`:`noerror`}-${n.state===`success`?`success`:`nosuccess`}`;return(0,l.jsxs)(`div`,{style:{gridColumn:`${a+1} / span 1`,gridRow:`${r+1} / span 1`},children:[e.showLabels&&(0,l.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,t,n.loading?`, loading`:``,n.disabled?`, disabled`:``,n.state]}),(0,l.jsx)(`div`,{className:`gap-sm flex flex-row`,children:(0,l.jsx)(i,{id:`${o}-input`,"aria-label":`Input ${t} ${n.state}`,defaultValue:`Text`,placeholder:`Placeholder`,size:t,loading:n.loading,disabled:n.disabled,state:n.state,className:`w-[192px]`})})]},o)}))}),args:{showLabels:!1}},g={render:()=>(0,l.jsx)(n,{})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
    id: "input",
    "aria-label": "Label",
    disabled: false,
