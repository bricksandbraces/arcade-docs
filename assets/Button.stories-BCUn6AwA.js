import{n as e}from"./chunk-jRWAZmH_.js";import{ci as t,li as n,qi as r,t as i,ui as a}from"./iframe-BmX5hFjR.js";var o,s,c,l,u,d,f,p,m,h,g;e((()=>{i(),o=r(),{action:s}=__STORYBOOK_MODULE_ACTIONS__,{expect:c,fn:l}=__STORYBOOK_MODULE_TEST__,u=e=>{s(`onClick`)(e)},d={title:`Components/Button`,component:t,tags:[`autodocs`],args:{label:`Button`,disabled:!1,loading:!1,kind:`primary`,size:`medium`,IconLeft:void 0,IconRight:void 0,onClick:u,tooltipContent:`Tooltip text`,tooltipPlacement:`bottom`},parameters:{docs:{description:{component:`Triggers an action when clicked. Use the primary kind for the main action on a page, secondary or ghost for supporting actions.`}}}},f={args:{kind:`primary`},argTypes:{kind:{description:`The kind of button`,control:{type:`select`},options:[`primary`,`secondary`,`tertiary`,`ghost`,`primary-danger`,`tertiary-danger`,`ghost-danger`],defaultValue:`primary`},size:{description:`The size of the button`,control:{type:`select`},options:[`small`,`medium`,`large`],defaultValue:`medium`},onClick:{control:{disable:!0}},IconLeft:{control:{disable:!0}},IconRight:{control:{disable:!0}}}},p=e=>(0,o.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,fill:`none`,viewBox:`0 0 24 24`,stroke:`currentColor`,className:e.className,children:(0,o.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:2,d:`M12 6v6m0 0v6m0-6h6m-6 0H6`})}),m={parameters:{controls:{disable:!0}},render:e=>{let r=a.toReversed().flatMap(e=>[{size:e,loading:!1,disabled:!1},{size:e,loading:!1,disabled:!0},{size:e,loading:!0,disabled:!1}]),i=n;return(0,o.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${i.length}, minmax(0, 1fr))`},children:r.map((n,r)=>i.map((i,a)=>{let s=`${i}-${n.size}-${n.loading?`loading`:`default`}-${n.disabled?`disabled`:`enabled`}`;return(0,o.jsxs)(`div`,{style:{gridColumn:`${a+1} / span 1`,gridRow:`${r+1} / span 1`},children:[e.showLabels&&(0,o.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,n.size,`, kind=`,i,n.loading?`, loading`:``,n.disabled?`, disabled`:``]}),(0,o.jsxs)(`div`,{className:`gap-sm flex flex-row`,children:[(0,o.jsx)(t,{label:`Button`,kind:i,size:n.size,loading:n.loading,disabled:n.disabled,onClick:u,tooltipContent:e.tooltipContent,tooltipPlacement:e.tooltipPlacement}),(0,o.jsx)(t,{"aria-label":`Icon button`,kind:i,size:n.size,loading:n.loading,disabled:n.disabled,IconLeft:p,onClick:u,tooltipContent:e.tooltipContent,tooltipPlacement:e.tooltipPlacement})]})]},s)}))})},args:{showLabels:!1}},h={args:{kind:`primary`,label:`Click me`,onClick:l()},play:async({args:e,canvas:t,userEvent:n})=>{let r=t.getByRole(`button`,{name:/click me/i});await c(r).toBeEnabled(),await n.click(r),await c(e.onClick).toHaveBeenCalledOnce()}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
    kind: "primary"
  },
  argTypes: {
