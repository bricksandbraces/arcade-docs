import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Bt as n,Fo as r,bo as i,t as a,zt as o}from"./iframe-Bb-sKdHW.js";var s,c,l,u,d,f,p,m,h,g,_,v;e((()=>{a(),s=t(r(),1),c=i(),l={title:`Feedback & Status/TrafficLight`,component:o,tags:[`autodocs`],argTypes:{state:{control:`inline-radio`,options:n},message:{control:`text`}},args:{state:`error`,message:`Your password is too vague.
...
Add a special character and numbers to it.`}},p={args:{state:`warning`,message:`Almost there. Mix upper- and lowercase letters.`}},m={args:{state:`success`,message:`Strong password.`}},h={render:()=>(0,c.jsx)(`div`,{className:`gap-xlg flex w-[368px] flex-col`,children:n.map(e=>(0,c.jsx)(o,{state:e,message:`State: ${e}`},e))})},g=[`empty`,`error`,`warning`,`success`],_={parameters:{docs:{description:{story:"Left-to-right fill (width 0%→100%, `duration-sm`, `ease-decelerate-sm`, stagger). Animation only runs when `state` updates — this story cycles every 900ms."}}},render:function(){let[e,t]=s.useState(0),n=g[e%g.length];return s.useEffect(()=>{let e=window.setInterval(()=>{t(e=>e+1)},900);return()=>window.clearInterval(e)},[]),(0,c.jsx)(`div`,{className:`w-[368px]`,children:(0,c.jsx)(o,{state:n,message:`Cycle: ${n} (ease-decelerate-sm, stagger left → right)`})})}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  args: {}
