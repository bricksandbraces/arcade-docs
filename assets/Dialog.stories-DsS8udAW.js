import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ci as n,Oo as r,Si as i,Ua as a,Uo as o,an as s,in as c,t as l,tn as u,wi as d,xi as f}from"./iframe-CbONSzYF.js";import{n as p,t as m}from"./figmaDesign-CO6i5n9C.js";var h,g,_,v,y,b,x,S,C,w,T,E;e((()=>{l(),h=t(o(),1),p(),g=r(),_={title:`Overlays & Menus/Dialog`,tags:[`autodocs`],args:{title:`Dialog Title`,subtitle:`Subtitle or Description`,primaryButton:{label:`Button`,onClick:()=>alert(`Primary action clicked`)},secondaryButton:{label:`Button`,onClick:()=>alert(`Secondary action clicked`)},onClose:()=>alert(`Dialog closed`),description:`Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.`,children:(0,g.jsx)(`div`,{className:`border-border-brand p-lg rounded-md border-[1px] border-dashed`,children:(0,g.jsx)(`span`,{className:`text-text-brand typography-body-small`,children:`Children`})})},parameters:{design:m(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2414-9433`),docs:{description:{component:`Overlay surface (Modal or Sheet) for focused tasks that interrupt the main flow. Compose with DialogHeader, DialogBody and DialogFooter.`}}}},v={name:`DialogHeader`,render:e=>(0,g.jsx)(d,{title:e.title,subtitle:e.subtitle})},y={name:`DialogBody`,render:e=>(0,g.jsx)(f,{description:e.description,children:e.children})},b={name:`DialogFooter`,render:e=>(0,g.jsx)(i,{primaryButton:e.primaryButton,secondaryButton:e.secondaryButton})},x={args:{layoutMode:`responsive`,open:!1},argTypes:{layoutMode:{control:{type:`inline-radio`},options:s},open:{control:{type:`boolean`}}},render:e=>{let[t,n]=(0,h.useState)(e.open||!1);return(0,h.useEffect)(()=>{n(e.open||!1)},[e.open]),(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(a,{onClick:()=>n(!0),label:`Open Modal`}),(0,g.jsx)(c,{...e,open:t,onClose:()=>n(!1),children:e.children})]})}},S={name:`Modal fixed width`,parameters:{docs:{description:{story:'Use `layoutMode="fixed"` for a compact dialog (fit-content height). Override width with `panelClassName` (e.g. `max-w-[420px]`).'}}},args:{layoutMode:`fixed`,open:!1,title:`Confirm action`,subtitle:``,description:`This uses the fixed width preset. Adjust with panelClassName if needed.`,primaryButton:{label:`Confirm`,onClick:()=>alert(`Confirmed`)},secondaryButton:{label:`Cancel`,onClick:()=>alert(`Cancelled`)},panelClassName:``,children:null},argTypes:{children:{table:{disable:!0}},layoutMode:{control:{type:`inline-radio`},options:s},panelClassName:{control:`text`,description:`Optional override, e.g. max-w-[420px]`},open:{control:{type:`boolean`}}},render:e=>{let[t,n]=(0,h.useState)(e.open||!1);return(0,h.useEffect)(()=>{n(e.open||!1)},[e.open]),(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(a,{onClick:()=>n(!0),label:`Open confirm modal`}),(0,g.jsx)(c,{...e,open:t,onClose:()=>n(!1),subtitle:e.subtitle??``,children:null})]})}},C={name:`Modal centred footer`,parameters:{docs:{description:{story:'Use `footerAlign="center"` for an explainer dialog with a single confirm: the button sits centred and takes the wider 40px padding.'}}},args:{layoutMode:`fixed`,open:!1,title:`What is an organization?`,subtitle:``,description:`An organization is the top level of your account. Your team, data and settings all live here, in one place.`,footerAlign:`center`,primaryButton:{label:`Okay`,onClick:()=>alert(`Okay`)},panelClassName:`md:max-w-[480px]!`,children:null},argTypes:{children:{table:{disable:!0}},footerAlign:{control:{type:`inline-radio`},options:n},open:{control:{type:`boolean`}}},render:e=>{let[t,n]=(0,h.useState)(e.open||!1);return(0,h.useEffect)(()=>{n(e.open||!1)},[e.open]),(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(a,{onClick:()=>n(!0),label:`Open explainer`}),(0,g.jsx)(c,{...e,open:t,onClose:()=>n(!1),subtitle:e.subtitle??``,children:null})]})}},w={args:{open:!1,withGrabHandler:!0,stepless:!0},argTypes:{open:{control:{type:`boolean`}},withGrabHandler:{control:{type:`boolean`}},stepless:{control:{type:`boolean`}}},render:e=>{let[t,n]=(0,h.useState)(e.open||!1);return(0,h.useEffect)(()=>{n(e.open||!1)},[e.open]),(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(a,{onClick:()=>n(!0),label:`Open Sheet`}),(0,g.jsx)(u,{...e,open:t,onClose:()=>n(!1),children:e.children})]})}},T=x,v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  name: "DialogHeader",
  render: (args: any) => {
