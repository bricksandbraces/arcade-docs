import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Di as n,Hi as r,Hr as i,J as a,K as o,Lr as s,Tr as c,Zn as l,fi as u,gr as d,ir as f,it as p,jr as m,lr as h,q as g,qn as _,st as v,t as y,zr as b}from"./iframe-BK1IgQO6.js";var x,S,C,w,T,E,D,O,k,A,j,M,N;e((()=>{y(),_(),x=t(u(),1),S=t(r(),1),C=n(),w={title:`Fabian Supervision/Navigation/Navigation`,component:g,tags:[`autodocs`],parameters:{layout:`fullscreen`,docs:{description:{component:`Collapsible side navigation with nested items. Use as the primary app chrome for switching between top-level sections.`}}}},T=[{id:`dashboard`,label:`Dashboard`,icon:c},{id:`projects`,label:`Projects`,icon:d,children:[{id:`projects-all`,label:`All projects`},{id:`projects-archived`,label:`Archived`},{id:`projects-templates`,label:`Templates`,disabled:!0}]},{id:`team`,label:`Team`,icon:l},{id:`reports`,label:`Reports`,icon:m},{id:`settings`,label:`Settings`,icon:f}],E=({logo:e})=>{let[t,n]=S.useState(!0),[r,i]=S.useState(`dashboard`),[o,s]=S.useState(`projects`);return(0,C.jsxs)(`div`,{className:(0,x.default)(`bg-background-accent`,`flex`,`min-h-screen`),children:[(0,C.jsx)(g,{expanded:t,onExpandedChange:n,logo:e(t),children:T.map(e=>{let n=!!e.children&&t,c=o===e.id,l=r===e.id;return(0,C.jsx)(a,{title:t?e.label:void 0,size:t?`default`:`small`,icon:e.icon,tooltip:t?void 0:e.label,selected:l&&!c,expandable:n,expanded:c,onExpandedChange:t=>s(t?e.id:null),onClick:()=>{e.children||i(e.id)},children:e.children?.map(e=>(0,C.jsx)(a,{title:e.label,level:2,disabled:e.disabled,selected:r===e.id,onClick:()=>{e.disabled||i(e.id)}},e.id))},e.id)})}),(0,C.jsx)(`div`,{className:(0,x.default)(`p-lg`,`typography-body-small`,`text-text`,`flex-1`)})]})},D={render:()=>(0,C.jsx)(E,{logo:e=>(0,C.jsx)(o,{compact:!e})})},O=()=>(0,C.jsxs)(`div`,{className:`gap-xs flex items-center`,children:[(0,C.jsx)(i,{kind:`ghost`,IconLeft:f,size:`medium`,"aria-label":`Settings`}),(0,C.jsx)(i,{kind:`ghost`,IconLeft:s,size:`medium`,"aria-label":`Notifications`}),(0,C.jsx)(i,{kind:`ghost`,IconLeft:h,size:`medium`,"aria-label":`Menu`})]}),k=()=>(0,C.jsx)(`div`,{className:`border-border-brand text-text-brand typography-body-small size-container-xs flex items-center justify-center rounded-md border border-dashed`,children:`L`}),A=()=>{let[e,t]=S.useState(`products`);return(0,C.jsx)(p,{title:`Dashboard`,border:!0,companyLogo:(0,C.jsx)(k,{}),backButton:(0,C.jsx)(i,{kind:`ghost`,IconLeft:b,size:`medium`,"aria-label":`Go back`}),linkGroupOne:(0,C.jsxs)(`div`,{className:`gap-xs flex items-center`,children:[(0,C.jsx)(v,{selected:e===`products`,onClick:()=>t(`products`),children:`Products`}),(0,C.jsx)(v,{selected:e===`resources`,onClick:()=>t(`resources`),children:`Resources`})]}),actions:(0,C.jsx)(O,{})})},j={parameters:{docs:{description:{story:"Pairs the Navigation sidebar with the Header `WithTwoLinks` setup to show a complete app shell: sidebar on the left, top bar above the content area."}}},render:function(){let[e,t]=S.useState(!0),[n,r]=S.useState(`dashboard`),[i,s]=S.useState(`projects`);return(0,C.jsxs)(`div`,{className:(0,x.default)(`bg-background-accent`,`flex`,`min-h-screen`),children:[(0,C.jsx)(g,{expanded:e,onExpandedChange:t,logo:(0,C.jsx)(o,{compact:!e}),children:T.map(t=>{let o=!!t.children&&e,c=i===t.id,l=n===t.id;return(0,C.jsx)(a,{title:e?t.label:void 0,size:e?`default`:`small`,icon:t.icon,tooltip:e?void 0:t.label,selected:l&&!c,expandable:o,expanded:c,onExpandedChange:e=>s(e?t.id:null),onClick:()=>{t.children||r(t.id)},children:t.children?.map(e=>(0,C.jsx)(a,{title:e.label,level:2,disabled:e.disabled,selected:n===e.id,onClick:()=>{e.disabled||r(e.id)}},e.id))},t.id)})}),(0,C.jsxs)(`div`,{className:`flex min-w-0 flex-1 flex-col`,children:[(0,C.jsx)(A,{}),(0,C.jsx)(`div`,{className:`p-lg typography-body-small text-text flex-1`})]})]})}},M={parameters:{docs:{description:{story:"Wraps a real consumer logo in `NavigationLogo`. The dashed-border placeholder styling is reserved for the empty/sample case and must not appear here."}}},render:()=>(0,C.jsx)(E,{logo:e=>(0,C.jsx)(o,{compact:!e,children:e?(0,C.jsxs)(`span`,{className:`gap-sm flex items-center`,children:[(0,C.jsx)(`span`,{className:`bg-background-onlight text-text-ondark typography-label flex h-6 w-6 items-center justify-center rounded-md`,children:`A`}),(0,C.jsx)(`span`,{className:`typography-headline-06 text-text font-semibold`,children:`Acme Inc.`})]}):(0,C.jsx)(`span`,{className:`bg-background-onlight text-text-ondark typography-label flex h-6 w-6 items-center justify-center rounded-md`,children:`A`})})})},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
