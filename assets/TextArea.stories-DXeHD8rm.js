import{j as g}from"./jsx-runtime-D_zvdyIk.js";import{bL as H}from"./ContextMenuList-DU-bfPtc.js";import"./index-CY-HDqYb.js";import{O as R}from"./onCardStoryShell-BJaWLAPz.js";import"./index-A6zbrgSY.js";import"./index-DWvd7WUe.js";import"./index-BDYMFBcC.js";import"./index-ZRCHFLd-.js";import"./sizes-BpUsT7VU.js";import"./colors-CoOIoG7W.js";const X={title:"Components/Inputs/TextArea",component:H,argTypes:{state:{control:{type:"select"},options:["default","error","warning","success"]}},args:{label:"Label",helperText:"Helper text",errorMessage:"Error Message",warningMessage:"Warning Message",successMessage:"Success",loadingMessage:"Loading...",disabled:!1,loading:!1,state:"default",maxLength:200,rows:4}},e={args:{placeholder:"Type your message..."}},s={args:{placeholder:"Type your message...",surface:"onCard"},render:I=>g.jsx(R,{children:g.jsx(H,{...I})})},a={args:{label:"Message",placeholder:"Type your message...",state:"error",errorMessage:"Please enter a valid message",rows:4}},r={args:{label:"Message",placeholder:"Type your message...",state:"warning",warningMessage:"Please review this text before continuing.",rows:4,value:"This message may need your attention."}},o={args:{label:"Message",placeholder:"Type your message...",state:"success",successMessage:"Looks good!",rows:4,value:"This is a sample message that has been validated successfully."}},t={args:{label:"Message",placeholder:"Type your message...",loading:!0,rows:4,value:"This is a sample message..."}},n={args:{label:"Message",placeholder:"Type your message...",disabled:!0,rows:4,value:"This is a disabled textarea."}},l={args:{label:"Message",placeholder:"No label textarea...",hideLabel:!0,rows:4}},c={args:{label:"Message",placeholder:"Type your message...",rows:4,value:"This story demonstrates trailing slot composition.",trailingSlot:g.jsx("span",{className:"typography-label-small rounded-max bg-background-selected px-xs py-2xs text-text",children:"Custom"}),state:"success",successMessage:"Saved"}};var i,p,d;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    placeholder: "Type your message..."
  }
}`,...(d=(p=e.parameters)==null?void 0:p.docs)==null?void 0:d.source}}};var u,m,h;s.parameters={...s.parameters,docs:{...(u=s.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    placeholder: "Type your message...",
    surface: "onCard"
  },
...
}`,...(j=(P=n.parameters)==null?void 0:P.docs)==null?void 0:j.source}}};var E,k,A;l.parameters={...l.parameters,docs:{...(E=l.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    label: "Message",
...
}`,...(A=(k=l.parameters)==null?void 0:k.docs)==null?void 0:A.source}}};var N,_,D;c.parameters={...c.parameters,docs:{...(N=c.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    label: "Message",
    placeholder: "Type your message...",
    rows: 4,
...
}`,...(D=(_=c.parameters)==null?void 0:_.docs)==null?void 0:D.source}}};const Y=["Playground","OnCard","WithError","WithWarning","WithSuccess","Loading","Disabled","WithoutLabel","Slot"];export{n as Disabled,t as Loading,s as OnCard,e as Playground,c as Slot,a as WithError,o as WithSuccess,r as WithWarning,l as WithoutLabel,Y as __namedExportsOrder,X as default};
