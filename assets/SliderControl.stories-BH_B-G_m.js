import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ea as n,Mt as r,Nt as i,da as a,jt as o,t as s}from"./iframe-BY85Oiue.js";var c,l,u,d,f,p,m,h,g,_;e((()=>{s(),c=t(n(),1),l=a(),{action:u}=__STORYBOOK_MODULE_ACTIONS__,d=e=>{u(`onChange`)(e)},f={title:`Inputs & Controls/Slider/SliderControl`,component:o,tags:[`autodocs`],args:{value:50,min:0,max:100,step:1,disabled:!1,showTooltip:!1,variant:`bar`,size:`md`,"aria-label":`Slider`,onChange:d}},p=e=>{let[t,n]=(0,c.useState)(e.value??50);return(0,c.useEffect)(()=>{n(e.value??50)},[e.value]),(0,l.jsx)(o,{...e,value:t,onChange:t=>{n(t),e.onChange?.(t)}})},m={render:e=>(0,l.jsx)(p,{...e}),argTypes:{variant:{description:`Bar (vertical handle) or Dot (circular handle)`,control:{type:`inline-radio`},options:i},size:{description:`Track and handle scale`,control:{type:`inline-radio`},options:r},value:{control:{type:`range`,min:0,max:100,step:1}},min:{control:{type:`number`}},max:{control:{type:`number`}},step:{control:{type:`number`}},disabled:{control:`boolean`},showTooltip:{description:`Value tooltip under the handle; visible while dragging (active) or when the range input matches :focus-visible`,control:`boolean`},tooltipFormat:{control:{disable:!0}},onChange:{control:{disable:!0}}}},h=[...r].toReversed().flatMap(e=>[{size:e,disabled:!1},{size:e,disabled:!0}]),g={parameters:{controls:{disable:!0}},render:e=>{let t=i;return(0,l.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${t.length}, minmax(0, 1fr))`},children:h.map((n,r)=>t.map((t,i)=>{let a=`${t}-${n.size}-${n.disabled?`disabled`:`enabled`}`;return(0,l.jsxs)(`div`,{style:{gridColumn:`${i+1} / span 1`,gridRow:`${r+1} / span 1`},children:[e.showLabels&&(0,l.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`variant=`,t,`, size=`,n.size,n.disabled?`, disabled`:`, enabled`]}),(0,l.jsx)(p,{value:50,min:0,max:100,step:1,variant:t,size:n.size,disabled:n.disabled,onChange:d,"aria-label":`Slider ${t} ${n.size}`})]},a)}))})},args:{showLabels:!1}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
