import{n as e}from"./chunk-jRWAZmH_.js";import{Jt as t,Kr as n,er as r,po as i,qr as a,t as o}from"./iframe-CanflEBn.js";import{n as s,t as c}from"./onCardStoryShell-CTF0G-8E.js";var l,u,d,f,p,m,h,g,_;e((()=>{o(),s(),l=i(),u={title:`Inputs & Controls/TextInput`,component:t,tags:[`autodocs`],argTypes:{size:{control:`inline-radio`,options:n},disabled:{control:`boolean`},loading:{control:`boolean`},successMessage:{control:`text`},errorMessage:{control:`text`},hideLabel:{control:`boolean`},label:{control:`text`},placeholder:{control:`text`},state:{control:`inline-radio`,options:a}},args:{errorMessage:`Error Message`,warningMessage:`Warning Message`,successMessage:`Success`,loadingMessage:`Loading...`,helperText:`Helper Text`,id:`playground-text-input`,label:`Label`,placeholder:`Placeholder text...`,size:`medium`},parameters:{docs:{description:{component:`Standard labeled text input with validation states. Use as the default single-line field in forms.`}}}},d={args:{}},f={args:{label:`Email address`,size:`large`,disabled:!0,value:`hendrik@bricksandbraces.com`,helperText:void 0,placeholder:void 0},render:e=>(0,l.jsx)(`div`,{className:`w-[150px]`,children:(0,l.jsx)(t,{...e})})},p={args:{...u.args,surface:`onCard`},render:e=>(0,l.jsx)(c,{children:(0,l.jsx)(t,{...e})})},m={args:{id:`slot-text-input`,label:`Label`,placeholder:`Placeholder text...`,trailingSlot:(0,l.jsx)(`span`,{className:`typography-label text-text-accent`,children:`ID`})},render:e=>(0,l.jsx)(t,{...e})},h={parameters:{controls:{disable:!0}},args:{showLabels:!1},render:e=>{let r=n.toReversed().flatMap(e=>[{size:e,loading:!1,disabled:!1,state:`default`},{size:e,loading:!1,disabled:!0,state:`default`},{size:e,loading:!0,disabled:!1,state:`default`},{size:e,loading:!1,disabled:!1,state:`error`},{size:e,loading:!1,disabled:!1,state:`success`}]),i=a;return(0,l.jsx)(`div`,{className:`gap-xlg grid pb-[128px]`,style:{display:`grid`,gridTemplateColumns:`repeat(${i.length}, minmax(0, 1fr))`},children:r.map((n,r)=>i.map((i,a)=>{let o=`${i}-${n.size}-${n.loading?`loading`:`default`}-${n.disabled?`disabled`:`enabled`}-${n.state}`;return(0,l.jsxs)(`div`,{style:{gridColumn:`${a+1} / span 1`,gridRow:`${r+1} / span 1`},children:[e.showLabels&&(0,l.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,n.size,`, state=`,i,n.loading?`, loading`:``,n.disabled?`, disabled`:``,n.state===`default`?``:`, status=${n.state}`]}),(0,l.jsxs)(`div`,{className:`gap-sm flex flex-col`,children:[(0,l.jsx)(`div`,{className:`pb-[32px]`,children:(0,l.jsx)(t,{id:`${i}-${n.size}-${r}-empty`,label:`Label`,placeholder:`Placeholder text...`,helperText:`Helper Text`,loadingMessage:`Loading...`,errorMessage:`Error Message`,successMessage:`Success`,warningMessage:`Warning Message`,size:n.size,state:n.state,loading:n.loading,disabled:n.disabled})}),(0,l.jsx)(`div`,{className:`pb-[32px]`,children:(0,l.jsx)(t,{id:`${i}-${n.size}-${r}-filled`,label:`Label`,placeholder:`Placeholder text...`,helperText:`Helper Text`,loadingMessage:`Loading...`,errorMessage:`Error Message`,successMessage:`Success`,warningMessage:`Warning Message`,size:n.size,state:n.state,loading:n.loading,disabled:n.disabled,value:`john.doe@example.com`})})]})]},o)}))})}},g={render:()=>(0,l.jsx)(r,{})},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {}
