import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ti as n,ai as r,at as i,ct as a,ga as o,go as s,la as c,lt as l,pa as u,st as d,t as f,to as p,yi as m}from"./iframe-BmHhhjqm.js";var h,g,_,v,y,b,x,S,C,w;e((()=>{f(),r(),h=t(s(),1),g=p(),_={title:`Layout & Structure/Header/Header`,component:i,tags:[`autodocs`],argTypes:{showBackButton:{control:`boolean`}},parameters:{layout:`fullscreen`,docs:{description:{component:"Top app bar with optional logo (`logo` + {@link HeaderLogo}), navigation links, and actions."}}}},v=()=>(0,g.jsxs)(`div`,{className:`gap-xs flex items-center`,children:[(0,g.jsx)(o,{kind:`ghost`,IconLeft:m,size:`medium`,"aria-label":`Settings`,tooltipContent:`Settings`,tooltipOpenDelayMs:0}),(0,g.jsx)(o,{kind:`ghost`,IconLeft:c,size:`medium`,"aria-label":`Notifications`,tooltipContent:`Notifications`,tooltipOpenDelayMs:0}),(0,g.jsx)(o,{kind:`ghost`,IconLeft:n,size:`medium`,"aria-label":`Menu`,tooltipContent:`Menu`,tooltipOpenDelayMs:0})]}),y=e=>`/arcade-docs/assets/${e}`,b=()=>(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(`img`,{src:y(`logo_default-dark.svg`),alt:``,className:`h-[20px] w-auto max-w-full dark:hidden`}),(0,g.jsx)(`img`,{src:y(`logo_default-light.svg`),alt:``,className:`hidden h-[20px] w-auto max-w-full dark:block`})]}),x={render:({showBackButton:e=!0})=>{let[t,n]=(0,h.useState)(`g1-b`);return(0,g.jsx)(i,{title:`Dashboard`,showBackButton:e,backButton:(0,g.jsx)(o,{kind:`ghost`,IconLeft:u,size:`medium`,"aria-label":`Go back`,tooltipContent:`Go back`,tooltipOpenDelayMs:0}),linkGroupOne:(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(l,{selected:t===`g1-a`,onClick:()=>n(`g1-a`),children:`Link`}),(0,g.jsx)(l,{selected:t===`g1-b`,onClick:()=>n(`g1-b`),children:`Link`}),(0,g.jsx)(l,{selected:t===`g1-c`,onClick:()=>n(`g1-c`),children:`Link`})]}),linkGroupTwo:(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(l,{selected:t===`g2-a`,onClick:()=>n(`g2-a`),children:`Link`}),(0,g.jsx)(d,{selected:t===`g2-dropdown`,items:[{label:`Link`,onClick:()=>n(`g2-dropdown`)},{label:`Link`,onClick:()=>n(`g2-dropdown`)},{label:`Link`,onClick:()=>n(`g2-dropdown`)}],children:(0,g.jsx)(a,{children:`Link`})}),(0,g.jsx)(l,{selected:t===`g2-c`,onClick:()=>n(`g2-c`),children:`Link`})]}),actions:(0,g.jsx)(v,{})})},args:{showBackButton:!0},parameters:{layout:`fullscreen`,controls:{include:[`showBackButton`]}}},S={parameters:{layout:`fullscreen`,docs:{description:{story:"Optional `logo` slot — pass SVG/img children; `Header` wraps them in `HeaderLogo`. Use `logoHref` for a home link."}}},render:()=>(0,g.jsx)(i,{title:`Dashboard`,showBackButton:!1,logo:(0,g.jsx)(b,{}),logoHref:`#`,actions:(0,g.jsx)(v,{})})},C={args:{showBackButton:!0},parameters:{layout:`fullscreen`,controls:{include:[`showBackButton`]},docs:{description:{story:"Header with exactly two top-level navigation links rendered as `HeaderButton`s. Click a link to make it the active one. Use when the app has only a couple of primary sections."}}},render:function({showBackButton:e=!0}){let[t,n]=(0,h.useState)(`products`);return(0,g.jsx)(i,{title:`Dashboard`,showBackButton:e,backButton:(0,g.jsx)(o,{kind:`ghost`,IconLeft:u,size:`medium`,"aria-label":`Go back`}),linkGroupOne:(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(l,{selected:t===`products`,onClick:()=>n(`products`),children:`Products`}),(0,g.jsx)(l,{selected:t===`resources`,onClick:()=>n(`resources`),children:`Resources`})]}),actions:(0,g.jsx)(v,{})})}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  render: ({
    showBackButton = true
  }) => {
    ...
    return <Header title="Dashboard" showBackButton={showBackButton} backButton={<Button kind="ghost" IconLeft={IconArrowLeft} size="medium" aria-label="Go back" tooltipContent="Go back" tooltipOpenDelayMs={0} />} linkGroupOne={<>
