import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ji as n,Mn as r,Xi as i,Yi as a,is as o,ln as s,qi as c,t as l,un as u,vi as d,yo as f,ys as p}from"./iframe-COa7Xbk1.js";import{n as m,t as h}from"./figmaDesign-CO6i5n9C.js";var g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I;e((()=>{l(),g=t(p(),1),m(),_=o(),{expect:v,fireEvent:y,waitFor:b,within:x}=__STORYBOOK_MODULE_TEST__,S={title:`Overlays & Menus/Dialog`,tags:[`autodocs`],args:{title:`Dialog Title`,subtitle:`Subtitle or Description`,primaryButton:{label:`Button`,onClick:()=>alert(`Primary action clicked`)},secondaryButton:{label:`Button`,onClick:()=>alert(`Secondary action clicked`)},onClose:()=>alert(`Dialog closed`),description:`Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.`,children:(0,_.jsx)(`div`,{className:`border-border-brand p-lg rounded-md border-[1px] border-dashed`,children:(0,_.jsx)(`span`,{className:`text-text-brand typography-body-small`,children:`Children`})})},parameters:{design:h(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2414-9433`),docs:{description:{component:`Overlay surface (Modal or Sheet) for focused tasks that interrupt the main flow. Compose with DialogHeader, DialogBody and DialogFooter.`}}}},C={config:{rules:[{id:`aria-hidden-focus`,enabled:!1}]}},w=e=>async({args:t,canvas:n,canvasElement:r,userEvent:i})=>{await i.click(n.getByRole(`button`,{name:e})),await v(await x(r.ownerDocument.body).findByRole(`dialog`,{name:t.title})).toHaveAccessibleDescription(t.subtitle)},T={name:`DialogHeader`,render:e=>(0,_.jsx)(i,{title:e.title,subtitle:e.subtitle})},E={name:`DialogHeader small`,parameters:{docs:{description:{story:`The compact header of a split view section, with and without a subtitle, and with the close button waiting on a save.`}}},render:()=>(0,_.jsxs)(`div`,{className:`gap-lg flex flex-col`,children:[(0,_.jsx)(i,{size:`small`,title:`Account`,subtitle:``}),(0,_.jsx)(i,{size:`small`,title:`Account`,subtitle:`Subtitle or Description`}),(0,_.jsx)(i,{size:`small`,title:`Account`,subtitle:``,closeButton:{onClose:()=>{},ariaLabel:`Close dialog`,loading:!0}})]})},D={name:`DialogBody`,render:e=>(0,_.jsx)(c,{description:e.description,children:e.children})},O={name:`DialogFooter`,render:e=>(0,_.jsx)(n,{primaryButton:e.primaryButton,secondaryButton:e.secondaryButton})},k={name:`DialogFooter with slot`,render:e=>(0,_.jsx)(n,{leadingSlot:(0,_.jsx)(d,{id:`dialog-footer-slot`,label:`Don't ask again`,hideLabel:!0,description:`Don't ask again`}),primaryButton:e.primaryButton,secondaryButton:e.secondaryButton})},A={parameters:{a11y:C},args:{layoutMode:`responsive`,open:!1},argTypes:{layoutMode:{control:{type:`inline-radio`},options:u},open:{control:{type:`boolean`}}},render:e=>{let[t,n]=(0,g.useState)(e.open||!1);return(0,g.useEffect)(()=>{n(e.open||!1)},[e.open]),(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(f,{onClick:()=>n(!0),label:`Open Modal`}),(0,_.jsx)(s,{...e,open:t,onClose:()=>n(!1),children:e.children})]})},play:w(`Open Modal`)},j={name:`Modal fixed width`,parameters:{docs:{description:{story:'Use `layoutMode="fixed"` for a compact dialog (fit-content height). Override width with `panelClassName` (e.g. `max-w-[420px]`).'}}},args:{layoutMode:`fixed`,open:!1,title:`Confirm action`,subtitle:``,description:`This uses the fixed width preset. Adjust with panelClassName if needed.`,primaryButton:{label:`Confirm`,onClick:()=>alert(`Confirmed`)},secondaryButton:{label:`Cancel`,onClick:()=>alert(`Cancelled`)},panelClassName:``,children:null},argTypes:{children:{table:{disable:!0}},layoutMode:{control:{type:`inline-radio`},options:u},panelClassName:{control:`text`,description:`Optional override, e.g. max-w-[420px]`},open:{control:{type:`boolean`}}},render:e=>{let[t,n]=(0,g.useState)(e.open||!1);return(0,g.useEffect)(()=>{n(e.open||!1)},[e.open]),(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(f,{onClick:()=>n(!0),label:`Open confirm modal`}),(0,_.jsx)(s,{...e,open:t,onClose:()=>n(!1),subtitle:e.subtitle??``,children:null})]})}},M={name:`Modal centred footer`,parameters:{docs:{description:{story:'Use `footerAlign="center"` for an explainer dialog with a single confirm: the button sits centred and takes the wider 40px padding.'}}},args:{layoutMode:`fixed`,open:!1,title:`What is an organization?`,subtitle:``,description:`An organization is the top level of your account. Your team, data and settings all live here, in one place.`,footerAlign:`center`,primaryButton:{label:`Okay`,onClick:()=>alert(`Okay`)},panelClassName:`md:max-w-[480px]!`,children:null},argTypes:{children:{table:{disable:!0}},footerAlign:{control:{type:`inline-radio`},options:a},open:{control:{type:`boolean`}}},render:e=>{let[t,n]=(0,g.useState)(e.open||!1);return(0,g.useEffect)(()=>{n(e.open||!1)},[e.open]),(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(f,{onClick:()=>n(!0),label:`Open explainer`}),(0,_.jsx)(s,{...e,open:t,onClose:()=>n(!1),subtitle:e.subtitle??``,children:null})]})}},N={parameters:{a11y:C},args:{open:!1,withGrabHandler:!0,stepless:!0},argTypes:{open:{control:{type:`boolean`}},withGrabHandler:{control:{type:`boolean`}},stepless:{control:{type:`boolean`}}},render:e=>{let[t,n]=(0,g.useState)(e.open||!1);return(0,g.useEffect)(()=>{n(e.open||!1)},[e.open]),(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(f,{onClick:()=>n(!0),label:`Open Sheet`}),(0,_.jsx)(r,{...e,open:t,onClose:()=>n(!1),children:e.children})]})},play:w(`Open Sheet`)},P=A,F={...A,name:`Modal keeps open after a drag onto the backdrop`,play:async({canvas:e,canvasElement:t,userEvent:n})=>{await n.click(e.getByRole(`button`,{name:`Open Modal`}));let r=x(t.ownerDocument.body),i=await r.findByRole(`dialog`,{name:`Dialog Title`}),a=i.parentElement;await y.pointerDown(x(i).getByText(`Children`)),await y.click(a),await v(i).toBeInTheDocument(),await y.pointerDown(a),await y.click(a),await b(()=>v(r.queryByRole(`dialog`,{name:`Dialog Title`})).not.toBeInTheDocument())}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  name: "DialogHeader",
  render: (args: any) => {
