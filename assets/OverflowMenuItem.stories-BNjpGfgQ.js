import{n as e}from"./chunk-jRWAZmH_.js";import{Ji as t,Xi as n,Yi as r,Za as i,Zi as a,hs as o,i as s,sa as c}from"./iframe-YAZ8xM7U.js";import{n as l,t as u}from"./figmaDesign-CO6i5n9C.js";var d,f,p,m,h,g;e((()=>{s(),c(),l(),d=o(),f={parameters:{design:u(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2331-13861`)},component:t,tags:[`autodocs`],title:`Overlays & Menus/OverflowMenu/OverflowMenuItem`,argTypes:{size:{control:{type:`inline-radio`},options:a},disabled:{control:{type:`boolean`}},danger:{control:{type:`boolean`}},showDivider:{control:{type:`boolean`}},positionInList:{control:{type:`inline-radio`},options:n},layout:{control:{type:`inline-radio`},options:r}},args:{label:`Menu item`,size:`medium`,layout:`menu`,positionInList:`middle`,onClick:()=>{}},decorators:[e=>(0,d.jsx)(`div`,{role:`menu`,children:(0,d.jsx)(e,{})})]},p={},m=[{key:`default`,props:{}},{key:`disabled`,props:{disabled:!0}},{key:`danger`,props:{danger:!0}},{key:`icon`,props:{icon:i}},{key:`divider`,props:{showDivider:!0}}],h={parameters:{controls:{disable:!0}},render:e=>{let n=a.toReversed();return(0,d.jsx)(`div`,{className:`gap-xlg grid w-full max-w-[1400px]`,style:{display:`grid`,gridTemplateColumns:`repeat(${m.length}, minmax(0, 1fr))`},children:n.map((n,r)=>m.map((i,a)=>{let o=`${n}-${i.key}`;return(0,d.jsxs)(`div`,{style:{gridColumn:`${a+1} / span 1`,gridRow:`${r+1} / span 1`},children:[e.showLabels&&(0,d.jsxs)(`p`,{className:`typography-body-small text-text mb-sm`,children:[`size=`,n,`, `,i.key]}),(0,d.jsx)(`div`,{className:`w-full max-w-[230px] min-w-[192px]`,children:(0,d.jsx)(t,{label:`Menu item`,size:n,onClick:()=>{},...i.props})})]},o)}))})},args:{showLabels:!1}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{}`,...p.parameters?.docs?.source}}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
