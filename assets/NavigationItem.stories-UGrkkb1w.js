import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{$o as n,$t as r,Aa as i,Ji as a,Ro as o,Va as s,en as c,la as l,ms as u,t as d,tn as f}from"./iframe-BHshPtOU.js";import{n as p,t as m}from"./figmaDesign-CO6i5n9C.js";var h,g,_,v,y,b,x,S,C;e((()=>{d(),a(),h=t(o(),1),g=t(u(),1),p(),_=n(),v={parameters:{design:m(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2438-38919`)},title:`Navigation/Navigation/NavigationItem`,component:r,tags:[`autodocs`],argTypes:{level:{control:`inline-radio`,options:c},size:{control:`inline-radio`,options:f},selected:{control:`boolean`},disabled:{control:`boolean`},expandable:{control:`boolean`},expanded:{control:`boolean`},title:{control:`text`},tooltip:{control:`text`}},args:{title:`Dashboard`,level:1,expandable:!1,selected:!1,disabled:!1,size:`default`},decorators:[e=>(0,_.jsx)(`div`,{className:(0,h.default)(`p-lg`,`w-72`,`bg-background`),children:(0,_.jsx)(e,{})})]},y={args:{icon:s}},b={parameters:{controls:{disable:!0}},render:()=>(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-xlg`,`flex`,`flex-col`),children:[(0,_.jsxs)(`section`,{className:(0,h.default)(`gap-md`,`flex`,`flex-col`),children:[(0,_.jsx)(`h3`,{className:(0,h.default)(`typography-headline-04`,`text-text`),children:`Level 1 - default size`}),(0,_.jsx)(r,{title:`Enabled`,icon:s}),(0,_.jsx)(r,{title:`Selected`,icon:s,selected:!0}),(0,_.jsx)(r,{title:`Disabled`,icon:s,disabled:!0}),(0,_.jsx)(r,{title:`Expandable (collapsed)`,icon:i,expandable:!0}),(0,_.jsxs)(r,{title:`Expandable (expanded)`,icon:i,expandable:!0,defaultExpanded:!0,children:[(0,_.jsx)(r,{title:`Nested item`,level:2}),(0,_.jsx)(r,{title:`Another nested`,level:2})]})]}),(0,_.jsxs)(`section`,{className:(0,h.default)(`gap-md`,`flex`,`flex-col`),children:[(0,_.jsx)(`h3`,{className:(0,h.default)(`typography-headline-04`,`text-text`),children:`Level 2`}),(0,_.jsx)(r,{title:`Nested enabled`,level:2}),(0,_.jsx)(r,{title:`Nested selected`,level:2,selected:!0}),(0,_.jsx)(r,{title:`Nested disabled`,level:2,disabled:!0})]}),(0,_.jsxs)(`section`,{className:(0,h.default)(`gap-md`,`flex`,`flex-col`),children:[(0,_.jsx)(`h3`,{className:(0,h.default)(`typography-headline-04`,`text-text`),children:`Small - icon only with tooltip`}),(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-sm`,`flex`,`flex-col`,`w-16`),children:[(0,_.jsx)(r,{size:`small`,icon:s,tooltip:`Dashboard`}),(0,_.jsx)(r,{size:`small`,icon:i,tooltip:`Projects`,selected:!0}),(0,_.jsx)(r,{size:`small`,icon:l,tooltip:`Settings`,disabled:!0})]})]})]})},x={parameters:{controls:{disable:!0}},render:function(){let[e,t]=g.useState(`projects`);return(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,_.jsx)(r,{title:`Dashboard`,icon:s,selected:e===null}),(0,_.jsxs)(r,{title:`Projects`,icon:i,expandable:!0,expanded:e===`projects`,onExpandedChange:e=>t(e?`projects`:null),children:[(0,_.jsx)(r,{title:`All projects`,level:2}),(0,_.jsx)(r,{title:`Archived`,level:2}),(0,_.jsx)(r,{title:`Templates`,level:2,disabled:!0})]}),(0,_.jsxs)(r,{title:`Settings`,icon:l,expandable:!0,expanded:e===`settings`,onExpandedChange:e=>t(e?`settings`:null),children:[(0,_.jsx)(r,{title:`Profile`,level:2}),(0,_.jsx)(r,{title:`Billing`,level:2})]})]})}},S={parameters:{controls:{disable:!0}},render:()=>(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,_.jsx)(r,{title:`Dashboard`,icon:s,href:`#dashboard`,selected:!0}),(0,_.jsx)(r,{title:`Projects`,icon:i,href:`#projects`}),(0,_.jsx)(r,{title:`Settings`,icon:l,href:`#settings`})]})},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    icon: IconDashboard
  }
