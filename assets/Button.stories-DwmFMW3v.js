import{n as e}from"./chunk-jRWAZmH_.js";import{Fo as t,Pr as n,Qa as r,Xa as i,Za as a,t as o}from"./iframe-RQUrcOP9.js";import{n as s,t as c}from"./figmaDesign-CO6i5n9C.js";var l,u,d,f,p,m,h,g,_,v,y,b;e((()=>{o(),s(),l=t(),{action:u}=__STORYBOOK_MODULE_ACTIONS__,{expect:d,fn:f}=__STORYBOOK_MODULE_TEST__,p=e=>{u(`onClick`)(e)},m={title:`Buttons & Actions/Button`,component:i,tags:[`autodocs`],args:{label:`Button`,disabled:!1,loading:!1,kind:`primary`,size:`medium`,IconLeft:void 0,IconRight:void 0,onClick:p,tooltipContent:`Tooltip text`,tooltipPlacement:`bottom`},parameters:{design:c(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2104-2841`),docs:{description:{component:`Triggers an action when clicked. Use the primary kind for the main action on a page, secondary or ghost for supporting actions.`}}}},h={args:{kind:`primary`},argTypes:{kind:{description:`The kind of button`,control:{type:`select`},options:[`primary`,`secondary`,`tertiary`,`ghost`,`primary-danger`,`tertiary-danger`,`ghost-danger`],defaultValue:`primary`},size:{description:`The size of the button`,control:{type:`select`},options:[`small`,`medium`,`large`],defaultValue:`medium`},onClick:{control:{disable:!0}},IconLeft:{control:{disable:!0}},IconRight:{control:{disable:!0}}}},g=e=>(0,l.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,fill:`none`,viewBox:`0 0 24 24`,stroke:`currentColor`,className:e.className,children:(0,l.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:2,d:`M12 6v6m0 0v6m0-6h6m-6 0H6`})}),_={parameters:{controls:{disable:!0}},render:e=>{let t=r.toReversed().flatMap(e=>[{size:e,loading:!1,disabled:!1},{size:e,loading:!1,disabled:!0},{size:e,loading:!0,disabled:!1}]),n=a;return(0,l.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${n.length}, minmax(0, 1fr))`},children:t.map((t,r)=>n.map((n,a)=>{let o=`${n}-${t.size}-${t.loading?`loading`:`default`}-${t.disabled?`disabled`:`enabled`}`;return(0,l.jsxs)(`div`,{style:{gridColumn:`${a+1} / span 1`,gridRow:`${r+1} / span 1`},children:[e.showLabels&&(0,l.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,t.size,`, kind=`,n,t.loading?`, loading`:``,t.disabled?`, disabled`:``]}),(0,l.jsxs)(`div`,{className:`gap-sm flex flex-row`,children:[(0,l.jsx)(i,{label:`Button`,kind:n,size:t.size,loading:t.loading,disabled:t.disabled,onClick:p,tooltipContent:e.tooltipContent,tooltipPlacement:e.tooltipPlacement}),(0,l.jsx)(i,{"aria-label":`Icon button`,kind:n,size:t.size,loading:t.loading,disabled:t.disabled,IconLeft:g,onClick:p,tooltipContent:e.tooltipContent,tooltipPlacement:e.tooltipPlacement})]})]},o)}))})},args:{showLabels:!1}},v={args:{kind:`primary`,label:`Click me`,onClick:f()},play:async({args:e,canvas:t,userEvent:n})=>{let r=t.getByRole(`button`,{name:/click me/i});await d(r).toBeEnabled(),await n.click(r),await d(e.onClick).toHaveBeenCalledOnce()}},y={render:()=>(0,l.jsx)(n,{})},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    kind: "primary"
  },
  argTypes: {
