import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{As as n,Fi as r,Ni as i,Pi as a,Tt as o,hs as s,i as c}from"./iframe-YAZ8xM7U.js";import{n as l,t as u}from"./figmaDesign-CO6i5n9C.js";import{n as d,t as f}from"./surfaceStoryShell-1SZ1MS3n.js";var p,m,h,g,_,v,y,b,x,S,C,w,T,E,D;e((()=>{d(),p=t(n(),1),c(),l(),m=s(),{action:h}=__STORYBOOK_MODULE_ACTIONS__,g={title:`Inputs & Controls/ColorInput`,component:o,tags:[`autodocs`],argTypes:{surface:{control:`inline-radio`,options:r},size:{control:`inline-radio`,options:i},state:{control:`inline-radio`,options:a},disabled:{control:`boolean`},hideLabel:{control:`boolean`},disablePicker:{control:`boolean`},loading:{control:`boolean`},label:{control:`text`},placeholder:{control:`text`},helperText:{control:`text`},successMessage:{control:`text`},warningMessage:{control:`text`},errorMessage:{control:`text`},loadingMessage:{control:`text`}},args:{surface:`default`,id:`playground-color-input`,label:`Brand color`,placeholder:`000000`,size:`medium`,helperText:`Enter a hex value or pick one from the palette`,errorMessage:`Please enter a valid hex color`,warningMessage:`This color may not meet contrast requirements`,successMessage:`Color saved`,loadingMessage:`Saving...`},parameters:{design:u(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=5088-819&m=dev`),docs:{description:{component:"Hex color input with an integrated ColorPicker popover. Use for theme, brand, and component color settings. The leading `#` is visual only - the value is normalised to `#RRGGBB`."}}}},_={args:{},render:e=>{let[t,n]=(0,p.useState)(`#0291FF`);return(0,m.jsxs)(`div`,{className:`gap-md flex flex-col`,children:[(0,m.jsx)(o,{...e,value:t,onValueChange:n}),(0,m.jsxs)(`div`,{className:`typography-label text-text-accent`,children:[`Current value: `,(0,m.jsx)(`code`,{children:t??`-`})]})]})}},v=({size:e})=>{let[t,n]=(0,p.useState)(`#10B981`);return(0,m.jsx)(o,{id:`color-input-${e}`,label:`${e.charAt(0).toUpperCase()+e.slice(1)} size`,size:e,value:t,onValueChange:n})},y={parameters:{controls:{disable:!0}},render:()=>(0,m.jsx)(`div`,{className:`gap-lg flex flex-col`,children:i.map(e=>(0,m.jsx)(v,{size:e},e))})},b={args:{id:`error-color-input`,label:`Accent color`,state:`error`,errorMessage:`Please enter a valid hex color`},render:e=>{let[t,n]=(0,p.useState)(`#GGGGGG`);return(0,m.jsx)(o,{...e,value:t,onValueChange:n})}},x={args:{id:`warning-color-input`,label:`Background color`,state:`warning`,warningMessage:`Low contrast against body text`},render:e=>{let[t,n]=(0,p.useState)(`#F0F1F2`);return(0,m.jsx)(o,{...e,value:t,onValueChange:n})}},S={args:{id:`success-color-input`,label:`Brand color`,state:`success`,successMessage:`Looks good!`},render:e=>{let[t,n]=(0,p.useState)(`#0D9467`);return(0,m.jsx)(o,{...e,value:t,onValueChange:n})}},C={args:{id:`loading-color-input`,label:`Theme color`,loading:!0,loadingMessage:`Saving...`},render:e=>{let[t,n]=(0,p.useState)(`#FF923F`);return(0,m.jsx)(o,{...e,value:t,onValueChange:n})}},w={args:{id:`disabled-color-input`,label:`Theme color`,disabled:!0},render:e=>(0,m.jsx)(o,{...e,defaultValue:`#6366F1`,onValueChange:()=>{}})},T={args:{id:`no-picker-color-input`,label:`Hex value`,disablePicker:!0,helperText:`Type a hex value - picker is disabled`},render:e=>{let[t,n]=(0,p.useState)(`#15171A`);return(0,m.jsx)(o,{...e,value:t,onValueChange:n})}},E={render:e=>(0,m.jsx)(f,{children:t=>(0,m.jsx)(o,{...e,id:`color-input-${t}`,surface:t,value:`#6366F1`,onValueChange:h(`onValueChange`)})})},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  args: {},
  render: args => {
