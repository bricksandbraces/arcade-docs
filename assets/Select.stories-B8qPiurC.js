import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Do as n,Gr as r,Kr as i,fo as a,gi as o,la as s,rr as c,t as l,vt as u}from"./iframe-4eq8CAan.js";import{n as d,t as f}from"./onCardStoryShell-DHMIqAgP.js";var p,m,h,g,_,v,y,b,x,S;e((()=>{p=t(n(),1),o(),l(),d(),m=a(),h=[{value:`apple`,label:`Apple`},{value:`banana`,label:`Banana`},{value:`orange`,label:`Orange`}],g={title:`Overlays & Menus/Dropdown/Select`,component:u,tags:[`autodocs`],args:{options:h,placeholder:`Choose an option`,size:`medium`,state:`default`,disabled:!1,inline:!1,fullWidth:!1},argTypes:{size:{control:`inline-radio`,options:r},inline:{control:`boolean`},fullWidth:{control:`boolean`},disabled:{control:`boolean`},placeholder:{control:`text`},label:{control:`text`},helperText:{control:`text`},errorMessage:{control:`text`},warningMessage:{control:`text`},successMessage:{control:`text`},hideLabel:{control:`boolean`},state:{control:`inline-radio`,options:i}},render:e=>{let[t,n]=(0,p.useState)(e.value);return(0,m.jsx)(u,{...e,value:t,onChange:e=>{n(e)}})},parameters:{docs:{description:{component:`Native select field styled to match the design system. Use when the browser's built-in picker is acceptable and you don't need a rich Dropdown menu.`}}}},_={args:{id:`playground-select`,label:`Label`,helperText:`Helper text below the field.`,errorMessage:`Error message`,warningMessage:`Warning message`,successMessage:`Erledigt`}},v={args:{id:`slot-select`,label:`Label`,helperText:`Helper text below the field.`,successMessage:`Saved`,state:`success`},render:e=>{let[t,n]=(0,p.useState)(e.value);return(0,m.jsx)(u,{...e,value:t,onChange:e=>{n(e)},leadingSlot:(0,m.jsx)(s,{size:12,className:`stroke-icon-info`}),trailingSlot:(0,m.jsx)(`span`,{className:`typography-label-small text-text-accent`,children:`Slot`})})}},y={args:{id:`on-card-select`,label:`Label`,helperText:`Helper text below the field.`,errorMessage:`Error message`,warningMessage:`Warning message`,successMessage:`Erledigt`,surface:`onCard`},render:e=>{let[t,n]=(0,p.useState)(e.value);return(0,m.jsx)(f,{children:(0,m.jsx)(u,{...e,value:t,onChange:e=>{n(e)}})})}},b={parameters:{controls:{disable:!0}},render:()=>(0,m.jsxs)(`div`,{className:`gap-xlg grid max-w-[720px] grid-cols-1 md:grid-cols-2`,children:[(0,m.jsx)(u,{id:`overview-default`,label:`Default + helper`,placeholder:`Select an option`,helperText:`Optional helper text.`,options:h}),(0,m.jsx)(u,{id:`overview-error`,label:`Error + notification`,placeholder:`Select an option`,state:`error`,errorMessage:`This field has an error.`,helperText:`Hidden while error is shown.`,options:h}),(0,m.jsx)(u,{id:`overview-warning`,label:`Warning + notification`,placeholder:`Select an option`,state:`warning`,warningMessage:`Please review your choice.`,options:h}),(0,m.jsx)(u,{id:`overview-success`,label:`Success`,placeholder:`Select an option`,state:`success`,successMessage:`Saved`,helperText:`Success still shows helper when no error/warning.`,options:h,value:`apple`})]})},x={args:{showLabel:!0},argTypes:{showLabel:{control:`boolean`}},render:({showLabel:e})=>(0,m.jsx)(c,{showLabel:e})},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  args: {
