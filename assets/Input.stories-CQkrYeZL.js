import{n as e}from"./chunk-jRWAZmH_.js";import{Br as t,Li as n,Os as r,Ri as i,t as a,zi as o}from"./iframe-jImnWlHt.js";import{n as s,t as c}from"./figmaDesign-DDiUnvXT.js";import{n as l,t as u}from"./onCardStoryShell-CDtBF3C8.js";var d,f,p,m,h,g,_,v,y;e((()=>{a(),l(),s(),d=r(),{action:f}=__STORYBOOK_MODULE_ACTIONS__,p={title:`Inputs & Controls/Input`,component:n,tags:[`autodocs`],argTypes:{state:{control:{type:`select`},options:o},size:{control:{type:`select`},options:i}},parameters:{design:c(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2345-1233`),docs:{description:{component:`Unlabelled text input primitive used to build TextInput and other form fields. Use directly only when a custom label layout is needed.`}}}},m={args:{id:`input`,"aria-label":`Label`,disabled:!1,loading:!1,state:`default`,trailingSlot:void 0,placeholder:`Placeholder`,onChange:f(`onChange`)},argTypes:{}},h={args:{...m.args,id:`slot-input`,defaultValue:`123.45`,leadingSlot:(0,d.jsx)(`span`,{className:`typography-label text-text-accent inline-flex min-w-[3ch] justify-center`,children:`EUR`}),trailingSlot:(0,d.jsx)(`span`,{className:`typography-label text-text-accent inline-flex min-w-[3ch] justify-center`,children:`NET`}),trailingSlotPadding:`inset`}},g={args:{...m.args,surface:`onCard`},render:e=>(0,d.jsx)(u,{children:(0,d.jsx)(n,{...e})})},_={parameters:{controls:{disable:!0}},render:e=>(0,d.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${i.length}, minmax(0, 1fr))`},children:[{loading:!1,disabled:!1,state:`default`},{loading:!1,disabled:!1,state:`error`},{loading:!1,disabled:!1,state:`warning`},{loading:!1,disabled:!1,state:`success`},{loading:!1,disabled:!1,state:`success`,trailingSlot:`Done`},{loading:!0,disabled:!1,state:`default`},{loading:!0,disabled:!0,state:`default`},{loading:!1,disabled:!0,state:`default`}].map((t,r)=>i.map((i,a)=>{let o=`${i}-${t.loading?`loading`:`default`}-${t.disabled?`disabled`:`enabled`}-${t.state===`error`?`error`:`noerror`}-${t.state===`success`?`success`:`nosuccess`}`;return(0,d.jsxs)(`div`,{style:{gridColumn:`${a+1} / span 1`,gridRow:`${r+1} / span 1`},children:[e.showLabels&&(0,d.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,i,t.loading?`, loading`:``,t.disabled?`, disabled`:``,t.state]}),(0,d.jsx)(`div`,{className:`gap-sm flex flex-row`,children:(0,d.jsx)(n,{id:`${o}-input`,"aria-label":`Input ${i} ${t.state}`,defaultValue:`Text`,placeholder:`Placeholder`,size:i,loading:t.loading,disabled:t.disabled,state:t.state,className:`w-[192px]`})})]},o)}))}),args:{showLabels:!1}},v={render:()=>(0,d.jsx)(t,{})},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    id: "input",
    "aria-label": "Label",
    disabled: false,
