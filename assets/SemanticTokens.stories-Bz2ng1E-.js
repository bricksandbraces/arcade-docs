import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{La as n,Ra as r,Ua as i,hn as a,io as o,mn as s,t as c,yo as l}from"./iframe-CSdI4VNE.js";import{n as u}from"./storybook-DXJ4jJ09.js";import{C as d,N as f,S as p,T as m,h,k as g,s as _,t as v,w as y}from"./docs-BTBqcnvd.js";var b,x,S,C,w,T;e((()=>{c(),r(),b=t(i(),1),x=t(l(),1),v(),S=o(),C={title:`Arcade Foundation/Colors/Color Tokens`,parameters:{a11y:{test:`off`},chromatic:{disableSnapshot:!0}}},w=()=>{let[e,t]=(0,x.useState)(`light`),r=g(n.light),i=()=>(0,S.jsx)(`div`,{className:p,children:(0,S.jsx)(`div`,{className:d,children:r.map(({group:t,items:n})=>(0,S.jsxs)(`section`,{className:y,children:[(0,S.jsx)(`h2`,{className:`typography-headline-03 text-text font-light capitalize`,children:t}),(0,S.jsxs)(`div`,{role:`row`,className:(0,b.default)(m,f),children:[(0,S.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Name`}),(0,S.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Description`}),(0,S.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`HEX value`}),(0,S.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Preview`})]}),(0,S.jsx)(`div`,{className:`gap-sm flex flex-col`,role:`presentation`,children:n.map(({key:t})=>(0,S.jsx)(_,{tokenKey:t,previewTheme:e,description:h(t)},t))})]},t))})});return(0,S.jsx)(`div`,{className:`gap-xlg text-text typography-body flex w-full min-w-0 flex-col`,children:(0,S.jsxs)(`div`,{className:`gap-xlg flex min-w-0 flex-col`,children:[(0,S.jsx)(u,{title:`Color Tokens`,className:`px-[80px] pt-[80px] pb-[48px]`}),(0,S.jsx)(`div`,{className:`semantic-tokens-tabs`,children:(0,S.jsxs)(a,{selectedId:e,onChange:e=>{(e===`light`||e===`dark`)&&t(e)},size:`md`,radius:`sharp`,withSpacing:!1,tabListClassName:`ml-[calc(80px-2*var(--spacing-lg)+4px)] mr-[calc(80px-var(--spacing-lg))]`,children:[(0,S.jsx)(s,{id:`light`,label:`Light mode`,children:(0,S.jsx)(`div`,{className:`gap-lg -m-lg flex flex-col`,children:i()})}),(0,S.jsx)(s,{id:`dark`,label:`Dark mode`,children:(0,S.jsx)(`div`,{className:`gap-lg -m-lg flex flex-col`,children:i()})})]})})]})})},w.__docgenInfo={description:``,methods:[],displayName:`ColorTokens`},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`() => {
