import{n as e}from"./chunk-jRWAZmH_.js";import{Ao as t,Ji as n,Ps as r,Qa as i,ao as a,ca as o,i as s,la as c,ya as l,ys as u}from"./iframe-BNKOs80O.js";import{n as d,t as f}from"./figmaDesign-CO6i5n9C.js";import{n as p,t as m}from"./figmaFrame-BQpGN_j4.js";var h,g,_,v,y,b,x,S;e((()=>{s(),c(),r(),d(),p(),h=u(),{action:g}=__STORYBOOK_MODULE_ACTIONS__,_={parameters:{design:f(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=5778-39560`),docs:{description:{component:"A main action next to a chevron that opens related actions. The chevron only reports its state - wire it to a `ContextMenu` or `Dropdown` through `onMenuClick` and `menuExpanded`."}}},title:`Buttons & Actions/SplitButton`,component:o,tags:[`autodocs`],argTypes:{kind:{control:`select`,options:[`primary`,`primary-light`,`secondary`,`tertiary`]},size:{control:`select`,options:[`small`,`medium`,`large`]},disabled:{control:`boolean`},loading:{control:`boolean`},menuExpanded:{control:`boolean`}}},v={args:{label:`Button`,menuLabel:`More actions`,IconLeft:t,kind:`primary`,size:`large`,onClick:g(`onClick`),onMenuClick:g(`onMenuClick`)}},y={parameters:{controls:{disable:!0}},render:()=>(0,h.jsx)(o,{label:`Save`,menuLabel:`More save options`,IconLeft:a,kind:`primary`,size:`large`,onClick:g(`onClick`),menu:(0,h.jsx)(n,{title:`More save options`,size:`medium`,placement:`bottom-end`,items:[{label:`Save as draft`,icon:i,onClick:g(`saveAsDraft`)},{label:`Save and close`,icon:a,onClick:g(`saveAndClose`)},{label:`Discard changes`,icon:l,danger:!0,showDivider:!0,onClick:g(`discard`)}]})})},b={parameters:{controls:{disable:!0}},render:()=>(0,h.jsx)(m,{node:`5778:39560`,width:164,height:48,children:(0,h.jsx)(o,{label:`Button`,menuLabel:`More actions`,IconLeft:t,kind:`primary`,size:`large`})})},x={parameters:{controls:{disable:!0}},render:()=>(0,h.jsx)(`div`,{className:`gap-lg flex flex-col items-start`,children:[`primary`,`primary-light`,`secondary`,`tertiary`].map(e=>(0,h.jsxs)(`div`,{className:`gap-md flex flex-row items-center`,children:[[`small`,`medium`,`large`].map(n=>(0,h.jsx)(o,{label:`Button`,menuLabel:`More actions`,IconLeft:t,kind:e,size:n,onClick:g(`onClick`),onMenuClick:g(`onMenuClick`)},`${e}-${n}`)),(0,h.jsx)(o,{label:`Button`,menuLabel:`More actions`,IconLeft:t,kind:e,size:`large`,disabled:!0})]},e))})},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    label: "Button",
