import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ai as n,ct as r,lt as i,ma as a,oo as o,ot as s,t as c,ui as l,ut as u,va as d,wi as f,xa as p,xo as m}from"./iframe-VcwlW7ek.js";var h,g,_,v,y,b,x,S,C,w,T;e((()=>{c(),l(),h=t(m(),1),g=o(),_={title:`Layout & Structure/Header/Header`,component:s,tags:[`autodocs`],argTypes:{showBackButton:{control:`boolean`},showTitleDivider:{control:`boolean`}},parameters:{layout:`fullscreen`,docs:{description:{component:"Top app bar with optional logo (`logo` + {@link HeaderLogo}), navigation links, and actions."}}}},v=()=>(0,g.jsxs)(`div`,{className:`gap-xs flex items-center`,children:[(0,g.jsx)(p,{kind:`ghost`,IconLeft:f,size:`medium`,"aria-label":`Settings`,tooltipContent:`Settings`,tooltipOpenDelayMs:0}),(0,g.jsx)(p,{kind:`ghost`,IconLeft:a,size:`medium`,"aria-label":`Notifications`,tooltipContent:`Notifications`,tooltipOpenDelayMs:0}),(0,g.jsx)(p,{kind:`ghost`,IconLeft:n,size:`medium`,"aria-label":`Menu`,tooltipContent:`Menu`,tooltipOpenDelayMs:0})]}),y=e=>`/arcade-docs/assets/${e}`,b=()=>(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(`img`,{src:y(`logo_default-dark.svg`),alt:``,className:`h-[20px] w-auto max-w-full dark:hidden`}),(0,g.jsx)(`img`,{src:y(`logo_default-light.svg`),alt:``,className:`hidden h-[20px] w-auto max-w-full dark:block`})]}),x={render:({showBackButton:e=!0,showTitleDivider:t=!0})=>{let[n,a]=(0,h.useState)(`g1-b`);return(0,g.jsx)(s,{title:`Dashboard`,showBackButton:e,showTitleDivider:t,backButton:(0,g.jsx)(p,{kind:`ghost`,IconLeft:d,size:`medium`,"aria-label":`Go back`,tooltipContent:`Go back`,tooltipOpenDelayMs:0}),linkGroupOne:(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(u,{selected:n===`g1-a`,onClick:()=>a(`g1-a`),children:`Link`}),(0,g.jsx)(u,{selected:n===`g1-b`,onClick:()=>a(`g1-b`),children:`Link`}),(0,g.jsx)(u,{selected:n===`g1-c`,onClick:()=>a(`g1-c`),children:`Link`})]}),linkGroupTwo:(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(u,{selected:n===`g2-a`,onClick:()=>a(`g2-a`),children:`Link`}),(0,g.jsx)(r,{selected:n===`g2-dropdown`,items:[{label:`Link`,onClick:()=>a(`g2-dropdown`)},{label:`Link`,onClick:()=>a(`g2-dropdown`)},{label:`Link`,onClick:()=>a(`g2-dropdown`)}],children:(0,g.jsx)(i,{children:`Link`})}),(0,g.jsx)(u,{selected:n===`g2-c`,onClick:()=>a(`g2-c`),children:`Link`})]}),actions:(0,g.jsx)(v,{})})},args:{showBackButton:!0,showTitleDivider:!0},parameters:{layout:`fullscreen`,controls:{include:[`showBackButton`,`showTitleDivider`]}}},S={parameters:{layout:`fullscreen`,docs:{description:{story:"Optional `logo` slot — pass SVG/img children; `Header` wraps them in `HeaderLogo`. Use `logoHref` for a home link."}}},render:()=>(0,g.jsx)(s,{title:`Dashboard`,showBackButton:!1,logo:(0,g.jsx)(b,{}),logoHref:`#`,actions:(0,g.jsx)(v,{})})},C={parameters:{layout:`fullscreen`,docs:{description:{story:"Pass `titleHref` to make the title a link (e.g. back to Home). It uses `linkComponent` when provided (framework `Link`), otherwise a native anchor. `titleLinkLabel` overrides the accessible name, which defaults to the visible title."}}},render:()=>(0,g.jsx)(s,{title:`Dashboard`,titleHref:`#`,titleLinkLabel:`Go to home`,showBackButton:!1,actions:(0,g.jsx)(v,{})})},w={args:{showBackButton:!0},parameters:{layout:`fullscreen`,controls:{include:[`showBackButton`]},docs:{description:{story:"Header with exactly two top-level navigation links rendered as `HeaderButton`s. Click a link to make it the active one. Use when the app has only a couple of primary sections."}}},render:function({showBackButton:e=!0}){let[t,n]=(0,h.useState)(`products`);return(0,g.jsx)(s,{title:`Dashboard`,showBackButton:e,backButton:(0,g.jsx)(p,{kind:`ghost`,IconLeft:d,size:`medium`,"aria-label":`Go back`}),linkGroupOne:(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(u,{selected:t===`products`,onClick:()=>n(`products`),children:`Products`}),(0,g.jsx)(u,{selected:t===`resources`,onClick:()=>n(`resources`),children:`Resources`})]}),actions:(0,g.jsx)(v,{})})}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  render: ({
    showBackButton = true,
