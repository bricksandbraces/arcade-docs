import{n as e}from"./chunk-jRWAZmH_.js";import{Da as t,Li as n,Oa as r,Pr as i,go as a,ra as o,t as s,tr as c,yi as l}from"./iframe-KaqYBI6z.js";var u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{s(),l(),u=a(),d={none:void 0,IconArrowRight:t,IconArrowLeft:r,IconExternalLink:o,Icon123:n},f=[`sm`,`md`,`lg`],p={title:`Navigation/Link`,component:i,tags:[`autodocs`],args:{href:`#`,label:`Link`,disabled:!1,inline:!1,size:`md`,leadingIcon:!1,icon:`IconArrowRight`},parameters:{docs:{description:{component:`Anchor styled as a text link, with optional leading or trailing icon. Use for in-page navigation and external references.`}}}},m={render:e=>{let{icon:t,...n}=e,r=d[t];return(0,u.jsx)(i,{...n,icon:r})},argTypes:{size:{description:`Typography scale`,control:{type:`inline-radio`},options:[...f]},inline:{description:`Inline (link style) vs accent (standalone)`,control:`boolean`},disabled:{control:`boolean`},leadingIcon:{control:`boolean`},label:{control:`text`},href:{control:`text`},icon:{control:{type:`select`},options:Object.keys(d)},component:{control:{disable:!0}},linkComponent:{control:{disable:!0}}}},h=[{inline:!1,disabled:!1,leadingIcon:!1},{inline:!1,disabled:!1,leadingIcon:!0},{inline:!1,disabled:!0,leadingIcon:!1},{inline:!0,disabled:!1,leadingIcon:!1},{inline:!0,disabled:!0,leadingIcon:!1}],g={sm:`typography-label`,md:`typography-body-small`,lg:`typography-body`},_={parameters:{controls:{disable:!0}},render:e=>{let n=[...f].toReversed();return(0,u.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${n.length}, minmax(0, 1fr))`},children:h.map((r,a)=>n.map((n,s)=>{let c=`${n}-${r.inline?`inline`:`accent`}-${r.disabled?`disabled`:`enabled`}-${r.leadingIcon?`leading`:`trailing`}`;return(0,u.jsxs)(`div`,{style:{gridColumn:`${s+1} / span 1`,gridRow:`${a+1} / span 1`},children:[e.showLabels&&(0,u.jsxs)(`p`,{className:`${g[n]} text-text`,children:[`size=`,n,`, `,r.inline?`inline`:`accent`,r.disabled?`, disabled`:`, enabled`,r.leadingIcon?`, leading icon`:`, trailing icon`]}),r.inline?(0,u.jsxs)(`p`,{className:`${g[n]} text-text`,children:[`Before`,` `,(0,u.jsx)(i,{href:`#`,label:`link`,size:n,inline:!0,disabled:r.disabled,icon:o,leadingIcon:r.leadingIcon}),` `,`after.`]}):(0,u.jsx)(i,{href:`#`,label:`Link`,size:n,inline:!1,disabled:r.disabled,icon:t,leadingIcon:r.leadingIcon})]},c)}))})},args:{showLabels:!1}},v={render:()=>(0,u.jsx)(c,{})},y=({href:e,children:t,...n})=>(0,u.jsx)(`a`,{...n,href:e,"data-next-link":`true`,children:t}),b={parameters:{controls:{disable:!0},docs:{description:{story:"Plug in `next/link`'s `Link` (or any equivalent) via `linkComponent` so consumers preserve SPA navigation. The rendered anchor below carries a `data-next-link` attribute set by the mock component to make the substitution visible."}}},render:()=>(0,u.jsx)(i,{href:`/dashboard`,label:`Open dashboard`,linkComponent:y})},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: args => {
    const {
      icon,
      ...rest
