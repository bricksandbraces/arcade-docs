import{n as e}from"./chunk-jRWAZmH_.js";import{Ti as t,Xr as n,Yr as r,ka as i,qt as a,t as o,xi as s,yo as c}from"./iframe-BXRL_JkN.js";import{n as l,t as u}from"./onCardStoryShell-CrKqyaH-.js";var d,f,p,m,h,g,_,v,y;e((()=>{s(),o(),l(),d=c(),f={title:`Inputs & Controls/InputGroup`,component:a,tags:[`autodocs`],argTypes:{size:{control:`inline-radio`,options:r},disabled:{control:`boolean`},loading:{control:`boolean`},successMessage:{control:`text`},errorMessage:{control:`text`},hideLabel:{control:`boolean`},label:{control:`text`},placeholder:{control:`text`},prefix:{control:`text`},suffix:{control:`text`},state:{control:`inline-radio`,options:n}},args:{errorMessage:`Error Message`,warningMessage:`Warning Message`,successMessage:`Success`,loadingMessage:`Loading...`,helperText:`Helper Text`,id:`playground-input-group`,label:`Website`,placeholder:`yourdomain`,prefix:`https://`,suffix:`.com`,size:`medium`},parameters:{docs:{description:{component:"Text input with a prefix and/or suffix affix. Use the affixes to provide units, protocols, domains, or icons that contextualize the input value. The middle field is a regular text input that supports the same validation states as `TextInput`."}}}},p={args:{}},m={args:{id:`prefix-only-input-group`,label:`Amount`,placeholder:`0.00`,prefix:`€`,suffix:void 0}},h={args:{id:`suffix-only-input-group`,label:`Weight`,placeholder:`0`,prefix:void 0,suffix:`kg`}},g={args:{id:`icon-affix-input-group`,label:`Email address`,placeholder:`name@example`,prefix:(0,d.jsx)(i,{className:`stroke-icon-accent size-4`,"aria-hidden":!0}),suffix:(0,d.jsx)(t,{className:`stroke-icon-accent size-4`,"aria-hidden":!0})}},_={args:{surface:`onCard`},render:e=>(0,d.jsx)(u,{children:(0,d.jsx)(a,{...e})})},v={parameters:{controls:{disable:!0}},args:{showLabels:!1},render:e=>{let t=r.toReversed().flatMap(e=>[{size:e,loading:!1,disabled:!1,state:`default`},{size:e,loading:!1,disabled:!0,state:`default`},{size:e,loading:!0,disabled:!1,state:`default`},{size:e,loading:!1,disabled:!1,state:`error`},{size:e,loading:!1,disabled:!1,state:`success`}]),i=n;return(0,d.jsx)(`div`,{className:`gap-xlg grid pb-[128px]`,style:{display:`grid`,gridTemplateColumns:`repeat(${i.length}, minmax(0, 1fr))`},children:t.map((t,n)=>i.map((r,i)=>{let o=`${r}-${t.size}-${t.loading?`loading`:`default`}-${t.disabled?`disabled`:`enabled`}-${t.state}`;return(0,d.jsxs)(`div`,{style:{gridColumn:`${i+1} / span 1`,gridRow:`${n+1} / span 1`},children:[e.showLabels&&(0,d.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,t.size,`, state=`,r,t.loading?`, loading`:``,t.disabled?`, disabled`:``,t.state===`default`?``:`, status=${t.state}`]}),(0,d.jsxs)(`div`,{className:`gap-sm flex flex-col`,children:[(0,d.jsx)(`div`,{className:`pb-[32px]`,children:(0,d.jsx)(a,{id:`${r}-${t.size}-${n}-empty`,label:`Label`,placeholder:`Placeholder`,prefix:`https://`,suffix:`.com`,helperText:`Helper Text`,loadingMessage:`Loading...`,errorMessage:`Error Message`,successMessage:`Success`,warningMessage:`Warning Message`,size:t.size,state:t.state,loading:t.loading,disabled:t.disabled})}),(0,d.jsx)(`div`,{className:`pb-[32px]`,children:(0,d.jsx)(a,{id:`${r}-${t.size}-${n}-filled`,label:`Label`,placeholder:`Placeholder`,prefix:`https://`,suffix:`.com`,helperText:`Helper Text`,loadingMessage:`Loading...`,errorMessage:`Error Message`,successMessage:`Success`,warningMessage:`Warning Message`,size:t.size,state:t.state,loading:t.loading,disabled:t.disabled,defaultValue:`example`})})]})]},o)}))})}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {}
