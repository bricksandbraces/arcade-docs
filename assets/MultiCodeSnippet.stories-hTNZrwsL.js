import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a0 as a}from"./ContextMenu-DwPyJibk.js";import"./index-CY-HDqYb.js";import"./index-A6zbrgSY.js";import"./index-DWvd7WUe.js";import"./index-BDYMFBcC.js";const s=`import React, { useState, useEffect } from "react";
...
};`,x={title:"Fabian Supervision/CodeSnippet/MultiCodeSnippet",component:a,parameters:{layout:"padded"}},t={render:()=>e.jsxs("div",{className:"gap-xlg flex max-w-3xl flex-col",children:[e.jsxs("div",{className:"gap-sm flex flex-col",children:[e.jsx("p",{className:"typography-body-small text-text",children:"280px height"}),e.jsx(a,{code:s,language:"typescript",defaultState:"collapsed",collapsedLineCount:6,scrollerMaxHeight:"280px"})]}),e.jsxs("div",{className:"gap-sm flex flex-col",children:[e.jsx("p",{className:"typography-body-small text-text",children:"64px height"}),e.jsx(a,{code:s,language:"typescript",defaultState:"collapsed",collapsedLineCount:6,scrollerMaxHeight:"64px"})]})]})};var o,l,r;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`{
