import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Pa as n,Po as r,bi as i,io as a,jt as o,t as s,vt as c,yi as l,yo as u}from"./iframe-BXRL_JkN.js";import{n as d,t as f}from"./react-BAZ1bsur.js";import{i as p,n as ee}from"./storybook-B4lsw9OO.js";import{C as m,S as h,T as g,t as _,w as v}from"./docs-DY_FIgiZ.js";function y(e){return e.startsWith(`animation-duration-`)?`--${e}`:e.startsWith(`animation-ease-`)?`--ease-${e.replace(`animation-ease-`,``)}`:e===`animation-bounce`?`--animation-bounce`:``}var b,x,S,C,w,T,E,D,O,k,A,j,M,N;e((()=>{b=t(r(),1),s(),x=t(a(),1),f(),_(),S=u(),C=[`animation-ease-accelerate-lg`,`animation-ease-accelerate-md`,`animation-ease-accelerate-sm`,`animation-ease-decelerate-lg`,`animation-ease-decelerate-md`,`animation-ease-decelerate-sm`,`animation-ease-ease`,`animation-ease-linear`,`animation-bounce`],w=.35,T=`fast-spatial-spring`,E=[`animation-duration-xs`,`animation-duration-sm`,`animation-duration-md`,`animation-duration-lg`,`animation-duration-xlg`,`animation-duration-2xlg`,`animation-duration-3xlg`],D=[{value:`translateX`,label:`Translate X`},{value:`translateY`,label:`Translate Y`},{value:`scale`,label:`Scale`},{value:`rotate`,label:`Rotate`},{value:`opacity`,label:`Opacity`},{value:`borderRadius`,label:`Border radius`}],O=[...C.map(e=>({value:e,label:e.replace(`animation-ease-`,``).replace(`animation-`,``)})),{value:T,label:`fast spatial spring`}],k=E.map(e=>({value:e,label:e.replace(`animation-duration-`,``)})),A=`grid-cols-[minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)]`,j={title:`Arcade Foundation/Animations`,parameters:{a11y:{test:`off`},chromatic:{disableSnapshot:!0}}},M=()=>{let[e,t]=(0,b.useState)(`translateX`),[r,a]=(0,b.useState)(`animation-ease-ease`),[s,u]=(0,b.useState)(`animation-duration-md`),[f,_]=(0,b.useState)(!1),[j,M]=(0,b.useState)(240),[N,P]=(0,b.useState)(72),[F,I]=(0,b.useState)(72),[L,R]=(0,b.useState)(120),[z,B]=(0,b.useState)(120),[V,H]=(0,b.useState)(1),[U,W]=(0,b.useState)(.25),[G,K]=(0,b.useState)(25),[q,J]=(0,b.useState)(8),[Y,X]=(0,b.useState)(24),Z=(0,b.useMemo)(()=>{let t=getComputedStyle(document.documentElement),n=r===T,a=y(r),o=y(s),c=!n&&a?t.getPropertyValue(a).trim():``,l=o?i(t.getPropertyValue(o)):0;return{isFastSpatialSpring:n,easing:c,durationMs:l,cssTransition:n?`transition: { type: "spring", duration: ${(l/1e3).toFixed(3)}, bounce: ${w} };`:`transition: ${e} ${l}ms ${c};`}},[s,r,e]),Q=(0,b.useMemo)(()=>{let e=getComputedStyle(document.documentElement),t=E.map(t=>({property:`Duration`,cssToken:`--${t}`,value:e.getPropertyValue(`--${t}`).trim()})),n=C.map(t=>{let n=y(t);return{property:`Easing`,cssToken:n,value:e.getPropertyValue(n).trim()}}),r={property:`Easing`,cssToken:`fastSpatialSpring`,value:`spring transition (duration controlled)`};return[...t,...n,r]},[]),te=Z.easing?l(Z.easing):`linear`,$=Z.durationMs/1e3;function ne(){let t={x:0,y:0,width:N,height:F,scale:1,rotate:0,opacity:V,borderRadius:q};if(!f)return t;switch(e){case`translateX`:return{...t,x:j};case`translateY`:return{...t,y:j};case`scale`:return{...t,width:L,height:z};case`rotate`:return{...t,rotate:G};case`opacity`:return{...t,opacity:U};case`borderRadius`:return{...t,borderRadius:Y}}}function re(){return e===`translateX`||e===`translateY`?(0,S.jsx)(`div`,{className:`w-[260px]`,children:(0,S.jsx)(o,{id:`animation-distance`,label:`Distance`,value:j,onValueChange:e=>M(e??0)})}):e===`scale`?(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(`div`,{className:`w-[260px]`,children:(0,S.jsx)(o,{id:`animation-initial-width`,label:`Initial width`,value:N,min:1,onValueChange:e=>P(e??1)})}),(0,S.jsx)(`div`,{className:`w-[260px]`,children:(0,S.jsx)(o,{id:`animation-initial-height`,label:`Initial height`,value:F,min:1,onValueChange:e=>I(e??1)})}),(0,S.jsx)(`div`,{className:`w-[260px]`,children:(0,S.jsx)(o,{id:`animation-target-width`,label:`Target width`,value:L,min:1,onValueChange:e=>R(e??1)})}),(0,S.jsx)(`div`,{className:`w-[260px]`,children:(0,S.jsx)(o,{id:`animation-target-height`,label:`Target height`,value:z,min:1,onValueChange:e=>B(e??1)})})]}):e===`opacity`?(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(`div`,{className:`w-[260px]`,children:(0,S.jsx)(o,{id:`animation-initial-opacity`,label:`Initial opacity`,value:V,min:0,max:1,step:.01,onValueChange:e=>H(e??0)})}),(0,S.jsx)(`div`,{className:`w-[260px]`,children:(0,S.jsx)(o,{id:`animation-target-opacity`,label:`Target opacity`,value:U,min:0,max:1,step:.01,onValueChange:e=>W(e??0)})})]}):e===`rotate`?(0,S.jsx)(`div`,{className:`w-[260px]`,children:(0,S.jsx)(o,{id:`animation-angle-change`,label:`Angle change`,value:G,onValueChange:e=>K(e??0)})}):(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(`div`,{className:`w-[260px]`,children:(0,S.jsx)(o,{id:`animation-initial-border-radius`,label:`Initial border radius`,value:q,min:0,onValueChange:e=>J(e??0)})}),(0,S.jsx)(`div`,{className:`w-[260px]`,children:(0,S.jsx)(o,{id:`animation-target-border-radius`,label:`Target border radius`,value:Y,min:0,onValueChange:e=>X(e??0)})})]})}return(0,S.jsx)(`div`,{className:`gap-xlg text-text typography-body flex w-full min-w-0 flex-col`,children:(0,S.jsxs)(`div`,{className:`gap-xlg flex min-w-0 flex-col`,children:[(0,S.jsx)(ee,{title:`Animation Tokens`,className:`px-[80px] pt-[80px] pb-[48px]`}),(0,S.jsx)(`div`,{className:`p-lg`,children:(0,S.jsx)(`div`,{className:`gap-lg -m-lg flex flex-col`,children:(0,S.jsx)(`div`,{className:h,children:(0,S.jsxs)(`div`,{className:m,children:[(0,S.jsxs)(`section`,{className:v,children:[(0,S.jsx)(`h2`,{className:`typography-headline-03 text-text mb-[24px] font-light`,children:`Token overview`}),(0,S.jsxs)(`div`,{role:`row`,className:(0,x.default)(g,A),children:[(0,S.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Property`}),(0,S.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`CSS Token`}),(0,S.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Value`})]}),(0,S.jsx)(`div`,{className:`gap-sm flex flex-col`,role:`presentation`,children:Q.map(e=>(0,S.jsxs)(`div`,{className:(0,x.default)(`border-border bg-background -mx-2xlg gap-lg px-2xlg py-lg border-component grid min-h-[80px] items-center rounded-lg border border-solid`,A),children:[(0,S.jsx)(`div`,{className:`min-w-0`,children:(0,S.jsx)(p,{text:e.property})}),(0,S.jsx)(`div`,{className:`min-w-0`,children:(0,S.jsx)(p,{text:e.cssToken})}),(0,S.jsx)(`div`,{className:`min-w-0`,children:(0,S.jsx)(p,{text:e.value})})]},`${e.property}-${e.cssToken}`))})]}),(0,S.jsxs)(`section`,{className:v,children:[(0,S.jsx)(`h2`,{className:`typography-headline-03 text-text mb-[24px] font-light`,children:`Playground`}),(0,S.jsxs)(`div`,{className:`flex min-w-0 flex-col gap-0`,children:[(0,S.jsxs)(`div`,{className:`flex min-w-0 items-start justify-start gap-[24px]`,children:[(0,S.jsx)(`div`,{children:(0,S.jsx)(c,{id:`animation-property`,label:`Property`,options:D,value:e,onChange:e=>{(e===`translateX`||e===`translateY`||e===`scale`||e===`rotate`||e===`opacity`||e===`borderRadius`)&&t(e)}})}),(0,S.jsx)(`div`,{children:(0,S.jsx)(c,{id:`animation-easing`,label:`Easing`,options:O,value:r,onChange:e=>{typeof e==`string`&&a(e)}})}),(0,S.jsx)(`div`,{className:`w-[260px]`,children:(0,S.jsx)(c,{id:`animation-duration`,label:`Duration`,options:k,value:s,onChange:e=>{typeof e==`string`&&u(e)}})})]}),(0,S.jsx)(`div`,{className:`flex min-w-0 flex-wrap items-start justify-start gap-[24px]`,children:re()})]}),(0,S.jsxs)(`div`,{className:`gap-lg bg-background-app border-border border-component -mx-[32px] flex min-h-[360px] min-w-0 flex-col rounded-[20px] border border-solid p-[8px]`,children:[(0,S.jsx)(`div`,{className:`bg-background-accent border-border rounded-[12px] border-[0.5px] border-solid p-[16px]`,children:(0,S.jsxs)(`div`,{className:`gap-lg flex min-w-0 items-center justify-between`,children:[(0,S.jsxs)(`div`,{className:`gap-sm flex min-w-0 items-center`,children:[(0,S.jsx)(`div`,{className:`typography-label-semibold text-text shrink-0 font-semibold`,children:`Output:`}),(0,S.jsx)(p,{text:Z.cssTransition})]}),(0,S.jsx)(n,{label:f?`Reset`:`Animate`,onClick:()=>_(e=>!e)})]})}),(0,S.jsx)(`div`,{className:`flex min-w-0 flex-1 items-start justify-start p-[24px]`,children:(0,S.jsx)(d.div,{className:`bg-background-brand size-[72px] rounded-lg`,initial:!1,animate:ne(),transition:{...Z.isFastSpatialSpring?{type:`spring`,duration:$,bounce:w}:{duration:$,ease:te}}})})]})]})]})})})})]})})},M.__docgenInfo={description:``,methods:[],displayName:`Animations`},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`() => {
