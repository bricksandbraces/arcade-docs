import{n as e}from"./chunk-jRWAZmH_.js";import{Fr as t,Hn as n,Nr as r,Pr as i,Za as a,t as o}from"./iframe-D1tTUzW4.js";import{n as s,t as c}from"./onCardStoryShell-DFZipD9f.js";var l,u,d,f,p,m,h,g,_;e((()=>{o(),s(),l=a(),{action:u}=__STORYBOOK_MODULE_ACTIONS__,d={title:`Inputs & Controls/Input`,component:r,tags:[`autodocs`],argTypes:{state:{control:{type:`select`},options:t},size:{control:{type:`select`},options:i}},parameters:{docs:{description:{component:`Unlabelled text input primitive used to build TextInput and other form fields. Use directly only when a custom label layout is needed.`}}}},f={args:{id:`input`,"aria-label":`Label`,disabled:!1,loading:!1,state:`default`,trailingSlot:void 0,placeholder:`Placeholder`,onChange:u(`onChange`)},argTypes:{}},p={args:{...f.args,id:`slot-input`,defaultValue:`123.45`,leadingSlot:(0,l.jsx)(`span`,{className:`typography-label text-text-accent inline-flex min-w-[3ch] justify-center`,children:`EUR`}),trailingSlot:(0,l.jsx)(`span`,{className:`typography-label text-text-accent inline-flex min-w-[3ch] justify-center`,children:`NET`}),trailingSlotPadding:`inset`}},m={args:{...f.args,surface:`onCard`},render:e=>(0,l.jsx)(c,{children:(0,l.jsx)(r,{...e})})},h={parameters:{controls:{disable:!0}},render:e=>(0,l.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${i.length}, minmax(0, 1fr))`},children:[{loading:!1,disabled:!1,state:`default`},{loading:!1,disabled:!1,state:`error`},{loading:!1,disabled:!1,state:`warning`},{loading:!1,disabled:!1,state:`success`},{loading:!1,disabled:!1,state:`success`,trailingSlot:`Done`},{loading:!0,disabled:!1,state:`default`},{loading:!0,disabled:!0,state:`default`},{loading:!1,disabled:!0,state:`default`}].map((t,n)=>i.map((i,a)=>{let o=`${i}-${t.loading?`loading`:`default`}-${t.disabled?`disabled`:`enabled`}-${t.state===`error`?`error`:`noerror`}-${t.state===`success`?`success`:`nosuccess`}`;return(0,l.jsxs)(`div`,{style:{gridColumn:`${a+1} / span 1`,gridRow:`${n+1} / span 1`},children:[e.showLabels&&(0,l.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,i,t.loading?`, loading`:``,t.disabled?`, disabled`:``,t.state]}),(0,l.jsx)(`div`,{className:`gap-sm flex flex-row`,children:(0,l.jsx)(r,{id:`${o}-input`,"aria-label":`Input ${i} ${t.state}`,defaultValue:`Text`,placeholder:`Placeholder`,size:i,loading:t.loading,disabled:t.disabled,state:t.state,className:`w-[192px]`})})]},o)}))}),args:{showLabels:!1}},g={render:()=>(0,l.jsx)(n,{})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
    id: "input",
    "aria-label": "Label",
    disabled: false,
