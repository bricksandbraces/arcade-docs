import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{ab as _,ac as b}from"./ContextMenuList-YiUAHO3R.js";import"./index-CY-HDqYb.js";import"./index-DWvd7WUe.js";import"./index-BDYMFBcC.js";import"./index-ZRCHFLd-.js";import"./borders-N_bRvfGw.js";import"./colors-mvAPBTAn.js";const B={title:"WIP Components/FileUpload/Extension",component:b,argTypes:{extension:{control:"inline-radio",options:_}}},s={args:{extension:"pdf"}},r={render:()=>e.jsx("div",{className:"gap-md flex items-center",children:_.map(p=>e.jsxs("div",{className:"gap-xs flex flex-col items-center",children:[e.jsx(b,{extension:p}),e.jsx("span",{className:"text-text-secondary text-xs",children:p})]},p))})},n={args:{extension:"pdf"}},a={args:{extension:"png"}},o={args:{extension:"jpg"}},t={args:{extension:"json"}},c={args:{extension:"csv"}},i={args:{extension:"svg"}};var m,d,x;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    extension: "pdf"
  }
