import{n as e}from"./chunk-jRWAZmH_.js";import{Ea as t,In as n,Ln as r,da as i,t as a}from"./iframe-BY85Oiue.js";var o,s,c,l,u,d;e((()=>{a(),t(),o=i(),{action:s}=__STORYBOOK_MODULE_ACTIONS__,c={title:`Display & Data/Badge/Badge`,component:n,tags:[`autodocs`],parameters:{docs:{description:{component:`Small colored label for status, counts, or metadata. Use inline next to text to flag state or categorize items.`}}}},l=({text:e,showCloseButton:t,...r})=>(0,o.jsx)(`div`,{children:(0,o.jsx)(n,{...r,type:t?`filter`:void 0,onDelete:t?s(`onDelete`):void 0,children:e})}),l.args={color:`red`,text:`Badge`,showCloseButton:!1},l.argTypes={color:{description:`The color of the badge`,control:{type:`select`},options:r},showCloseButton:{name:`Close button`,description:`Renders the filter badge with a dismiss control`,control:{type:`boolean`},table:{category:`Playground`}},text:{description:`Label text`,control:{type:`text`},table:{category:`Playground`}}},u={render:e=>{let{text:t,showCloseButton:i,...a}=e;return(0,o.jsx)(`div`,{className:`gap-x-md flex`,children:r.map(e=>(0,o.jsx)(n,{color:e,...a,type:i?`filter`:void 0,onDelete:i?s(`onDelete`):void 0,children:t},e))})},args:{text:`Badge`,showCloseButton:!1},argTypes:{color:{control:!1,table:{disable:!0}},type:{control:!1,table:{disable:!0}},id:{control:!1,table:{disable:!0}},className:{control:!1,table:{disable:!0}},onDelete:{control:!1,table:{disable:!0}},buttonProps:{control:!1,table:{disable:!0}},showCloseButton:{name:`Close button`,description:`Renders each badge as a filter badge with a dismiss control`,control:{type:`boolean`},table:{category:`Overview`}},text:{description:`Label text`,control:{type:`text`},table:{category:`Overview`}}}},l.__docgenInfo={description:``,methods:[],displayName:`Playground`,props:{text:{required:!1,tsType:{name:`string`},description:``},showCloseButton:{required:!1,tsType:{name:`boolean`},description:``}}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`({
  text,
  showCloseButton,
  ...args
