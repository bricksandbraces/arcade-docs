import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ft as n,Io as r,It as i,Zo as a,t as o}from"./iframe-BikmupxW.js";import{n as s,t as c}from"./figmaDesign-CO6i5n9C.js";var l,u,d,f,p,m,h,g,_,v,y,b;e((()=>{o(),l=t(a(),1),s(),u=r(),d={title:`Feedback & Status/TrafficLight`,component:n,tags:[`autodocs`],argTypes:{state:{control:`inline-radio`,options:i},message:{control:`text`}},args:{state:`error`,message:`Your password is too vague.
...
Add a special character and numbers to it.`}},h={args:{state:`warning`,message:`Almost there. Mix upper- and lowercase letters.`}},g={args:{state:`success`,message:`Strong password.`}},_={render:()=>(0,u.jsx)(`div`,{className:`gap-xlg flex w-[368px] flex-col`,children:i.map(e=>(0,u.jsx)(n,{state:e,message:`State: ${e}`},e))})},v=[`empty`,`error`,`warning`,`success`],y={parameters:{docs:{description:{story:"Left-to-right fill (width 0%→100%, `duration-sm`, `ease-decelerate-sm`, stagger). Animation only runs when `state` updates - this story cycles every 900ms."}}},render:function(){let[e,t]=l.useState(0),r=v[e%v.length];return l.useEffect(()=>{let e=window.setInterval(()=>{t(e=>e+1)},900);return()=>window.clearInterval(e)},[]),(0,u.jsx)(`div`,{className:`w-[368px]`,children:(0,u.jsx)(n,{state:r,message:`Cycle: ${r} (ease-decelerate-sm, stagger left → right)`})})}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {}
