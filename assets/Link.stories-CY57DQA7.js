import{n as e}from"./chunk-jRWAZmH_.js";import{Di as t,Jn as n,Rr as r,Sr as i,cr as a,fn as o,t as s,zr as c}from"./iframe-ChiQ7sZy.js";var l,u,d,f,p,m,h,g,_;e((()=>{s(),n(),l=t(),u={none:void 0,IconArrowRight:r,IconArrowLeft:c,IconExternalLink:i,Icon123:a},d=[`sm`,`md`,`lg`],f={title:`Components/Link`,component:o,tags:[`autodocs`],args:{href:`#`,label:`Link`,disabled:!1,inline:!1,size:`md`,leadingIcon:!1,icon:`IconArrowRight`},parameters:{docs:{description:{component:`Anchor styled as a text link, with optional leading or trailing icon. Use for in-page navigation and external references.`}}}},p={render:e=>{let{icon:t,...n}=e,r=u[t];return(0,l.jsx)(o,{...n,icon:r})},argTypes:{size:{description:`Typography scale`,control:{type:`inline-radio`},options:[...d]},inline:{description:`Inline (link style) vs accent (standalone)`,control:`boolean`},disabled:{control:`boolean`},leadingIcon:{control:`boolean`},label:{control:`text`},href:{control:`text`},icon:{control:{type:`select`},options:Object.keys(u)},component:{control:{disable:!0}}}},m=[{inline:!1,disabled:!1,leadingIcon:!1},{inline:!1,disabled:!1,leadingIcon:!0},{inline:!1,disabled:!0,leadingIcon:!1},{inline:!0,disabled:!1,leadingIcon:!1},{inline:!0,disabled:!0,leadingIcon:!1}],h={sm:`typography-label`,md:`typography-body-small`,lg:`typography-body`},g={parameters:{controls:{disable:!0}},render:e=>{let t=[...d].toReversed();return(0,l.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${t.length}, minmax(0, 1fr))`},children:m.map((n,a)=>t.map((t,s)=>{let c=`${t}-${n.inline?`inline`:`accent`}-${n.disabled?`disabled`:`enabled`}-${n.leadingIcon?`leading`:`trailing`}`;return(0,l.jsxs)(`div`,{style:{gridColumn:`${s+1} / span 1`,gridRow:`${a+1} / span 1`},children:[e.showLabels&&(0,l.jsxs)(`p`,{className:`${h[t]} text-text`,children:[`size=`,t,`, `,n.inline?`inline`:`accent`,n.disabled?`, disabled`:`, enabled`,n.leadingIcon?`, leading icon`:`, trailing icon`]}),n.inline?(0,l.jsxs)(`p`,{className:`${h[t]} text-text`,children:[`Before`,` `,(0,l.jsx)(o,{href:`#`,label:`link`,size:t,inline:!0,disabled:n.disabled,icon:i,leadingIcon:n.leadingIcon}),` `,`after.`]}):(0,l.jsx)(o,{href:`#`,label:`Link`,size:t,inline:!1,disabled:n.disabled,icon:r,leadingIcon:n.leadingIcon})]},c)}))})},args:{showLabels:!1}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  render: args => {
    const {
      icon,
      ...rest
