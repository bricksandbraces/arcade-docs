import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ds as n,Ea as r,Hs as i,Ma as a,Vo as o,Zi as s,ga as c,ra as l,so as u,t as d,ta as f,wa as p}from"./iframe-_Ug8tvbS.js";import{n as m,t as h}from"./figmaDesign-DDiUnvXT.js";var g,_,v,y,b,x,S,C,w,T,E,D;e((()=>{d(),c(),g=t(i(),1),m(),_=n(),v={component:s,title:`Overlays & Menus/OverflowMenu`,tags:[`autodocs`],args:{title:`OverflowMenu`,size:`medium`,disabled:!1,items:[{label:`Item 1`,icon:u},{label:`Item 2`,icon:a},{label:`Item 3`,disabled:!0,icon:p},{label:`Item 4`,danger:!0,showDivider:!0,icon:r}]},argTypes:{size:{description:`Size of the OverflowMenu`,control:{type:`inline-radio`},options:f},disabled:{description:`Whether the OverflowMenu is disabled`,control:{type:`boolean`}},tooltipContent:{description:`Tooltip content for the overflow menu button (only shown if provided)`,control:{type:`text`}},menuWidthPx:{description:`Width of the desktop menu panel in px (default 230)`,control:{type:`number`}},tooltipPlacement:{description:`Placement of the tooltip`,control:{type:`select`},options:[`top`,`top-start`,`top-end`,`bottom`,`bottom-start`,`bottom-end`,`left`,`left-start`,`left-end`,`right`,`right-start`,`right-end`]}},render:e=>(0,_.jsx)(s,{...e}),parameters:{design:h(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2331-13861`),docs:{description:{component:`Icon button that opens a popover menu of secondary actions. Use on rows and cards for actions that don't deserve top-level buttons.`}}}},y={},b=[{label:`Edit`,icon:u},{label:`Rotate`,icon:a},{label:`Upload`,icon:p},{label:`Delete`,danger:!0,showDivider:!0,icon:r}],x=[{key:`default`,disabled:!1,tooltipContent:void 0},{key:`disabled`,disabled:!0,tooltipContent:void 0},{key:`tooltip`,disabled:!1,tooltipContent:`More options`}],S={parameters:{controls:{disable:!0}},render:e=>{let t=f.toReversed();return(0,_.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${x.length}, minmax(0, 1fr))`},children:t.map((t,n)=>x.map((r,i)=>{let a=`${t}-${r.key}`;return(0,_.jsxs)(`div`,{style:{gridColumn:`${i+1} / span 1`,gridRow:`${n+1} / span 1`},children:[e.showLabels&&(0,_.jsxs)(`p`,{className:`typography-body-small text-text mb-sm`,children:[`size=`,t,`, `,r.key]}),(0,_.jsx)(s,{title:`OverflowMenu ${t} ${r.key}`,size:t,disabled:r.disabled,tooltipContent:r.tooltipContent,tooltipPlacement:`bottom`,items:b})]},a)}))})},args:{showLabels:!1}},C={parameters:{controls:{disable:!0}},render:()=>(0,_.jsxs)(`div`,{className:`gap-sm flex flex-col items-start`,children:[(0,_.jsx)(`p`,{className:`typography-body-small text-text-label`,children:`Table row action (24px trigger)`}),(0,_.jsx)(s,{title:`Row actions`,size:`small`,items:b,placement:`bottom-end`,trigger:(0,_.jsx)(l,{ariaLabel:`Row actions`})})]})},w={parameters:{controls:{disable:!0}},render:()=>{let e=[{label:`Edit`,icon:u},{label:`Rotate`,icon:a},{label:`Upload`,icon:p},{label:`Delete`,danger:!0,showDivider:!0,icon:r}];return(0,_.jsxs)(`div`,{className:`gap-xlg flex flex-col items-start`,children:[(0,_.jsxs)(`div`,{className:`gap-sm flex flex-col items-start`,children:[(0,_.jsx)(`p`,{className:`typography-body-small text-text-label`,children:`With tooltip`}),(0,_.jsx)(s,{title:`OverflowMenu`,size:`medium`,items:e,tooltipContent:`More options`,tooltipPlacement:`bottom`})]}),(0,_.jsxs)(`div`,{className:`gap-sm flex flex-col items-start`,children:[(0,_.jsx)(`p`,{className:`typography-body-small text-text-label`,children:`Without tooltip (no tooltipContent prop)`}),(0,_.jsx)(s,{title:`OverflowMenu`,size:`medium`,items:e})]})]})}},T=()=>{let[e,t]=(0,g.useState)(!0);return(0,_.jsxs)(`div`,{className:`gap-sm flex h-[160px] flex-col items-start`,children:[(0,_.jsx)(`p`,{className:`typography-body-small text-text-label`,children:`192px panel (menuWidthPx)`}),(0,_.jsx)(s,{title:`View actions`,size:`small`,menuWidthPx:192,open:e,onOpenChange:t,items:[{label:`Customize view`,trailingIcon:o},{label:`Delete view`,trailingIcon:r,danger:!0,showDivider:!0}]})]})},E={parameters:{controls:{disable:!0},a11y:{test:`todo`},design:h(`https://www.figma.com/design/GPsOC3XQdyxUOZxb7qNgJu/Studio---Orapulse?node-id=2993-133351`)},render:()=>(0,_.jsx)(T,{})},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{}`,...y.parameters?.docs?.source}}},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
