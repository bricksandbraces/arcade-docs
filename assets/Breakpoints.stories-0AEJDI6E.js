import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{c as n}from"./index-A6zbrgSY.js";import{j as r,f as m,h as d,c,d as p,k as x,B as N}from"./TypographyTokenRow-Ifxt58kW.js";import{S as h}from"./StorybookHeader-FVHTizmc.js";import"./index-CY-HDqYb.js";import"./ContextMenu-DwPyJibk.js";import"./index-DWvd7WUe.js";import"./index-BDYMFBcC.js";const b={sm:"384px",md:"640px",lg:"928px",xl:"1232px","2xl":"1536px"},C={title:"Essentials/Breakpoints",parameters:{docs:{description:{component:"Responsive breakpoint min-width tokens from the design system. Values are ordered from smallest to largest."}}}},s=()=>{const i=r(b);return e.jsx("div",{className:"gap-xlg text-text typography-body flex w-full min-w-0 flex-col",children:e.jsxs("div",{className:"gap-xlg flex min-w-0 flex-col",children:[e.jsx(h,{title:"Breakpoints",className:"px-[80px] pt-[80px] pb-[48px]"}),e.jsx("div",{className:"p-lg",children:e.jsx("div",{className:"gap-lg -m-lg flex flex-col",children:e.jsx("div",{className:m,children:e.jsx("div",{className:d,children:e.jsxs("section",{className:c,children:[e.jsxs("div",{role:"row",className:n(p,x),children:[e.jsx("div",{className:"typography-label-semibold text-text min-w-0 truncate font-semibold",children:"Name"}),e.jsx("div",{className:"typography-label-semibold text-text min-w-0 truncate font-semibold",children:"CSS Token"}),e.jsx("div",{className:"typography-label-semibold text-text min-w-0 truncate font-semibold",children:"Min-width"}),e.jsx("div",{className:"typography-label-semibold text-text min-w-0 truncate font-semibold",children:"Max-width"})]}),e.jsx("div",{className:"gap-sm flex flex-col",role:"presentation",children:i.map(a=>e.jsx(N,{cssVar:a.cssVar,maxWidth:a.maxWidth,minWidth:a.minWidth,name:a.name},a.name))})]})})})})})]})})};s.__docgenInfo={description:"",methods:[],displayName:"Breakpoints"};s.__docgenInfo={description:"",methods:[],displayName:"Breakpoints"};var o,t,l;s.parameters={...s.parameters,docs:{...(o=s.parameters)==null?void 0:o.docs,source:{originalSource:`() => {
