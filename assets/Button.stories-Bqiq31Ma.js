import{n as e}from"./chunk-jRWAZmH_.js";import{Ca as t,Ta as n,br as r,co as i,t as a,wa as o}from"./iframe-M7vOl6ig.js";var s,c,l,u,d,f,p,m,h,g,_,v;e((()=>{a(),s=i(),{action:c}=__STORYBOOK_MODULE_ACTIONS__,{expect:l,fn:u}=__STORYBOOK_MODULE_TEST__,d=e=>{c(`onClick`)(e)},f={title:`Buttons & Actions/Button`,component:t,tags:[`autodocs`],args:{label:`Button`,disabled:!1,loading:!1,kind:`primary`,size:`medium`,IconLeft:void 0,IconRight:void 0,onClick:d,tooltipContent:`Tooltip text`,tooltipPlacement:`bottom`},parameters:{docs:{description:{component:`Triggers an action when clicked. Use the primary kind for the main action on a page, secondary or ghost for supporting actions.`}}}},p={args:{kind:`primary`},argTypes:{kind:{description:`The kind of button`,control:{type:`select`},options:[`primary`,`secondary`,`tertiary`,`ghost`,`primary-danger`,`tertiary-danger`,`ghost-danger`],defaultValue:`primary`},size:{description:`The size of the button`,control:{type:`select`},options:[`small`,`medium`,`large`],defaultValue:`medium`},onClick:{control:{disable:!0}},IconLeft:{control:{disable:!0}},IconRight:{control:{disable:!0}}}},m=e=>(0,s.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,fill:`none`,viewBox:`0 0 24 24`,stroke:`currentColor`,className:e.className,children:(0,s.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:2,d:`M12 6v6m0 0v6m0-6h6m-6 0H6`})}),h={parameters:{controls:{disable:!0}},render:e=>{let r=n.toReversed().flatMap(e=>[{size:e,loading:!1,disabled:!1},{size:e,loading:!1,disabled:!0},{size:e,loading:!0,disabled:!1}]),i=o;return(0,s.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${i.length}, minmax(0, 1fr))`},children:r.map((n,r)=>i.map((i,a)=>{let o=`${i}-${n.size}-${n.loading?`loading`:`default`}-${n.disabled?`disabled`:`enabled`}`;return(0,s.jsxs)(`div`,{style:{gridColumn:`${a+1} / span 1`,gridRow:`${r+1} / span 1`},children:[e.showLabels&&(0,s.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,n.size,`, kind=`,i,n.loading?`, loading`:``,n.disabled?`, disabled`:``]}),(0,s.jsxs)(`div`,{className:`gap-sm flex flex-row`,children:[(0,s.jsx)(t,{label:`Button`,kind:i,size:n.size,loading:n.loading,disabled:n.disabled,onClick:d,tooltipContent:e.tooltipContent,tooltipPlacement:e.tooltipPlacement}),(0,s.jsx)(t,{"aria-label":`Icon button`,kind:i,size:n.size,loading:n.loading,disabled:n.disabled,IconLeft:m,onClick:d,tooltipContent:e.tooltipContent,tooltipPlacement:e.tooltipPlacement})]})]},o)}))})},args:{showLabels:!1}},g={args:{kind:`primary`,label:`Click me`,onClick:u()},play:async({args:e,canvas:t,userEvent:n})=>{let r=t.getByRole(`button`,{name:/click me/i});await l(r).toBeEnabled(),await n.click(r),await l(e.onClick).toHaveBeenCalledOnce()}},_={render:()=>(0,s.jsx)(r,{})},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
    kind: "primary"
  },
  argTypes: {
