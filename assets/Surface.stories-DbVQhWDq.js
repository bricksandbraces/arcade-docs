import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{$r as n,$t as r,Jt as i,Ma as a,Mo as o,X as s,_o as c,ln as l,t as u}from"./iframe-dCkyJnNO.js";var d,f,p,m,h,g,_,v,y;e((()=>{d=t(o(),1),u(),f=c(),p={title:`Arcade Components/Surface`,component:s,parameters:{a11y:{test:`off`},docs:{description:{component:"Surfaces alternate. Each surface (a `Modal`, `Sheet` or `Surface` box) paints\nitself in one of two background shades and flips the shade for its children,\nso every nested level — and the fields inside it — always contrasts with what\nit sits on. No manual `surface` prop needed; an explicit `surface` still wins.\n\nIn dark mode the two shades are `gray-10` and `gray-15`:\ndialog `gray-10` → card on it `gray-15` → field on the card back to `gray-10`\n→ card on that card `gray-15`, and so on."}}}},m=[{label:`Manager`,value:`manager`},{label:`Member`,value:`member`}],h=({children:e})=>(0,f.jsx)(`p`,{className:`typography-label-small text-text-accent`,children:e}),g={render:()=>(0,f.jsx)(()=>{let[e,t]=(0,d.useState)(!1),[n,o]=(0,d.useState)(``),[s,c]=(0,d.useState)(null);return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(a,{label:`Invite member`,onClick:()=>t(!0)}),(0,f.jsx)(r,{open:e,onClose:()=>t(!1),title:`Invite member`,subtitle:`They get an email to join your organization.`,layoutMode:`fixed`,children:(0,f.jsxs)(`div`,{className:`gap-xlg flex flex-col`,children:[(0,f.jsx)(i,{id:`surface-demo-email`,label:`Email`,placeholder:`first.last@example.com`,value:n,onChange:e=>o(e.target.value),size:`large`}),(0,f.jsx)(l,{title:`Select role`,size:`large`,value:s,onChange:e=>c(e),items:m,fullWidth:!0})]})})]})},{})},_={render:()=>(0,f.jsx)(()=>{let[e,t]=(0,d.useState)(!0);return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(a,{label:`Open dialog`,onClick:()=>t(!0)}),(0,f.jsx)(r,{open:e,onClose:()=>t(!1),title:`Surface levels`,layoutMode:`fixed`,children:(0,f.jsxs)(`div`,{className:`gap-xlg flex flex-col`,children:[(0,f.jsxs)(`div`,{className:`gap-sm flex flex-col`,children:[(0,f.jsx)(h,{children:`Field on the dialog (matches a card on the dialog)`}),(0,f.jsx)(i,{id:`lvl-dialog-field`,placeholder:`On dialog`})]}),(0,f.jsxs)(s,{className:`gap-sm p-lg flex flex-col`,children:[(0,f.jsx)(h,{children:`Card on the dialog`}),(0,f.jsx)(h,{children:`Field on the card (matches the dialog)`}),(0,f.jsx)(i,{id:`lvl-card-field`,placeholder:`On card`}),(0,f.jsxs)(s,{className:`gap-sm p-lg flex flex-col`,children:[(0,f.jsx)(h,{children:`Card on the card`}),(0,f.jsx)(i,{id:`lvl-card-card-field`,placeholder:`On card²`})]})]})]})})]})},{})},v={render:()=>(0,f.jsx)(n,{surface:`onCard`,children:(0,f.jsxs)(`div`,{className:`bg-background-elevation rounded-lg shadow-default p-lg gap-md border-component border-border flex w-[320px] flex-col`,children:[(0,f.jsx)(h,{children:`Dialog`}),(0,f.jsx)(i,{id:`nest-field-0`,placeholder:`Field on dialog`}),(0,f.jsxs)(s,{className:`gap-md p-lg flex flex-col`,children:[(0,f.jsx)(h,{children:`Card`}),(0,f.jsx)(i,{id:`nest-field-1`,placeholder:`Field on card`}),(0,f.jsxs)(s,{className:`gap-md p-lg flex flex-col`,children:[(0,f.jsx)(h,{children:`Card on card`}),(0,f.jsx)(i,{id:`nest-field-2`,placeholder:`Field on card²`})]})]})]})})},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  render: () => {
    const Demo = () => {
