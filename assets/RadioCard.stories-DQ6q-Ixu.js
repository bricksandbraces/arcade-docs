import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{$r as n,No as r,On as i,t as a,vo as o}from"./iframe-Bu5mwsKt.js";var s,c,l,u,d,f,p,m,h,g;e((()=>{a(),s=t(r(),1),c=o(),{action:l}=__STORYBOOK_MODULE_ACTIONS__,u={title:`Display & Data/Cards/RadioCard`,component:n,tags:[`autodocs`],parameters:{docs:{description:{component:`Larger selectable card acting as a radio, with room for a title and description. Use for exclusive choices that need more context than a plain RadioButton.`}}}},d=`flex flex-wrap gap-md`,f=e=>{let[t,r]=s.useState(`a`);return(0,c.jsxs)(`div`,{className:d,children:[(0,c.jsx)(n,{...e,name:`radio-card`,value:`a`,checked:t===`a`,onChange:e=>{l(`onChange`)(e),e.target.checked&&r(`a`)},className:`h-[218px] w-[388px] shrink-0`,children:(0,c.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card A`})}),(0,c.jsx)(n,{...e,name:`radio-card`,value:`b`,checked:t===`b`,onChange:e=>{l(`onChange`)(e),e.target.checked&&r(`b`)},className:`h-[218px] w-[388px] shrink-0`,children:(0,c.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card B`})}),(0,c.jsx)(n,{...e,name:`radio-card`,value:`c`,checked:t===`c`,onChange:e=>{l(`onChange`)(e),e.target.checked&&r(`c`)},className:`h-[218px] w-[388px] shrink-0`,children:(0,c.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card C`})})]})},f.args={disabled:!1,name:`radio-card`},p=e=>(0,c.jsxs)(`div`,{className:d,children:[(0,c.jsx)(n,{...e,name:`radio-card-disabled`,value:`a`,checked:!0,disabled:!0,onChange:e=>l(`onChange`)(e),className:`h-[218px] w-[388px] shrink-0`,children:(0,c.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card A`})}),(0,c.jsx)(n,{...e,name:`radio-card-disabled`,value:`b`,checked:!1,disabled:!0,onChange:e=>l(`onChange`)(e),className:`h-[218px] w-[388px] shrink-0`,children:(0,c.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card B`})}),(0,c.jsx)(n,{...e,name:`radio-card-disabled`,value:`c`,checked:!1,disabled:!0,onChange:e=>l(`onChange`)(e),className:`h-[218px] w-[388px] shrink-0`,children:(0,c.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card C`})})]}),p.args={disabled:!0,name:`radio-card`},m={render:()=>(0,c.jsxs)(`div`,{className:`gap-md flex w-[388px] flex-col`,children:[(0,c.jsx)(i,{}),(0,c.jsx)(i,{})]})},h=()=>{let[e,t]=s.useState(`a`);return(0,c.jsx)(`div`,{className:`bg-background-elevation gap-md p-xlg flex w-[420px] flex-col rounded-lg`,children:[`a`,`b`].map(r=>(0,c.jsx)(n,{name:`radio-card-elevation`,value:r,surface:`onCard`,checked:e===r,onChange:e=>{l(`onChange`)(e),e.target.checked&&t(r)},children:(0,c.jsxs)(`span`,{className:`typography-body text-text p-md block`,children:[`I'm on an elevated surface (`,r.toUpperCase(),`)`]})},r))})},h.parameters={docs:{description:{story:'`surface="onElevation"` for cards placed on an already-elevated surface (e.g. inside a Modal). The mock elevation below uses `bg-background-elevation`; the default surface would collide with it in dark mode, `onElevation` stays a distinct layer.'}}},f.__docgenInfo={description:``,methods:[],displayName:`Playground`},p.__docgenInfo={description:``,methods:[],displayName:`Disabled`},h.__docgenInfo={description:``,methods:[],displayName:`OnElevation`},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`(args: React.ComponentProps<typeof RadioCard> & Record<string, unknown>) => {
