import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{$ as n,Di as r,Ha as i,Ji as a,Li as o,Q as s,Ri as c,X as l,Y as u,Z as d,at as f,ca as p,da as m,ha as h,nt as g,ot as _,pi as v,ra as y,ro as b,si as x,t as S,ut as C,va as w,vo as T,xi as E,zi as D}from"./iframe-C1Q2u2SU.js";import{r as O,t as k}from"./react-CYqyh9jH.js";var A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{S(),x(),A=t(i(),1),k(),j=t(T(),1),M=b(),N={title:`Navigation/Navigation/Navigation`,component:f,tags:[`autodocs`],parameters:{layout:`fullscreen`,docs:{description:{component:`Collapsible side navigation with nested items. Use as the primary app chrome for switching between top-level sections.`}}}},P=e=>`/arcade-docs/assets/${e}`,F=({compact:e})=>{let t=P(e?`logo_small-dark.svg`:`logo_default-dark.svg`),n=P(e?`logo_small-light.svg`:`logo_default-light.svg`);return(0,M.jsx)(u,{compact:e,children:(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(`img`,{src:t,alt:``,className:(0,A.default)(`dark:hidden`,e?`size-full object-contain`:`h-[20px] w-auto max-w-full`)}),(0,M.jsx)(`img`,{src:n,alt:``,className:(0,A.default)(`hidden`,`dark:block`,e?`size-full object-contain`:`h-[20px] w-auto max-w-full`)})]})})},I=[{id:`dashboard`,label:`Dashboard`,icon:a},{id:`projects`,label:`Projects`,icon:D,children:[{id:`projects-all`,label:`All projects`},{id:`projects-archived`,label:`Archived`},{id:`projects-templates`,label:`Templates`,disabled:!0}]},{id:`team`,label:`Team`,icon:v},{id:`reports`,label:`Reports`,icon:y},{id:`settings`,label:`Settings`,icon:E}],L=I.slice(0,3),R=I.slice(3),z=[{id:`help`,label:`Help`,icon:o},{id:`docs`,label:`Documentation`,icon:p}],B=[{id:`l2-overview`,label:`Overview`},{id:`l2-members`,label:`Members`},{id:`l2-settings`,label:`Settings`},{id:`l2-billing`,label:`Billing`,disabled:!0}],V=[a,D,v,y,E,m],H=Array.from({length:30},(e,t)=>({id:`overflow-item-${t}`,label:`Item ${t+1}`,icon:V[t%V.length]})),U=({items:e,expanded:t,selectedId:n,setSelectedId:r,openId:i,setOpenId:a})=>(0,M.jsx)(M.Fragment,{children:e.map(e=>{let o=!!e.children,s=i===e.id,c=n===e.id,l=s&&t;return(0,M.jsx)(g,{title:t?e.label:void 0,size:t?`default`:`small`,icon:e.icon,tooltip:t?void 0:e.label,selected:c&&!s,expandable:o,expanded:l,onExpandedChange:t=>a(t?e.id:null),onClick:()=>{e.children||r(e.id)},children:e.children?.map(e=>(0,M.jsx)(g,{title:e.label,level:2,disabled:e.disabled,selected:n===e.id,onClick:()=>{e.disabled||r(e.id)}},e.id))},e.id)})}),W=({expanded:e,selectedId:t,setSelectedId:n,openId:r,setOpenId:i})=>(0,M.jsx)(`div`,{className:`gap-sm pt-sm flex w-full min-w-0 shrink-0 flex-col`,children:(0,M.jsx)(U,{items:z,expanded:e,selectedId:t,setSelectedId:n,openId:r,setOpenId:i})}),G=({logo:e,logoHoverMinimize:t})=>{let[n,r]=j.useState(!0),[i,a]=j.useState(`dashboard`),[o,s]=j.useState(`projects`);return(0,M.jsxs)(`div`,{className:(0,A.default)(`bg-background-accent`,`flex`,`min-h-screen`),children:[(0,M.jsxs)(f,{expanded:n,onExpandedChange:r,logo:e(n),logoHoverMinimize:t,footer:(0,M.jsx)(W,{expanded:n,selectedId:i,setSelectedId:a,openId:o,setOpenId:s}),children:[(0,M.jsx)(U,{items:L,expanded:n,selectedId:i,setSelectedId:a,openId:o,setOpenId:s}),(0,M.jsx)(l,{children:`Main`}),(0,M.jsx)(U,{items:R,expanded:n,selectedId:i,setSelectedId:a,openId:o,setOpenId:s})]}),(0,M.jsx)(`div`,{className:(0,A.default)(`p-lg`,`typography-body-small`,`text-text`,`flex-1`)})]})},K={render:()=>(0,M.jsx)(G,{logo:e=>(0,M.jsx)(F,{compact:!e}),logoHoverMinimize:!0})},q=({trailingSlot:e})=>(0,M.jsxs)(`div`,{className:`gap-xs flex items-center`,children:[(0,M.jsx)(w,{kind:`ghost`,IconLeft:E,size:`medium`,"aria-label":`Settings`}),(0,M.jsx)(w,{kind:`ghost`,IconLeft:m,size:`medium`,"aria-label":`Notifications`}),(0,M.jsx)(w,{kind:`ghost`,IconLeft:r,size:`medium`,"aria-label":`Menu`}),e]}),J=({drawerTrigger:e}={})=>{let[t,n]=j.useState(`products`);return(0,M.jsx)(_,{title:`Dashboard`,backButton:(0,M.jsx)(w,{kind:`ghost`,IconLeft:h,size:`medium`,"aria-label":`Go back`}),linkGroupOne:(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(C,{selected:t===`products`,onClick:()=>n(`products`),children:`Products`}),(0,M.jsx)(C,{selected:t===`resources`,onClick:()=>n(`resources`),children:`Resources`})]}),actions:(0,M.jsx)(q,{trailingSlot:e})})},Y={parameters:{docs:{description:{story:"Pairs the Navigation sidebar with the Header `WithTwoLinks` setup to show a complete app shell: sidebar on the left, top bar above the content area."}}},render:function(){let[e,t]=j.useState(!0),[n,r]=j.useState(`dashboard`),[i,a]=j.useState(`projects`);return(0,M.jsxs)(`div`,{className:(0,A.default)(`bg-background-accent`,`flex`,`min-h-screen`),children:[(0,M.jsxs)(f,{expanded:e,onExpandedChange:t,logo:(0,M.jsx)(F,{compact:!e}),logoHoverMinimize:!0,footer:(0,M.jsx)(W,{expanded:e,selectedId:n,setSelectedId:r,openId:i,setOpenId:a}),children:[(0,M.jsx)(U,{items:L,expanded:e,selectedId:n,setSelectedId:r,openId:i,setOpenId:a}),(0,M.jsx)(l,{children:`Main`}),(0,M.jsx)(U,{items:R,expanded:e,selectedId:n,setSelectedId:r,openId:i,setOpenId:a})]}),(0,M.jsxs)(`div`,{className:`flex min-w-0 flex-1 flex-col`,children:[(0,M.jsx)(J,{}),(0,M.jsx)(`div`,{className:`p-lg typography-body-small text-text flex-1`})]})]})}},X={name:`withOverflowGradient`,parameters:{docs:{description:{story:`Thirty top-level rows plus a fixed footer strip (Help, Documentation). The bottom scroll-fade sits on the top edge of the footer, like the dialog pattern.`}}},render:function(){let[e,t]=j.useState(!0),[n,r]=j.useState(`overflow-item-0`),[i,a]=j.useState(null);return(0,M.jsxs)(`div`,{className:(0,A.default)(`bg-background-accent`,`flex`,`min-h-screen`),children:[(0,M.jsx)(f,{expanded:e,onExpandedChange:t,logo:(0,M.jsx)(F,{compact:!e}),logoHoverMinimize:!0,footer:(0,M.jsx)(W,{expanded:e,selectedId:n,setSelectedId:r,openId:i,setOpenId:a}),children:(0,M.jsx)(U,{items:H,expanded:e,selectedId:n,setSelectedId:r,openId:i,setOpenId:a})}),(0,M.jsx)(`div`,{className:(0,A.default)(`p-lg`,`typography-body-small`,`text-text`,`flex-1`)})]})}},Z={parameters:{docs:{description:{story:"Wraps a real consumer logo in `NavigationLogo`. The dashed-border placeholder styling is reserved for the empty/sample case and must not appear here."}}},render:()=>(0,M.jsx)(G,{logoHoverMinimize:!0,logo:e=>(0,M.jsx)(u,{compact:!e,children:e?(0,M.jsxs)(`span`,{className:`gap-sm flex items-center`,children:[(0,M.jsx)(`span`,{className:`bg-background-onlight text-text-ondark typography-label flex h-6 w-6 items-center justify-center rounded-md`,children:`A`}),(0,M.jsx)(`span`,{className:`typography-headline-06 text-text font-semibold`,children:`Acme Inc.`})]}):(0,M.jsx)(`span`,{className:`bg-background-onlight text-text-ondark typography-label flex size-full items-center justify-center rounded-md`,children:`A`})})})},Q={name:`withLevel2Sidebar`,parameters:{docs:{description:{story:"Shell uses **CSS Grid**: primary `Navigation` spans the full height of column 1; column 2 has row 1 = **`Header`** (full width of the main column, unaffected by L2) and row 2 = **L2** + scrollable main. Below `md`, an **app icon** in the header opens **`NavigationDrawer`** (L1); choosing **Settings** runs the same **month-slide** transition as the Datepicker calendar, then shows L2 with a **Back** row. Closing the drawer resets its stack: reopening always starts on L1, even if desktop still has **Settings** selected."}}},render:function(){let[e,t]=j.useState(!0),[r,i]=j.useState(`projects`),[a,o]=j.useState(`projects`),[u,p]=j.useState(`l2-overview`),[m,h]=j.useState(!1),[g,_]=j.useState(!1),[v,y]=j.useState(1),b=j.useCallback(e=>{i(t=>{let n=typeof e==`function`?e(t):e;return n===`settings`&&t!==`settings`&&y(1),n})},[]),x=j.useCallback(e=>{i(t=>{let n=typeof e==`function`?e(t):e;return n===`settings`&&t!==`settings`&&(y(1),_(!0)),n})},[]),S=()=>{y(-1),i(`dashboard`),_(!1)},C=()=>{h(!1),_(!1)},T=(0,M.jsx)(w,{kind:`ghost`,IconLeft:c,size:`medium`,"aria-label":`Open navigation`,className:`md:hidden`,onClick:()=>h(!0)}),E=(0,M.jsxs)(f,{layout:`drawer`,drawerCloseInDrawerShell:!0,expanded:!0,onExpandedChange:()=>{},logo:(0,M.jsx)(F,{compact:!1}),footer:(0,M.jsx)(W,{expanded:!0,selectedId:r,setSelectedId:x,openId:a,setOpenId:o}),children:[(0,M.jsx)(U,{items:L,expanded:!0,selectedId:r,setSelectedId:x,openId:a,setOpenId:o}),(0,M.jsx)(l,{children:`Main`}),(0,M.jsx)(U,{items:R,expanded:!0,selectedId:r,setSelectedId:x,openId:a,setOpenId:o})]}),D=(0,M.jsx)(n,{layout:`drawer`,ariaLabel:`Settings sections`,children:B.map(e=>(0,M.jsx)(d,{title:e.label,disabled:e.disabled,selected:u===e.id,onClick:()=>{e.disabled||p(e.id)}},e.id))});return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsxs)(`div`,{className:(0,A.default)(`bg-background-accent`,`grid min-h-[100svh]`,`grid-cols-[auto_minmax(0,1fr)]`,`grid-rows-[auto_minmax(0,1fr)]`),children:[(0,M.jsx)(`div`,{className:`col-start-1 row-span-2 row-start-1 min-h-0`,children:(0,M.jsxs)(f,{expanded:e,onExpandedChange:t,logo:(0,M.jsx)(F,{compact:!e}),logoHoverMinimize:!0,footer:(0,M.jsx)(W,{expanded:e,selectedId:r,setSelectedId:b,openId:a,setOpenId:o}),children:[(0,M.jsx)(U,{items:L,expanded:e,selectedId:r,setSelectedId:b,openId:a,setOpenId:o}),(0,M.jsx)(l,{children:`Main`}),(0,M.jsx)(U,{items:R,expanded:e,selectedId:r,setSelectedId:b,openId:a,setOpenId:o})]})}),(0,M.jsx)(`div`,{className:`col-start-2 row-start-1 min-w-0 self-start`,children:(0,M.jsx)(J,{drawerTrigger:T})}),(0,M.jsxs)(`div`,{className:(0,A.default)(`col-start-2 row-start-2`,`flex min-h-0 min-w-0`),children:[(0,M.jsx)(O,{children:r===`settings`?(0,M.jsx)(n,{ariaLabel:`Settings sections`,children:B.map(e=>(0,M.jsx)(d,{title:e.label,disabled:e.disabled,selected:u===e.id,onClick:()=>{e.disabled||p(e.id)}},e.id))},`navigation-l2`):null}),(0,M.jsx)(`div`,{className:(0,A.default)(`min-h-0 min-w-0 flex-1`,`p-lg`,`typography-body-small`,`text-text`,`overflow-auto`)})]})]}),(0,M.jsx)(s,{open:m,onClose:C,stackDirection:v,showSecondary:g,onBack:S,secondaryTitle:`Settings`,primary:E,secondary:D})]})}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
