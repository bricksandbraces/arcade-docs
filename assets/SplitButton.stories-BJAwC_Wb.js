import{n as e}from"./chunk-jRWAZmH_.js";import{Ns as t,Za as n,ca as r,i,io as a,ko as o,qi as s,sa as c,va as l,vs as u}from"./iframe-vatATh5Q.js";import{n as d,t as f}from"./figmaDesign-CO6i5n9C.js";import{n as p,t as m}from"./figmaFrame-BkF_FCmc.js";var h,g,_,v,y,b,x,S;e((()=>{i(),r(),t(),d(),p(),h=u(),{action:g}=__STORYBOOK_MODULE_ACTIONS__,_={parameters:{design:f(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=5778-39560`),docs:{description:{component:"A main action next to a chevron that opens related actions. The chevron only reports its state - wire it to a `ContextMenu` or `Dropdown` through `onMenuClick` and `menuExpanded`."}}},title:`Buttons & Actions/SplitButton`,component:c,tags:[`autodocs`],argTypes:{kind:{control:`select`,options:[`primary`,`primary-light`,`secondary`,`tertiary`]},size:{control:`select`,options:[`small`,`medium`,`large`]},disabled:{control:`boolean`},loading:{control:`boolean`},menuExpanded:{control:`boolean`}}},v={args:{label:`Button`,menuLabel:`More actions`,IconLeft:o,kind:`primary`,size:`large`,onClick:g(`onClick`),onMenuClick:g(`onMenuClick`)}},y={parameters:{controls:{disable:!0}},render:()=>(0,h.jsx)(c,{label:`Save`,menuLabel:`More save options`,IconLeft:a,kind:`primary`,size:`large`,onClick:g(`onClick`),menu:(0,h.jsx)(s,{title:`More save options`,size:`medium`,placement:`bottom-end`,items:[{label:`Save as draft`,icon:n,onClick:g(`saveAsDraft`)},{label:`Save and close`,icon:a,onClick:g(`saveAndClose`)},{label:`Discard changes`,icon:l,danger:!0,showDivider:!0,onClick:g(`discard`)}]})})},b={parameters:{controls:{disable:!0}},render:()=>(0,h.jsx)(m,{node:`5778:39560`,width:164,height:48,children:(0,h.jsx)(c,{label:`Button`,menuLabel:`More actions`,IconLeft:o,kind:`primary`,size:`large`})})},x={parameters:{controls:{disable:!0}},render:()=>(0,h.jsx)(`div`,{className:`gap-lg flex flex-col items-start`,children:[`primary`,`primary-light`,`secondary`,`tertiary`].map(e=>(0,h.jsxs)(`div`,{className:`gap-md flex flex-row items-center`,children:[[`small`,`medium`,`large`].map(t=>(0,h.jsx)(c,{label:`Button`,menuLabel:`More actions`,IconLeft:o,kind:e,size:t,onClick:g(`onClick`),onMenuClick:g(`onMenuClick`)},`${e}-${t}`)),(0,h.jsx)(c,{label:`Button`,menuLabel:`More actions`,IconLeft:o,kind:e,size:`large`,disabled:!0})]},e))})},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    label: "Button",
