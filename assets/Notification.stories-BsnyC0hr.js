import{n as e}from"./chunk-jRWAZmH_.js";import{Co as t,Jr as n,Ra as r,Ro as i,Xr as a,Yr as o,t as s}from"./iframe-K9qsHq0w.js";var c,l,u,d,f,p,m;e((()=>{s(),i(),c=t(),{action:l}=__STORYBOOK_MODULE_ACTIONS__,u={title:`Feedback & Status/Notification/Notification`,component:n,tags:[`autodocs`],argTypes:{kind:{control:{type:`select`},options:[...o]},state:{control:{type:`select`},options:[...a]}},parameters:{docs:{description:{component:`Inline banner communicating status or feedback within a page. Use for persistent messages tied to a view (unlike Toast, which is transient).`}}}},d={render:e=>(0,c.jsx)(n,{...e}),args:{title:`Title`,subtitle:`Subtitle`,timestamp:new Date().toISOString(),kind:`banner`,state:`info`,onClose:l(`onClose`)}},f={parameters:{controls:{disable:!0}},render:()=>(0,c.jsx)(n,{title:`Jonas Bergmann's qualification expired.`,subtitle:`Jonas's First Aid Course ran out on October 10. Renew it to keep them cleared for sessions.`,kind:`banner`,state:`error`,onClose:l(`onClose`),action:(0,c.jsx)(r,{kind:`ghost`,size:`small`,variant:`rounded`,label:`Check Qualifications`,onClick:l(`onAction`)}),className:`w-[720px]`})},p={parameters:{controls:{disable:!0}},render:()=>(0,c.jsxs)(`div`,{className:`gap-lg flex flex-row`,children:[(0,c.jsx)(`div`,{className:`gap-lg flex flex-col`,children:[`banner`].map(e=>a.map(t=>(0,c.jsx)(n,{title:`Title`,subtitle:`Subtitle`,kind:e,state:t,onClose:l(`onClose`),className:`w-[460px]`},`${e}-${t}`)))}),(0,c.jsx)(`div`,{className:`gap-lg flex flex-col`,children:[`inline`].map(e=>a.map(t=>(0,c.jsx)(n,{title:`Title`,kind:e,state:t},`${e}-${t}`)))})]})},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
