import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Bo as n,To as r,jn as i,ni as a,t as o}from"./iframe-Cjmc8IvS.js";var s,c,l,u,d,f,p,m,h,g;e((()=>{o(),s=t(n(),1),c=r(),{action:l}=__STORYBOOK_MODULE_ACTIONS__,u={title:`Display & Data/Cards/RadioCard`,component:a,tags:[`autodocs`],parameters:{docs:{description:{component:`Larger selectable card acting as a radio, with room for a title and description. Use for exclusive choices that need more context than a plain RadioButton.`}}}},d=`flex flex-wrap gap-md`,f=e=>{let[t,n]=s.useState(`a`);return(0,c.jsxs)(`div`,{className:d,children:[(0,c.jsx)(a,{...e,name:`radio-card`,value:`a`,checked:t===`a`,onChange:e=>{l(`onChange`)(e),e.target.checked&&n(`a`)},className:`h-[218px] w-[388px] shrink-0`,children:(0,c.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card A`})}),(0,c.jsx)(a,{...e,name:`radio-card`,value:`b`,checked:t===`b`,onChange:e=>{l(`onChange`)(e),e.target.checked&&n(`b`)},className:`h-[218px] w-[388px] shrink-0`,children:(0,c.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card B`})}),(0,c.jsx)(a,{...e,name:`radio-card`,value:`c`,checked:t===`c`,onChange:e=>{l(`onChange`)(e),e.target.checked&&n(`c`)},className:`h-[218px] w-[388px] shrink-0`,children:(0,c.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card C`})})]})},f.args={disabled:!1,name:`radio-card`},p=e=>(0,c.jsxs)(`div`,{className:d,children:[(0,c.jsx)(a,{...e,name:`radio-card-disabled`,value:`a`,checked:!0,disabled:!0,onChange:e=>l(`onChange`)(e),className:`h-[218px] w-[388px] shrink-0`,children:(0,c.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card A`})}),(0,c.jsx)(a,{...e,name:`radio-card-disabled`,value:`b`,checked:!1,disabled:!0,onChange:e=>l(`onChange`)(e),className:`h-[218px] w-[388px] shrink-0`,children:(0,c.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card B`})}),(0,c.jsx)(a,{...e,name:`radio-card-disabled`,value:`c`,checked:!1,disabled:!0,onChange:e=>l(`onChange`)(e),className:`h-[218px] w-[388px] shrink-0`,children:(0,c.jsx)(`span`,{className:`typography-body text-text p-md block`,children:`I'm a Radio Card C`})})]}),p.args={disabled:!0,name:`radio-card`},m={render:()=>(0,c.jsxs)(`div`,{className:`gap-md flex w-[388px] flex-col`,children:[(0,c.jsx)(i,{}),(0,c.jsx)(i,{})]})},h=()=>{let[e,t]=s.useState(`a`);return(0,c.jsx)(`div`,{className:`bg-background-elevation gap-md p-xlg flex w-[420px] flex-col rounded-lg`,children:[`a`,`b`].map(n=>(0,c.jsx)(a,{name:`radio-card-elevation`,value:n,surface:`onCard`,checked:e===n,onChange:e=>{l(`onChange`)(e),e.target.checked&&t(n)},children:(0,c.jsxs)(`span`,{className:`typography-body text-text p-md block`,children:[`I'm on an elevated surface (`,n.toUpperCase(),`)`]})},n))})},h.parameters={docs:{description:{story:'`surface="onElevation"` for cards placed on an already-elevated surface (e.g. inside a Modal). The mock elevation below uses `bg-background-elevation`; the default surface would collide with it in dark mode, `onElevation` stays a distinct layer.'}}},f.__docgenInfo={description:``,methods:[],displayName:`Playground`},p.__docgenInfo={description:``,methods:[],displayName:`Disabled`},h.__docgenInfo={description:``,methods:[],displayName:`OnElevation`},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`(args: React.ComponentProps<typeof RadioCard> & Record<string, unknown>) => {
