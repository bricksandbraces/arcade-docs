import{n as e}from"./chunk-jRWAZmH_.js";import{co as t,dr as n,qa as r,t as i,vr as a,yr as o}from"./iframe-1mzDmMUm.js";var s,c,l,u,d,f,p;e((()=>{i(),t(),s=r(),{action:c}=__STORYBOOK_MODULE_ACTIONS__,l={title:`Display & Data/Badge/Badge`,component:a,tags:[`autodocs`],parameters:{docs:{description:{component:`Small colored label for status, counts, or metadata. Use inline next to text to flag state or categorize items.`}}}},u=({text:e,showCloseButton:t,...n})=>(0,s.jsx)(`div`,{children:(0,s.jsx)(a,{...n,type:t?`filter`:void 0,onDelete:t?c(`onDelete`):void 0,children:e})}),u.args={color:`red`,text:`Badge`,showCloseButton:!1},u.argTypes={color:{description:`The color of the badge`,control:{type:`select`},options:o},showCloseButton:{name:`Close button`,description:`Renders the filter badge with a dismiss control`,control:{type:`boolean`},table:{category:`Playground`}},text:{description:`Label text`,control:{type:`text`},table:{category:`Playground`}}},d={render:e=>{let{text:t,showCloseButton:n,...r}=e;return(0,s.jsx)(`div`,{className:`gap-x-md flex`,children:o.map(e=>(0,s.jsx)(a,{color:e,...r,type:n?`filter`:void 0,onDelete:n?c(`onDelete`):void 0,children:t},e))})},args:{text:`Badge`,showCloseButton:!1},argTypes:{color:{control:!1,table:{disable:!0}},type:{control:!1,table:{disable:!0}},id:{control:!1,table:{disable:!0}},className:{control:!1,table:{disable:!0}},onDelete:{control:!1,table:{disable:!0}},buttonProps:{control:!1,table:{disable:!0}},showCloseButton:{name:`Close button`,description:`Renders each badge as a filter badge with a dismiss control`,control:{type:`boolean`},table:{category:`Overview`}},text:{description:`Label text`,control:{type:`text`},table:{category:`Overview`}}}},f={render:()=>(0,s.jsx)(n,{})},u.__docgenInfo={description:``,methods:[],displayName:`Playground`,props:{text:{required:!1,tsType:{name:`string`},description:``},showCloseButton:{required:!1,tsType:{name:`boolean`},description:``}}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`({
  text,
  showCloseButton,
  ...args
