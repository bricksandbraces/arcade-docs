import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{aj as D,ak as _}from"./ContextMenuList-DU-bfPtc.js";import"./index-CY-HDqYb.js";import"./index-A6zbrgSY.js";import"./index-DWvd7WUe.js";import"./index-BDYMFBcC.js";import"./index-ZRCHFLd-.js";import"./sizes-BpUsT7VU.js";import"./colors-CoOIoG7W.js";const H={title:"WIP Components/FileUpload/Extension",component:_,argTypes:{extension:{control:"inline-radio",options:D}}},s={args:{extension:"pdf"}},r={render:()=>e.jsx("div",{className:"gap-md flex items-center",children:D.map(p=>e.jsxs("div",{className:"gap-xs flex flex-col items-center",children:[e.jsx(_,{extension:p}),e.jsx("span",{className:"text-text-secondary text-xs",children:p})]},p))})},n={args:{extension:"pdf"}},a={args:{extension:"png"}},o={args:{extension:"jpg"}},t={args:{extension:"json"}},c={args:{extension:"csv"}},i={args:{extension:"svg"}};var m,d,x;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    extension: "pdf"
  }
...
}`,...(O=(F=c.parameters)==null?void 0:F.docs)==null?void 0:O.source}}};var T,k,A;i.parameters={...i.parameters,docs:{...(T=i.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    extension: "svg"
  }
}`,...(A=(k=i.parameters)==null?void 0:k.docs)==null?void 0:A.source}}};const K=["Playground","AllExtensions","PDF","PNG","JPG","JSON","CSV","SVG"];export{r as AllExtensions,c as CSV,o as JPG,t as JSON,n as PDF,a as PNG,s as Playground,i as SVG,K as __namedExportsOrder,H as default};
