import{n as e}from"./chunk-jRWAZmH_.js";import{Aa as t,Fr as n,aa as r,ja as i,nr as a,t as o,xi as s,yo as c,zi as l}from"./iframe-BXRL_JkN.js";var u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{o(),s(),u=c(),d={none:void 0,IconArrowRight:t,IconArrowLeft:i,IconExternalLink:r,Icon123:l},f=[`sm`,`md`,`lg`],p={title:`Navigation/Link`,component:n,tags:[`autodocs`],args:{href:`#`,label:`Link`,disabled:!1,inline:!1,size:`md`,leadingIcon:!1,icon:`IconArrowRight`},parameters:{docs:{description:{component:`Anchor styled as a text link, with optional leading or trailing icon. Use for in-page navigation and external references.`}}}},m={render:e=>{let{icon:t,...r}=e,i=d[t];return(0,u.jsx)(n,{...r,icon:i})},argTypes:{size:{description:`Typography scale`,control:{type:`inline-radio`},options:[...f]},inline:{description:`Inline (link style) vs accent (standalone)`,control:`boolean`},disabled:{control:`boolean`},leadingIcon:{control:`boolean`},label:{control:`text`},href:{control:`text`},icon:{control:{type:`select`},options:Object.keys(d)},component:{control:{disable:!0}},linkComponent:{control:{disable:!0}}}},h=[{inline:!1,disabled:!1,leadingIcon:!1},{inline:!1,disabled:!1,leadingIcon:!0},{inline:!1,disabled:!0,leadingIcon:!1},{inline:!0,disabled:!1,leadingIcon:!1},{inline:!0,disabled:!0,leadingIcon:!1}],g={sm:`typography-label`,md:`typography-body-small`,lg:`typography-body`},_={parameters:{controls:{disable:!0}},render:e=>{let i=[...f].toReversed();return(0,u.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${i.length}, minmax(0, 1fr))`},children:h.map((a,o)=>i.map((i,s)=>{let c=`${i}-${a.inline?`inline`:`accent`}-${a.disabled?`disabled`:`enabled`}-${a.leadingIcon?`leading`:`trailing`}`;return(0,u.jsxs)(`div`,{style:{gridColumn:`${s+1} / span 1`,gridRow:`${o+1} / span 1`},children:[e.showLabels&&(0,u.jsxs)(`p`,{className:`${g[i]} text-text`,children:[`size=`,i,`, `,a.inline?`inline`:`accent`,a.disabled?`, disabled`:`, enabled`,a.leadingIcon?`, leading icon`:`, trailing icon`]}),a.inline?(0,u.jsxs)(`p`,{className:`${g[i]} text-text`,children:[`Before`,` `,(0,u.jsx)(n,{href:`#`,label:`link`,size:i,inline:!0,disabled:a.disabled,icon:r,leadingIcon:a.leadingIcon}),` `,`after.`]}):(0,u.jsx)(n,{href:`#`,label:`Link`,size:i,inline:!1,disabled:a.disabled,icon:t,leadingIcon:a.leadingIcon})]},c)}))})},args:{showLabels:!1}},v={render:()=>(0,u.jsx)(a,{})},y=({href:e,children:t,...n})=>(0,u.jsx)(`a`,{...n,href:e,"data-next-link":`true`,children:t}),b={parameters:{controls:{disable:!0},docs:{description:{story:"Plug in `next/link`'s `Link` (or any equivalent) via `linkComponent` so consumers preserve SPA navigation. The rendered anchor below carries a `data-next-link` attribute set by the mock component to make the substitution visible."}}},render:()=>(0,u.jsx)(n,{href:`/dashboard`,label:`Open dashboard`,linkComponent:y})},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: args => {
    const {
      icon,
      ...rest
