import{n as e}from"./chunk-jRWAZmH_.js";import{Io as t,Rr as n,Ur as r,Zo as i,t as a}from"./iframe-BugE88Md.js";import{n as o,t as s}from"./figmaDesign-CO6i5n9C.js";var c,l,u,d,f,p,m,h,g,_,v,y,b,x,S;e((()=>{a(),i(),o(),c=t(),{action:l}=__STORYBOOK_MODULE_ACTIONS__,u={title:`Display & Data/Avatar/Avatar`,component:r,tags:[`autodocs`],parameters:{design:s(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2127-26200`),docs:{description:{component:`Circular representation of a user, showing an image, memoji, initials or fallback icon. Use in headers, comment threads, and member lists.`}}}},d=e=>(0,c.jsx)(r,{...e,image:e.media===`image`?(0,c.jsx)(`img`,{src:`/arcade-docs/assets/image-sample.png`,alt:`Franklin Kudos Profile`,className:`size-full object-cover`}):void 0,memoji:e.media===`memoji`?(0,c.jsx)(`img`,{src:`/arcade-docs/assets/memoji-sample.png`,alt:`Franklin Kudos Memoji`,className:`scale-[1.4] object-cover`}):void 0}),d.args={state:`Online`,size:`medium`,name:`Franklin Kudos`,media:`none`},f={description:`The state of the indicator`,control:{type:`select`},options:[void 0,`Online`,`Offline`,`Busy`,`Pending`,`Notification`]},d.argTypes={state:f,size:{description:`The size of the avatar`,control:{type:`select`},options:[`small`,`medium`,`large`]},name:{description:`The name of the avatar`,control:{type:`text`}},media:{description:`Optional media source for the avatar`,control:{type:`select`},options:[`image`,`memoji`,`none`]}},p=l(`onClick`),m={parameters:{controls:{disable:!0}},render:e=>{let t=[`large`,`medium`,`small`],n=[{media:`image`,name:`Franklin Kudos`},{media:`memoji`,name:`Franklin Kudos`},{media:`none`,name:`Franklin Kudos`},{media:`none`,name:``}];return(0,c.jsx)(`div`,{className:`gap-x-lg gap-y-md grid grid-cols-4`,children:t.map(t=>n.map((n,i)=>(0,c.jsx)(r,{state:e.state,size:t,name:n.name,image:n.media===`image`?(0,c.jsx)(`img`,{src:`/arcade-docs/assets/image-sample.png`,alt:`Franklin Kudos Profile`,className:`size-full object-cover`}):void 0,memoji:n.media===`memoji`?(0,c.jsx)(`img`,{src:`/arcade-docs/assets/memoji-sample.png`,alt:`Franklin Kudos Memoji`,className:`scale-[1.4] object-cover`}):void 0},`${t}-${i}`)))})},argTypes:{state:f}},h={parameters:{controls:{disable:!0}},render:()=>{let e=[`large`,`medium`,`small`],t=[{media:`image`,name:`Franklin Kudos`},{media:`memoji`,name:`Franklin Kudos`},{media:`none`,name:`Franklin Kudos`},{media:`none`,name:``}];return(0,c.jsx)(`div`,{className:`gap-x-lg gap-y-md grid grid-cols-4`,children:e.map(e=>t.map((t,n)=>(0,c.jsx)(r,{state:`Online`,size:e,name:t.name,onClick:p,image:t.media===`image`?(0,c.jsx)(`img`,{src:`/arcade-docs/assets/image-sample.png`,alt:`Franklin Kudos Profile`,className:`size-full object-cover`}):void 0,memoji:t.media===`memoji`?(0,c.jsx)(`img`,{src:`/arcade-docs/assets/memoji-sample.png`,alt:`Franklin Kudos Memoji`,className:`scale-[1.4] object-cover`}):void 0},`${e}-${n}`)))})}},g={parameters:{controls:{disable:!0}},render:()=>{let e=[`large`,`medium`,`small`],t=[{media:`image`,name:`Franklin Kudos`},{media:`memoji`,name:`Franklin Kudos`},{media:`none`,name:`Franklin Kudos`},{media:`none`,name:``}];return(0,c.jsx)(`div`,{className:`gap-x-lg gap-y-md grid grid-cols-4`,children:e.map(e=>t.map((t,n)=>(0,c.jsx)(r,{state:`Online`,size:e,name:t.name,href:`#`,image:t.media===`image`?(0,c.jsx)(`img`,{src:`/arcade-docs/assets/image-sample.png`,alt:`Franklin Kudos Profile`,className:`size-full object-cover`}):void 0,memoji:t.media===`memoji`?(0,c.jsx)(`img`,{src:`/arcade-docs/assets/memoji-sample.png`,alt:`Franklin Kudos Memoji`,className:`scale-[1.4] object-cover`}):void 0},`${e}-${n}`)))})}},_={parameters:{controls:{disable:!0}},render:()=>{let e=[`large`,`medium`,`small`],t=[{media:`image`,name:`Franklin Kudos`},{media:`memoji`,name:`Franklin Kudos`},{media:`none`,name:`Franklin Kudos`},{media:`none`,name:``}];return(0,c.jsx)(`div`,{className:`gap-x-lg gap-y-md grid grid-cols-4`,children:e.map(e=>t.map((t,n)=>(0,c.jsx)(r,{state:`Online`,size:e,name:t.name,disabled:!0,onClick:p,image:t.media===`image`?(0,c.jsx)(`img`,{src:`/arcade-docs/assets/image-sample.png`,alt:`Franklin Kudos Profile`,className:`size-full object-cover`}):void 0,memoji:t.media===`memoji`?(0,c.jsx)(`img`,{src:`/arcade-docs/assets/memoji-sample.png`,alt:`Franklin Kudos Memoji`,className:`scale-[1.4] object-cover`}):void 0},`${e}-${n}`)))})}},v={render:()=>(0,c.jsx)(n,{})},y=({href:e,children:t,...n})=>(0,c.jsx)(`a`,{...n,href:e,"data-next-link":`true`,children:t}),b=({src:e,alt:t,className:n})=>(0,c.jsx)(`img`,{src:e,alt:t,className:n,"data-next-image":`true`}),x={parameters:{controls:{disable:!0},docs:{description:{story:"End-to-end Next.js integration: `linkComponent={NextLink}` for routing, `next/image` via the `image` slot. The rendered nodes below carry `data-next-link` / `data-next-image` so the substitution is visible."}}},render:()=>(0,c.jsx)(`div`,{className:`gap-lg flex items-center`,children:(0,c.jsx)(r,{size:`large`,name:`Franklin Kudos`,href:`/profile`,linkComponent:y,image:(0,c.jsx)(b,{src:`/arcade-docs/assets/image-sample.png`,alt:`Franklin Kudos Profile`,className:`size-full object-cover`})})})},d.__docgenInfo={description:``,methods:[],displayName:`Playground`},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:'(args: React.ComponentProps<typeof Avatar> & Record<string, any>) => {\n  return <Avatar {...args} image={args.media === "image" ? <img src={`${import.meta.env.BASE_URL}assets/image-sample.png`} alt="Franklin Kudos Profile" className="size-full object-cover" /> : undefined} memoji={args.media === "memoji" ? <img src={`${import.meta.env.BASE_URL}assets/memoji-sample.png`} alt="Franklin Kudos Memoji" className="scale-[1.4] object-cover" /> : undefined} />;\n}',...d.parameters?.docs?.source}}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
