import{n as e}from"./chunk-jRWAZmH_.js";import{Za as t,gi as n,i as r,n as i,r as a,ri as o,t as s}from"./iframe-D1tTUzW4.js";var c,l,u,d,f,p,m,h;e((()=>{s(),o(),c=t(),l={title:`Display & Data/UserProfile/UserProfileItem`,component:i,tags:[`autodocs`],parameters:{layout:`centered`},argTypes:{kind:{control:`inline-radio`,options:a},size:{control:`inline-radio`,options:r},label:{control:`text`},disabled:{control:`boolean`}},args:{kind:`default`,size:`medium`,label:`Item Title`,disabled:!1},decorators:[e=>(0,c.jsx)(`div`,{role:`menu`,children:(0,c.jsx)(e,{})})]},u={args:{IconLeft:n}},d=[`default`,`danger`],f=[`small`,`medium`,`large`],p=[{label:`enabled (hover / active / focus me)`,disabled:!1},{label:`disabled`,disabled:!0}],m={parameters:{layout:`padded`},render:()=>(0,c.jsx)(`div`,{className:`gap-2xlg flex flex-col`,children:p.map(e=>(0,c.jsxs)(`div`,{className:`gap-sm flex flex-col`,children:[(0,c.jsx)(`div`,{className:`typography-label text-text-accent uppercase`,children:e.label}),(0,c.jsx)(`div`,{className:`gap-lg flex flex-wrap`,children:d.map(t=>f.map(r=>(0,c.jsxs)(`div`,{className:`gap-xs flex w-48 flex-col`,children:[(0,c.jsxs)(`div`,{className:`typography-label text-text-tertiary`,children:[t,` / `,r]}),(0,c.jsx)(i,{kind:t,size:r,disabled:e.disabled,label:`Item Title`,IconLeft:n})]},`${t}-${r}`)))})]},e.label))})},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  args: {
