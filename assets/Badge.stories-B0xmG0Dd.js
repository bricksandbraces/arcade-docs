import{n as e}from"./chunk-jRWAZmH_.js";import{Pi as t,Yi as n,t as r,vn as i,yn as a}from"./iframe-CppZwykT.js";var o,s,c,l,u,d;e((()=>{r(),n(),o=t(),{action:s}=__STORYBOOK_MODULE_ACTIONS__,c={title:`Components/Badge/Badge`,component:i,tags:[`autodocs`],parameters:{docs:{description:{component:`Small colored label for status, counts, or metadata. Use inline next to text to flag state or categorize items.`}}}},l=({text:e,showCloseButton:t,...n})=>(0,o.jsx)(`div`,{children:(0,o.jsx)(i,{...n,type:t?`filter`:void 0,onDelete:t?s(`onDelete`):void 0,children:e})}),l.args={color:`red`,text:`Badge`,showCloseButton:!1},l.argTypes={color:{description:`The color of the badge`,control:{type:`select`},options:a},showCloseButton:{name:`Close button`,description:`Renders the filter badge with a dismiss control`,control:{type:`boolean`},table:{category:`Playground`}},text:{description:`Label text`,control:{type:`text`},table:{category:`Playground`}}},u={render:e=>{let{text:t,showCloseButton:n,...r}=e;return(0,o.jsx)(`div`,{className:`gap-x-md flex`,children:a.map(e=>(0,o.jsx)(i,{color:e,...r,type:n?`filter`:void 0,onDelete:n?s(`onDelete`):void 0,children:t},e))})},args:{text:`Badge`,showCloseButton:!1},argTypes:{color:{control:!1,table:{disable:!0}},type:{control:!1,table:{disable:!0}},id:{control:!1,table:{disable:!0}},className:{control:!1,table:{disable:!0}},onDelete:{control:!1,table:{disable:!0}},buttonProps:{control:!1,table:{disable:!0}},showCloseButton:{name:`Close button`,description:`Renders each badge as a filter badge with a dismiss control`,control:{type:`boolean`},table:{category:`Overview`}},text:{description:`Label text`,control:{type:`text`},table:{category:`Overview`}}}},l.__docgenInfo={description:``,methods:[],displayName:`Playground`,props:{text:{required:!1,tsType:{name:`string`},description:``},showCloseButton:{required:!1,tsType:{name:`boolean`},description:``}}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`({
  text,
  showCloseButton,
  ...args
