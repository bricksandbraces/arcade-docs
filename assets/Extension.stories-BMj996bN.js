import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a2 as _,a3 as k}from"./ContextMenuList-pvZaRry1.js";import"./NumberInput-LKINkquG.js";import"./index-0yr9KlQE.js";import"./index-tymuTqDW.js";import"./index-DotmK1FS.js";import"./borders-N_bRvfGw.js";import"./colors-mvAPBTAn.js";import"./index-ChaIqHV-.js";const K={title:"Components/FileUpload/Extension",component:k,argTypes:{extension:{control:"inline-radio",options:_}}},s={args:{extension:"pdf"}},r={render:()=>e.jsx("div",{className:"gap-md flex items-center",children:_.map(p=>e.jsxs("div",{className:"gap-xs flex flex-col items-center",children:[e.jsx(k,{extension:p}),e.jsx("span",{className:"text-text-secondary text-xs",children:p})]},p))})},n={args:{extension:"pdf"}},a={args:{extension:"png"}},o={args:{extension:"jpg"}},t={args:{extension:"json"}},c={args:{extension:"csv"}},i={args:{extension:"svg"}};var m,d,x;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    extension: "pdf"
  }
...
}`,...(E=(N=a.parameters)==null?void 0:N.docs)==null?void 0:E.source}}};var y,P,G;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    extension: "jpg"
  }
}`,...(G=(P=o.parameters)==null?void 0:P.docs)==null?void 0:G.source}}};var J,V,h;t.parameters={...t.parameters,docs:{...(J=t.parameters)==null?void 0:J.docs,source:{originalSource:`{
  args: {
    extension: "json"
  }
...
}`,...(D=(A=i.parameters)==null?void 0:A.docs)==null?void 0:D.source}}};const L=["Playground","AllExtensions","PDF","PNG","JPG","JSON","CSV","SVG"];export{r as AllExtensions,c as CSV,o as JPG,t as JSON,n as PDF,a as PNG,s as Playground,i as SVG,L as __namedExportsOrder,K as default};
