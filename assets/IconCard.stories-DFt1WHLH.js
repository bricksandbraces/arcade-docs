import{n as e}from"./chunk-jRWAZmH_.js";import{Da as t,Ei as n,Eo as r,Hi as i,Li as a,Mi as o,Ta as s,Vo as c,aa as l,ai as u,ba as d,ga as f,ji as p,t as m,ya as h}from"./iframe-Cy6jdjZ5.js";var g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j;e((()=>{m(),n(),c(),g=r(),{action:_}=__STORYBOOK_MODULE_ACTIONS__,v={title:`Display & Data/Cards/IconCard`,component:u,tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:`Compact navigational card with a leading icon, title, optional subtitle, and trailing chevron. Hover / active scale matches ClickableCard.`}}},argTypes:{disabled:{control:`boolean`},orientation:{control:`radio`,options:[`vertical`,`horizontal`]},interactive:{control:`boolean`}}},y=(0,g.jsx)(a,{className:`stroke-icon`,"aria-hidden":!0}),b=`stroke-icon`,x=[{icon:(0,g.jsx)(p,{className:b,"aria-hidden":!0}),title:`Accounts`,subtitle:`Balances and transactions`},{icon:(0,g.jsx)(d,{className:b,"aria-hidden":!0}),title:`Cards`,subtitle:`Manage limits and freezes`},{icon:(0,g.jsx)(h,{className:b,"aria-hidden":!0}),title:`Transfers`,subtitle:`SEPA and instant payments`},{icon:(0,g.jsx)(s,{className:b,"aria-hidden":!0}),title:`Portfolio & markets`,subtitle:`Securities and quotes`},{icon:(0,g.jsx)(t,{className:b,"aria-hidden":!0}),title:`Financing`,subtitle:`Loans and conditions`},{icon:(0,g.jsx)(i,{className:b,"aria-hidden":!0}),title:`Statements`,subtitle:`Taxes and receipts`}],S={args:{title:`Title`,subtitle:`Subtitle`,disabled:!1},render:e=>(0,g.jsx)(u,{...e,icon:y,className:`max-w-[346px]`,onClick:e=>_(`onClick`)(e)})},C=[{icon:(0,g.jsx)(o,{className:b,"aria-hidden":!0}),title:`Manage your team`,subtitle:`Invite members, assign roles, control access.`},{icon:(0,g.jsx)(l,{className:b,"aria-hidden":!0}),title:`Everything in one place`,subtitle:`Locations, customers and data under one roof, not scattered across accounts.`},{icon:(0,g.jsx)(f,{className:b,"aria-hidden":!0}),title:`Central control`,subtitle:`Branding, configuration and billing apply to the whole organization, not per user.`}],w={render:()=>(0,g.jsx)(`div`,{className:`gap-sm flex w-[448px] flex-col`,children:C.map(e=>(0,g.jsx)(u,{orientation:`horizontal`,icon:e.icon,title:e.title,subtitle:e.subtitle,onClick:e=>_(`onClick`)(e)},e.title))})},T={render:()=>(0,g.jsx)(`div`,{className:`gap-sm flex w-[448px] flex-col`,children:C.map(e=>(0,g.jsx)(u,{orientation:`horizontal`,interactive:!1,icon:e.icon,title:e.title,subtitle:e.subtitle},e.title))})},E={args:{title:`Settings`,disabled:!1},render:e=>(0,g.jsx)(u,{...e,icon:y,className:`max-w-[346px]`,onClick:e=>_(`onClick`)(e)})},D={render:()=>(0,g.jsx)(u,{href:`https://example.com`,icon:y,title:`External link`,subtitle:`Opens example.com`,className:`max-w-[346px]`,onClick:e=>_(`onClick`)(e)})},O={args:{title:`Unavailable`,subtitle:`Try again later`,disabled:!0},render:e=>(0,g.jsx)(u,{...e,icon:y,className:`max-w-[346px]`})},k={parameters:{controls:{disable:!0}},render:()=>(0,g.jsx)(`div`,{className:`gap-md flex w-full flex-wrap`,children:x.map((e,t)=>(0,g.jsx)(u,{icon:e.icon,title:e.title,subtitle:e.subtitle,className:`max-w-[346px] flex-[1_1_220px]`,onClick:e=>_(`card-${t+1}`)(e)},e.title))})},A={parameters:{controls:{disable:!0}},render:()=>(0,g.jsxs)(`div`,{className:`gap-md flex max-w-[360px] flex-col`,children:[(0,g.jsx)(u,{icon:y,title:`Title`,subtitle:`Subtitle`,onClick:e=>_(`default`)(e)}),(0,g.jsx)(u,{icon:(0,g.jsx)(a,{className:`stroke-icon`}),title:`No subtitle`,onClick:e=>_(`no subtitle`)(e)}),(0,g.jsx)(u,{icon:y,title:`Disabled`,subtitle:`Subtitle`,disabled:!0})]})},S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  args: {
    title: "Title",
    subtitle: "Subtitle",
    disabled: false
