import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as p}from"./index-CY-HDqYb.js";import{I as C,Z as T,a0 as a,a1 as y}from"./ContextMenuList-UUP63zD1.js";import{O as V}from"./onCardStoryShell-BJaWLAPz.js";import"./index-A6zbrgSY.js";import"./index-DWvd7WUe.js";import"./index-BDYMFBcC.js";const t=[{value:"apple",label:"Apple"},{value:"banana",label:"Banana"},{value:"orange",label:"Orange"}],N={title:"Components/Dropdown/Select",component:a,args:{options:t,placeholder:"Choose an option",size:"medium",state:"default",disabled:!1,inline:!1,fullWidth:!1},argTypes:{size:{control:"inline-radio",options:T},inline:{control:"boolean"},fullWidth:{control:"boolean"},disabled:{control:"boolean"},placeholder:{control:"text"},label:{control:"text"},helperText:{control:"text"},errorMessage:{control:"text"},warningMessage:{control:"text"},successMessage:{control:"text"},hideLabel:{control:"boolean"},state:{control:"inline-radio",options:C}},render:s=>{const[r,l]=p.useState(s.value);return e.jsx(a,{...s,value:r,onChange:n=>{l(n)}})}},o={args:{id:"playground-select",label:"Label",helperText:"Helper text below the field.",errorMessage:"Error message",warningMessage:"Warning message",successMessage:"Erledigt"}},i={args:{id:"slot-select",label:"Label",helperText:"Helper text below the field.",successMessage:"Saved",state:"success"},render:s=>{const[r,l]=p.useState(s.value);return e.jsx(a,{...s,value:r,onChange:n=>{l(n)},leadingSlot:e.jsx(y,{size:12,className:"stroke-icon-info"}),trailingSlot:e.jsx("span",{className:"typography-label-small text-text-accent",children:"Slot"})})}},c={args:{id:"on-card-select",label:"Label",helperText:"Helper text below the field.",errorMessage:"Error message",warningMessage:"Warning message",successMessage:"Erledigt",surface:"onCard"},render:s=>{const[r,l]=p.useState(s.value);return e.jsx(V,{children:e.jsx(a,{...s,value:r,onChange:n=>{l(n)}})})}},d={parameters:{controls:{disable:!0}},render:()=>e.jsxs("div",{className:"gap-xlg grid max-w-[720px] grid-cols-1 md:grid-cols-2",children:[e.jsx(a,{id:"overview-default",label:"Default + helper",placeholder:"Select an option",helperText:"Optional helper text.",options:t}),e.jsx(a,{id:"overview-error",label:"Error + notification",placeholder:"Select an option",state:"error",errorMessage:"This field has an error.",helperText:"Hidden while error is shown.",options:t}),e.jsx(a,{id:"overview-warning",label:"Warning + notification",placeholder:"Select an option",state:"warning",warningMessage:"Please review your choice.",options:t}),e.jsx(a,{id:"overview-success",label:"Success",placeholder:"Select an option",state:"success",successMessage:"Saved",helperText:"Success still shows helper when no error/warning.",options:t,value:"apple"})]})};var g,u,h;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
