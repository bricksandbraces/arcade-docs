import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ct as n,Ia as r,Za as i,fa as a,fo as o,ni as s,pt as c,t as l,ti as u}from"./iframe-D1tTUzW4.js";import{n as d,t as f}from"./react-BMgScnYl.js";import{i as p,n as m}from"./storybook-0bccxYTm.js";import{C as h,S as g,T as _,t as v,w as y}from"./docs-HBwgZ3V5.js";function b(e){return e.startsWith(`animation-duration-`)?`--${e}`:e.startsWith(`animation-ease-`)?`--ease-${e.replace(`animation-ease-`,``)}`:e===`animation-bounce`?`--animation-bounce`:``}var x,S,C,w,T,E,D,O,k,A,j,M,N,P;e((()=>{x=t(o(),1),l(),S=t(r(),1),f(),v(),C=i(),w=[`animation-ease-accelerate-lg`,`animation-ease-accelerate-md`,`animation-ease-accelerate-sm`,`animation-ease-decelerate-lg`,`animation-ease-decelerate-md`,`animation-ease-decelerate-sm`,`animation-ease-ease`,`animation-ease-linear`,`animation-bounce`],T=.35,E=`fast-spatial-spring`,D=[`animation-duration-xs`,`animation-duration-sm`,`animation-duration-md`,`animation-duration-lg`,`animation-duration-xlg`,`animation-duration-2xlg`,`animation-duration-3xlg`],O=[{value:`translateX`,label:`Translate X`},{value:`translateY`,label:`Translate Y`},{value:`scale`,label:`Scale`},{value:`rotate`,label:`Rotate`},{value:`opacity`,label:`Opacity`},{value:`borderRadius`,label:`Border radius`}],k=[...w.map(e=>({value:e,label:e.replace(`animation-ease-`,``).replace(`animation-`,``)})),{value:E,label:`fast spatial spring`}],A=D.map(e=>({value:e,label:e.replace(`animation-duration-`,``)})),j=`grid-cols-[minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)]`,M={title:`Arcade Foundation/Animations`,parameters:{a11y:{test:`off`},chromatic:{disableSnapshot:!0}}},N=()=>{let[e,t]=(0,x.useState)(`translateX`),[r,i]=(0,x.useState)(`animation-ease-ease`),[o,l]=(0,x.useState)(`animation-duration-md`),[f,v]=(0,x.useState)(!1),[M,N]=(0,x.useState)(240),[P,F]=(0,x.useState)(72),[I,L]=(0,x.useState)(72),[R,ee]=(0,x.useState)(120),[z,B]=(0,x.useState)(120),[V,H]=(0,x.useState)(1),[U,W]=(0,x.useState)(.25),[G,K]=(0,x.useState)(25),[q,J]=(0,x.useState)(8),[Y,X]=(0,x.useState)(24),Z=(0,x.useMemo)(()=>{let t=getComputedStyle(document.documentElement),n=r===E,i=b(r),a=b(o),c=!n&&i?t.getPropertyValue(i).trim():``,l=a?s(t.getPropertyValue(a)):0;return{isFastSpatialSpring:n,easing:c,durationMs:l,cssTransition:n?`transition: { type: "spring", duration: ${(l/1e3).toFixed(3)}, bounce: ${T} };`:`transition: ${e} ${l}ms ${c};`}},[o,r,e]),Q=(0,x.useMemo)(()=>{let e=getComputedStyle(document.documentElement),t=D.map(t=>({property:`Duration`,cssToken:`--${t}`,value:e.getPropertyValue(`--${t}`).trim()})),n=w.map(t=>{let n=b(t);return{property:`Easing`,cssToken:n,value:e.getPropertyValue(n).trim()}}),r={property:`Easing`,cssToken:`fastSpatialSpring`,value:`spring transition (duration controlled)`};return[...t,...n,r]},[]),te=Z.easing?u(Z.easing):`linear`,$=Z.durationMs/1e3;function ne(){let t={x:0,y:0,width:P,height:I,scale:1,rotate:0,opacity:V,borderRadius:q};if(!f)return t;switch(e){case`translateX`:return{...t,x:M};case`translateY`:return{...t,y:M};case`scale`:return{...t,width:R,height:z};case`rotate`:return{...t,rotate:G};case`opacity`:return{...t,opacity:U};case`borderRadius`:return{...t,borderRadius:Y}}}function re(){return e===`translateX`||e===`translateY`?(0,C.jsx)(`div`,{className:`w-[260px]`,children:(0,C.jsx)(n,{id:`animation-distance`,label:`Distance`,value:M,onValueChange:e=>N(e??0)})}):e===`scale`?(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(`div`,{className:`w-[260px]`,children:(0,C.jsx)(n,{id:`animation-initial-width`,label:`Initial width`,value:P,min:1,onValueChange:e=>F(e??1)})}),(0,C.jsx)(`div`,{className:`w-[260px]`,children:(0,C.jsx)(n,{id:`animation-initial-height`,label:`Initial height`,value:I,min:1,onValueChange:e=>L(e??1)})}),(0,C.jsx)(`div`,{className:`w-[260px]`,children:(0,C.jsx)(n,{id:`animation-target-width`,label:`Target width`,value:R,min:1,onValueChange:e=>ee(e??1)})}),(0,C.jsx)(`div`,{className:`w-[260px]`,children:(0,C.jsx)(n,{id:`animation-target-height`,label:`Target height`,value:z,min:1,onValueChange:e=>B(e??1)})})]}):e===`opacity`?(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(`div`,{className:`w-[260px]`,children:(0,C.jsx)(n,{id:`animation-initial-opacity`,label:`Initial opacity`,value:V,min:0,max:1,step:.01,onValueChange:e=>H(e??0)})}),(0,C.jsx)(`div`,{className:`w-[260px]`,children:(0,C.jsx)(n,{id:`animation-target-opacity`,label:`Target opacity`,value:U,min:0,max:1,step:.01,onValueChange:e=>W(e??0)})})]}):e===`rotate`?(0,C.jsx)(`div`,{className:`w-[260px]`,children:(0,C.jsx)(n,{id:`animation-angle-change`,label:`Angle change`,value:G,onValueChange:e=>K(e??0)})}):(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(`div`,{className:`w-[260px]`,children:(0,C.jsx)(n,{id:`animation-initial-border-radius`,label:`Initial border radius`,value:q,min:0,onValueChange:e=>J(e??0)})}),(0,C.jsx)(`div`,{className:`w-[260px]`,children:(0,C.jsx)(n,{id:`animation-target-border-radius`,label:`Target border radius`,value:Y,min:0,onValueChange:e=>X(e??0)})})]})}return(0,C.jsx)(`div`,{className:`gap-xlg text-text typography-body flex w-full min-w-0 flex-col`,children:(0,C.jsxs)(`div`,{className:`gap-xlg flex min-w-0 flex-col`,children:[(0,C.jsx)(m,{title:`Animation Tokens`,className:`px-[80px] pt-[80px] pb-[48px]`}),(0,C.jsx)(`div`,{className:`p-lg`,children:(0,C.jsx)(`div`,{className:`gap-lg -m-lg flex flex-col`,children:(0,C.jsx)(`div`,{className:g,children:(0,C.jsxs)(`div`,{className:h,children:[(0,C.jsxs)(`section`,{className:y,children:[(0,C.jsx)(`h2`,{className:`typography-headline-03 text-text mb-[24px] font-light`,children:`Token overview`}),(0,C.jsxs)(`div`,{role:`row`,className:(0,S.default)(_,j),children:[(0,C.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Property`}),(0,C.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`CSS Token`}),(0,C.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Value`})]}),(0,C.jsx)(`div`,{className:`gap-sm flex flex-col`,role:`presentation`,children:Q.map(e=>(0,C.jsxs)(`div`,{className:(0,S.default)(`border-border bg-background -mx-2xlg gap-lg px-2xlg py-lg border-component grid min-h-[80px] items-center rounded-lg border border-solid`,j),children:[(0,C.jsx)(`div`,{className:`min-w-0`,children:(0,C.jsx)(p,{text:e.property})}),(0,C.jsx)(`div`,{className:`min-w-0`,children:(0,C.jsx)(p,{text:e.cssToken})}),(0,C.jsx)(`div`,{className:`min-w-0`,children:(0,C.jsx)(p,{text:e.value})})]},`${e.property}-${e.cssToken}`))})]}),(0,C.jsxs)(`section`,{className:y,children:[(0,C.jsx)(`h2`,{className:`typography-headline-03 text-text mb-[24px] font-light`,children:`Playground`}),(0,C.jsxs)(`div`,{className:`flex min-w-0 flex-col gap-0`,children:[(0,C.jsxs)(`div`,{className:`flex min-w-0 items-start justify-start gap-[24px]`,children:[(0,C.jsx)(`div`,{children:(0,C.jsx)(c,{id:`animation-property`,label:`Property`,options:O,value:e,onChange:e=>{(e===`translateX`||e===`translateY`||e===`scale`||e===`rotate`||e===`opacity`||e===`borderRadius`)&&t(e)}})}),(0,C.jsx)(`div`,{children:(0,C.jsx)(c,{id:`animation-easing`,label:`Easing`,options:k,value:r,onChange:e=>{typeof e==`string`&&i(e)}})}),(0,C.jsx)(`div`,{className:`w-[260px]`,children:(0,C.jsx)(c,{id:`animation-duration`,label:`Duration`,options:A,value:o,onChange:e=>{typeof e==`string`&&l(e)}})})]}),(0,C.jsx)(`div`,{className:`flex min-w-0 flex-wrap items-start justify-start gap-[24px]`,children:re()})]}),(0,C.jsxs)(`div`,{className:`gap-lg bg-background-app border-border border-component -mx-[32px] flex min-h-[360px] min-w-0 flex-col rounded-[20px] border border-solid p-[8px]`,children:[(0,C.jsx)(`div`,{className:`bg-background-accent border-border rounded-[12px] border-[0.5px] border-solid p-[16px]`,children:(0,C.jsxs)(`div`,{className:`gap-lg flex min-w-0 items-center justify-between`,children:[(0,C.jsxs)(`div`,{className:`gap-sm flex min-w-0 items-center`,children:[(0,C.jsx)(`div`,{className:`typography-label-semibold text-text shrink-0 font-semibold`,children:`Output:`}),(0,C.jsx)(p,{text:Z.cssTransition})]}),(0,C.jsx)(a,{label:f?`Reset`:`Animate`,onClick:()=>v(e=>!e)})]})}),(0,C.jsx)(`div`,{className:`flex min-w-0 flex-1 items-start justify-start p-[24px]`,children:(0,C.jsx)(d.div,{className:`bg-background-brand size-[72px] rounded-lg`,initial:!1,animate:ne(),transition:{...Z.isFastSpatialSpring?{type:`spring`,duration:$,bounce:T}:{duration:$,ease:te}}})})]})]})]})})})})]})})},N.__docgenInfo={description:``,methods:[],displayName:`Animations`},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`() => {
