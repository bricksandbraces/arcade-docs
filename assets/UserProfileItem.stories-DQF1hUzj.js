import{n as e}from"./chunk-jRWAZmH_.js";import{Ni as t,Ri as n,go as r,i,n as a,r as o,ra as s,t as c,yi as l}from"./iframe-D_22E2i2.js";var u,d,f,p,m,h,g,_,v,y;e((()=>{c(),l(),u=r(),d={title:`Display & Data/UserProfile/UserProfileItem`,component:a,tags:[`autodocs`],parameters:{layout:`centered`},argTypes:{kind:{control:`inline-radio`,options:o},size:{control:`inline-radio`,options:i},label:{control:`text`},disabled:{control:`boolean`},toggle:{control:`boolean`},selected:{control:`boolean`},href:{control:`text`}},args:{kind:`default`,size:`medium`,label:`Item Title`,disabled:!1,toggle:!1,selected:!1},decorators:[e=>(0,u.jsx)(`div`,{role:`menu`,children:(0,u.jsx)(e,{})})]},f={args:{IconLeft:t}},p={args:{toggle:!0,selected:!0,label:`Dark mode`,IconLeft:n}},m={args:{label:`Open documentation`,href:`https://example.com`,IconLeft:s}},h=[`default`,`danger`],g=[`small`,`medium`,`large`],_=[{label:`enabled (hover / active / focus me)`,disabled:!1},{label:`disabled`,disabled:!0}],v={parameters:{layout:`padded`},render:()=>(0,u.jsx)(`div`,{className:`gap-2xlg flex flex-col`,children:_.map(e=>(0,u.jsxs)(`div`,{className:`gap-sm flex flex-col`,children:[(0,u.jsx)(`div`,{className:`typography-label text-text-accent uppercase`,children:e.label}),(0,u.jsx)(`div`,{className:`gap-lg flex flex-wrap`,children:h.map(n=>g.map(r=>(0,u.jsxs)(`div`,{className:`gap-xs flex w-48 flex-col`,children:[(0,u.jsxs)(`div`,{className:`typography-label text-text-tertiary`,children:[n,` / `,r]}),(0,u.jsx)(a,{kind:n,size:r,disabled:e.disabled,label:`Item Title`,IconLeft:t})]},`${n}-${r}`)))})]},e.label))})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
