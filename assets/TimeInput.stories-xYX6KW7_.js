import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Eo as n,Mt as r,Nt as i,Vo as a,ei as o,t as s,ti as c}from"./iframe-Cy6jdjZ5.js";import{n as l,t as u}from"./surfaceStoryShell-B6tZ_sQt.js";var d,f,p,m,h,g;e((()=>{l(),d=t(a(),1),s(),f=n(),p={title:`Inputs & Controls/TimeInput`,component:r,tags:[`autodocs`],argTypes:{surface:{control:`inline-radio`,options:c},size:{control:`inline-radio`,options:i},disabled:{control:`boolean`},hideLabel:{control:`boolean`},min:{control:`number`},max:{control:`number`},step:{control:`number`},label:{control:`text`},helperText:{control:`text`},state:{control:`inline-radio`,options:o}},args:{surface:`default`,id:`playground-time-input`,label:`Duration`,size:`medium`,step:30,helperText:`Format mm:ss`},parameters:{docs:{description:{component:"Time input built on the same primitives as `NumberInput`. The value is a number of **seconds**; the field displays and parses `mm:ss` (or `h:mm:ss`). The +/- buttons and arrow keys step by `step` seconds (default 30). Use `trailingSlot` to add controls before the steppers (e.g. a colour picker)."}}}},m={render:e=>{let[t,n]=(0,d.useState)(e.value??90);return(0,f.jsx)(r,{...e,value:t,onValueChange:n})}},h={render:e=>(0,f.jsx)(u,{children:t=>(0,f.jsx)(r,{...e,surface:t})})},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: args => {
