import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Jr as n,Ot as r,ko as i,mo as a,qr as o,t as s}from"./iframe-DsWaMiRm.js";import{n as c,t as l}from"./onCardStoryShell-Bbg4MBek.js";var u,d,f,p,m,h,g,_,v,y,b,x,S,C;e((()=>{u=t(i(),1),s(),c(),d=a(),f={title:`Inputs & Controls/ColorInput`,component:r,tags:[`autodocs`],argTypes:{size:{control:`inline-radio`,options:o},state:{control:`inline-radio`,options:n},disabled:{control:`boolean`},hideLabel:{control:`boolean`},disablePicker:{control:`boolean`},loading:{control:`boolean`},label:{control:`text`},placeholder:{control:`text`},helperText:{control:`text`},successMessage:{control:`text`},warningMessage:{control:`text`},errorMessage:{control:`text`},loadingMessage:{control:`text`}},args:{id:`playground-color-input`,label:`Brand color`,placeholder:`000000`,size:`medium`,helperText:`Enter a hex value or pick one from the palette`,errorMessage:`Please enter a valid hex color`,warningMessage:`This color may not meet contrast requirements`,successMessage:`Color saved`,loadingMessage:`Saving...`},parameters:{docs:{description:{component:"Hex color input with an integrated ColorPicker popover. Use for theme, brand, and component color settings. The leading `#` is visual only — the value is normalised to `#RRGGBB`."}}}},p={args:{},render:e=>{let[t,n]=(0,u.useState)(`#0291FF`);return(0,d.jsxs)(`div`,{className:`gap-md flex flex-col`,children:[(0,d.jsx)(r,{...e,value:t,onValueChange:n}),(0,d.jsxs)(`div`,{className:`typography-label text-text-accent`,children:[`Current value: `,(0,d.jsx)(`code`,{children:t??`—`})]})]})}},m={args:{surface:`onCard`},render:e=>{let[t,n]=(0,u.useState)(`#6366F1`);return(0,d.jsx)(l,{children:(0,d.jsx)(r,{...e,value:t,onValueChange:n,surface:`onCard`})})}},h=({size:e})=>{let[t,n]=(0,u.useState)(`#10B981`);return(0,d.jsx)(r,{id:`color-input-${e}`,label:`${e.charAt(0).toUpperCase()+e.slice(1)} size`,size:e,value:t,onValueChange:n})},g={parameters:{controls:{disable:!0}},render:()=>(0,d.jsx)(`div`,{className:`gap-lg flex flex-col`,children:o.map(e=>(0,d.jsx)(h,{size:e},e))})},_={args:{id:`error-color-input`,label:`Accent color`,state:`error`,errorMessage:`Please enter a valid hex color`},render:e=>{let[t,n]=(0,u.useState)(`#GGGGGG`);return(0,d.jsx)(r,{...e,value:t,onValueChange:n})}},v={args:{id:`warning-color-input`,label:`Background color`,state:`warning`,warningMessage:`Low contrast against body text`},render:e=>{let[t,n]=(0,u.useState)(`#F0F1F2`);return(0,d.jsx)(r,{...e,value:t,onValueChange:n})}},y={args:{id:`success-color-input`,label:`Brand color`,state:`success`,successMessage:`Looks good!`},render:e=>{let[t,n]=(0,u.useState)(`#0D9467`);return(0,d.jsx)(r,{...e,value:t,onValueChange:n})}},b={args:{id:`loading-color-input`,label:`Theme color`,loading:!0,loadingMessage:`Saving...`},render:e=>{let[t,n]=(0,u.useState)(`#FF923F`);return(0,d.jsx)(r,{...e,value:t,onValueChange:n})}},x={args:{id:`disabled-color-input`,label:`Theme color`,disabled:!0},render:e=>(0,d.jsx)(r,{...e,defaultValue:`#6366F1`,onValueChange:()=>{}})},S={args:{id:`no-picker-color-input`,label:`Hex value`,disablePicker:!0,helperText:`Type a hex value — picker is disabled`},render:e=>{let[t,n]=(0,u.useState)(`#15171A`);return(0,d.jsx)(r,{...e,value:t,onValueChange:n})}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {},
  render: args => {
