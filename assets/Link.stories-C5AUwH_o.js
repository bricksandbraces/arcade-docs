import{n as e}from"./chunk-jRWAZmH_.js";import{Es as t,Fo as n,Ia as r,Io as i,ao as a,ha as o,i as s,vi as c,zr as l}from"./iframe-BNwjH-n2.js";import{n as u,t as d}from"./figmaDesign-CO6i5n9C.js";import{n as f,t as p}from"./figmaFrame-Czb2laIC.js";var m,h,g,_,v,y,b,x,S,C,w,T,E,D;e((()=>{s(),o(),u(),f(),m=t(),h={none:void 0,IconArrowRight:n,IconArrowLeft:i,IconExternalLink:a,Icon123:r},g=[`sm`,`md`,`lg`],_={title:`Navigation/Link`,component:c,tags:[`autodocs`],args:{href:`#`,label:`Link`,disabled:!1,inline:!1,size:`md`,leadingIcon:!1,icon:`IconArrowRight`},parameters:{design:d(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2130-35884`),docs:{description:{component:`Anchor styled as a text link, with optional leading or trailing icon. Use for in-page navigation and external references.`}}}},v={render:e=>{let{icon:t,...n}=e,r=h[t];return(0,m.jsx)(c,{...n,icon:r})},argTypes:{size:{description:`Typography scale`,control:{type:`inline-radio`},options:[...g]},inline:{description:`Inline (link style) vs accent (standalone)`,control:`boolean`},disabled:{control:`boolean`},leadingIcon:{control:`boolean`},label:{control:`text`},href:{control:`text`},icon:{control:{type:`select`},options:Object.keys(h)},component:{control:{disable:!0}},linkComponent:{control:{disable:!0}}}},y=[{inline:!1,disabled:!1,leadingIcon:!1},{inline:!1,disabled:!1,leadingIcon:!0},{inline:!1,disabled:!0,leadingIcon:!1},{inline:!0,disabled:!1,leadingIcon:!1},{inline:!0,disabled:!0,leadingIcon:!1}],b={sm:`typography-label`,md:`typography-body-small`,lg:`typography-body`},x={parameters:{controls:{disable:!0}},render:e=>{let t=[...g].toReversed();return(0,m.jsx)(`div`,{className:`gap-xlg grid`,style:{display:`grid`,gridTemplateColumns:`repeat(${t.length}, minmax(0, 1fr))`},children:y.map((r,i)=>t.map((t,o)=>{let s=`${t}-${r.inline?`inline`:`accent`}-${r.disabled?`disabled`:`enabled`}-${r.leadingIcon?`leading`:`trailing`}`;return(0,m.jsxs)(`div`,{style:{gridColumn:`${o+1} / span 1`,gridRow:`${i+1} / span 1`},children:[e.showLabels&&(0,m.jsxs)(`p`,{className:`${b[t]} text-text`,children:[`size=`,t,`, `,r.inline?`inline`:`accent`,r.disabled?`, disabled`:`, enabled`,r.leadingIcon?`, leading icon`:`, trailing icon`]}),r.inline?(0,m.jsxs)(`p`,{className:`${b[t]} text-text`,children:[`Before`,` `,(0,m.jsx)(c,{href:`#`,label:`link`,size:t,inline:!0,disabled:r.disabled,icon:a,leadingIcon:r.leadingIcon}),` `,`after.`]}):(0,m.jsx)(c,{href:`#`,label:`Link`,size:t,inline:!1,disabled:r.disabled,icon:n,leadingIcon:r.leadingIcon})]},s)}))})},args:{showLabels:!1}},S={sm:{accent:{node:`2130:35851`,width:38,height:14},inline:{node:`2130:35863`,width:38,height:14}},md:{accent:{node:`2130:35882`,width:50,height:19},inline:{node:`2130:35857`,width:46,height:19}},lg:{accent:{node:`2130:35852`,width:53,height:22},inline:{node:`2130:35862`,width:49,height:22}}},C={parameters:{controls:{include:[`size`,`inline`]}},args:{size:`sm`,inline:!1},render:({size:e=`md`,inline:t=!1})=>{let r=S[e][t?`inline`:`accent`];return(0,m.jsx)(p,{node:r.node,width:r.width,height:r.height,className:`flex items-start`,children:(0,m.jsx)(c,{href:`#`,label:`Link`,size:e,inline:t,visited:!1,icon:n})})}},w={render:()=>(0,m.jsx)(l,{})},T=({href:e,children:t,...n})=>(0,m.jsx)(`a`,{...n,href:e,"data-next-link":`true`,children:t}),E={parameters:{controls:{disable:!0},docs:{description:{story:"Plug in `next/link`'s `Link` (or any equivalent) via `linkComponent` so consumers preserve SPA navigation. The rendered anchor below carries a `data-next-link` attribute set by the mock component to make the substitution visible."}}},render:()=>(0,m.jsx)(c,{href:`/dashboard`,label:`Open dashboard`,linkComponent:T})},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  render: args => {
    const {
      icon,
      ...rest
