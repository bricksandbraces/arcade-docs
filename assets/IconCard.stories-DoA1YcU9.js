import{n as e}from"./chunk-jRWAZmH_.js";import{Ds as t,Ii as n,Qa as r,Va as i,co as a,fo as o,fs as s,ha as c,ia as l,la as u,no as d,t as f,to as p,ua as m,xa as h}from"./iframe-BdpsU0Re.js";import{n as g,t as _}from"./figmaDesign-CO6i5n9C.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N;e((()=>{f(),l(),t(),g(),v=s(),{action:y}=__STORYBOOK_MODULE_ACTIONS__,b={title:`Display & Data/Cards/IconCard`,component:n,tags:[`autodocs`],parameters:{design:_(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=4999-7980`),layout:`padded`,docs:{description:{component:`Compact navigational card with a leading icon, title, optional subtitle, and trailing chevron. Hover / active scale matches ClickableCard.`}}},argTypes:{disabled:{control:`boolean`},orientation:{control:`radio`,options:[`vertical`,`horizontal`]},interactive:{control:`boolean`}}},x=(0,v.jsx)(c,{className:`stroke-icon`,"aria-hidden":!0}),S=`stroke-icon`,C=[{icon:(0,v.jsx)(u,{className:S,"aria-hidden":!0}),title:`Accounts`,subtitle:`Balances and transactions`},{icon:(0,v.jsx)(d,{className:S,"aria-hidden":!0}),title:`Cards`,subtitle:`Manage limits and freezes`},{icon:(0,v.jsx)(p,{className:S,"aria-hidden":!0}),title:`Transfers`,subtitle:`SEPA and instant payments`},{icon:(0,v.jsx)(a,{className:S,"aria-hidden":!0}),title:`Portfolio & markets`,subtitle:`Securities and quotes`},{icon:(0,v.jsx)(o,{className:S,"aria-hidden":!0}),title:`Financing`,subtitle:`Loans and conditions`},{icon:(0,v.jsx)(h,{className:S,"aria-hidden":!0}),title:`Statements`,subtitle:`Taxes and receipts`}],w={args:{title:`Title`,subtitle:`Subtitle`,disabled:!1},render:e=>(0,v.jsx)(n,{...e,icon:x,className:`max-w-[346px]`,onClick:e=>y(`onClick`)(e)})},T=[{icon:(0,v.jsx)(m,{className:S,"aria-hidden":!0}),title:`Manage your team`,subtitle:`Invite members, assign roles, control access.`},{icon:(0,v.jsx)(i,{className:S,"aria-hidden":!0}),title:`Everything in one place`,subtitle:`Locations, customers and data under one roof, not scattered across accounts.`},{icon:(0,v.jsx)(r,{className:S,"aria-hidden":!0}),title:`Central control`,subtitle:`Branding, configuration and billing apply to the whole organization, not per user.`}],E={render:()=>(0,v.jsx)(`div`,{className:`gap-sm flex w-[448px] flex-col`,children:T.map(e=>(0,v.jsx)(n,{orientation:`horizontal`,icon:e.icon,title:e.title,subtitle:e.subtitle,onClick:e=>y(`onClick`)(e)},e.title))})},D={render:()=>(0,v.jsx)(`div`,{className:`gap-sm flex w-[448px] flex-col`,children:T.map(e=>(0,v.jsx)(n,{orientation:`horizontal`,interactive:!1,icon:e.icon,title:e.title,subtitle:e.subtitle},e.title))})},O={args:{title:`Settings`,disabled:!1},render:e=>(0,v.jsx)(n,{...e,icon:x,className:`max-w-[346px]`,onClick:e=>y(`onClick`)(e)})},k={render:()=>(0,v.jsx)(n,{href:`https://example.com`,icon:x,title:`External link`,subtitle:`Opens example.com`,className:`max-w-[346px]`,onClick:e=>y(`onClick`)(e)})},A={args:{title:`Unavailable`,subtitle:`Try again later`,disabled:!0},render:e=>(0,v.jsx)(n,{...e,icon:x,className:`max-w-[346px]`})},j={parameters:{controls:{disable:!0}},render:()=>(0,v.jsx)(`div`,{className:`gap-md flex w-full flex-wrap`,children:C.map((e,t)=>(0,v.jsx)(n,{icon:e.icon,title:e.title,subtitle:e.subtitle,className:`max-w-[346px] flex-[1_1_220px]`,onClick:e=>y(`card-${t+1}`)(e)},e.title))})},M={parameters:{controls:{disable:!0}},render:()=>(0,v.jsxs)(`div`,{className:`gap-md flex max-w-[360px] flex-col`,children:[(0,v.jsx)(n,{icon:x,title:`Title`,subtitle:`Subtitle`,onClick:e=>y(`default`)(e)}),(0,v.jsx)(n,{icon:(0,v.jsx)(c,{className:`stroke-icon`}),title:`No subtitle`,onClick:e=>y(`no subtitle`)(e)}),(0,v.jsx)(n,{icon:x,title:`Disabled`,subtitle:`Subtitle`,disabled:!0})]})},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  args: {
    title: "Title",
    subtitle: "Subtitle",
    disabled: false
