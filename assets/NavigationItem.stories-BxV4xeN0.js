import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ni as n,Qi as r,at as i,go as a,jo as o,ot as s,sa as c,st as l,t as u,to as d,yi as f}from"./iframe-KaqYBI6z.js";var p,m,h,g,_,v,y,b,x;e((()=>{u(),f(),p=t(d(),1),m=t(o(),1),h=a(),g={title:`Navigation/Navigation/NavigationItem`,component:i,tags:[`autodocs`],argTypes:{level:{control:`inline-radio`,options:s},size:{control:`inline-radio`,options:l},selected:{control:`boolean`},disabled:{control:`boolean`},expandable:{control:`boolean`},expanded:{control:`boolean`},title:{control:`text`},tooltip:{control:`text`}},args:{title:`Dashboard`,level:1,expandable:!1,selected:!1,disabled:!1,size:`default`},decorators:[e=>(0,h.jsx)(`div`,{className:(0,p.default)(`p-lg`,`w-72`,`bg-background`),children:(0,h.jsx)(e,{})})]},_={args:{icon:c}},v={parameters:{controls:{disable:!0}},render:()=>(0,h.jsxs)(`div`,{className:(0,p.default)(`gap-xlg`,`flex`,`flex-col`),children:[(0,h.jsxs)(`section`,{className:(0,p.default)(`gap-md`,`flex`,`flex-col`),children:[(0,h.jsx)(`h3`,{className:(0,p.default)(`typography-headline-04`,`text-text`),children:`Level 1 - default size`}),(0,h.jsx)(i,{title:`Enabled`,icon:c}),(0,h.jsx)(i,{title:`Selected`,icon:c,selected:!0}),(0,h.jsx)(i,{title:`Disabled`,icon:c,disabled:!0}),(0,h.jsx)(i,{title:`Expandable (collapsed)`,icon:r,expandable:!0}),(0,h.jsxs)(i,{title:`Expandable (expanded)`,icon:r,expandable:!0,defaultExpanded:!0,children:[(0,h.jsx)(i,{title:`Nested item`,level:2}),(0,h.jsx)(i,{title:`Another nested`,level:2})]})]}),(0,h.jsxs)(`section`,{className:(0,p.default)(`gap-md`,`flex`,`flex-col`),children:[(0,h.jsx)(`h3`,{className:(0,p.default)(`typography-headline-04`,`text-text`),children:`Level 2`}),(0,h.jsx)(i,{title:`Nested enabled`,level:2}),(0,h.jsx)(i,{title:`Nested selected`,level:2,selected:!0}),(0,h.jsx)(i,{title:`Nested disabled`,level:2,disabled:!0})]}),(0,h.jsxs)(`section`,{className:(0,p.default)(`gap-md`,`flex`,`flex-col`),children:[(0,h.jsx)(`h3`,{className:(0,p.default)(`typography-headline-04`,`text-text`),children:`Small - icon only with tooltip`}),(0,h.jsxs)(`div`,{className:(0,p.default)(`gap-sm`,`flex`,`flex-col`,`w-16`),children:[(0,h.jsx)(i,{size:`small`,icon:c,tooltip:`Dashboard`}),(0,h.jsx)(i,{size:`small`,icon:r,tooltip:`Projects`,selected:!0}),(0,h.jsx)(i,{size:`small`,icon:n,tooltip:`Settings`,disabled:!0})]})]})]})},y={parameters:{controls:{disable:!0}},render:function(){let[e,t]=m.useState(`projects`);return(0,h.jsxs)(`div`,{className:(0,p.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,h.jsx)(i,{title:`Dashboard`,icon:c,selected:e===null}),(0,h.jsxs)(i,{title:`Projects`,icon:r,expandable:!0,expanded:e===`projects`,onExpandedChange:e=>t(e?`projects`:null),children:[(0,h.jsx)(i,{title:`All projects`,level:2}),(0,h.jsx)(i,{title:`Archived`,level:2}),(0,h.jsx)(i,{title:`Templates`,level:2,disabled:!0})]}),(0,h.jsxs)(i,{title:`Settings`,icon:n,expandable:!0,expanded:e===`settings`,onExpandedChange:e=>t(e?`settings`:null),children:[(0,h.jsx)(i,{title:`Profile`,level:2}),(0,h.jsx)(i,{title:`Billing`,level:2})]})]})}},b={parameters:{controls:{disable:!0}},render:()=>(0,h.jsxs)(`div`,{className:(0,p.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,h.jsx)(i,{title:`Dashboard`,icon:c,href:`#dashboard`,selected:!0}),(0,h.jsx)(i,{title:`Projects`,icon:r,href:`#projects`}),(0,h.jsx)(i,{title:`Settings`,icon:n,href:`#settings`})]})},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  args: {
    icon: IconDashboard
  }
