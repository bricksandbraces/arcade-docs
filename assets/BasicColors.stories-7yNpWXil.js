import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Dn as n,En as r,Ni as i,Pi as a,Ui as o,ia as s,t as c,ya as l}from"./iframe-D_WxSr3l.js";import{n as u}from"./storybook-CGSdyNwD.js";import{C as d,N as f,O as p,S as m,T as h,b as g,t as _,w as v}from"./docs-Dzq_QmUV.js";var y,b,x,S,C,w;e((()=>{c(),i(),y=t(o(),1),b=t(l(),1),_(),x=s(),S={title:`Arcade Foundation/Colors/Color Primitives`,parameters:{a11y:{test:`off`},chromatic:{disableSnapshot:!0}}},C=()=>{let[e,t]=(0,b.useState)(`light`),i=p(a),o=()=>(0,x.jsx)(`div`,{className:m,children:(0,x.jsx)(`div`,{className:d,children:i.map(({group:t,items:n})=>(0,x.jsxs)(`section`,{className:v,children:[(0,x.jsx)(`h2`,{className:`typography-headline-03 text-text font-light capitalize`,children:t}),(0,x.jsxs)(`div`,{role:`row`,className:(0,y.default)(h,f),children:[(0,x.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Name`}),(0,x.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`CSS Token`}),(0,x.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`HEX value`}),(0,x.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Preview`})]}),(0,x.jsx)(`div`,{className:`gap-sm flex flex-col`,role:`presentation`,children:n.map(({key:t,cssVar:n})=>(0,x.jsx)(g,{cssVar:n,previewTheme:e,tokenKey:t},t))})]},t))})});return(0,x.jsx)(`div`,{className:`gap-xlg text-text typography-body flex w-full min-w-0 flex-col`,children:(0,x.jsxs)(`div`,{className:`gap-xlg flex min-w-0 flex-col`,children:[(0,x.jsx)(u,{title:`Color Primitives`,className:`px-[80px] pt-[80px] pb-[48px]`}),(0,x.jsxs)(`div`,{className:`basic-colors-tabs`,children:[(0,x.jsx)(`style`,{children:`
              .basic-colors-tabs > div > div:first-child {
                display: none !important;
              }
            `}),(0,x.jsxs)(n,{selectedId:e,onChange:e=>{(e===`light`||e===`dark`)&&t(e)},size:`md`,radius:`sharp`,withSpacing:!1,tabListClassName:`ml-[calc(80px-2*var(--spacing-lg)+4px)] mr-[calc(80px-var(--spacing-lg))]`,children:[(0,x.jsx)(r,{id:`light`,label:`Light mode`,children:(0,x.jsx)(`div`,{className:`gap-lg -m-lg flex flex-col`,children:o()})}),(0,x.jsx)(r,{id:`dark`,label:`Dark mode`,children:(0,x.jsx)(`div`,{className:`gap-lg -m-lg flex flex-col`,children:o()})})]})]})]})})},C.__docgenInfo={description:``,methods:[],displayName:`ColorPrimitives`},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`() => {
