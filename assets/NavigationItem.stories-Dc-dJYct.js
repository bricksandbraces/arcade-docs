import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{$t as n,Mo as r,Oi as i,Ui as a,_o as o,en as s,qo as c,t as l,tn as u,ua as d,xa as f}from"./iframe-DTfjFPcB.js";import{n as p,t as m}from"./figmaDesign-CO6i5n9C.js";var h,g,_,v,y,b,x,S,C;e((()=>{l(),i(),h=t(o(),1),g=t(c(),1),p(),_=r(),v={parameters:{design:m(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2438-38919`)},title:`Navigation/Navigation/NavigationItem`,component:n,tags:[`autodocs`],argTypes:{level:{control:`inline-radio`,options:s},size:{control:`inline-radio`,options:u},selected:{control:`boolean`},disabled:{control:`boolean`},expandable:{control:`boolean`},expanded:{control:`boolean`},title:{control:`text`},tooltip:{control:`text`}},args:{title:`Dashboard`,level:1,expandable:!1,selected:!1,disabled:!1,size:`default`},decorators:[e=>(0,_.jsx)(`div`,{className:(0,h.default)(`p-lg`,`w-72`,`bg-background`),children:(0,_.jsx)(e,{})})]},y={args:{icon:f}},b={parameters:{controls:{disable:!0}},render:()=>(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-xlg`,`flex`,`flex-col`),children:[(0,_.jsxs)(`section`,{className:(0,h.default)(`gap-md`,`flex`,`flex-col`),children:[(0,_.jsx)(`h3`,{className:(0,h.default)(`typography-headline-04`,`text-text`),children:`Level 1 - default size`}),(0,_.jsx)(n,{title:`Enabled`,icon:f}),(0,_.jsx)(n,{title:`Selected`,icon:f,selected:!0}),(0,_.jsx)(n,{title:`Disabled`,icon:f,disabled:!0}),(0,_.jsx)(n,{title:`Expandable (collapsed)`,icon:d,expandable:!0}),(0,_.jsxs)(n,{title:`Expandable (expanded)`,icon:d,expandable:!0,defaultExpanded:!0,children:[(0,_.jsx)(n,{title:`Nested item`,level:2}),(0,_.jsx)(n,{title:`Another nested`,level:2})]})]}),(0,_.jsxs)(`section`,{className:(0,h.default)(`gap-md`,`flex`,`flex-col`),children:[(0,_.jsx)(`h3`,{className:(0,h.default)(`typography-headline-04`,`text-text`),children:`Level 2`}),(0,_.jsx)(n,{title:`Nested enabled`,level:2}),(0,_.jsx)(n,{title:`Nested selected`,level:2,selected:!0}),(0,_.jsx)(n,{title:`Nested disabled`,level:2,disabled:!0})]}),(0,_.jsxs)(`section`,{className:(0,h.default)(`gap-md`,`flex`,`flex-col`),children:[(0,_.jsx)(`h3`,{className:(0,h.default)(`typography-headline-04`,`text-text`),children:`Small - icon only with tooltip`}),(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-sm`,`flex`,`flex-col`,`w-16`),children:[(0,_.jsx)(n,{size:`small`,icon:f,tooltip:`Dashboard`}),(0,_.jsx)(n,{size:`small`,icon:d,tooltip:`Projects`,selected:!0}),(0,_.jsx)(n,{size:`small`,icon:a,tooltip:`Settings`,disabled:!0})]})]})]})},x={parameters:{controls:{disable:!0}},render:function(){let[e,t]=g.useState(`projects`);return(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,_.jsx)(n,{title:`Dashboard`,icon:f,selected:e===null}),(0,_.jsxs)(n,{title:`Projects`,icon:d,expandable:!0,expanded:e===`projects`,onExpandedChange:e=>t(e?`projects`:null),children:[(0,_.jsx)(n,{title:`All projects`,level:2}),(0,_.jsx)(n,{title:`Archived`,level:2}),(0,_.jsx)(n,{title:`Templates`,level:2,disabled:!0})]}),(0,_.jsxs)(n,{title:`Settings`,icon:a,expandable:!0,expanded:e===`settings`,onExpandedChange:e=>t(e?`settings`:null),children:[(0,_.jsx)(n,{title:`Profile`,level:2}),(0,_.jsx)(n,{title:`Billing`,level:2})]})]})}},S={parameters:{controls:{disable:!0}},render:()=>(0,_.jsxs)(`div`,{className:(0,h.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,_.jsx)(n,{title:`Dashboard`,icon:f,href:`#dashboard`,selected:!0}),(0,_.jsx)(n,{title:`Projects`,icon:d,href:`#projects`}),(0,_.jsx)(n,{title:`Settings`,icon:a,href:`#settings`})]})},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    icon: IconDashboard
  }
