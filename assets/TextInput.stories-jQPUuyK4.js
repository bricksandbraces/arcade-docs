import{n as e}from"./chunk-jRWAZmH_.js";import{Ai as t,Ht as n,Mi as r,fs as i,ji as a,jr as o,t as s}from"./iframe-3giZHg2a.js";import{n as c,t as l}from"./figmaDesign-CO6i5n9C.js";import{n as u,t as d}from"./surfaceStoryShell-CkpWaZ4i.js";var f,p,m,h,g,_,v,y,b,x,S,C;e((()=>{u(),s(),c(),f=i(),{expect:p,within:m}=__STORYBOOK_MODULE_TEST__,h={title:`Inputs & Controls/TextInput`,component:n,tags:[`autodocs`],argTypes:{surface:{control:`inline-radio`,options:r},size:{control:`inline-radio`,options:t},disabled:{control:`boolean`},readOnly:{control:`boolean`},loading:{control:`boolean`},successMessage:{control:`text`},errorMessage:{control:`text`},hideLabel:{control:`boolean`},label:{control:`text`},placeholder:{control:`text`},state:{control:`inline-radio`,options:a}},args:{surface:`default`,errorMessage:`Error Message`,warningMessage:`Warning Message`,successMessage:`Success`,loadingMessage:`Loading...`,helperText:`Helper Text`,id:`playground-text-input`,label:`Label`,placeholder:`Placeholder text...`,size:`medium`},parameters:{design:l(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2345-1233`),docs:{description:{component:`Standard labeled text input with validation states. Use as the default single-line field in forms.`}}}},g={args:{}},_={args:{label:`Email address`,size:`large`,disabled:!0,value:`hendrik@bricksandbraces.com`,helperText:void 0,placeholder:void 0},render:e=>(0,f.jsx)(`div`,{className:`w-[150px]`,children:(0,f.jsx)(n,{...e})})},v={args:{id:`read-only-text-input`,label:`Organization URL`,defaultValue:`bricksandbraces`,readOnly:!0,helperText:void 0},play:async({canvas:e,canvasElement:t,userEvent:n})=>{let r=e.getByLabelText(`Organization URL`);await p(r).toHaveAttribute(`readonly`),await p(r).toBeEnabled();let i=m(t.ownerDocument.body),a=t.querySelector(`[data-input-read-only-indicator]`);await p(a).toBeInTheDocument(),await p(i.queryByRole(`tooltip`)).not.toBeInTheDocument(),await n.hover(a),await p(await i.findByRole(`tooltip`)).toHaveTextContent(`Not editable`),await n.unhover(a),await p(i.queryByRole(`tooltip`)).not.toBeInTheDocument(),await n.tab(),await p(r).toHaveFocus(),await p(await i.findByRole(`tooltip`)).toHaveTextContent(`Not editable`),await n.click(t),await p(r).not.toHaveFocus(),await p(i.queryByRole(`tooltip`)).not.toBeInTheDocument()}},y={args:{id:`slot-text-input`,label:`Label`,placeholder:`Placeholder text...`,trailingSlot:(0,f.jsx)(`span`,{className:`typography-label text-text-accent`,children:`ID`})},render:e=>(0,f.jsx)(n,{...e})},b={parameters:{controls:{disable:!0}},args:{showLabels:!1},render:e=>{let r=t.toReversed().flatMap(e=>[{size:e,loading:!1,disabled:!1,state:`default`},{size:e,loading:!1,disabled:!0,state:`default`},{size:e,loading:!0,disabled:!1,state:`default`},{size:e,loading:!1,disabled:!1,state:`error`},{size:e,loading:!1,disabled:!1,state:`success`}]),i=a;return(0,f.jsx)(`div`,{className:`gap-xlg grid pb-[128px]`,style:{display:`grid`,gridTemplateColumns:`repeat(${i.length}, minmax(0, 1fr))`},children:r.map((t,r)=>i.map((i,a)=>{let o=`${i}-${t.size}-${t.loading?`loading`:`default`}-${t.disabled?`disabled`:`enabled`}-${t.state}`;return(0,f.jsxs)(`div`,{style:{gridColumn:`${a+1} / span 1`,gridRow:`${r+1} / span 1`},children:[e.showLabels&&(0,f.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,t.size,`, state=`,i,t.loading?`, loading`:``,t.disabled?`, disabled`:``,t.state===`default`?``:`, status=${t.state}`]}),(0,f.jsxs)(`div`,{className:`gap-sm flex flex-col`,children:[(0,f.jsx)(`div`,{className:`pb-[32px]`,children:(0,f.jsx)(n,{id:`${i}-${t.size}-${r}-empty`,label:`Label`,placeholder:`Placeholder text...`,helperText:`Helper Text`,loadingMessage:`Loading...`,errorMessage:`Error Message`,successMessage:`Success`,warningMessage:`Warning Message`,size:t.size,state:t.state,loading:t.loading,disabled:t.disabled})}),(0,f.jsx)(`div`,{className:`pb-[32px]`,children:(0,f.jsx)(n,{id:`${i}-${t.size}-${r}-filled`,label:`Label`,placeholder:`Placeholder text...`,helperText:`Helper Text`,loadingMessage:`Loading...`,errorMessage:`Error Message`,successMessage:`Success`,warningMessage:`Warning Message`,size:t.size,state:t.state,loading:t.loading,disabled:t.disabled,value:`john.doe@example.com`})})]})]},o)}))})}},x={render:()=>(0,f.jsx)(o,{})},S={render:e=>(0,f.jsx)(d,{children:t=>(0,f.jsx)(n,{...e,surface:t})})},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  args: {}
