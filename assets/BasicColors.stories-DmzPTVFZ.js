import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Co as n,La as r,Ra as i,_n as a,co as o,gn as s,qa as c,t as l}from"./iframe-DzboGb7Y.js";import{n as u}from"./storybook-C21UVvRM.js";import{C as d,N as f,O as p,S as m,T as h,b as g,t as _,w as v}from"./docs-BnUWTNRf.js";var y,b,x,S,C,w;e((()=>{l(),r(),y=t(c(),1),b=t(n(),1),_(),x=o(),S={title:`Arcade Foundation/Colors/Color Primitives`,parameters:{a11y:{test:`off`},chromatic:{disableSnapshot:!0}}},C=()=>{let[e,t]=(0,b.useState)(`light`),n=p(i),r=()=>(0,x.jsx)(`div`,{className:m,children:(0,x.jsx)(`div`,{className:d,children:n.map(({group:t,items:n})=>(0,x.jsxs)(`section`,{className:v,children:[(0,x.jsx)(`h2`,{className:`typography-headline-03 text-text font-light capitalize`,children:t}),(0,x.jsxs)(`div`,{role:`row`,className:(0,y.default)(h,f),children:[(0,x.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Name`}),(0,x.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`CSS Token`}),(0,x.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`HEX value`}),(0,x.jsx)(`div`,{className:`typography-label-semibold text-text min-w-0 truncate font-semibold`,children:`Preview`})]}),(0,x.jsx)(`div`,{className:`gap-sm flex flex-col`,role:`presentation`,children:n.map(({key:t,cssVar:n})=>(0,x.jsx)(g,{cssVar:n,previewTheme:e,tokenKey:t},t))})]},t))})});return(0,x.jsx)(`div`,{className:`gap-xlg text-text typography-body flex w-full min-w-0 flex-col`,children:(0,x.jsxs)(`div`,{className:`gap-xlg flex min-w-0 flex-col`,children:[(0,x.jsx)(u,{title:`Color Primitives`,className:`px-[80px] pt-[80px] pb-[48px]`}),(0,x.jsxs)(`div`,{className:`basic-colors-tabs`,children:[(0,x.jsx)(`style`,{children:`
              .basic-colors-tabs > div > div:first-child {
                display: none !important;
              }
            `}),(0,x.jsxs)(a,{selectedId:e,onChange:e=>{(e===`light`||e===`dark`)&&t(e)},size:`md`,radius:`sharp`,withSpacing:!1,tabListClassName:`ml-[calc(80px-2*var(--spacing-lg)+4px)] mr-[calc(80px-var(--spacing-lg))]`,children:[(0,x.jsx)(s,{id:`light`,label:`Light mode`,children:(0,x.jsx)(`div`,{className:`gap-lg -m-lg flex flex-col`,children:r()})}),(0,x.jsx)(s,{id:`dark`,label:`Dark mode`,children:(0,x.jsx)(`div`,{className:`gap-lg -m-lg flex flex-col`,children:r()})})]})]})]})})},C.__docgenInfo={description:``,methods:[],displayName:`ColorPrimitives`},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`() => {
