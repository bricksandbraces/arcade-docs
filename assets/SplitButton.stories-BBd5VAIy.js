import{n as e}from"./chunk-jRWAZmH_.js";import{Da as t,Os as n,Qi as r,Ro as i,Us as a,_a as o,ga as s,oo as c,po as l,t as u}from"./iframe-jImnWlHt.js";import{n as d,t as f}from"./figmaDesign-DDiUnvXT.js";import{n as p,t as m}from"./figmaFrame-DV8WZAX4.js";var h,g,_,v,y,b,x,S;e((()=>{u(),o(),a(),d(),p(),h=n(),{action:g}=__STORYBOOK_MODULE_ACTIONS__,_={parameters:{design:f(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=5778-39560`),docs:{description:{component:"A main action next to a chevron that opens related actions. The chevron only reports its state - wire it to a `ContextMenu` or `Dropdown` through `onMenuClick` and `menuExpanded`."}}},title:`Buttons & Actions/SplitButton`,component:s,tags:[`autodocs`],argTypes:{kind:{control:`select`,options:[`primary`,`primary-light`,`secondary`,`tertiary`]},size:{control:`select`,options:[`small`,`medium`,`large`]},disabled:{control:`boolean`},loading:{control:`boolean`},menuExpanded:{control:`boolean`}}},v={args:{label:`Button`,menuLabel:`More actions`,IconLeft:i,kind:`primary`,size:`large`,onClick:g(`onClick`),onMenuClick:g(`onMenuClick`)}},y={parameters:{controls:{disable:!0}},render:()=>(0,h.jsx)(s,{label:`Save`,menuLabel:`More save options`,IconLeft:l,kind:`primary`,size:`large`,onClick:g(`onClick`),menu:(0,h.jsx)(r,{title:`More save options`,size:`medium`,placement:`bottom-end`,items:[{label:`Save as draft`,icon:c,onClick:g(`saveAsDraft`)},{label:`Save and close`,icon:l,onClick:g(`saveAndClose`)},{label:`Discard changes`,icon:t,danger:!0,showDivider:!0,onClick:g(`discard`)}]})})},b={parameters:{controls:{disable:!0}},render:()=>(0,h.jsx)(m,{node:`5778:39560`,width:164,height:48,children:(0,h.jsx)(s,{label:`Button`,menuLabel:`More actions`,IconLeft:i,kind:`primary`,size:`large`})})},x={parameters:{controls:{disable:!0}},render:()=>(0,h.jsx)(`div`,{className:`gap-lg flex flex-col items-start`,children:[`primary`,`primary-light`,`secondary`,`tertiary`].map(e=>(0,h.jsxs)(`div`,{className:`gap-md flex flex-row items-center`,children:[[`small`,`medium`,`large`].map(t=>(0,h.jsx)(s,{label:`Button`,menuLabel:`More actions`,IconLeft:i,kind:e,size:t,onClick:g(`onClick`),onMenuClick:g(`onMenuClick`)},`${e}-${t}`)),(0,h.jsx)(s,{label:`Button`,menuLabel:`More actions`,IconLeft:i,kind:e,size:`large`,disabled:!0})]},e))})},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    label: "Button",
