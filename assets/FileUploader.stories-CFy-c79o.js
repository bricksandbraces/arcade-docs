import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ia as n,T as r,Za as i,b as a,t as o,x as s}from"./iframe-D1tTUzW4.js";var c,l,u,d,f,p,m,h,g;e((()=>{o(),c=t(n(),1),l=i(),u={title:`Inputs & Controls/FileUpload/FileUploader`,component:a,tags:[`autodocs`,`!test`],argTypes:{variant:{control:`inline-radio`,options:s},dragDropKind:{control:`inline-radio`,options:r},disabled:{control:`boolean`},multiple:{control:`boolean`}},parameters:{docs:{description:{component:`Drop target and file list for uploading one or more files. Use in forms or dedicated upload panels.`}}}},d=[{id:`1`,filename:`Filename.pdf`,extension:`pdf`,state:`uploaded`},{id:`2`,filename:`Filename.pdf`,extension:`pdf`,state:`uploading`,progress:60},{id:`3`,filename:`Filename.pdf`,extension:`pdf`,state:`error`,errorText:`This file could not be uploaded.`}],f={render:()=>(0,l.jsxs)(`div`,{className:(0,c.default)(`gap-2xlg flex flex-col`),children:[(0,l.jsx)(a,{variant:`button`,title:`Upload files`,description:`Max file size is 500kb. Supported file types are .png and .pdf.`,files:d,onFileRemove:()=>void 0}),(0,l.jsx)(a,{variant:`drag-drop`,dragDropKind:`inline`,title:`Upload files`,description:`Max file size is 500kb. Supported file types are .png and .pdf.`,files:d,onFileRemove:()=>void 0}),(0,l.jsx)(a,{variant:`drag-drop`,dragDropKind:`default`,title:`Upload files`,description:`Max file size is 500kb. Supported file types are .png and .pdf.`,files:d,onFileRemove:()=>void 0})]})},p={args:{variant:`drag-drop`,dragDropKind:`inline`,title:`Upload files`,description:`Max file size is 500kb. Supported file types are .png and .pdf.`,files:d}},m={args:{variant:`drag-drop`,dragDropKind:`default`,title:`Upload files`,description:`Max file size is 500kb. Supported file types are .png and .pdf.`,files:d}},h=f,f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
