import{n as e}from"./chunk-jRWAZmH_.js";import{Ur as t,Za as n,lr as r,ma as i,t as a}from"./iframe-D1tTUzW4.js";var o,s,c,l,u,d;e((()=>{a(),o=n(),{action:s}=__STORYBOOK_MODULE_ACTIONS__,c={title:`Buttons & Actions/CopyButton`,component:t,tags:[`autodocs`],argTypes:{size:{control:`inline-radio`,options:i},disabled:{control:`boolean`},resetDelay:{control:`number`}},args:{value:`Hello World!`,size:`large`,disabled:!1,resetDelay:2e3},parameters:{docs:{description:{component:`Button that copies a value to the clipboard and shows a confirmation state. Use next to code snippets, IDs, or share links.`}}}},l={args:{value:`This text will be copied to your clipboard`,onCopy:e=>{s(`onCopy`)(e)}}},u={render:()=>(0,o.jsx)(r,{})},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
