import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{bv as I,bw as y,bx as n,by as a}from"./ContextMenu-CxMNWebl.js";import{R as c}from"./index-CY-HDqYb.js";import{I as v,a as w,b as p}from"./IconLayoutList-C5atMoB2.js";import"./index-A6zbrgSY.js";import"./index-DWvd7WUe.js";import"./index-BDYMFBcC.js";const L={title:"WIP Components/Switcher/Switcher",component:n,argTypes:{kind:{control:"inline-radio",options:y},size:{control:"inline-radio",options:I},children:{control:{disable:!0},table:{disable:!0}}},parameters:{layout:"padded"}},i={render:function(t){const[r,s]=c.useState("day");return c.useEffect(()=>{s(t.kind==="icon"?"grid":"day")},[t.kind]),t.kind==="icon"?e.jsxs(n,{...t,value:r,onValueChange:s,children:[e.jsx(a,{value:"list","aria-label":"List view",children:e.jsx(v,{className:"stroke-icon size-4",stroke:1.5})}),e.jsx(a,{value:"grid","aria-label":"Grid view",children:e.jsx(w,{className:"stroke-icon size-4",stroke:1.5})}),e.jsx(a,{value:"board","aria-label":"Board view",children:e.jsx(p,{className:"stroke-icon size-4",stroke:1.5})})]}):e.jsxs(n,{...t,value:r,onValueChange:s,children:[e.jsx(a,{value:"day",children:"Day"}),e.jsx(a,{value:"week",children:"Week"}),e.jsx(a,{value:"month",children:"Month"})]})},args:{kind:"text",size:"small"}},l={parameters:{controls:{disable:!0}},render:function(){const[t,r]=c.useState("day"),[s,k]=c.useState("grid");return e.jsxs("div",{className:"gap-xlg flex flex-col items-start",children:[e.jsxs("div",{className:"gap-sm flex flex-col items-start",children:[e.jsx("p",{className:"typography-body-small text-text-accent",children:"Text"}),e.jsxs(n,{value:t,onValueChange:r,children:[e.jsx(a,{value:"day",children:"Day"}),e.jsx(a,{value:"week",children:"Week"}),e.jsx(a,{value:"month",children:"Month"})]})]}),e.jsxs("div",{className:"gap-sm flex flex-col items-start",children:[e.jsx("p",{className:"typography-body-small text-text-accent",children:"Icon"}),e.jsxs(n,{kind:"icon",value:s,onValueChange:k,children:[e.jsx(a,{value:"list","aria-label":"List view",children:e.jsx(v,{className:"stroke-icon size-4",stroke:1.5})}),e.jsx(a,{value:"grid","aria-label":"Grid view",children:e.jsx(w,{className:"stroke-icon size-4",stroke:1.5})}),e.jsx(a,{value:"board","aria-label":"Board view",children:e.jsx(p,{className:"stroke-icon size-4",stroke:1.5})})]})]})]})}};var o,d,u;i.parameters={...i.parameters,docs:{...(o=i.parameters)==null?void 0:o.docs,source:{originalSource:`{
