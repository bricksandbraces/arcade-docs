import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{a0 as d,I as C,aT as o}from"./ContextMenuList-D_lNAfMU.js";import"./index-CY-HDqYb.js";import{a as $}from"./index-B-lxVbXh.js";import{O as I}from"./onCardStoryShell-BJaWLAPz.js";import"./index-A6zbrgSY.js";import"./index-DWvd7WUe.js";import"./index-BDYMFBcC.js";import"./index-ZRCHFLd-.js";import"./sizes-BpUsT7VU.js";import"./colors-CoOIoG7W.js";import"./v4-CtRu48qb.js";const _={title:"Components/Inputs/Input",component:o,argTypes:{state:{control:{type:"select"},options:C},size:{control:{type:"select"},options:d}}},s={args:{id:"input","aria-label":"Label",disabled:!1,loading:!1,state:"default",trailingSlot:void 0,placeholder:"Placeholder",onChange:$("onChange")},argTypes:{}},n={args:{...s.args,surface:"onCard"},render:t=>a.jsx(I,{children:a.jsx(o,{...t})})},l={parameters:{controls:{disable:!0}},render:t=>{const h=[{loading:!1,disabled:!1,state:"default"},{loading:!1,disabled:!1,state:"error"},{loading:!1,disabled:!1,state:"warning"},{loading:!1,disabled:!1,state:"success"},{loading:!1,disabled:!1,state:"success",trailingSlot:"Erledigt"},{loading:!0,disabled:!1,state:"default"},{loading:!0,disabled:!0,state:"default"},{loading:!1,disabled:!0,state:"default"}];return a.jsx("div",{className:"gap-xlg grid",style:{display:"grid",gridTemplateColumns:`repeat(${d.length}, minmax(0, 1fr))`},children:h.map((e,w)=>d.map((r,S)=>{const i=`${r}-${e.loading?"loading":"default"}-${e.disabled?"disabled":"enabled"}-${e.state==="error"?"error":"noerror"}-${e.state==="success"?"success":"nosuccess"}`;return a.jsxs("div",{style:{gridColumn:`${S+1} / span 1`,gridRow:`${w+1} / span 1`},children:[t.showLabels&&a.jsxs("p",{className:"typography-body-small text-text",children:["size=",r,e.loading?", loading":"",e.disabled?", disabled":"",e.state]}),a.jsx("div",{className:"gap-sm flex flex-row",children:a.jsx(o,{id:`${i}-input`,defaultValue:"Text",placeholder:"Placeholder",size:r,loading:e.loading,disabled:e.disabled,state:e.state,className:"w-[192px]"})})]},i)}))})},args:{showLabels:!1}};var g,p,c;s.parameters={...s.parameters,docs:{...(g=s.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    id: "input",
    "aria-label": "Label",
    disabled: false,
