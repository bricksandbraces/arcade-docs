import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ba as n,Ds as r,Ho as i,Hs as a,Lo as o,No as s,ct as c,dt as l,ga as u,ja as d,lt as f,ot as p,t as m}from"./iframe-_Ug8tvbS.js";import{n as h,t as g}from"./figmaDesign-DDiUnvXT.js";var _,v,y,b,x,S,C,w,T,E,D;e((()=>{m(),u(),_=t(a(),1),h(),v=r(),y={title:`Layout & Structure/Header/Header`,component:p,tags:[`autodocs`],argTypes:{showBackButton:{control:`boolean`},showTitleDivider:{control:`boolean`}},parameters:{design:g(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=5097-807`),layout:`fullscreen`,docs:{description:{component:"Top app bar with optional logo (`logo` + {@link HeaderLogo}), navigation links, and actions."}}}},b=()=>(0,v.jsxs)(`div`,{className:`gap-xs flex items-center`,children:[(0,v.jsx)(i,{kind:`ghost`,IconLeft:d,size:`medium`,"aria-label":`Settings`,tooltipContent:`Settings`}),(0,v.jsx)(i,{kind:`ghost`,IconLeft:s,size:`medium`,"aria-label":`Notifications`,tooltipContent:`Notifications`}),(0,v.jsx)(i,{kind:`ghost`,IconLeft:n,size:`medium`,"aria-label":`Menu`,tooltipContent:`Menu`})]}),x=e=>`/arcade-docs/assets/${e}`,S=()=>(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(`img`,{src:x(`logo_default-dark.svg`),alt:``,className:`h-[20px] w-auto max-w-full dark:hidden`}),(0,v.jsx)(`img`,{src:x(`logo_default-light.svg`),alt:``,className:`hidden h-[20px] w-auto max-w-full dark:block`})]}),C={render:({showBackButton:e=!0,showTitleDivider:t=!0})=>{let[n,r]=(0,_.useState)(`g1-b`);return(0,v.jsx)(p,{title:`Dashboard`,showBackButton:e,showTitleDivider:t,backButton:(0,v.jsx)(i,{kind:`ghost`,IconLeft:o,size:`medium`,"aria-label":`Go back`,tooltipContent:`Go back`}),linkGroupOne:(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(l,{selected:n===`g1-a`,onClick:()=>r(`g1-a`),children:`Link`}),(0,v.jsx)(l,{selected:n===`g1-b`,onClick:()=>r(`g1-b`),children:`Link`}),(0,v.jsx)(l,{selected:n===`g1-c`,onClick:()=>r(`g1-c`),children:`Link`})]}),linkGroupTwo:(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(l,{selected:n===`g2-a`,onClick:()=>r(`g2-a`),children:`Link`}),(0,v.jsx)(c,{selected:n===`g2-dropdown`,items:[{label:`Link`,onClick:()=>r(`g2-dropdown`)},{label:`Link`,onClick:()=>r(`g2-dropdown`)},{label:`Link`,onClick:()=>r(`g2-dropdown`)}],children:(0,v.jsx)(f,{children:`Link`})}),(0,v.jsx)(l,{selected:n===`g2-c`,onClick:()=>r(`g2-c`),children:`Link`})]}),actions:(0,v.jsx)(b,{})})},args:{showBackButton:!0,showTitleDivider:!0},parameters:{layout:`fullscreen`,controls:{include:[`showBackButton`,`showTitleDivider`]}}},w={parameters:{layout:`fullscreen`,docs:{description:{story:"Optional `logo` slot - pass SVG/img children; `Header` wraps them in `HeaderLogo`. Use `logoHref` for a home link."}}},render:()=>(0,v.jsx)(p,{title:`Dashboard`,showBackButton:!1,logo:(0,v.jsx)(S,{}),logoHref:`#`,actions:(0,v.jsx)(b,{})})},T={parameters:{layout:`fullscreen`,docs:{description:{story:"Pass `titleHref` to make the title a link (e.g. back to Home). It uses `linkComponent` when provided (framework `Link`), otherwise a native anchor. `titleLinkLabel` overrides the accessible name, which defaults to the visible title."}}},render:()=>(0,v.jsx)(p,{title:`Dashboard`,titleHref:`#`,titleLinkLabel:`Go to home`,showBackButton:!1,actions:(0,v.jsx)(b,{})})},E={args:{showBackButton:!0},parameters:{layout:`fullscreen`,controls:{include:[`showBackButton`]},docs:{description:{story:"Header with exactly two top-level navigation links rendered as `HeaderButton`s. Click a link to make it the active one. Use when the app has only a couple of primary sections."}}},render:function({showBackButton:e=!0}){let[t,n]=(0,_.useState)(`products`);return(0,v.jsx)(p,{title:`Dashboard`,showBackButton:e,backButton:(0,v.jsx)(i,{kind:`ghost`,IconLeft:o,size:`medium`,"aria-label":`Go back`}),linkGroupOne:(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(l,{selected:t===`products`,onClick:()=>n(`products`),children:`Products`}),(0,v.jsx)(l,{selected:t===`resources`,onClick:()=>n(`resources`),children:`Resources`})]}),actions:(0,v.jsx)(b,{})})}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  render: ({
    showBackButton = true,
