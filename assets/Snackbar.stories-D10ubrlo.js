import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Es as n,Fi as r,Li as i,Sn as a,Vo as o,Vs as s,i as c}from"./iframe-BNwjH-n2.js";import{n as l,t as u}from"./figmaDesign-CO6i5n9C.js";function d(e){let[t,n]=(0,f.useState)(!1);return(0,p.jsxs)(`div`,{className:`relative min-h-[480px] w-full`,children:[(0,p.jsx)(`div`,{className:`absolute inset-0 flex items-center justify-center`,children:(0,p.jsx)(o,{kind:`primary`,label:`Show Snackbar`,onClick:()=>n(!0)})}),(0,p.jsx)(a,{...e,open:t,onOpenChange:n})]})}var f,p,m,h,g,_;e((()=>{c(),f=t(s(),1),l(),p=n(),m={title:`Feedback & Status/Notification/Snackbar`,component:a,tags:[`autodocs`],argTypes:{open:{control:!1},state:{control:{type:`select`},options:[...i]},subtitle:{control:`text`},autoHideDurationMs:{control:{type:`number`}}},parameters:{design:u(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=4419-2565`),docs:{description:{component:`Transient bottom-anchored message auto-dismissed after a short delay. Use for quick confirmations like "Copied to clipboard".`}}}},h={args:{title:`Saved`,state:`success`,autoHideDurationMs:3e3},render:e=>(0,p.jsx)(d,{...e})},g={parameters:{controls:{disable:!0}},render:()=>(0,p.jsx)(`div`,{className:`gap-lg flex flex-col`,children:i.map(e=>(0,p.jsx)(r,{title:`Title`,subtitle:`Subtitle`,kind:`snackbar`,state:e},e))})},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    title: "Saved",
    state: "success",
