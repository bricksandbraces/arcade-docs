import{n as e}from"./chunk-jRWAZmH_.js";import{Ps as t,i as n,ys as r,zn as i}from"./iframe-BNKOs80O.js";import{n as a,t as o}from"./figmaDesign-CO6i5n9C.js";var s,c,l,u,d;e((()=>{t(),n(),a(),s=r(),c={parameters:{design:o(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=2394-7026&m=dev`)},title:`Inputs & Controls/DatePicker/Date`,component:i,tags:[`autodocs`],argTypes:{day:{control:`number`},state:{control:`select`,options:[`default`,`disabled`,`clicked`,`range-selected`,`range-selected-left`,`range-selected-right`,`today`]},onClick:{control:{disable:!0}}}},l={args:{day:15,state:`default`,onClick:()=>console.log(`Date clicked`)}},u={parameters:{controls:{disable:!0}},render:()=>(0,s.jsxs)(`div`,{className:`gap-md flex flex-col`,children:[(0,s.jsxs)(`div`,{className:`gap-sm flex items-center`,children:[(0,s.jsx)(i,{day:17,state:`default`,onClick:()=>console.log(`default clicked`)}),(0,s.jsx)(`span`,{className:`text-text-secondary text-xs`,children:`Default`})]}),(0,s.jsxs)(`div`,{className:`gap-sm flex items-center`,children:[(0,s.jsx)(i,{day:17,state:`clicked`,onClick:()=>console.log(`clicked clicked`)}),(0,s.jsx)(`span`,{className:`text-text-secondary text-xs`,children:`Clicked`})]}),(0,s.jsxs)(`div`,{className:`gap-sm flex items-center`,children:[(0,s.jsx)(i,{day:17,state:`range-selected`,onClick:()=>console.log(`range selected clicked`)}),(0,s.jsx)(`span`,{className:`text-text-secondary text-xs`,children:`Range Selected`})]}),(0,s.jsxs)(`div`,{className:`gap-sm flex items-center`,children:[(0,s.jsx)(i,{day:17,state:`range-selected-left`,onClick:()=>console.log(`range selected left clicked`)}),(0,s.jsx)(`span`,{className:`text-text-secondary text-xs`,children:`Range Selected Left`})]}),(0,s.jsxs)(`div`,{className:`gap-sm flex items-center`,children:[(0,s.jsx)(i,{day:17,state:`range-selected-right`,onClick:()=>console.log(`range selected right clicked`)}),(0,s.jsx)(`span`,{className:`text-text-secondary text-xs`,children:`Range Selected Right`})]}),(0,s.jsxs)(`div`,{className:`gap-sm flex items-center`,children:[(0,s.jsx)(i,{day:17,state:`disabled`,onClick:()=>console.log(`disabled clicked`)}),(0,s.jsx)(`span`,{className:`text-text-secondary text-xs`,children:`Disabled`})]}),(0,s.jsxs)(`div`,{className:`gap-sm flex items-center`,children:[(0,s.jsx)(i,{day:17,state:`today`,onClick:()=>console.log(`today clicked`)}),(0,s.jsx)(`span`,{className:`text-text-secondary text-xs`,children:`Today`})]})]})},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    day: 15,
    state: "default",
