import{n as e}from"./chunk-jRWAZmH_.js";import{$o as t,Fa as n,Ji as r,ha as i,i as a,la as o,n as s,r as c,t as l}from"./iframe-DAdTAyfZ.js";import{n as u,t as d}from"./figmaDesign-CO6i5n9C.js";var f,p,m,h,g,_,v,y,b,x;e((()=>{l(),r(),u(),f=t(),p={title:`Display & Data/UserProfile/UserProfileItem`,component:s,tags:[`autodocs`],parameters:{design:d(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=4717-3860`),layout:`centered`},argTypes:{kind:{control:`inline-radio`,options:c},size:{control:`inline-radio`,options:a},label:{control:`text`},disabled:{control:`boolean`},toggle:{control:`boolean`},selected:{control:`boolean`},href:{control:`text`}},args:{kind:`default`,size:`medium`,label:`Item Title`,disabled:!1,toggle:!1,selected:!1},decorators:[e=>(0,f.jsx)(`div`,{role:`menu`,children:(0,f.jsx)(e,{})})]},m={args:{IconLeft:o}},h={args:{toggle:!0,selected:!0,label:`Dark mode`,IconLeft:i}},g={args:{label:`Open documentation`,href:`https://example.com`,IconLeft:n}},_=[`default`,`danger`],v=[`small`,`medium`,`large`],y=[{label:`enabled (hover / active / focus me)`,disabled:!1},{label:`disabled`,disabled:!0}],b={parameters:{layout:`padded`},render:()=>(0,f.jsx)(`div`,{className:`gap-2xlg flex flex-col`,children:y.map(e=>(0,f.jsxs)(`div`,{className:`gap-sm flex flex-col`,children:[(0,f.jsx)(`div`,{className:`typography-label text-text-accent uppercase`,children:e.label}),(0,f.jsx)(`div`,{className:`gap-lg flex flex-wrap`,children:_.map(t=>v.map(n=>(0,f.jsxs)(`div`,{className:`gap-xs flex w-48 flex-col`,children:[(0,f.jsxs)(`div`,{className:`typography-label text-text-tertiary`,children:[t,` / `,n]}),(0,f.jsx)(s,{kind:t,size:n,disabled:e.disabled,label:`Item Title`,IconLeft:o})]},`${t}-${n}`)))})]},e.label))})},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
