import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Di as n,Ki as r,To as i,Ya as a,it as o,nt as s,pi as c,rt as l,t as u,ta as d,uo as f}from"./iframe-DmcAZirG.js";var p,m,h,g,_,v,y,b,x;e((()=>{u(),c(),p=t(a(),1),m=t(i(),1),h=f(),g={title:`Navigation/Navigation/NavigationItem`,component:s,tags:[`autodocs`],argTypes:{level:{control:`inline-radio`,options:l},size:{control:`inline-radio`,options:o},selected:{control:`boolean`},disabled:{control:`boolean`},expandable:{control:`boolean`},expanded:{control:`boolean`},title:{control:`text`},tooltip:{control:`text`}},args:{title:`Dashboard`,level:1,expandable:!1,selected:!1,disabled:!1,size:`default`},decorators:[e=>(0,h.jsx)(`div`,{className:(0,p.default)(`p-lg`,`w-72`,`bg-background`),children:(0,h.jsx)(e,{})})]},_={args:{icon:d}},v={parameters:{controls:{disable:!0}},render:()=>(0,h.jsxs)(`div`,{className:(0,p.default)(`gap-xlg`,`flex`,`flex-col`),children:[(0,h.jsxs)(`section`,{className:(0,p.default)(`gap-md`,`flex`,`flex-col`),children:[(0,h.jsx)(`h3`,{className:(0,p.default)(`typography-headline-04`,`text-text`),children:`Level 1 - default size`}),(0,h.jsx)(s,{title:`Enabled`,icon:d}),(0,h.jsx)(s,{title:`Selected`,icon:d,selected:!0}),(0,h.jsx)(s,{title:`Disabled`,icon:d,disabled:!0}),(0,h.jsx)(s,{title:`Expandable (collapsed)`,icon:r,expandable:!0}),(0,h.jsxs)(s,{title:`Expandable (expanded)`,icon:r,expandable:!0,defaultExpanded:!0,children:[(0,h.jsx)(s,{title:`Nested item`,level:2}),(0,h.jsx)(s,{title:`Another nested`,level:2})]})]}),(0,h.jsxs)(`section`,{className:(0,p.default)(`gap-md`,`flex`,`flex-col`),children:[(0,h.jsx)(`h3`,{className:(0,p.default)(`typography-headline-04`,`text-text`),children:`Level 2`}),(0,h.jsx)(s,{title:`Nested enabled`,level:2}),(0,h.jsx)(s,{title:`Nested selected`,level:2,selected:!0}),(0,h.jsx)(s,{title:`Nested disabled`,level:2,disabled:!0})]}),(0,h.jsxs)(`section`,{className:(0,p.default)(`gap-md`,`flex`,`flex-col`),children:[(0,h.jsx)(`h3`,{className:(0,p.default)(`typography-headline-04`,`text-text`),children:`Small - icon only with tooltip`}),(0,h.jsxs)(`div`,{className:(0,p.default)(`gap-sm`,`flex`,`flex-col`,`w-16`),children:[(0,h.jsx)(s,{size:`small`,icon:d,tooltip:`Dashboard`}),(0,h.jsx)(s,{size:`small`,icon:r,tooltip:`Projects`,selected:!0}),(0,h.jsx)(s,{size:`small`,icon:n,tooltip:`Settings`,disabled:!0})]})]})]})},y={parameters:{controls:{disable:!0}},render:function(){let[e,t]=m.useState(`projects`);return(0,h.jsxs)(`div`,{className:(0,p.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,h.jsx)(s,{title:`Dashboard`,icon:d,selected:e===null}),(0,h.jsxs)(s,{title:`Projects`,icon:r,expandable:!0,expanded:e===`projects`,onExpandedChange:e=>t(e?`projects`:null),children:[(0,h.jsx)(s,{title:`All projects`,level:2}),(0,h.jsx)(s,{title:`Archived`,level:2}),(0,h.jsx)(s,{title:`Templates`,level:2,disabled:!0})]}),(0,h.jsxs)(s,{title:`Settings`,icon:n,expandable:!0,expanded:e===`settings`,onExpandedChange:e=>t(e?`settings`:null),children:[(0,h.jsx)(s,{title:`Profile`,level:2}),(0,h.jsx)(s,{title:`Billing`,level:2})]})]})}},b={parameters:{controls:{disable:!0}},render:()=>(0,h.jsxs)(`div`,{className:(0,p.default)(`gap-sm`,`flex`,`flex-col`),children:[(0,h.jsx)(s,{title:`Dashboard`,icon:d,href:`#dashboard`,selected:!0}),(0,h.jsx)(s,{title:`Projects`,icon:r,href:`#projects`}),(0,h.jsx)(s,{title:`Settings`,icon:n,href:`#settings`})]})},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  args: {
    icon: IconDashboard
  }
