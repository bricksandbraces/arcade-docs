import{n as e}from"./chunk-jRWAZmH_.js";import{Ca as t,Fi as n,Gi as r,Hi as i,Mi as a,Si as o,Ta as s,_a as c,aa as l,ca as u,d,ga as f,gi as p,ia as m,l as h,pa as g,qi as _,ra as v,sa as y,t as b,u as x,wa as S,xo as C}from"./iframe-B6wnkTng.js";var w,T,E,D,O;e((()=>{b(),o(),w=C(),T={title:`Overlays & Menus/ContextMenu/ContextMenu`,component:h,tags:[`autodocs`],argTypes:{size:{control:`inline-radio`,options:x}},args:{size:`medium`},parameters:{layout:`centered`,docs:{description:{component:["Right-click menu attached to a trigger surface. Compose entries with `ContextMenuListItem` (optionally nested via `submenu`) and `Divider` for grouping.",``,"Breaking change from earlier versions: `ContextMenuList` was removed — compose items directly as `ContextMenu` children."].join(`
`)}}}},E=`select-none rounded-md border border-dashed border-border p-xlg text-center text-text typography-body-small`,D={render:e=>(0,w.jsxs)(h,{size:e.size,ariaLabel:`File actions`,trigger:(0,w.jsx)(`div`,{className:E,children:`Right-click anywhere in this area`}),children:[(0,w.jsx)(d,{label:`Cut`,shortcut:`⌘X`,IconLeft:g,onClick:()=>console.log(`Cut`)}),(0,w.jsx)(d,{label:`Copy`,shortcut:`⌘C`,IconLeft:f,onClick:()=>console.log(`Copy`)}),(0,w.jsx)(d,{label:`Paste`,shortcut:`⌘V`,IconLeft:c,onClick:()=>console.log(`Paste`)}),(0,w.jsx)(p,{}),(0,w.jsx)(d,{label:`Edit`,shortcut:`⌘E`,IconLeft:y,onClick:()=>console.log(`Edit`)}),(0,w.jsx)(d,{label:`Share`,IconLeft:n,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(d,{label:`Email`,IconLeft:r,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(d,{label:`New message`,IconLeft:r}),(0,w.jsx)(d,{label:`Reply to thread`,IconLeft:i})]})}),(0,w.jsx)(d,{label:`Copy link`,IconLeft:_,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(d,{label:`Full URL`,IconLeft:_}),(0,w.jsx)(d,{label:`Short URL`,IconLeft:_})]})}),(0,w.jsx)(d,{label:`Social`,IconLeft:n,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(d,{label:`Post to X`,IconLeft:t}),(0,w.jsx)(d,{label:`Share on LinkedIn`,IconLeft:S}),(0,w.jsx)(d,{label:`Share on Facebook`,IconLeft:s})]})})]})}),(0,w.jsx)(d,{label:`Download`,IconLeft:u,submenu:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(d,{label:`As PDF`,IconLeft:m}),(0,w.jsx)(d,{label:`As PNG`,IconLeft:v}),(0,w.jsx)(d,{label:`As CSV`,IconLeft:l})]})}),(0,w.jsx)(p,{}),(0,w.jsx)(d,{label:`Delete`,kind:`danger`,shortcut:`⌫`,IconLeft:a,onClick:()=>console.log(`Delete`)})]})},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
