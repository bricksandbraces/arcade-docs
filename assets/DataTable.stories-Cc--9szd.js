import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{F as n,I as r,L as i,O as a,P as o,Pa as s,Po as c,Sr as l,dr as u,fr as d,gr as f,hi as p,ln as m,sa as h,t as g,vr as _,xi as v,xr as y,yo as b,yr as x}from"./iframe-BXRL_JkN.js";function S({search:e,onSearchChange:t,filters:a,onFiltersChange:c}){let[l,u]=(0,w.useState)(`all`),[d,f]=(0,w.useState)(`list`);return(0,T.jsx)(i,{leftSlot:(0,T.jsx)(m,{id:`data-table-composition-view`,title:`View`,hideLabel:!0,inline:!0,size:`small`,reserveInlineNotificationHeight:!1,value:l,onChange:u,items:A}),rightSlot:(0,T.jsxs)(T.Fragment,{children:[(0,T.jsxs)(`div`,{className:`gap-2xs flex items-center`,children:[(0,T.jsx)(r,{value:d,onValueChange:f}),(0,T.jsx)(n,{value:e,onValueChange:t}),(0,T.jsx)(o,{groups:j,value:a,onValueChange:c})]}),(0,T.jsx)(`div`,{className:`py-sm flex items-center self-stretch`,children:(0,T.jsx)(p,{orientation:`vertical`,width:`0.5`,className:`min-h-[24px]`})}),(0,T.jsx)(s,{kind:`ghost`,size:`small`,label:`Export`,IconRight:h})]})})}function C(){if(typeof window>`u`)return{};try{let e=window.localStorage.getItem(K);if(!e)return{};let t=JSON.parse(e);if(t&&typeof t==`object`)return t}catch{}return{}}var w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q;e((()=>{g(),v(),w=t(c(),1),T=b(),E=[{name:`Ada Lovelace`,email:`ada@example.com`,role:`Admin`,status:`active`},{name:`Grace Hopper`,email:`grace@example.com`,role:`Editor`,status:`active`},{name:`Alan Turing`,email:`alan@example.com`,role:`Viewer`,status:`pending`},{name:`Katherine Johnson`,email:`katherine@example.com`,role:`Editor`,status:`inactive`},{name:`Margaret Hamilton`,email:`margaret@example.com`,role:`Admin`,status:`active`}],D=Array.from({length:47},(e,t)=>{let n=E[t%E.length],r=t+1;return{...n,id:String(r),name:`${n.name} #${r}`}}),O={active:`lime`,inactive:`gray`,pending:`orange`},k=10,A=[{label:`All members`,value:`all`},{label:`Admins only`,value:`admins`},{label:`Pending invites`,value:`pending`}],j=[{id:`role`,label:`Role`,options:[{value:`Admin`,label:`Admin`},{value:`Editor`,label:`Editor`},{value:`Viewer`,label:`Viewer`}]},{id:`status`,label:`Status`,options:[{value:`active`,label:`Active`},{value:`inactive`,label:`Inactive`},{value:`pending`,label:`Pending`}]}],M={role:`role`,status:`status`},N=[{key:`_index`,header:``,kind:`rowIndex`},{key:`name`,header:`Name`,sortable:!0},{key:`owner`,header:`Owner`,kind:`user`,render:e=>(0,T.jsx)(y,{name:e.name})},{key:`email`,header:`Email`,sortable:!0},{key:`role`,header:`Role`},{key:`status`,header:`Status`,kind:`badge`,render:e=>(0,T.jsx)(l,{color:O[e.status],children:e.status})}],P=[{key:`_index`,header:``,kind:`rowIndex`},{key:`name`,header:`Name`,sortable:!0,editable:!0},{key:`owner`,header:`Owner`,kind:`user`,render:e=>(0,T.jsx)(y,{name:e.name})},{key:`email`,header:`Email`,sortable:!0},{key:`role`,header:`Role`},{key:`status`,header:`Status`,kind:`badge`,render:e=>(0,T.jsx)(l,{color:O[e.status],children:e.status})}],F=[{id:`1`,firstName:`-`,lastName:`-`,email:`e2e@test.com`,role:`Owner`},{id:`2`,firstName:`Katherine`,lastName:`Johnson`,email:`katherine.johnson@example.com`,role:`Editor`},{id:`3`,firstName:`Margaret`,lastName:`Hamilton`,email:`margaret.hamilton@longsubdomain.example.com`,role:`Admin`}],I=[{key:`firstName`,header:`First name`},{key:`lastName`,header:`Last name`},{key:`email`,header:`Email`},{key:`role`,header:`Role`}],L={title:`Display & Data/DataTable/DataTable`,component:u,tags:[`autodocs`],argTypes:{selectionMode:{control:`inline-radio`,options:[`none`,`single`,`multiple`]},selectionControl:{control:`inline-radio`,options:d,description:`Row-index column control. Defaults: single → radio, multiple → checkbox. "multiple" always uses checkboxes.`}},args:{selectionMode:`none`,title:`Data Table`,subtitle:`A compact overview of the team.`},parameters:{docs:{description:{component:`Data grid with sorting, selection, and pagination. Use for dense tabular data where rows represent records and columns are consistent fields.`}}}},R={render:e=>{let[t,n]=(0,w.useState)(1),r=Math.max(1,Math.ceil(D.length/k)),i=Math.min(t,r);return(0,T.jsx)(`div`,{style:{width:960},children:(0,T.jsx)(u,{...e,columns:N,data:D,currentPage:i,rowsPerPage:k,footer:(0,T.jsx)(a,{currentPage:i,totalPages:r,onPageChange:n})})})}},z={args:{selectionMode:`single`},render:R.render},B={args:{selectionMode:`multiple`},render:R.render},V={args:{selectionMode:`single`},render:R.render},H={args:{selectionMode:`single`,selectionControl:`checkbox`},render:R.render},U={args:{selectionMode:`multiple`},render:e=>{let[t,n]=(0,w.useState)(1),[r,i]=(0,w.useState)(``),[o,s]=(0,w.useState)({}),[c,l]=(0,w.useState)(D.length),d=Math.max(1,Math.ceil(c/k)),f=Math.min(t,d);return(0,T.jsx)(`div`,{style:{width:960},children:(0,T.jsx)(u,{...e,className:`bg-transparent`,toolbar:(0,T.jsx)(S,{search:r,onSearchChange:e=>{i(e),n(1)},filters:o,onFiltersChange:e=>{s(e),n(1)}}),header:(0,T.jsx)(_,{title:`Team directory`,subtitle:`Search, filter, and manage workspace members.`}),columns:N,data:D,searchQuery:r,filters:o,filterKeys:M,onFilteredCountChange:l,currentPage:f,rowsPerPage:k,footer:(0,T.jsx)(a,{currentPage:f,totalPages:d,onPageChange:n})})})}},W={render:e=>(0,T.jsx)(`div`,{style:{width:960},children:(0,T.jsx)(u,{...e,columns:N,data:D})})},G={name:`With inline editable cells`,parameters:{docs:{description:{story:"The **Name** column uses `editable: true`. Click a cell to edit (pointer cursor); blur or Enter commits (updates local story state). Escape restores the previous value."}}},args:{selectionMode:`none`,title:`Editable cells`,subtitle:`Click a name to edit inline.`},render:e=>{let[t,n]=(0,w.useState)(()=>D.slice(0,12).map(e=>({...e})));return(0,T.jsx)(`div`,{style:{width:960},children:(0,T.jsx)(u,{...e,columns:P,data:t,onCellTextCommit:({rowId:e,columnKey:t,value:r})=>{n(n=>n.map(n=>n.id===e&&t===`name`?{...n,name:r}:n))}})})}},K=`arcade-storybook:datatable:column-widths`,q={name:`With persisted column widths`,parameters:{docs:{description:{story:"Columns are resizable; the widths are saved to `localStorage` so they persist across reloads. The story wires up `columnWidths` (controlled) + `onColumnWidthsChange`. Use the **Reset widths** button to clear the stored widths and fall back to auto sizing."}}},args:{selectionMode:`none`,title:`Persisted column widths`,subtitle:`Drag a header divider to resize. Reload to verify persistence.`},render:e=>{let[t,n]=(0,w.useState)(()=>C()),r=e=>{n(e);try{window.localStorage.setItem(K,JSON.stringify(e))}catch{}};return(0,T.jsxs)(`div`,{style:{width:960},className:`gap-md flex flex-col`,children:[(0,T.jsx)(`div`,{children:(0,T.jsx)(s,{kind:`ghost`,size:`small`,label:`Reset widths`,onClick:()=>{try{window.localStorage.removeItem(K)}catch{}n({})}})}),(0,T.jsx)(u,{...e,columns:N,data:D.slice(0,10),columnWidths:t,onColumnWidthsChange:r})]})}},J={render:e=>(0,T.jsx)(`div`,{style:{width:720},children:(0,T.jsxs)(u,{...e,title:`Recent activity`,subtitle:`Manually composed rows`,children:[(0,T.jsxs)(f,{showBorderTop:!0,showBorderBottom:!0,children:[(0,T.jsx)(x,{columnBorderRight:!0,children:`Deployment succeeded`}),(0,T.jsx)(x,{children:`2 minutes ago`})]}),(0,T.jsxs)(f,{children:[(0,T.jsx)(x,{columnBorderRight:!0,children:`Build finished`}),(0,T.jsx)(x,{children:`11 minutes ago`})]})]})})},Y={name:`Column alignment (auto-sized, narrow)`,parameters:{docs:{description:{story:"Short header labels with long body content in a deliberately narrow container, with no per-column `width` set. Header and body columns must stay aligned and overflow truncates with an ellipsis. Guards the `min-w-0` fix that keeps auto-sized flex columns from being widened by their content."}}},render:e=>(0,T.jsx)(`div`,{style:{width:460},children:(0,T.jsx)(u,{...e,title:`People`,subtitle:`Auto-sized columns must align header-to-body.`,columns:I,data:F})})},X=N.map(e=>e.kind===`rowIndex`?e:{...e,width:220}),Z={name:`Horizontal scroll fade`,parameters:{docs:{description:{story:`When the columns are wider than the container, the grid fades out towards every edge that still hides content - right only at the start, both once scrolled, left only at the end. The fade is a mask, so it works on any surface the table is placed on.`}}},render:e=>(0,T.jsx)(`div`,{style:{width:520},children:(0,T.jsx)(u,{...e,title:`People`,subtitle:`Scroll sideways - the faded edge marks the columns still out of view.`,columns:X,data:D.slice(0,6)})})},R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  render: args => {
