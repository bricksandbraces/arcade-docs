import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{No as n,Ot as r,Xr as i,Yr as a,Zr as o,t as s,vo as c}from"./iframe-Bu5mwsKt.js";import{n as l,t as u}from"./surfaceStoryShell-CxMW0EdU.js";var d,f,p,m,h,g,_,v,y,b,x,S,C,w,T;e((()=>{l(),d=t(n(),1),s(),f=c(),{action:p}=__STORYBOOK_MODULE_ACTIONS__,m={title:`Inputs & Controls/ColorInput`,component:r,tags:[`autodocs`],argTypes:{surface:{control:`inline-radio`,options:o},size:{control:`inline-radio`,options:a},state:{control:`inline-radio`,options:i},disabled:{control:`boolean`},hideLabel:{control:`boolean`},disablePicker:{control:`boolean`},loading:{control:`boolean`},label:{control:`text`},placeholder:{control:`text`},helperText:{control:`text`},successMessage:{control:`text`},warningMessage:{control:`text`},errorMessage:{control:`text`},loadingMessage:{control:`text`}},args:{surface:`default`,id:`playground-color-input`,label:`Brand color`,placeholder:`000000`,size:`medium`,helperText:`Enter a hex value or pick one from the palette`,errorMessage:`Please enter a valid hex color`,warningMessage:`This color may not meet contrast requirements`,successMessage:`Color saved`,loadingMessage:`Saving...`},parameters:{docs:{description:{component:"Hex color input with an integrated ColorPicker popover. Use for theme, brand, and component color settings. The leading `#` is visual only - the value is normalised to `#RRGGBB`."}}}},h={args:{},render:e=>{let[t,n]=(0,d.useState)(`#0291FF`);return(0,f.jsxs)(`div`,{className:`gap-md flex flex-col`,children:[(0,f.jsx)(r,{...e,value:t,onValueChange:n}),(0,f.jsxs)(`div`,{className:`typography-label text-text-accent`,children:[`Current value: `,(0,f.jsx)(`code`,{children:t??`-`})]})]})}},g=({size:e})=>{let[t,n]=(0,d.useState)(`#10B981`);return(0,f.jsx)(r,{id:`color-input-${e}`,label:`${e.charAt(0).toUpperCase()+e.slice(1)} size`,size:e,value:t,onValueChange:n})},_={parameters:{controls:{disable:!0}},render:()=>(0,f.jsx)(`div`,{className:`gap-lg flex flex-col`,children:a.map(e=>(0,f.jsx)(g,{size:e},e))})},v={args:{id:`error-color-input`,label:`Accent color`,state:`error`,errorMessage:`Please enter a valid hex color`},render:e=>{let[t,n]=(0,d.useState)(`#GGGGGG`);return(0,f.jsx)(r,{...e,value:t,onValueChange:n})}},y={args:{id:`warning-color-input`,label:`Background color`,state:`warning`,warningMessage:`Low contrast against body text`},render:e=>{let[t,n]=(0,d.useState)(`#F0F1F2`);return(0,f.jsx)(r,{...e,value:t,onValueChange:n})}},b={args:{id:`success-color-input`,label:`Brand color`,state:`success`,successMessage:`Looks good!`},render:e=>{let[t,n]=(0,d.useState)(`#0D9467`);return(0,f.jsx)(r,{...e,value:t,onValueChange:n})}},x={args:{id:`loading-color-input`,label:`Theme color`,loading:!0,loadingMessage:`Saving...`},render:e=>{let[t,n]=(0,d.useState)(`#FF923F`);return(0,f.jsx)(r,{...e,value:t,onValueChange:n})}},S={args:{id:`disabled-color-input`,label:`Theme color`,disabled:!0},render:e=>(0,f.jsx)(r,{...e,defaultValue:`#6366F1`,onValueChange:()=>{}})},C={args:{id:`no-picker-color-input`,label:`Hex value`,disablePicker:!0,helperText:`Type a hex value - picker is disabled`},render:e=>{let[t,n]=(0,d.useState)(`#15171A`);return(0,f.jsx)(r,{...e,value:t,onValueChange:n})}},w={render:e=>(0,f.jsx)(u,{children:t=>(0,f.jsx)(r,{...e,id:`color-input-${t}`,surface:t,value:`#6366F1`,onValueChange:p(`onValueChange`)})})},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {},
  render: args => {
