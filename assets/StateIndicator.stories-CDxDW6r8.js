import{n as e}from"./chunk-jRWAZmH_.js";import{mo as t,ni as n,t as r,ti as i}from"./iframe-ys9-gXlz.js";var a,o,s,c,l;e((()=>{r(),a=t(),o={title:`Display & Data/Avatar/StateIndicator`,component:n,tags:[`autodocs`],parameters:{docs:{description:{component:`Small status dot overlaid on avatars or list items to signal presence or activity (Online, Busy, Pending, …). Use sparingly — one indicator per surface.`}}}},s={args:{state:`Online`},argTypes:{state:{description:`The state of the indicator`,control:{type:`select`},options:[`Online`,`Offline`,`Busy`,`Pending`,`Notification`],defaultValue:`Online`}}},c={parameters:{controls:{disable:!0}},render:()=>(0,a.jsx)(`div`,{className:`gap-xlg flex flex-row`,children:i.map(e=>(0,a.jsx)(n,{state:e},e))})},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    state: "Online"
  },
  argTypes: {
