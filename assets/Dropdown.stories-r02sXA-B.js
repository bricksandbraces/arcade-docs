import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ai as n,Do as r,Ds as i,Fr as a,In as o,Ln as s,Mi as c,Sa as l,Xa as u,fs as d,ia as f,ji as p,oa as m,sn as h,t as g}from"./iframe-3giZHg2a.js";import{n as _,t as v}from"./figmaDesign-CO6i5n9C.js";import{n as y,t as b}from"./surfaceStoryShell-CkpWaZ4i.js";function x({id:e,rowConfig:t,filled:n}){let[r,i]=(0,C.useState)(n?`de`:null);return(0,w.jsx)(o,{id:e,label:`Label`,title:`Select`,size:t.size,disabled:t.disabled,inline:t.inline,state:t.state,value:r,onChange:i,items:D,helperText:`Helper Text`,errorMessage:`Error Message`,warningMessage:`Warning Message`,successMessage:`Erledigt`})}function S(){let[e,t]=(0,C.useState)([`item2`,`item4`]);return(0,w.jsx)(o,{id:`multiple-dropdown`,label:`Location`,title:`Select one or multiple locations`,size:`large`,fullWidth:!0,multiple:!0,value:e,onChange:t,items:[{label:`Berlin`,value:`item1`},{label:`Cologne`,value:`item2`},{label:`Hamburg`,value:`item3`},{label:`Munich`,value:`item4`},{label:`Stuttgart`,value:`item5`}],helperText:`Picking keeps the menu open. The chip clears the selection.`})}var C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;e((()=>{y(),C=t(i(),1),g(),f(),_(),w=d(),{expect:T,within:E}=__STORYBOOK_MODULE_TEST__,D=[{label:`Germany`,value:`de`},{label:`France`,value:`fr`},{label:`Spain`,value:`es`}],O={component:o,title:`Overlays & Menus/Dropdown`,tags:[`autodocs`],args:{surface:`default`,title:`Select an option`,size:`medium`,disabled:!1,inline:!1,fullWidth:!1,items:[{label:`Item 1`,value:`item1`},{label:`Item 2`,value:`item2`},{label:`Item 3`,value:`item3`,disabled:!0},{label:`Item 4`,value:`item4`},{label:`Item 5`,value:`item5`},{label:`Item 6`,value:`item6`},{label:`Item 7`,value:`item7`},{label:`Item 8`,value:`item8`},{label:`Item 9`,value:`item9`},{label:`Item 10`,value:`item10`}]},argTypes:{surface:{control:`inline-radio`,options:c},size:{control:`inline-radio`,options:n},disabled:{control:`boolean`},inline:{control:`boolean`},fullWidth:{control:`boolean`},label:{control:`text`},errorMessage:{control:`text`},warningMessage:{control:`text`},successMessage:{control:`text`},helperText:{control:`text`},hideLabel:{control:`boolean`},state:{control:`inline-radio`,options:p},selectionIndicator:{control:`inline-radio`,options:s}},render:e=>{let[t,n]=(0,C.useState)(null);return(0,w.jsx)(o,{...e,value:t,onChange:n})},parameters:{design:v(`https://www.figma.com/design/xkNZGbjGlGt3gFpuMWrdge/Arcade-Design-System?node-id=4513-3142`),docs:{description:{component:`Form field for picking one value from a list. Use when choices are short labels; prefer Select for typeahead over many options.`}}}},k={args:{id:`playground-dropdown`,label:`Select Option`,helperText:`Choose one of the available options.`,errorMessage:`Error Message`,warningMessage:`Warning Message`}},A={args:{...k.args,id:`slot-dropdown`,label:`Label`,trailingSlot:(0,w.jsx)(m,{size:10,className:`fill-icon-accent`,"aria-hidden":!0})}},j={args:{...k.args,id:`disabled-dropdown`,disabled:!0},play:async({canvas:e,canvasElement:t,userEvent:n})=>{let r=e.getByRole(`button`,{name:`Select an option`});await T(r).toHaveAttribute(`aria-disabled`,`true`),await T(r).toHaveAttribute(`aria-expanded`,`false`);let i=E(t.ownerDocument.body);await n.tab(),await T(r).toHaveFocus(),await n.keyboard(`{Enter}`),await n.keyboard(`{ArrowDown}`),await T(r).toHaveAttribute(`aria-expanded`,`false`),await T(i.queryByRole(`list`)).not.toBeInTheDocument(),await n.click(r),await T(r).toHaveAttribute(`aria-expanded`,`false`),await T(i.queryByRole(`list`)).not.toBeInTheDocument()}},M={parameters:{controls:{disable:!0},docs:{description:{story:"With `multiple`, the trigger keeps its placeholder and shows how many options are picked. The chip's close button clears them all."}}},render:()=>(0,w.jsx)(S,{})},N={parameters:{controls:{disable:!0}},args:{showLabels:!1},render:e=>{let t=n.toReversed().flatMap(e=>[{size:e,disabled:!1,inline:!1,state:`default`},{size:e,disabled:!0,inline:!1,state:`default`},{size:e,disabled:!1,inline:!0,state:`default`},{size:e,disabled:!1,inline:!1,state:`error`},{size:e,disabled:!1,inline:!1,state:`success`}]),r=p;return(0,w.jsx)(`div`,{className:`gap-xlg grid pb-[128px]`,style:{display:`grid`,gridTemplateColumns:`repeat(${r.length}, minmax(0, 1fr))`},children:t.map((t,n)=>r.map((r,i)=>{let a=`${r}-${t.size}-${t.disabled?`disabled`:`enabled`}-${t.state}-${t.inline?`inline`:`block`}`;return(0,w.jsxs)(`div`,{style:{gridColumn:`${i+1} / span 1`,gridRow:`${n+1} / span 1`},children:[e.showLabels?(0,w.jsxs)(`p`,{className:`typography-body-small text-text`,children:[`size=`,t.size,`, state=`,r,t.disabled?`, disabled`:``,t.inline?`, inline`:``,t.state===`default`?``:`, status=${t.state}`]}):null,(0,w.jsxs)(`div`,{className:`gap-sm flex flex-col`,children:[(0,w.jsx)(`div`,{className:`pb-[32px]`,children:(0,w.jsx)(x,{id:`${r}-${t.size}-${n}-empty`,rowConfig:t,filled:!1})}),(0,w.jsx)(`div`,{className:`pb-[32px]`,children:(0,w.jsx)(x,{id:`${r}-${t.size}-${n}-filled`,rowConfig:t,filled:!0})})]})]},a)}))})}},P={args:{showLabel:!0},argTypes:{showLabel:{control:`boolean`}},render:({showLabel:e})=>(0,w.jsx)(a,{showLabel:e})},F={parameters:{controls:{disable:!0},a11y:{test:`off`},chromatic:{disableSnapshot:!0}},render:()=>{let[e,t]=(0,C.useState)(!0),[n,i]=(0,C.useState)(null);return(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(r,{label:`Open modal`,onClick:()=>t(!0)}),(0,w.jsx)(h,{open:e,onClose:()=>t(!1),title:`Invite member`,subtitle:`Pick a role from the dropdown.`,layoutMode:`fixed`,children:(0,w.jsx)(o,{label:`Role`,title:`Select a role`,size:`large`,value:n,onChange:i,items:D,fullWidth:!0})})]})}},I={render:e=>(0,w.jsx)(b,{children:t=>(0,w.jsx)(o,{...e,id:`dropdown-${t}`,surface:t})})},L={args:{selectionIndicator:`leading`,title:`All Employees`,hideLabel:!0,inline:!0,items:[{label:`All Employees`,value:`all`},{label:`External employees`,value:`external`},{label:`New view`,value:`new`,IconLeft:l,separatorBefore:!0}]},render:e=>{let[t,n]=(0,C.useState)(`all`);return(0,w.jsx)(o,{...e,value:t,onChange:n})}},R={args:{selectionIndicator:`leading`,title:`All Employees`,hideLabel:!0,inline:!0,items:[{label:`All Employees`,value:`all`,actionSlot:(0,w.jsx)(r,{kind:`ghost`,size:`small`,variant:`rounded`,IconLeft:u,"aria-label":`Manage All Employees`})},{label:`External employees`,value:`external`,actionSlot:(0,w.jsx)(r,{kind:`ghost`,size:`small`,variant:`rounded`,IconLeft:u,"aria-label":`Manage External employees`})}]},render:e=>{let[t,n]=(0,C.useState)(`all`);return(0,w.jsx)(o,{...e,value:t,onChange:n})}},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  args: {
