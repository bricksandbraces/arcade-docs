import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Cr as n,Ii as r,J as i,Jr as a,Kr as o,Pr as s,Q as c,Tr as l,Ur as u,X as ee,Y as d,Z as f,Zi as p,Zr as m,dr as h,er as g,ft as _,gr as v,ir as y,lt as b,q as x,t as S,tt as C,wr as w,xi as T,zr as E}from"./iframe-B1mIPWxP.js";import{r as D,t as O}from"./react-CcnlDmhR.js";var k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{S(),g(),k=t(T(),1),O(),A=t(p(),1),j=r(),M={title:`Components/Navigation/Navigation`,component:C,tags:[`autodocs`],parameters:{layout:`fullscreen`,docs:{description:{component:`Collapsible side navigation with nested items. Use as the primary app chrome for switching between top-level sections.`}}}},N=e=>`/arcade-docs/assets/${e}`,P=({compact:e})=>{let t=N(e?`logo_small-dark.svg`:`logo_default-dark.svg`),n=N(e?`logo_small-light.svg`:`logo_default-light.svg`);return(0,j.jsx)(x,{compact:e,children:(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`img`,{src:t,alt:``,className:(0,k.default)(`dark:hidden`,e?`size-full object-contain`:`h-[20px] w-auto max-w-full`)}),(0,j.jsx)(`img`,{src:n,alt:``,className:(0,k.default)(`hidden`,`dark:block`,e?`size-full object-contain`:`h-[20px] w-auto max-w-full`)})]})})},F=[{id:`dashboard`,label:`Dashboard`,icon:s},{id:`projects`,label:`Projects`,icon:l,children:[{id:`projects-all`,label:`All projects`},{id:`projects-archived`,label:`Archived`},{id:`projects-templates`,label:`Templates`,disabled:!0}]},{id:`team`,label:`Team`,icon:y},{id:`reports`,label:`Reports`,icon:E},{id:`settings`,label:`Settings`,icon:h}],I=F.slice(0,3),L=F.slice(3),R=[{id:`help`,label:`Help`,icon:n},{id:`docs`,label:`Documentation`,icon:u}],z=[{id:`l2-overview`,label:`Overview`},{id:`l2-members`,label:`Members`},{id:`l2-settings`,label:`Settings`},{id:`l2-billing`,label:`Billing`,disabled:!0}],B=[s,l,y,E,h,o],V=Array.from({length:30},(e,t)=>({id:`overflow-item-${t}`,label:`Item ${t+1}`,icon:B[t%B.length]})),H=({items:e,expanded:t,selectedId:n,setSelectedId:r,openId:i,setOpenId:a})=>(0,j.jsx)(j.Fragment,{children:e.map(e=>{let o=!!e.children,s=i===e.id,l=n===e.id,u=s&&t;return(0,j.jsx)(c,{title:t?e.label:void 0,size:t?`default`:`small`,icon:e.icon,tooltip:t?void 0:e.label,selected:l&&!s,expandable:o,expanded:u,onExpandedChange:t=>a(t?e.id:null),onClick:()=>{e.children||r(e.id)},children:e.children?.map(e=>(0,j.jsx)(c,{title:e.label,level:2,disabled:e.disabled,selected:n===e.id,onClick:()=>{e.disabled||r(e.id)}},e.id))},e.id)})}),U=({expanded:e,selectedId:t,setSelectedId:n,openId:r,setOpenId:i})=>(0,j.jsx)(`div`,{className:`flex min-w-0 w-full shrink-0 flex-col gap-sm pt-sm`,children:(0,j.jsx)(H,{items:R,expanded:e,selectedId:t,setSelectedId:n,openId:r,setOpenId:i})}),W=({logo:e,logoHoverMinimize:t})=>{let[n,r]=A.useState(!0),[a,o]=A.useState(`dashboard`),[s,c]=A.useState(`projects`);return(0,j.jsxs)(`div`,{className:(0,k.default)(`bg-background-accent`,`flex`,`min-h-screen`),children:[(0,j.jsxs)(C,{expanded:n,onExpandedChange:r,logo:e(n),logoHoverMinimize:t,footer:(0,j.jsx)(U,{expanded:n,selectedId:a,setSelectedId:o,openId:s,setOpenId:c}),children:[(0,j.jsx)(H,{items:I,expanded:n,selectedId:a,setSelectedId:o,openId:s,setOpenId:c}),(0,j.jsx)(i,{children:`Main`}),(0,j.jsx)(H,{items:L,expanded:n,selectedId:a,setSelectedId:o,openId:s,setOpenId:c})]}),(0,j.jsx)(`div`,{className:(0,k.default)(`p-lg`,`typography-body-small`,`text-text`,`flex-1`)})]})},G={render:()=>(0,j.jsx)(W,{logo:e=>(0,j.jsx)(P,{compact:!e}),logoHoverMinimize:!0})},K=({trailingSlot:e})=>(0,j.jsxs)(`div`,{className:`gap-xs flex items-center`,children:[(0,j.jsx)(m,{kind:`ghost`,IconLeft:h,size:`medium`,"aria-label":`Settings`}),(0,j.jsx)(m,{kind:`ghost`,IconLeft:o,size:`medium`,"aria-label":`Notifications`}),(0,j.jsx)(m,{kind:`ghost`,IconLeft:v,size:`medium`,"aria-label":`Menu`}),e]}),q=()=>(0,j.jsx)(x,{compact:!0,children:(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`img`,{src:N(`logo_small-dark.svg`),alt:``,className:`size-full object-contain dark:hidden`}),(0,j.jsx)(`img`,{src:N(`logo_small-light.svg`),alt:``,className:`hidden size-full object-contain dark:block`})]})}),J=({drawerTrigger:e}={})=>{let[t,n]=A.useState(`products`);return(0,j.jsx)(b,{title:`Dashboard`,companyLogo:(0,j.jsx)(q,{}),companyLogoHref:`#`,backButton:(0,j.jsx)(m,{kind:`ghost`,IconLeft:a,size:`medium`,"aria-label":`Go back`}),linkGroupOne:(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(_,{selected:t===`products`,onClick:()=>n(`products`),children:`Products`}),(0,j.jsx)(_,{selected:t===`resources`,onClick:()=>n(`resources`),children:`Resources`})]}),actions:(0,j.jsx)(K,{trailingSlot:e})})},Y={parameters:{docs:{description:{story:"Pairs the Navigation sidebar with the Header `WithTwoLinks` setup to show a complete app shell: sidebar on the left, top bar above the content area."}}},render:function(){let[e,t]=A.useState(!0),[n,r]=A.useState(`dashboard`),[a,o]=A.useState(`projects`);return(0,j.jsxs)(`div`,{className:(0,k.default)(`bg-background-accent`,`flex`,`min-h-screen`),children:[(0,j.jsxs)(C,{expanded:e,onExpandedChange:t,logo:(0,j.jsx)(P,{compact:!e}),logoHoverMinimize:!0,footer:(0,j.jsx)(U,{expanded:e,selectedId:n,setSelectedId:r,openId:a,setOpenId:o}),children:[(0,j.jsx)(H,{items:I,expanded:e,selectedId:n,setSelectedId:r,openId:a,setOpenId:o}),(0,j.jsx)(i,{children:`Main`}),(0,j.jsx)(H,{items:L,expanded:e,selectedId:n,setSelectedId:r,openId:a,setOpenId:o})]}),(0,j.jsxs)(`div`,{className:`flex min-w-0 flex-1 flex-col`,children:[(0,j.jsx)(J,{}),(0,j.jsx)(`div`,{className:`p-lg typography-body-small text-text flex-1`})]})]})}},X={name:`withOverflowGradient`,parameters:{docs:{description:{story:`Thirty top-level rows plus a fixed footer strip (Help, Documentation). The bottom scroll-fade sits on the top edge of the footer, like the dialog pattern.`}}},render:function(){let[e,t]=A.useState(!0),[n,r]=A.useState(`overflow-item-0`),[i,a]=A.useState(null);return(0,j.jsxs)(`div`,{className:(0,k.default)(`bg-background-accent`,`flex`,`min-h-screen`),children:[(0,j.jsx)(C,{expanded:e,onExpandedChange:t,logo:(0,j.jsx)(P,{compact:!e}),logoHoverMinimize:!0,footer:(0,j.jsx)(U,{expanded:e,selectedId:n,setSelectedId:r,openId:i,setOpenId:a}),children:(0,j.jsx)(H,{items:V,expanded:e,selectedId:n,setSelectedId:r,openId:i,setOpenId:a})}),(0,j.jsx)(`div`,{className:(0,k.default)(`p-lg`,`typography-body-small`,`text-text`,`flex-1`)})]})}},Z={parameters:{docs:{description:{story:"Wraps a real consumer logo in `NavigationLogo`. The dashed-border placeholder styling is reserved for the empty/sample case and must not appear here."}}},render:()=>(0,j.jsx)(W,{logoHoverMinimize:!0,logo:e=>(0,j.jsx)(x,{compact:!e,children:e?(0,j.jsxs)(`span`,{className:`gap-sm flex items-center`,children:[(0,j.jsx)(`span`,{className:`bg-background-onlight text-text-ondark typography-label flex h-6 w-6 items-center justify-center rounded-md`,children:`A`}),(0,j.jsx)(`span`,{className:`typography-headline-06 text-text font-semibold`,children:`Acme Inc.`})]}):(0,j.jsx)(`span`,{className:`bg-background-onlight text-text-ondark typography-label flex size-full items-center justify-center rounded-md`,children:`A`})})})},Q={name:`withLevel2Sidebar`,parameters:{docs:{description:{story:"Shell uses **CSS Grid**: primary `Navigation` spans the full height of column 1; column 2 has row 1 = **`Header`** (full width of the main column, unaffected by L2) and row 2 = **L2** + scrollable main. Below `md`, an **app icon** in the header opens **`NavigationDrawer`** (L1); choosing **Settings** runs the same **month-slide** transition as the Datepicker calendar, then shows L2 with a **Back** row. Closing the drawer resets its stack: reopening always starts on L1, even if desktop still has **Settings** selected."}}},render:function(){let[e,t]=A.useState(!0),[n,r]=A.useState(`projects`),[a,o]=A.useState(`projects`),[s,c]=A.useState(`l2-overview`),[l,u]=A.useState(!1),[p,h]=A.useState(!1),[g,_]=A.useState(1),v=A.useCallback(e=>{r(t=>{let n=typeof e==`function`?e(t):e;return n===`settings`&&t!==`settings`&&_(1),n})},[]),y=A.useCallback(e=>{r(t=>{let n=typeof e==`function`?e(t):e;return n===`settings`&&t!==`settings`&&(_(1),h(!0)),n})},[]),b=()=>{_(-1),r(`dashboard`),h(!1)},x=()=>{u(!1),h(!1)},S=(0,j.jsx)(m,{kind:`ghost`,IconLeft:w,size:`medium`,"aria-label":`Open navigation`,className:`md:hidden`,onClick:()=>u(!0)}),T=(0,j.jsxs)(C,{layout:`drawer`,drawerCloseInDrawerShell:!0,expanded:!0,onExpandedChange:()=>{},logo:(0,j.jsx)(P,{compact:!1}),footer:(0,j.jsx)(U,{expanded:!0,selectedId:n,setSelectedId:y,openId:a,setOpenId:o}),children:[(0,j.jsx)(H,{items:I,expanded:!0,selectedId:n,setSelectedId:y,openId:a,setOpenId:o}),(0,j.jsx)(i,{children:`Main`}),(0,j.jsx)(H,{items:L,expanded:!0,selectedId:n,setSelectedId:y,openId:a,setOpenId:o})]}),E=(0,j.jsx)(f,{layout:`drawer`,ariaLabel:`Settings sections`,children:z.map(e=>(0,j.jsx)(d,{title:e.label,disabled:e.disabled,selected:s===e.id,onClick:()=>{e.disabled||c(e.id)}},e.id))});return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(`div`,{className:(0,k.default)(`bg-background-accent`,`grid min-h-[100svh]`,`grid-cols-[auto_minmax(0,1fr)]`,`grid-rows-[auto_minmax(0,1fr)]`),children:[(0,j.jsx)(`div`,{className:`col-start-1 row-start-1 row-span-2 min-h-0`,children:(0,j.jsxs)(C,{expanded:e,onExpandedChange:t,logo:(0,j.jsx)(P,{compact:!e}),logoHoverMinimize:!0,footer:(0,j.jsx)(U,{expanded:e,selectedId:n,setSelectedId:v,openId:a,setOpenId:o}),children:[(0,j.jsx)(H,{items:I,expanded:e,selectedId:n,setSelectedId:v,openId:a,setOpenId:o}),(0,j.jsx)(i,{children:`Main`}),(0,j.jsx)(H,{items:L,expanded:e,selectedId:n,setSelectedId:v,openId:a,setOpenId:o})]})}),(0,j.jsx)(`div`,{className:`col-start-2 row-start-1 min-w-0 self-start`,children:(0,j.jsx)(J,{drawerTrigger:S})}),(0,j.jsxs)(`div`,{className:(0,k.default)(`col-start-2 row-start-2`,`flex min-h-0 min-w-0`),children:[(0,j.jsx)(D,{children:n===`settings`?(0,j.jsx)(f,{ariaLabel:`Settings sections`,children:z.map(e=>(0,j.jsx)(d,{title:e.label,disabled:e.disabled,selected:s===e.id,onClick:()=>{e.disabled||c(e.id)}},e.id))},`navigation-l2`):null}),(0,j.jsx)(`div`,{className:(0,k.default)(`min-h-0 min-w-0 flex-1`,`p-lg`,`typography-body-small`,`text-text`,`overflow-auto`)})]})]}),(0,j.jsx)(ee,{open:l,onClose:x,stackDirection:g,showSecondary:p,onBack:b,secondaryTitle:`Settings`,primary:T,secondary:E})]})}},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{
